...
#ifndef INCLUDE_LSTME_POINT3_H_
#define INCLUDE_LSTME_POINT3_H_
...
template<typename T>
Point3<T>
operator-(const Point3<T>& a);

//! Computes (a, a, a) + (b.x, b.y, b.z).
template<typename T>
Point3<T>
operator+(T a, const Point3<T>& b);

//! Computes (a.x, a.y, a.z) + (b.x, b.y, b.z).
template<typename T>
Point3<T>
operator+(const Point3<T>& a, const Point3<T>& b);

//! Computes (a.x, a.y, a.z) - (b, b, b).
template<typename T>
Point3<T>
operator-(const Point3<T>& a, T b);
...
template<typename T>
Point3<T>
min(const Point3<T>& a, const Point3<T>& b);

//! Returns element-wise max point.
template<typename T>
Point3<T>
max(const Point3<T>& a, const Point3<T>& b);

//! Returns element-wise clamped point.
template<typename T>
Point3<T>
clamp(const Point3<T>& v, const Point3<T>& low, const Point3<T>& high);

//! Returns element-wise ceiled point.
template<typename T>
Point3<T>
ceil(const Point3<T>& a);

//! Returns element-wise floored point.
template<typename T>
Point3<T>
floor(const Point3<T>& a);
