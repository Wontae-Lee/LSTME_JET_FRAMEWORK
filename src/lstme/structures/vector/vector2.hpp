...
#ifndef INCLUDE_LSTME_VECTOR2_H_
#define INCLUDE_LSTME_VECTOR2_H_
...
template<typename T>
Vector2<T>
operator+(T a, const Vector2<T>& b);
...
template<typename T>
Vector2<T>
operator-(const Vector2<T>& a, T b);
...
template<typename T>
Vector2<T>
min(const Vector2<T>& a, const Vector2<T>& b);

//! Returns element-wise max vector: (max(a.x, b.x), max(a.y, b.y)).
template<typename T>
Vector2<T>
max(const Vector2<T>& a, const Vector2<T>& b);

//! Returns element-wise clamped vector.
template<typename T>
Vector2<T>
clamp(const Vector2<T>& v, const Vector2<T>& low, const Vector2<T>& high);

//! Returns element-wise ceiled vector.
template<typename T>
Vector2<T>
ceil(const Vector2<T>& a);

//! Returns element-wise floored vector.
template<typename T>
Vector2<T>
floor(const Vector2<T>& a);
...
template<typename T>
Vector2<T>
monotonicCatmullRom(const Vector2<T>& v0,
                    const Vector2<T>& v1,
                    const Vector2<T>& v2,
                    const Vector2<T>& v3,
                    T f);
...
#endif // INCLUDE_LSTME_VECTOR2_H_
