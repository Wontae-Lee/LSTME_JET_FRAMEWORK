...
template<typename T>
void
Octree<T>::build(const std::vector<T>& items,
...
Octree<T>::nearest(const Vector3D& pt,
...
template<typename T>
bool
Octree<T>::intersects(const BoundingBox3D& box,
...
template<typename T>
bool
Octree<T>::intersects(const Ray3D& ray,
...
template<typename T>
void
Octree<T>::forEachIntersectingItem(
