...
#ifndef SRC_LSTME_PHYSICS_HELPERS_H_
#define SRC_LSTME_PHYSICS_HELPERS_H_
...
inline Vector2D
computeDragForce(double dragCoefficient,
                 double radius,
...
projectAndApplyFriction(const Vector<double, N>& vel,
...
inline double
computePressureFromEos(double density,
...
#endif // SRC_LSTME_PHYSICS_HELPERS_H_
