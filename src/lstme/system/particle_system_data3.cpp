...
#include <generated/particle_system_data3_generated.hpp>
...
ParticleSystemData3::ParticleSystemData3(size_t numberOfParticles)
{
  ...
  _neighborSearcher =
    std::make_shared<PointParallelHashGridSearcher3>(kDefaultHashGridResolution,
...
void
ParticleSystemData3::addParticle(const Vector3D& newPosition,
...
void
ParticleSystemData3::addParticles(
...
void
ParticleSystemData3::serializeParticleSystemData(
  ...
  flatbuffers::Offset<fbs::ParticleSystemData3>* fbsParticleSystemData) const
{
  ...
  // Copy the searcher
  *fbsParticleSystemData = fbs::CreateParticleSystemData3(*builder,
                                                          _radius,
                                                          _mass,
                                                          _positionIdx,
                                                          _velocityIdx,
...
void
ParticleSystemData3::deserializeParticleSystemData(
  const fbs::ParticleSystemData3* fbsParticleSystemData)
{
  ...
  _neighborSearcher =
    Factory::buildPointNeighborSearcher3(fbsNeighborSearcher->type()->c_str());
  std::vector<uint8_t> neighborSearcherSerialized(
