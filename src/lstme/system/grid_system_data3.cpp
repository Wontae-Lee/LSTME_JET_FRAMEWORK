...
#include <generated/grid_system_data3_generated.hpp>
...
GridSystemData3::GridSystemData3(const GridSystemData3& other)
{
  ...
  _velocity =
    std::dynamic_pointer_cast<FaceCenteredGrid3>(_advectableVectorDataList[0]);
...
void
GridSystemData3::resize(const Size3& resolution,
                        const Vector3D& gridSpacing,
                        const Vector3D& origin)
{
...
size_t
GridSystemData3::addScalarData(const ScalarGridBuilder3Ptr& builder,
                               double initialVal)
{
...
size_t
GridSystemData3::addVectorData(const VectorGridBuilder3Ptr& builder,
...
size_t
GridSystemData3::addAdvectableScalarData(const ScalarGridBuilder3Ptr& builder,
                                         double initialVal)
{
...
size_t
GridSystemData3::addAdvectableVectorData(const VectorGridBuilder3Ptr& builder,
                                         const Vector3D& initialVal)
{
...
GridSystemData3::serialize(std::vector<uint8_t>* buffer) const
{
  ...
  auto gsd =
    fbs::CreateGridSystemData3(builder,
                               &resolution,
                               &gridSpacing,
                               &origin,
                               _velocityIdx,
...
GridSystemData3::deserialize(const std::vector<uint8_t>& buffer)
{
  ...
  deserializeGrid(
    gsd->scalarData(), Factory::buildScalarGrid3, &_scalarDataList);
  deserializeGrid(
    gsd->vectorData(), Factory::buildVectorGrid3, &_vectorDataList);
