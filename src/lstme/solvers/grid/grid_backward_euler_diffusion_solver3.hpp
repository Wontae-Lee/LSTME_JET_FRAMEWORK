...
#ifndef INCLUDE_LSTME_GRID_BACKWARD_EULER_DIFFUSION_SOLVER3_H_
#define INCLUDE_LSTME_GRID_BACKWARD_EULER_DIFFUSION_SOLVER3_H_
...
private:
  ...
  void buildVectors(const ConstArrayAccessor3<Vector3D>& f,
                    const Vector3D& c,
                    size_t component);
};
...
#endif // INCLUDE_LSTME_GRID_BACKWARD_EULER_DIFFUSION_SOLVER3_H_
