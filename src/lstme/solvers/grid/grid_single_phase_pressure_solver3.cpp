...
void
GridSinglePhasePressureSolver3::buildMarkers(
  const Size3& size,
...
void
GridSinglePhasePressureSolver3::buildSystem(const FaceCenteredGrid3& input,
                                            bool useCompressed)
{
  Size3 size = input.resolution();
  size_t numLevels = 1;
...
void
GridSinglePhasePressureSolver3::applyPressureGradient(
  const FaceCenteredGrid3& input,
  FaceCenteredGrid3* output)
{
  Size3 size = input.resolution();
