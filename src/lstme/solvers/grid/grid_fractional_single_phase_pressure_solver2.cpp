...
void
GridFractionalSinglePhasePressureSolver2::solve(
  const FaceCenteredGrid2& input,
...
void
GridFractionalSinglePhasePressureSolver2::buildWeights(
  const FaceCenteredGrid2& input,
  const ScalarField2& boundarySdf,
  const VectorField2& boundaryVelocity,
  const ScalarField2& fluidSdf)
...
void
GridFractionalSinglePhasePressureSolver2::buildSystem(
  const FaceCenteredGrid2& input,
  bool useCompressed)
{
...
void
GridFractionalSinglePhasePressureSolver2::applyPressureGradient(
  const FaceCenteredGrid2& input,
  FaceCenteredGrid2* output)
{
  Size2 size = input.resolution();
