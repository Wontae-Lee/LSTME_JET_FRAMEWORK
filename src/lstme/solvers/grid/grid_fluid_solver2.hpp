...
#ifndef INCLUDE_LSTME_GRID_FLUID_SOLVER2_H_
#define INCLUDE_LSTME_GRID_FLUID_SOLVER2_H_
...
public:
  ...
  GridFluidSolver2(const Size2& resolution,
  ...
  //!
  void resizeGrid(const Size2& newSize,
...
template<typename T>
T&
GridFluidSolverBuilderBase2<T>::withResolution(const Size2& resolution)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase2<T>::withGridSpacing(const Vector2D& gridSpacing)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase2<T>::withGridSpacing(double gridSpacing)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase2<T>::withDomainSizeX(double domainSizeX)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase2<T>::withOrigin(const Vector2D& gridOrigin)
{
...
template<typename T>
Vector2D
GridFluidSolverBuilderBase2<T>::getGridSpacing() const
{
...
public:
  ...
  GridFluidSolver2Ptr makeShared() const
  {
    return std::make_shared<GridFluidSolver2>(
      _resolution, getGridSpacing(), _gridOrigin);
  }
};

} // namespace lstme

#endif // INCLUDE_LSTME_GRID_FLUID_SOLVER2_H_
