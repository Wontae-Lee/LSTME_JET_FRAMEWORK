...
#ifndef INCLUDE_LSTME_GRID_FLUID_SOLVER3_H_
#define INCLUDE_LSTME_GRID_FLUID_SOLVER3_H_
...
public:
  ...
  GridFluidSolver3(const Size3& resolution,
  ...
  //!
  void resizeGrid(const Size3& newSize,
...
#endif // INCLUDE_LSTME_GRID_FLUID_SOLVER3_H_
