...
#ifndef INCLUDE_LSTME_GRID_BACKWARD_EULER_DIFFUSION_SOLVER2_H_
#define INCLUDE_LSTME_GRID_BACKWARD_EULER_DIFFUSION_SOLVER2_H_
...
private:
  ...
  void buildVectors(const ConstArrayAccessor2<Vector2D>& f,
                    const Vector2D& c,
                    size_t component);
};
...
#endif // INCLUDE_LSTME_GRID_BACKWARD_EULER_DIFFUSION_SOLVER2_H_
