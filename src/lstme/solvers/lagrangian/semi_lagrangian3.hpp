...
#ifndef INCLUDE_LSTME_SEMI_LAGRANGIAN3_H_
#define INCLUDE_LSTME_SEMI_LAGRANGIAN3_H_
...
private:
  Vector3D backTrace(const VectorField3& flow,
                     double dt,
                     double h,
                     const Vector3D& pt0,
                     const ScalarField3& boundarySdf);
...
#endif // INCLUDE_LSTME_SEMI_LAGRANGIAN3_H_
