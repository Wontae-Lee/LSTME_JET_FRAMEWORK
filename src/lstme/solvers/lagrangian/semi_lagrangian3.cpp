...
void
SemiLagrangian3::advect(const ScalarGrid3& input,
                        ...
                        const ScalarField3& boundarySdf)
{
  ...
  double h = min3(
    output->gridSpacing().x, output->gridSpacing().y, output->gridSpacing().z);
...
Vector3D
SemiLagrangian3::backTrace(const VectorField3& flow,
                           double dt,
                           double h,
