...
public:
  ...
  //! radius.
  SphSolver3(double targetDensity,
...
template<typename T>
T&
SphSolverBuilderBase3<T>::withTargetDensity(double targetDensity)
{
...
template<typename T>
T&
SphSolverBuilderBase3<T>::withTargetSpacing(double targetSpacing)
{
...
template<typename T>
T&
SphSolverBuilderBase3<T>::withRelativeKernelRadius(double relativeKernelRadius)
{
...
#endif // INCLUDE_LSTME_SPH_SOLVER3_H_
