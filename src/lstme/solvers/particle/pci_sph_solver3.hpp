...
#ifndef INCLUDE_LSTME_PCI_SPH_SOLVER3_H_
#define INCLUDE_LSTME_PCI_SPH_SOLVER3_H_
...
public:
  ...
  //! radius.
  PciSphSolver3(double targetDensity,
...
#endif // INCLUDE_LSTME_PCI_SPH_SOLVER3_H_
