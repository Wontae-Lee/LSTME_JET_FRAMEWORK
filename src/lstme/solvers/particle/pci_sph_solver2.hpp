...
#ifndef INCLUDE_LSTME_PCI_SPH_SOLVER2_H_
#define INCLUDE_LSTME_PCI_SPH_SOLVER2_H_
...
public:
  ...
  //! radius.
  PciSphSolver2(double targetDensity,
...
#endif // INCLUDE_LSTME_PCI_SPH_SOLVER2_H_
