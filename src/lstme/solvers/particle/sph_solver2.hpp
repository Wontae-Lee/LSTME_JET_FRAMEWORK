...
#ifndef INCLUDE_LSTME_SPH_SOLVER2_H_
#define INCLUDE_LSTME_SPH_SOLVER2_H_
...
public:
  ...
  //! radius.
  SphSolver2(double targetDensity,
...
template<typename T>
T&
SphSolverBuilderBase2<T>::withTargetDensity(double targetDensity)
{
...
template<typename T>
T&
SphSolverBuilderBase2<T>::withTargetSpacing(double targetSpacing)
{
...
template<typename T>
T&
SphSolverBuilderBase2<T>::withRelativeKernelRadius(double relativeKernelRadius)
{
...
#endif // INCLUDE_LSTME_SPH_SOLVER2_H_
