...
PciSphSolver3::PciSphSolver3(double targetDensity,
...
double
PciSphSolver3::maxDensityErrorRatio() const
{
  return _maxDensityErrorRatio;
}

void
PciSphSolver3::setMaxDensityErrorRatio(double ratio)
{
  _maxDensityErrorRatio = std::max(ratio, 0.0);
}

unsigned int
PciSphSolver3::maxNumberOfIterations() const
{
  return _maxNumberOfIterations;
}

void
PciSphSolver3::setMaxNumberOfIterations(unsigned int n)
{
  _maxNumberOfIterations = n;
}

void
PciSphSolver3::accumulatePressureForce(double timeIntervalInSeconds)
{
...
void
PciSphSolver3::onBeginAdvanceTimeStep(double timeStepInSeconds)
{
...
double
PciSphSolver3::computeDelta(double timeStepInSeconds)
{
  auto particles = sphSystemData();
...
double
PciSphSolver3::computeBeta(double timeStepInSeconds)
{
  auto particles = sphSystemData();
