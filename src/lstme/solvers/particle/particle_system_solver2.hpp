...
#ifndef INCLUDE_LSTME_PARTICLE_SYSTEM_SOLVER2_H_
#define INCLUDE_LSTME_PARTICLE_SYSTEM_SOLVER2_H_
...
template<typename T>
T&
ParticleSystemSolverBuilderBase2<T>::withRadius(double radius)
{
  _radius = radius;
...
template<typename T>
T&
ParticleSystemSolverBuilderBase2<T>::withMass(double mass)
{
  _mass = mass;
  return static_cast<T&>(*this);
}
...
#endif // INCLUDE_LSTME_PARTICLE_SYSTEM_SOLVER2_H_
