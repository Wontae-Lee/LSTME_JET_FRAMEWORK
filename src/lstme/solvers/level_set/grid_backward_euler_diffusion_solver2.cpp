...
void
GridBackwardEulerDiffusionSolver2::setLinearSystemSolver(
...
void
GridBackwardEulerDiffusionSolver2::buildMarkers(
  const Size2& size,
...
void
GridBackwardEulerDiffusionSolver2::buildMatrix(const Size2& size,
                                               const Vector2D& c)
{
...
void
GridBackwardEulerDiffusionSolver2::buildVectors(
