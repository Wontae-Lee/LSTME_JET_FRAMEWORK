...
#ifndef INCLUDE_LSTME_LEVEL_SET_SOLVER3_H_
#define INCLUDE_LSTME_LEVEL_SET_SOLVER3_H_
...
public:
  ...
  //!
  virtual void reinitialize(const ScalarGrid3& inputSdf,
                            double maxDistance,
  ...
  //!
  virtual void extrapolate(const ScalarGrid3& input,
...
#endif // INCLUDE_LSTME_LEVEL_SET_SOLVER3_H_
