...
void
IterativeLevelSetSolver2::reinitialize(const ScalarGrid2& inputSdf,
                                       double maxDistance,
...
void
IterativeLevelSetSolver2::extrapolate(const ScalarGrid2& input,
...
void
IterativeLevelSetSolver2::extrapolate(const CollocatedVectorGrid2& input,
                                      const ScalarField2& sdf,
                                      double maxDistance,
...
void
IterativeLevelSetSolver2::extrapolate(const FaceCenteredGrid2& input,
                                      const ScalarField2& sdf,
                                      double maxDistance,
...
unsigned int
IterativeLevelSetSolver2::distanceToNumberOfIterations(double distance,
                                                       double dtau)
{
...
double
IterativeLevelSetSolver2::sign(const ConstArrayAccessor2<double>& sdf,
                               const Vector2D& gridSpacing,
                               size_t i,
                               size_t j)
{
...
double
IterativeLevelSetSolver2::pseudoTimeStep(ConstArrayAccessor2<double> sdf,
                                         const Vector2D& gridSpacing)
{
