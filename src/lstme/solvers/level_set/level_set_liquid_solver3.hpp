...
#ifndef INCLUDE_LSTME_LEVEL_SET_LIQUID_SOLVER3_H_
#define INCLUDE_LSTME_LEVEL_SET_LIQUID_SOLVER3_H_
...
public:
  ...
  LevelSetLiquidSolver3(const Size3& resolution,
...
#endif // INCLUDE_LSTME_LEVEL_SET_LIQUID_SOLVER3_H_
