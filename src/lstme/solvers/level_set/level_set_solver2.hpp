...
#ifndef INCLUDE_LSTME_LEVEL_SET_SOLVER2_H_
#define INCLUDE_LSTME_LEVEL_SET_SOLVER2_H_
...
public:
  ...
  //!
  virtual void reinitialize(const ScalarGrid2& inputSdf,
                            double maxDistance,
  ...
  //!
  virtual void extrapolate(const ScalarGrid2& input,
...
#endif // INCLUDE_LSTME_LEVEL_SET_SOLVER2_H_
