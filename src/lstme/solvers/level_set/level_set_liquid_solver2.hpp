...
#ifndef INCLUDE_LSTME_LEVEL_SET_LIQUID_SOLVER2_H_
#define INCLUDE_LSTME_LEVEL_SET_LIQUID_SOLVER2_H_
...
public:
  ...
  LevelSetLiquidSolver2(const Size2& resolution,
...
#endif // INCLUDE_LSTME_LEVEL_SET_LIQUID_SOLVER2_H_
