...
void
GridBlockedBoundaryConditionSolver2::constrainVelocity(
  FaceCenteredGrid2* velocity,
  unsigned int extrapolationDepth)
{
  GridFractionalBoundaryConditionSolver2::constrainVelocity(velocity,
                                                            extrapolationDepth);
...
void
GridBlockedBoundaryConditionSolver2::onColliderUpdated(
