...
#ifndef INCLUDE_LSTME_FDM_GAUSS_SEIDEL_SOLVER2_H_
#define INCLUDE_LSTME_FDM_GAUSS_SEIDEL_SOLVER2_H_
...
public:
  ...
  static void relax(const FdmMatrix2& A,
                    const FdmVector2& b,
                    double sorFactor,
                    FdmVector2* x);
  ...
  //!        compressed sys.
  static void relax(const MatrixCsrD& A,
                    const VectorND& b,
                    double sorFactor,
                    VectorND* x);

  //! Performs single Red-Black Gauss-Seidel relaxation step.
  static void relaxRedBlack(const FdmMatrix2& A,
                            const FdmVector2& b,
                            double sorFactor,
                            FdmVector2* x);
...
#endif // INCLUDE_LSTME_FDM_GAUSS_SEIDEL_SOLVER2_H_
