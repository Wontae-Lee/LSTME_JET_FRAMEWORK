...
#ifndef INCLUDE_LSTME_FDM_GAUSS_SEIDEL_SOLVER3_H_
#define INCLUDE_LSTME_FDM_GAUSS_SEIDEL_SOLVER3_H_
...
public:
  ...
  static void relax(const FdmMatrix3& A,
                    const FdmVector3& b,
                    double sorFactor,
                    FdmVector3* x);
  ...
  static void relaxRedBlack(const FdmMatrix3& A,
                            const FdmVector3& b,
                            double sorFactor,
                            FdmVector3* x);
...
#endif // INCLUDE_LSTME_FDM_GAUSS_SEIDEL_SOLVER3_H_
