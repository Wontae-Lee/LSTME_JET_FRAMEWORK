...
#ifndef FLATBUFFERS_GENERATED_SPHSYSTEMDATA3_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_SPHSYSTEMDATA3_LSTME_FBS_H_

#include <flatbuffers.hpp>

#include "basic_types_generated.hpp"
#include "particle_system_data3_generated.hpp"
...
struct SphSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  const lstme::fbs::ParticleSystemData3* base() const
  {
    return GetPointer<const lstme::fbs::ParticleSystemData3*>(VT_BASE);
  }
...
struct SphSystemData3Builder
{
  ...
  void add_base(flatbuffers::Offset<lstme::fbs::ParticleSystemData3> base)
  {
  ...
  void add_targetDensity(double targetDensity)
  {
    fbb_.AddElement<double>(
      SphSystemData3::VT_TARGETDENSITY, targetDensity, 0.0);
  }
  void add_targetSpacing(double targetSpacing)
  {
    fbb_.AddElement<double>(
      SphSystemData3::VT_TARGETSPACING, targetSpacing, 0.0);
  }
  void add_kernelRadiusOverTargetSpacing(double kernelRadiusOverTargetSpacing)
  {
    fbb_.AddElement<double>(SphSystemData3::VT_KERNELRADIUSOVERTARGETSPACING,
...
CreateSphSystemData3(
  flatbuffers::FlatBufferBuilder& _fbb,
  flatbuffers::Offset<lstme::fbs::ParticleSystemData3> base = 0,
...
inline const lstme::fbs::SphSystemData3*
GetSphSystemData3(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::SphSystemData3>(buf);
}

inline bool
VerifySphSystemData3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::SphSystemData3>(nullptr);
}

inline void
FinishSphSystemData3Buffer(flatbuffers::FlatBufferBuilder& fbb,
                           flatbuffers::Offset<lstme::fbs::SphSystemData3> root)
{
  fbb.Finish(root);
}
...
#endif // FLATBUFFERS_GENERATED_SPHSYSTEMDATA3_LSTME_FBS_H_
