...
#ifndef FLAT_DATA_GENERATED
#define FLAT_DATA_GENERATED
...
{
  return lstme::fbs::CreateFlatData(
    _fbb, data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}

inline const lstme::fbs::FlatData*
GetFlatData(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::FlatData>(buf);
}

inline bool
VerifyFlatDataBuffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::FlatData>(nullptr);
}

inline void
FinishFlatDataBuffer(flatbuffers::FlatBufferBuilder& fbb,
                     flatbuffers::Offset<lstme::fbs::FlatData> root)
{
  fbb.Finish(root);
}
