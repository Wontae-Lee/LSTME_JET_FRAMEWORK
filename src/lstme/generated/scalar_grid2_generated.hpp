...
#ifndef SCALAR_GRID2_GENERATED
#define SCALAR_GRID2_GENERATED
...
{
  return lstme::fbs::CreateScalarGrid2(_fbb,
                                       resolution,
                                       gridSpacing,
                                       origin,
...
inline const lstme::fbs::ScalarGrid2*
GetScalarGrid2(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::ScalarGrid2>(buf);
}

inline bool
VerifyScalarGrid2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::ScalarGrid2>(nullptr);
}

inline void
FinishScalarGrid2Buffer(flatbuffers::FlatBufferBuilder& fbb,
                        flatbuffers::Offset<lstme::fbs::ScalarGrid2> root)
{
  fbb.Finish(root);
}
