...
#ifndef VECTOR_GRID3_GENERATED
#define VECTOR_GRID3_GENERATED
...
inline flatbuffers::Offset<VectorGrid3>
CreateVectorGrid3(flatbuffers::FlatBufferBuilder& _fbb,
...
inline flatbuffers::Offset<VectorGrid3>
CreateVectorGrid3Direct(flatbuffers::FlatBufferBuilder& _fbb,
                        const lstme::fbs::Size3* resolution = 0,
                        const lstme::fbs::Vector3D* gridSpacing = 0,
                        const lstme::fbs::Vector3D* origin = 0,
                        const std::vector<double>* data = nullptr)
{
  return lstme::fbs::CreateVectorGrid3(_fbb,
                                       resolution,
                                       gridSpacing,
                                       origin,
...
inline const lstme::fbs::VectorGrid3*
GetVectorGrid3(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::VectorGrid3>(buf);
}

inline bool
VerifyVectorGrid3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::VectorGrid3>(nullptr);
}

inline void
FinishVectorGrid3Buffer(flatbuffers::FlatBufferBuilder& fbb,
                        flatbuffers::Offset<lstme::fbs::VectorGrid3> root)
{
  fbb.Finish(root);
}
