...
#ifndef GRID_SYSTEM_DATA3_GENERATED
#define GRID_SYSTEM_DATA3_GENERATED
...
struct ScalarGridSerialized3 FLATBUFFERS_FINAL_CLASS
...
inline flatbuffers::Offset<ScalarGridSerialized3>
CreateScalarGridSerialized3Direct(flatbuffers::FlatBufferBuilder& _fbb,
                                  const char* type = nullptr,
                                  const std::vector<uint8_t>* data = nullptr)
{
  return lstme::fbs::CreateScalarGridSerialized3(
    _fbb,
    type ? _fbb.CreateString(type) : 0,
    data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}

struct VectorGridSerialized3 FLATBUFFERS_FINAL_CLASS
  : private flatbuffers::Table
{
  enum
  {
...
inline flatbuffers::Offset<VectorGridSerialized3>
CreateVectorGridSerialized3Direct(flatbuffers::FlatBufferBuilder& _fbb,
                                  const char* type = nullptr,
                                  const std::vector<uint8_t>* data = nullptr)
{
  return lstme::fbs::CreateVectorGridSerialized3(
    _fbb,
    type ? _fbb.CreateString(type) : 0,
    data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
struct GridSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  const lstme::fbs::Vector3D* gridSpacing() const
  {
    return GetStruct<const lstme::fbs::Vector3D*>(VT_GRIDSPACING);
  }
  const lstme::fbs::Vector3D* origin() const
  {
    return GetStruct<const lstme::fbs::Vector3D*>(VT_ORIGIN);
  }
  uint64_t velocityIdx() const { return GetField<uint64_t>(VT_VELOCITYIDX, 0); }
  const flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized3>>*
  scalarData() const
  {
    return GetPointer<
      const flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized3>>*>(
  ...
  const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>>*
  vectorData() const
  {
    return GetPointer<
      const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>>*>(
  ...
  const flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized3>>*
  advectableScalarData() const
  {
    return GetPointer<
      const flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized3>>*>(
      VT_ADVECTABLESCALARDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>>*
  advectableVectorData() const
  {
    return GetPointer<
      const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>>*>(
      VT_ADVECTABLEVECTORDATA);
  }
  bool Verify(flatbuffers::Verifier& verifier) const
  {
    return VerifyTableStart(verifier) &&
           VerifyField<lstme::fbs::Size3>(verifier, VT_RESOLUTION) &&
           VerifyField<lstme::fbs::Vector3D>(verifier, VT_GRIDSPACING) &&
           VerifyField<lstme::fbs::Vector3D>(verifier, VT_ORIGIN) &&
...
struct GridSystemData3Builder
{
  ...
  void add_gridSpacing(const lstme::fbs::Vector3D* gridSpacing)
  {
    fbb_.AddStruct(GridSystemData3::VT_GRIDSPACING, gridSpacing);
  }
  void add_origin(const lstme::fbs::Vector3D* origin)
  {
  ...
  void add_scalarData(flatbuffers::Offset<flatbuffers::Vector<
                        flatbuffers::Offset<ScalarGridSerialized3>>> scalarData)
  {
    fbb_.AddOffset(GridSystemData3::VT_SCALARDATA, scalarData);
  }
  void add_vectorData(flatbuffers::Offset<flatbuffers::Vector<
                        flatbuffers::Offset<VectorGridSerialized3>>> vectorData)
  {
    fbb_.AddOffset(GridSystemData3::VT_VECTORDATA, vectorData);
  }
  void add_advectableScalarData(
    flatbuffers::Offset<
      flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized3>>>
      advectableScalarData)
  {
    fbb_.AddOffset(GridSystemData3::VT_ADVECTABLESCALARDATA,
                   advectableScalarData);
  }
  void add_advectableVectorData(
    flatbuffers::Offset<
      flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>>>
      advectableVectorData)
  {
    fbb_.AddOffset(GridSystemData3::VT_ADVECTABLEVECTORDATA,
                   advectableVectorData);
  }
...
CreateGridSystemData3(
  flatbuffers::FlatBufferBuilder& _fbb,
  const lstme::fbs::Size3* resolution = 0,
  const lstme::fbs::Vector3D* gridSpacing = 0,
  const lstme::fbs::Vector3D* origin = 0,
  uint64_t velocityIdx = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<ScalarGridSerialized3>>> scalarData = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<VectorGridSerialized3>>> vectorData = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<ScalarGridSerialized3>>> advectableScalarData = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<VectorGridSerialized3>>> advectableVectorData = 0)
{
...
inline flatbuffers::Offset<GridSystemData3>
CreateGridSystemData3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  const lstme::fbs::Size3* resolution = 0,
  const lstme::fbs::Vector3D* gridSpacing = 0,
  const lstme::fbs::Vector3D* origin = 0,
  uint64_t velocityIdx = 0,
  const std::vector<flatbuffers::Offset<ScalarGridSerialized3>>* scalarData =
    nullptr,
  const std::vector<flatbuffers::Offset<VectorGridSerialized3>>* vectorData =
    nullptr,
  const std::vector<flatbuffers::Offset<ScalarGridSerialized3>>*
    advectableScalarData = nullptr,
  const std::vector<flatbuffers::Offset<VectorGridSerialized3>>*
    advectableVectorData = nullptr)
{
  return lstme::fbs::CreateGridSystemData3(
    _fbb,
    resolution,
    gridSpacing,
    origin,
    velocityIdx,
    scalarData ? _fbb.CreateVector<flatbuffers::Offset<ScalarGridSerialized3>>(
                   *scalarData)
               : 0,
    vectorData ? _fbb.CreateVector<flatbuffers::Offset<VectorGridSerialized3>>(
                   *vectorData)
               : 0,
    advectableScalarData
      ? _fbb.CreateVector<flatbuffers::Offset<ScalarGridSerialized3>>(
          *advectableScalarData)
      : 0,
    advectableVectorData
      ? _fbb.CreateVector<flatbuffers::Offset<VectorGridSerialized3>>(
          *advectableVectorData)
      : 0);
}

inline const lstme::fbs::GridSystemData3*
GetGridSystemData3(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::GridSystemData3>(buf);
}

inline bool
VerifyGridSystemData3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::GridSystemData3>(nullptr);
}

inline void
FinishGridSystemData3Buffer(
  flatbuffers::FlatBufferBuilder& fbb,
  flatbuffers::Offset<lstme::fbs::GridSystemData3> root)
{
  fbb.Finish(root);
}
...
#endif /* GRID_SYSTEM_DATA3_GENERATED */
