...
#ifndef PARTICLE_SYSTEM_DATA2_GENERATED
#define PARTICLE_SYSTEM_DATA2_GENERATED
...
inline flatbuffers::Offset<ScalarParticleData2>
CreateScalarParticleData2Direct(flatbuffers::FlatBufferBuilder& _fbb,
                                const std::vector<double>* data = nullptr)
{
  return lstme::fbs::CreateScalarParticleData2(
...
struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  const flatbuffers::Vector<const lstme::fbs::Vector2D*>* data() const
  {
    return GetPointer<const flatbuffers::Vector<const lstme::fbs::Vector2D*>*>(
      VT_DATA);
  }
  bool Verify(flatbuffers::Verifier& verifier) const
  {
...
struct VectorParticleData2Builder
{
  ...
  flatbuffers::uoffset_t start_;
  void add_data(
    flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector2D*>> data)
  {
...
inline flatbuffers::Offset<VectorParticleData2>
CreateVectorParticleData2Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  const std::vector<const lstme::fbs::Vector2D*>* data = nullptr)
{
  return lstme::fbs::CreateVectorParticleData2(
    _fbb, data ? _fbb.CreateVector<const lstme::fbs::Vector2D*>(*data) : 0);
}

struct PointNeighborSearcherSerialized2 FLATBUFFERS_FINAL_CLASS
...
struct PointNeighborSearcherSerialized2Builder
{
  ...
  PointNeighborSearcherSerialized2Builder& operator=(
    const PointNeighborSearcherSerialized2Builder&);
...
CreatePointNeighborSearcherSerialized2(
  flatbuffers::FlatBufferBuilder& _fbb,
...
inline flatbuffers::Offset<PointNeighborSearcherSerialized2>
CreatePointNeighborSearcherSerialized2Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  const char* type = nullptr,
  const std::vector<uint8_t>* data = nullptr)
{
  return lstme::fbs::CreatePointNeighborSearcherSerialized2(
    _fbb,
    type ? _fbb.CreateString(type) : 0,
    data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}

struct ParticleNeighborList2 FLATBUFFERS_FINAL_CLASS
  : private flatbuffers::Table
{
  enum
  {
...
inline flatbuffers::Offset<ParticleNeighborList2>
CreateParticleNeighborList2Direct(flatbuffers::FlatBufferBuilder& _fbb,
                                  const std::vector<uint64_t>* data = nullptr)
{
  return lstme::fbs::CreateParticleNeighborList2(
...
struct ParticleSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  const flatbuffers::Vector<flatbuffers::Offset<ScalarParticleData2>>*
  ...
  const flatbuffers::Vector<flatbuffers::Offset<VectorParticleData2>>*
  ...
  {
    return GetPointer<const PointNeighborSearcherSerialized2*>(
      VT_NEIGHBORSEARCHER);
  }
  const flatbuffers::Vector<flatbuffers::Offset<ParticleNeighborList2>>*
  neighborLists() const
  {
    return GetPointer<
      const flatbuffers::Vector<flatbuffers::Offset<ParticleNeighborList2>>*>(
...
struct ParticleSystemData2Builder
{
  ...
  void add_positionIdx(uint64_t positionIdx)
  {
    fbb_.AddElement<uint64_t>(
      ParticleSystemData2::VT_POSITIONIDX, positionIdx, 0);
  }
  void add_velocityIdx(uint64_t velocityIdx)
  {
    fbb_.AddElement<uint64_t>(
      ParticleSystemData2::VT_VELOCITYIDX, velocityIdx, 0);
  }
  ...
  void add_scalarDataList(
    flatbuffers::Offset<
      flatbuffers::Vector<flatbuffers::Offset<ScalarParticleData2>>>
      scalarDataList)
  {
...
CreateParticleSystemData2(
  ...
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<ScalarParticleData2>>> scalarDataList = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<VectorParticleData2>>> vectorDataList = 0,
  flatbuffers::Offset<PointNeighborSearcherSerialized2> neighborSearcher = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<ParticleNeighborList2>>> neighborLists = 0)
{
...
inline flatbuffers::Offset<ParticleSystemData2>
CreateParticleSystemData2Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  double radius = 0.0,
  double mass = 0.0,
  uint64_t positionIdx = 0,
  uint64_t velocityIdx = 0,
  uint64_t forceIdx = 0,
  const std::vector<flatbuffers::Offset<ScalarParticleData2>>* scalarDataList =
    nullptr,
  const std::vector<flatbuffers::Offset<VectorParticleData2>>* vectorDataList =
    nullptr,
  flatbuffers::Offset<PointNeighborSearcherSerialized2> neighborSearcher = 0,
  const std::vector<flatbuffers::Offset<ParticleNeighborList2>>* neighborLists =
    nullptr)
{
  return lstme::fbs::CreateParticleSystemData2(
    _fbb,
    radius,
    mass,
    positionIdx,
    ...
    forceIdx,
    scalarDataList
      ? _fbb.CreateVector<flatbuffers::Offset<ScalarParticleData2>>(
          *scalarDataList)
      : 0,
    vectorDataList
      ? _fbb.CreateVector<flatbuffers::Offset<VectorParticleData2>>(
          *vectorDataList)
      : 0,
    neighborSearcher,
    neighborLists
      ? _fbb.CreateVector<flatbuffers::Offset<ParticleNeighborList2>>(
          *neighborLists)
      : 0);
}

inline const lstme::fbs::ParticleSystemData2*
GetParticleSystemData2(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::ParticleSystemData2>(buf);
}

inline bool
VerifyParticleSystemData2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::ParticleSystemData2>(nullptr);
}

inline void
FinishParticleSystemData2Buffer(
  flatbuffers::FlatBufferBuilder& fbb,
  flatbuffers::Offset<lstme::fbs::ParticleSystemData2> root)
{
  fbb.Finish(root);
}
...
#endif /* PARTICLE_SYSTEM_DATA2_GENERATED */
