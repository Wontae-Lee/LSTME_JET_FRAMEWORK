...
#ifndef FLATBUFFERS_GENERATED_SCALARGRID3_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_SCALARGRID3_LSTME_FBS_H_
...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3Direct(
  ...
  return lstme::fbs::CreateScalarGrid3(
      _fbb,
      resolution,
      gridSpacing,
      origin,
...
inline const lstme::fbs::ScalarGrid3 *GetScalarGrid3(const void *buf) {
  return flatbuffers::GetRoot<lstme::fbs::ScalarGrid3>(buf);
}

inline bool VerifyScalarGrid3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<lstme::fbs::ScalarGrid3>(nullptr);
}

inline void FinishScalarGrid3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<lstme::fbs::ScalarGrid3> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_SCALARGRID3_LSTME_FBS_H_
