...
#ifndef POINT_KDTREE_SEARCHER3_GENERATED
#define POINT_KDTREE_SEARCHER3_GENERATED
...
struct PointKdTreeSearcher3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  {
    return GetPointer<
      const flatbuffers::Vector<const PointKdTreeSearcherNode3*>*>(VT_NODES);
  }
...
struct PointKdTreeSearcher3Builder
{
  ...
  void add_nodes(
    flatbuffers::Offset<flatbuffers::Vector<const PointKdTreeSearcherNode3*>>
      nodes)
  {
...
inline flatbuffers::Offset<PointKdTreeSearcher3>
CreatePointKdTreeSearcher3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  const std::vector<const lstme::fbs::Vector3D*>* points = nullptr,
  const std::vector<const PointKdTreeSearcherNode3*>* nodes = nullptr)
{
  return lstme::fbs::CreatePointKdTreeSearcher3(
    _fbb,
    points ? _fbb.CreateVector<const lstme::fbs::Vector3D*>(*points) : 0,
    nodes ? _fbb.CreateVector<const PointKdTreeSearcherNode3*>(*nodes) : 0);
}

inline const lstme::fbs::PointKdTreeSearcher3*
GetPointKdTreeSearcher3(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::PointKdTreeSearcher3>(buf);
}

inline bool
VerifyPointKdTreeSearcher3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::PointKdTreeSearcher3>(nullptr);
}

inline void
FinishPointKdTreeSearcher3Buffer(
  flatbuffers::FlatBufferBuilder& fbb,
  flatbuffers::Offset<lstme::fbs::PointKdTreeSearcher3> root)
{
  fbb.Finish(root);
}
...
#endif /* POINT_KDTREE_SEARCHER3_GENERATED */
