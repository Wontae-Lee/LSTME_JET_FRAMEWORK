...
#ifndef FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_LSTME_FBS_H_
...
struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const lstme::fbs::Vector2D *> *data() const {
    return GetPointer<const flatbuffers::Vector<const lstme::fbs::Vector2D *> *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DATA) &&
...
struct VectorParticleData2Builder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_data(flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector2D *>> data) {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector2D *>> data = 0) {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2Direct(
  ...
  return lstme::fbs::CreateVectorParticleData2(
      _fbb,
      data ? _fbb.CreateVector<const lstme::fbs::Vector2D *>(*data) : 0);
}
...
inline const lstme::fbs::ParticleSystemData2 *GetParticleSystemData2(const void *buf) {
...
#endif  // FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_LSTME_FBS_H_
