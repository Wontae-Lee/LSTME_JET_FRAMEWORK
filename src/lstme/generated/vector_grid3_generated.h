...
#ifndef FLATBUFFERS_GENERATED_VECTORGRID3_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_VECTORGRID3_LSTME_FBS_H_
...
inline flatbuffers::Offset<VectorGrid3> CreateVectorGrid3Direct(
  ...
  return lstme::fbs::CreateVectorGrid3(
      _fbb,
      resolution,
      gridSpacing,
      origin,
...
inline const lstme::fbs::VectorGrid3 *GetVectorGrid3(const void *buf) {
...
#endif  // FLATBUFFERS_GENERATED_VECTORGRID3_LSTME_FBS_H_
