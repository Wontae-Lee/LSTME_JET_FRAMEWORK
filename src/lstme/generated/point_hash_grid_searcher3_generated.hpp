...
struct PointHashGridSearcherBucket3 FLATBUFFERS_FINAL_CLASS
...
struct PointHashGridSearcherBucket3Builder
{
  ...
  PointHashGridSearcherBucket3Builder& operator=(
    const PointHashGridSearcherBucket3Builder&);
...
CreatePointHashGridSearcherBucket3(
...
inline flatbuffers::Offset<PointHashGridSearcherBucket3>
CreatePointHashGridSearcherBucket3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
...
struct PointHashGridSearcher3 FLATBUFFERS_FINAL_CLASS
  : private flatbuffers::Table
{
  enum
  {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<PointHashGridSearcherBucket3>>*
  buckets() const
  {
    return GetPointer<const flatbuffers::Vector<
      flatbuffers::Offset<PointHashGridSearcherBucket3>>*>(VT_BUCKETS);
  }
  bool Verify(flatbuffers::Verifier& verifier) const
  {
...
struct PointHashGridSearcher3Builder
{
  ...
  void add_gridSpacing(double gridSpacing)
  {
    fbb_.AddElement<double>(
      PointHashGridSearcher3::VT_GRIDSPACING, gridSpacing, 0.0);
  }
  ...
  void add_buckets(
    flatbuffers::Offset<
      flatbuffers::Vector<flatbuffers::Offset<PointHashGridSearcherBucket3>>>
      buckets)
  {
  ...
  PointHashGridSearcher3Builder& operator=(
    const PointHashGridSearcher3Builder&);
...
CreatePointHashGridSearcher3(
  ...
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<PointHashGridSearcherBucket3>>> buckets = 0)
{
...
inline flatbuffers::Offset<PointHashGridSearcher3>
CreatePointHashGridSearcher3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  double gridSpacing = 0.0,
  const lstme::fbs::Size3* resolution = 0,
  const std::vector<const lstme::fbs::Vector3D*>* points = nullptr,
  const std::vector<flatbuffers::Offset<PointHashGridSearcherBucket3>>*
    buckets = nullptr)
{
  return lstme::fbs::CreatePointHashGridSearcher3(
    ...
    buckets
      ? _fbb.CreateVector<flatbuffers::Offset<PointHashGridSearcherBucket3>>(
          *buckets)
      : 0);
}

inline const lstme::fbs::PointHashGridSearcher3*
...
inline void
FinishPointHashGridSearcher3Buffer(
