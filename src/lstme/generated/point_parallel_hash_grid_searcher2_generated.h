...
#ifndef FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER2_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER2_LSTME_FBS_H_
...
struct PointParallelHashGridSearcher2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const lstme::fbs::Vector2D *> *points() const {
    return GetPointer<const flatbuffers::Vector<const lstme::fbs::Vector2D *> *>(VT_POINTS);
  }
...
struct PointParallelHashGridSearcher2Builder {
  ...
  void add_points(flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector2D *>> points) {
...
inline flatbuffers::Offset<PointParallelHashGridSearcher2> CreatePointParallelHashGridSearcher2(
    ...
    flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector2D *>> points = 0,
...
inline const lstme::fbs::PointParallelHashGridSearcher2 *GetPointParallelHashGridSearcher2(const void *buf) {
...
inline bool VerifyPointParallelHashGridSearcher2Buffer(
  ...
  return verifier.VerifyBuffer<lstme::fbs::PointParallelHashGridSearcher2>(nullptr);
}
...
#endif  // FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER2_LSTME_FBS_H_
