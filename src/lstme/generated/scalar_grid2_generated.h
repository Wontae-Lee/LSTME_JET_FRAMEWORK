...
#ifndef FLATBUFFERS_GENERATED_SCALARGRID2_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_SCALARGRID2_LSTME_FBS_H_
...
inline flatbuffers::Offset<ScalarGrid2> CreateScalarGrid2Direct(
  ...
  return lstme::fbs::CreateScalarGrid2(
      _fbb,
      resolution,
      gridSpacing,
      origin,
...
inline const lstme::fbs::ScalarGrid2 *GetScalarGrid2(const void *buf) {
...
#endif  // FLATBUFFERS_GENERATED_SCALARGRID2_LSTME_FBS_H_
