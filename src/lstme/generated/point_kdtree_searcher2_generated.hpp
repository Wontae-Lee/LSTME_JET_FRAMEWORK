...
#ifndef POINT_KDTREE_SEARCHER2_GENERATED
#define POINT_KDTREE_SEARCHER2_GENERATED
...
struct PointKdTreeSearcher2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  {
    return GetPointer<
      const flatbuffers::Vector<const PointKdTreeSearcherNode2*>*>(VT_NODES);
  }
  bool Verify(flatbuffers::Verifier& verifier) const
  {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_POINTS) &&
           verifier.Verify(points()) && VerifyOffset(verifier, VT_NODES) &&
           verifier.Verify(nodes()) && verifier.EndTable();
  }
};
...
struct PointKdTreeSearcher2Builder
{
  ...
  void add_nodes(
    flatbuffers::Offset<flatbuffers::Vector<const PointKdTreeSearcherNode2*>>
      nodes)
  {
...
#endif /* POINT_KDTREE_SEARCHER2_GENERATED */
