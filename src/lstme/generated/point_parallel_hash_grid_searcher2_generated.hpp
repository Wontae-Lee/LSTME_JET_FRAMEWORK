...
#ifndef POINT_PARALLEL_HASH_GRID_SEARCHER2_GENERATED
#define POINT_PARALLEL_HASH_GRID_SEARCHER2_GENERATED
...
struct PointParallelHashGridSearcher2 FLATBUFFERS_FINAL_CLASS
  : private flatbuffers::Table
{
  ...
  bool Verify(flatbuffers::Verifier& verifier) const
  {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_KEYS) && verifier.Verify(keys()) &&
...
struct PointParallelHashGridSearcher2Builder
{
  ...
  void add_gridSpacing(double gridSpacing)
  {
    fbb_.AddElement<double>(
      PointParallelHashGridSearcher2::VT_GRIDSPACING, gridSpacing, 0.0);
  }
  ...
  void add_startIndexTable(
    flatbuffers::Offset<flatbuffers::Vector<uint64_t>> startIndexTable)
  {
    fbb_.AddOffset(PointParallelHashGridSearcher2::VT_STARTINDEXTABLE,
                   startIndexTable);
  }
  void add_endIndexTable(
    flatbuffers::Offset<flatbuffers::Vector<uint64_t>> endIndexTable)
  {
    fbb_.AddOffset(PointParallelHashGridSearcher2::VT_ENDINDEXTABLE,
                   endIndexTable);
  }
  void add_sortedIndices(
    flatbuffers::Offset<flatbuffers::Vector<uint64_t>> sortedIndices)
  {
    fbb_.AddOffset(PointParallelHashGridSearcher2::VT_SORTEDINDICES,
                   sortedIndices);
  }
  ...
  PointParallelHashGridSearcher2Builder& operator=(
    const PointParallelHashGridSearcher2Builder&);
...
inline flatbuffers::Offset<PointParallelHashGridSearcher2>
CreatePointParallelHashGridSearcher2Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  double gridSpacing = 0.0,
  const lstme::fbs::Size2* resolution = 0,
...
{
  return lstme::fbs::CreatePointParallelHashGridSearcher2(
    _fbb,
    gridSpacing,
    resolution,
...
inline const lstme::fbs::PointParallelHashGridSearcher2*
GetPointParallelHashGridSearcher2(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::PointParallelHashGridSearcher2>(buf);
}

inline bool
VerifyPointParallelHashGridSearcher2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::PointParallelHashGridSearcher2>(
    nullptr);
}

inline void
FinishPointParallelHashGridSearcher2Buffer(
  flatbuffers::FlatBufferBuilder& fbb,
  flatbuffers::Offset<lstme::fbs::PointParallelHashGridSearcher2> root)
{
  fbb.Finish(root);
}
...
#endif /* POINT_PARALLEL_HASH_GRID_SEARCHER2_GENERATED */
