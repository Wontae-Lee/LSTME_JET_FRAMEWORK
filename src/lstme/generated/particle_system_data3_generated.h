...
#ifndef FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA3_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA3_LSTME_FBS_H_
...
struct VectorParticleData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const lstme::fbs::Vector3D *> *data() const {
    return GetPointer<const flatbuffers::Vector<const lstme::fbs::Vector3D *> *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DATA) &&
...
struct VectorParticleData3Builder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_data(flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector3D *>> data) {
...
inline flatbuffers::Offset<VectorParticleData3> CreateVectorParticleData3(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector3D *>> data = 0) {
...
inline flatbuffers::Offset<VectorParticleData3> CreateVectorParticleData3Direct(
  ...
  return lstme::fbs::CreateVectorParticleData3(
      _fbb,
      data ? _fbb.CreateVector<const lstme::fbs::Vector3D *>(*data) : 0);
}
...
inline const lstme::fbs::ParticleSystemData3 *GetParticleSystemData3(const void *buf) {
...
#endif  // FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA3_LSTME_FBS_H_
