...
#ifndef PARTICLE_SYSTEM_DATA3_GENERATED
#define PARTICLE_SYSTEM_DATA3_GENERATED
...
{
  return lstme::fbs::CreateScalarParticleData3(
...
struct VectorParticleData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  const flatbuffers::Vector<const lstme::fbs::Vector3D*>* data() const
  {
    return GetPointer<const flatbuffers::Vector<const lstme::fbs::Vector3D*>*>(
      VT_DATA);
  }
  bool Verify(flatbuffers::Verifier& verifier) const
  {
...
struct VectorParticleData3Builder
{
  ...
  flatbuffers::uoffset_t start_;
  void add_data(
    flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector3D*>> data)
  {
...
inline flatbuffers::Offset<VectorParticleData3>
CreateVectorParticleData3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  const std::vector<const lstme::fbs::Vector3D*>* data = nullptr)
{
  return lstme::fbs::CreateVectorParticleData3(
    _fbb, data ? _fbb.CreateVector<const lstme::fbs::Vector3D*>(*data) : 0);
}
...
struct PointNeighborSearcherSerialized3Builder
{
  ...
  PointNeighborSearcherSerialized3Builder& operator=(
    const PointNeighborSearcherSerialized3Builder&);
...
{
  return lstme::fbs::CreatePointNeighborSearcherSerialized3(
    _fbb,
...
{
  return lstme::fbs::CreateParticleNeighborList3(
...
struct ParticleSystemData3Builder
{
  ...
  void add_positionIdx(uint64_t positionIdx)
  {
    fbb_.AddElement<uint64_t>(
      ParticleSystemData3::VT_POSITIONIDX, positionIdx, 0);
  }
  void add_velocityIdx(uint64_t velocityIdx)
  {
    fbb_.AddElement<uint64_t>(
      ParticleSystemData3::VT_VELOCITYIDX, velocityIdx, 0);
  }
...
CreateParticleSystemData3(
  ...
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<ScalarParticleData3>>> scalarDataList = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<VectorParticleData3>>> vectorDataList = 0,
  flatbuffers::Offset<PointNeighborSearcherSerialized3> neighborSearcher = 0,
  flatbuffers::Offset<flatbuffers::Vector<
    flatbuffers::Offset<ParticleNeighborList3>>> neighborLists = 0)
{
...
inline flatbuffers::Offset<ParticleSystemData3>
CreateParticleSystemData3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  double radius = 0.0,
  double mass = 0.0,
  uint64_t positionIdx = 0,
  uint64_t velocityIdx = 0,
  uint64_t forceIdx = 0,
  const std::vector<flatbuffers::Offset<ScalarParticleData3>>* scalarDataList =
    nullptr,
  const std::vector<flatbuffers::Offset<VectorParticleData3>>* vectorDataList =
    nullptr,
  flatbuffers::Offset<PointNeighborSearcherSerialized3> neighborSearcher = 0,
  const std::vector<flatbuffers::Offset<ParticleNeighborList3>>* neighborLists =
    nullptr)
{
  return lstme::fbs::CreateParticleSystemData3(
    _fbb,
    radius,
    mass,
    positionIdx,
...
inline const lstme::fbs::ParticleSystemData3*
GetParticleSystemData3(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::ParticleSystemData3>(buf);
}

inline bool
VerifyParticleSystemData3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::ParticleSystemData3>(nullptr);
}

inline void
FinishParticleSystemData3Buffer(
  flatbuffers::FlatBufferBuilder& fbb,
  flatbuffers::Offset<lstme::fbs::ParticleSystemData3> root)
{
  fbb.Finish(root);
}
...
#endif /* PARTICLE_SYSTEM_DATA3_GENERATED */
