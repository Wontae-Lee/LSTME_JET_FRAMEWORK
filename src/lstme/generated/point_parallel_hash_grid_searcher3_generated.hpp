...
#ifndef FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER3_LSTME_FBS_H_
#define FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER3_LSTME_FBS_H_
...
struct PointParallelHashGridSearcher3 FLATBUFFERS_FINAL_CLASS
...
struct PointParallelHashGridSearcher3Builder
{
  ...
  void add_gridSpacing(double gridSpacing)
  {
    fbb_.AddElement<double>(
      PointParallelHashGridSearcher3::VT_GRIDSPACING, gridSpacing, 0.0);
  }
  ...
  void add_points(
    flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector3D*>>
      points)
  {
  ...
  {
    fbb_.AddOffset(PointParallelHashGridSearcher3::VT_STARTINDEXTABLE,
                   startIndexTable);
  }
  void add_endIndexTable(
    flatbuffers::Offset<flatbuffers::Vector<uint64_t>> endIndexTable)
  {
    fbb_.AddOffset(PointParallelHashGridSearcher3::VT_ENDINDEXTABLE,
                   endIndexTable);
  }
  void add_sortedIndices(
    flatbuffers::Offset<flatbuffers::Vector<uint64_t>> sortedIndices)
  {
    fbb_.AddOffset(PointParallelHashGridSearcher3::VT_SORTEDINDICES,
                   sortedIndices);
  }
  ...
  PointParallelHashGridSearcher3Builder& operator=(
    const PointParallelHashGridSearcher3Builder&);
...
CreatePointParallelHashGridSearcher3(
  flatbuffers::FlatBufferBuilder& _fbb,
  double gridSpacing = 0.0,
  const lstme::fbs::Size3* resolution = 0,
  flatbuffers::Offset<flatbuffers::Vector<const lstme::fbs::Vector3D*>> points =
    0,
...
inline flatbuffers::Offset<PointParallelHashGridSearcher3>
CreatePointParallelHashGridSearcher3Direct(
  flatbuffers::FlatBufferBuilder& _fbb,
  double gridSpacing = 0.0,
  const lstme::fbs::Size3* resolution = 0,
...
{
  return lstme::fbs::CreatePointParallelHashGridSearcher3(
    _fbb,
    gridSpacing,
    resolution,
...
inline const lstme::fbs::PointParallelHashGridSearcher3*
GetPointParallelHashGridSearcher3(const void* buf)
{
  return flatbuffers::GetRoot<lstme::fbs::PointParallelHashGridSearcher3>(buf);
}

inline bool
VerifyPointParallelHashGridSearcher3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<lstme::fbs::PointParallelHashGridSearcher3>(
    nullptr);
}

inline void
FinishPointParallelHashGridSearcher3Buffer(
  flatbuffers::FlatBufferBuilder& fbb,
  flatbuffers::Offset<lstme::fbs::PointParallelHashGridSearcher3> root)
{
  fbb.Finish(root);
}
...
#endif // FLATBUFFERS_GENERATED_POINTPARALLELHASHGRIDSEARCHER3_LSTME_FBS_H_
