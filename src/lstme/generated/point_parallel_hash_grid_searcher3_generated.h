...
inline const lstme::fbs::PointParallelHashGridSearcher3 *GetPointParallelHashGridSearcher3(const void *buf) {
...
inline bool VerifyPointParallelHashGridSearcher3Buffer(
  ...
  return verifier.VerifyBuffer<lstme::fbs::PointParallelHashGridSearcher3>(nullptr);
}
