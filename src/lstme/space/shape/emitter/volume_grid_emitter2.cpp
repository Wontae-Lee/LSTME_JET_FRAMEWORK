...
void
VolumeGridEmitter2::addTarget(const ScalarGrid2Ptr& scalarGridTarget,
...
void
VolumeGridEmitter2::addTarget(const VectorGrid2Ptr& vectorGridTarget,
...
void
VolumeGridEmitter2::onUpdate(double currentTimeInSeconds,
