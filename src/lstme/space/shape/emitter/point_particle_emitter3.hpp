...
#ifndef INCLUDE_LSTME_POINT_PARTICLE_EMITTER3_H_
#define INCLUDE_LSTME_POINT_PARTICLE_EMITTER3_H_
...
private:
  ...
  void emit(Array1<Vector3D>* newPositions,
...
#endif // INCLUDE_LSTME_POINT_PARTICLE_EMITTER3_H_
