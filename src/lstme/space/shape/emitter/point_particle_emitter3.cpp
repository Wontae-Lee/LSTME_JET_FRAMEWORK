...
void
PointParticleEmitter3::onUpdate(double currentTimeInSeconds,
...
void
PointParticleEmitter3::emit(Array1<Vector3D>* newPositions,
                            Array1<Vector3D>* newVelocities,
                            size_t maxNewNumberOfParticles)
{
  for (size_t i = 0; i < maxNewNumberOfParticles; ++i) {
    Vector3D newDirection =
      uniformSampleCone(random(), random(), _direction, _spreadAngleInRadians);
...
{
  return PointParticleEmitter3(_origin,
                               _direction,
                               _speed,
...
PointParticleEmitter3::Builder::makeShared() const
{
  return std::shared_ptr<PointParticleEmitter3>(
    new PointParticleEmitter3(_origin,
                              _direction,
                              _speed,
                              _spreadAngleInDegrees,
                              _maxNumberOfNewParticlesPerSecond,
