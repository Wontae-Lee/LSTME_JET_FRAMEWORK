...
void
PointParticleEmitter2::onUpdate(double currentTimeInSeconds,
...
void
PointParticleEmitter2::emit(Array1<Vector2D>* newPositions,
                            Array1<Vector2D>* newVelocities,
...
{
  return PointParticleEmitter2(_origin,
                               _direction,
                               _speed,
...
PointParticleEmitter2::Builder::makeShared() const
{
  return std::shared_ptr<PointParticleEmitter2>(
    new PointParticleEmitter2(_origin,
                              _direction,
                              _speed,
                              _spreadAngleInDegrees,
                              _maxNumberOfNewParticlesPerSecond,
