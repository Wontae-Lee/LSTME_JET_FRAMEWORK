...
#ifndef INCLUDE_LSTME_VOLUME_GRID_EMITTER2_H_
#define INCLUDE_LSTME_VOLUME_GRID_EMITTER2_H_
...
public:
  ...
  typedef std::function<double(double, const Vector2D&, double)> ScalarMapper;
...
#endif // INCLUDE_LSTME_VOLUME_GRID_EMITTER2_H_
