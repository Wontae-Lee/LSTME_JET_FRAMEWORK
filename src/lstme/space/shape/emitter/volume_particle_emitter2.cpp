...
void
VolumeParticleEmitter2::onUpdate(double currentTimeInSeconds,
...
void
VolumeParticleEmitter2::emit(const ParticleSystemData2Ptr& particles,
                             Array1<Vector2D>* newPositions,
                             Array1<Vector2D>* newVelocities)
{
  if (!_implicitSurface) {
...
void
VolumeParticleEmitter2::setPointGenerator(
...
{
  return VolumeParticleEmitter2(_implicitSurface,
                                _bounds,
                                _spacing,
                                _initialVel,
                                _linearVel,
...
VolumeParticleEmitter2::Builder::makeShared() const
{
  return std::shared_ptr<VolumeParticleEmitter2>(
    new VolumeParticleEmitter2(_implicitSurface,
                               _bounds,
                               _spacing,
                               _initialVel,
                               _linearVel,
