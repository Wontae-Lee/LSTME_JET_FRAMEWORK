...
#ifndef INCLUDE_LSTME_POINT_PARTICLE_EMITTER2_H_
#define INCLUDE_LSTME_POINT_PARTICLE_EMITTER2_H_
...
private:
  ...
  void emit(Array1<Vector2D>* newPositions,
...
#endif // INCLUDE_LSTME_POINT_PARTICLE_EMITTER2_H_
