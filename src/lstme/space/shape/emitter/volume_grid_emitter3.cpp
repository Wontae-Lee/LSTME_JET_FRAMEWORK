...
void
VolumeGridEmitter3::addTarget(const ScalarGrid3Ptr& scalarGridTarget,
...
void
VolumeGridEmitter3::addTarget(const VectorGrid3Ptr& vectorGridTarget,
...
void
VolumeGridEmitter3::onUpdate(double currentTimeInSeconds,
