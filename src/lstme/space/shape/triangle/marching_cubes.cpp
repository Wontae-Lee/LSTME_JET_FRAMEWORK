...
inline bool
queryVertexId(const MarchingCubeVertexMap& vertexMap,
...
inline Vector3D
grad(const ConstArrayAccessor3<double>& grid,
     ssize_t i,
     ssize_t j,
     ssize_t k,
  ...
  for (itrTri = 0; itrTri < 5; ++itrTri) {
    ...
    for (int j = 0; j < 3; j++) {
      ...
      if (queryVertexId(*vertexMap, vKey, &vId)) {
        ...
        face[j] = mesh->numberOfPoints();
        mesh->addNormal(
          safeNormalize(n[triangleConnectionTable3D[idxFlagSize][k]]));
      ...
      for (ssize_t i = 0; i < dimx - 1; ++i) {
        ...
        if (bndClose & kDirectionBack) {
          ...
          singleSquare(data,
                       ...
                       normal,
                       corners,
                       (bndConnectivity & kDirectionBack) ? &vertexMap
                                                          : &vertexMapBack,
                       mesh,
                       isoValue);
        }
        ...
        if (bndClose & kDirectionFront) {
          ...
          singleSquare(data,
                       ...
                       normal,
                       corners,
                       (bndConnectivity & kDirectionFront) ? &vertexMap
                                                           : &vertexMapFront,
                       mesh,
                       isoValue);
        }
      ...
      for (ssize_t j = 0; j < dimy - 1; ++j) {
        ...
        if (bndClose & kDirectionLeft) {
          ...
          singleSquare(data,
                       ...
                       normal,
                       corners,
                       (bndConnectivity & kDirectionLeft) ? &vertexMap
                                                          : &vertexMapLeft,
                       mesh,
                       isoValue);
        }
        ...
        if (bndClose & kDirectionRight) {
          ...
          singleSquare(data,
                       ...
                       normal,
                       corners,
                       (bndConnectivity & kDirectionRight) ? &vertexMap
                                                           : &vertexMapRight,
                       mesh,
                       isoValue);
        }
      ...
      for (ssize_t i = 0; i < dimx - 1; ++i) {
        ...
        if (bndClose & kDirectionDown) {
          ...
          singleSquare(data,
                       ...
                       normal,
                       corners,
                       (bndConnectivity & kDirectionDown) ? &vertexMap
                                                          : &vertexMapDown,
                       mesh,
                       isoValue);
        }
        ...
        if (bndClose & kDirectionUp) {
          ...
          singleSquare(data,
                       ...
                       normal,
                       corners,
                       (bndConnectivity & kDirectionUp) ? &vertexMap
                                                        : &vertexMapUp,
                       mesh,
                       isoValue);
        }
