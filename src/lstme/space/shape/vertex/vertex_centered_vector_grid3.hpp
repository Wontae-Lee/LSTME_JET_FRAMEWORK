...
#ifndef INCLUDE_LSTME_VERTEX_CENTERED_VECTOR_GRID3_H_
#define INCLUDE_LSTME_VERTEX_CENTERED_VECTOR_GRID3_H_
...
{
public:
  LSTME_GRID3_TYPE_NAME(VertexCenteredVectorGrid3)
  ...
  VertexCenteredVectorGrid3(const Size3& resolution,
                            const Vector3D& gridSpacing = Vector3D(1.0,
                                                                   1.0,
                                                                   1.0),
...
#endif // INCLUDE_LSTME_VERTEX_CENTERED_VECTOR_GRID3_H_
