...
#ifndef INCLUDE_LSTME_VERTEX_CENTERED_SCALAR_GRID2_H_
#define INCLUDE_LSTME_VERTEX_CENTERED_SCALAR_GRID2_H_
...
class VertexCenteredScalarGrid2 final : public ScalarGrid2 {
 public:
    LSTME_GRID2_TYPE_NAME(VertexCenteredScalarGrid2)
...
#endif  // INCLUDE_LSTME_VERTEX_CENTERED_SCALAR_GRID2_H_
