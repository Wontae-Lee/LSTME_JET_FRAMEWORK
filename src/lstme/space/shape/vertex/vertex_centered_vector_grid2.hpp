...
#ifndef INCLUDE_LSTME_VERTEX_CENTERED_VECTOR_GRID2_H_
#define INCLUDE_LSTME_VERTEX_CENTERED_VECTOR_GRID2_H_
...
{
public:
  LSTME_GRID2_TYPE_NAME(VertexCenteredVectorGrid2)
...
#endif // INCLUDE_LSTME_VERTEX_CENTERED_VECTOR_GRID2_H_
