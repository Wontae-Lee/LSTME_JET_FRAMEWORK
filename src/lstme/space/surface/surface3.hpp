...
template<typename T>
T&
SurfaceBuilderBase3<T>::withIsNormalFlipped(bool isNormalFlipped)
{
...
template<typename T>
T&
SurfaceBuilderBase3<T>::withTranslation(const Vector3D& translation)
{
...
template<typename T>
T&
SurfaceBuilderBase3<T>::withOrientation(const QuaternionD& orientation)
{
...
template<typename T>
T&
SurfaceBuilderBase3<T>::withTransform(const Transform3& transform)
{
...
#endif // INCLUDE_LSTME_SURFACE3_H_
