...
ImplicitSurface3::ImplicitSurface3(const Transform3& transform_,
...
double
ImplicitSurface3::signedDistance(const Vector3D& otherPoint) const
{
...
double
ImplicitSurface3::closestDistanceLocal(const Vector3D& otherPoint) const
{
  return std::fabs(signedDistanceLocal(otherPoint));
}

bool
ImplicitSurface3::isInsideLocal(const Vector3D& otherPoint) const
{
