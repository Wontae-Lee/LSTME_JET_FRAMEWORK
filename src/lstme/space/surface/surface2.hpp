...
#ifndef INCLUDE_LSTME_SURFACE2_H_
#define INCLUDE_LSTME_SURFACE2_H_
...
template<typename T>
T&
SurfaceBuilderBase2<T>::withIsNormalFlipped(bool isNormalFlipped)
{
...
template<typename T>
T&
SurfaceBuilderBase2<T>::withTranslation(const Vector2D& translation)
{
...
template<typename T>
T&
SurfaceBuilderBase2<T>::withOrientation(double orientation)
{
...
template<typename T>
T&
SurfaceBuilderBase2<T>::withTransform(const Transform2& transform)
{
...
#endif // INCLUDE_LSTME_SURFACE2_H_
