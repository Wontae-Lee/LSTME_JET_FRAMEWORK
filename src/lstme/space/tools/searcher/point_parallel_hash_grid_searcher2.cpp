...
#include <generated/point_parallel_hash_grid_searcher2_generated.hpp>
#include <pch.hpp>
...
void
PointParallelHashGridSearcher2::build(
...
void
PointParallelHashGridSearcher2::forEachNearbyPoint(
...
bool
PointParallelHashGridSearcher2::hasNearbyPoint(const Vector2D& origin,
                                               double radius) const
{
  size_t nearbyKeys[4];
  getNearbyKeys(origin, nearbyKeys);
...
size_t
PointParallelHashGridSearcher2::getHashKeyFromPosition(
...
size_t
PointParallelHashGridSearcher2::getHashKeyFromBucketIndex(
...
void
PointParallelHashGridSearcher2::getNearbyKeys(const Vector2D& position,
...
PointParallelHashGridSearcher2::serialize(std::vector<uint8_t>* buffer) const
{
  ...
  // Copy the searcher
  auto fbsSearcher =
    fbs::CreatePointParallelHashGridSearcher2(builder,
                                              _gridSpacing,
                                              &fbsResolution,
                                              fbsPoints,
                                              fbsKeys,
