...
#include <generated/point_simple_list_searcher2_generated.hpp>
#include <pch.hpp>
...
void
PointSimpleListSearcher2::forEachNearbyPoint(
...
bool
PointSimpleListSearcher2::hasNearbyPoint(const Vector2D& origin,
                                         double radius) const
{
  double radiusSquared = radius * radius;
  for (size_t i = 0; i < _points.size(); ++i) {
