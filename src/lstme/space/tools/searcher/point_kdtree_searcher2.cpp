...
#include <generated/point_kdtree_searcher2_generated.hpp>
...
void
PointKdTreeSearcher2::forEachNearbyPoint(
...
bool
PointKdTreeSearcher2::hasNearbyPoint(const Vector2D& origin,
                                     double radius) const
{
...
PointKdTreeSearcher2::Builder::makeShared() const
{
  return std::shared_ptr<PointKdTreeSearcher2>(
    new PointKdTreeSearcher2, [](PointKdTreeSearcher2* obj) { delete obj; });
}
