...
#ifndef INCLUDE_LSTME_POINT_KDTREE_SEARCHER2_H
#define INCLUDE_LSTME_POINT_KDTREE_SEARCHER2_H
...
class PointKdTreeSearcher2 final : public PointNeighborSearcher2 {
 public:
    LSTME_NEIGHBOR_SEARCHER2_TYPE_NAME(PointKdTreeSearcher2)
...
#endif  // INCLUDE_LSTME_POINT_KDTREE_SEARCHER2_H
