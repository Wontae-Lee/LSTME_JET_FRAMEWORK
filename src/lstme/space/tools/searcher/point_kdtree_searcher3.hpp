...
#ifndef INCLUDE_LSTME_POINT_KDTREE_SEARCHER3_H
#define INCLUDE_LSTME_POINT_KDTREE_SEARCHER3_H
...
class PointKdTreeSearcher3 final : public PointNeighborSearcher3 {
 public:
    LSTME_NEIGHBOR_SEARCHER3_TYPE_NAME(PointKdTreeSearcher3)
...
#endif  // INCLUDE_LSTME_POINT_KDTREE_SEARCHER3_H
