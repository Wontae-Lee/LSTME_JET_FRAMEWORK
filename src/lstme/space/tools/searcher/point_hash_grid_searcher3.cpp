...
#include <generated/point_hash_grid_searcher3_generated.hpp>
...
PointHashGridSearcher3::PointHashGridSearcher3(const Size3& resolution,
                                               double gridSpacing)
  : PointHashGridSearcher3(resolution.x,
                           resolution.y,
                           resolution.z,
                           gridSpacing)
{
...
void
PointHashGridSearcher3::forEachNearbyPoint(
...
bool
PointHashGridSearcher3::hasNearbyPoint(const Vector3D& origin,
                                       double radius) const
{
  if (_buckets.empty()) {
    return false;
...
size_t
PointHashGridSearcher3::getHashKeyFromBucketIndex(
...
void
PointHashGridSearcher3::getNearbyKeys(const Vector3D& position,
