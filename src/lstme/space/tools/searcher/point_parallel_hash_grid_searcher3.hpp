...
#ifndef INCLUDE_LSTME_POINT_PARALLEL_HASH_GRID_SEARCHER3_H_
#define INCLUDE_LSTME_POINT_PARALLEL_HASH_GRID_SEARCHER3_H_
...
{
public:
  LSTME_NEIGHBOR_SEARCHER3_TYPE_NAME(PointParallelHashGridSearcher3)
  ...
  //! \param[in]  gridSpacing The grid spacing.
  //!
  PointParallelHashGridSearcher3(size_t resolutionX,
                                 size_t resolutionY,
                                 size_t resolutionZ,
                                 double gridSpacing);
...
#endif // INCLUDE_LSTME_POINT_PARALLEL_HASH_GRID_SEARCHER3_H_
