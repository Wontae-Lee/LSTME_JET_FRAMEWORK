...
#ifndef INCLUDE_LSTME_POINT_PARALLEL_HASH_GRID_SEARCHER2_H_
#define INCLUDE_LSTME_POINT_PARALLEL_HASH_GRID_SEARCHER2_H_
...
{
public:
  LSTME_NEIGHBOR_SEARCHER2_TYPE_NAME(PointParallelHashGridSearcher2)
  ...
  //! \param[in]  gridSpacing The grid spacing.
  //!
  PointParallelHashGridSearcher2(size_t resolutionX,
                                 size_t resolutionY,
                                 double gridSpacing);
...
#endif // INCLUDE_LSTME_POINT_PARALLEL_HASH_GRID_SEARCHER2_H_
