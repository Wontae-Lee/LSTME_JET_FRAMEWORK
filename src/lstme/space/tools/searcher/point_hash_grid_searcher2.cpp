...
#include <generated/point_hash_grid_searcher2_generated.hpp>
...
void
PointHashGridSearcher2::forEachNearbyPoint(
...
bool
PointHashGridSearcher2::hasNearbyPoint(const Vector2D& origin,
                                       double radius) const
{
  if (_buckets.empty()) {
    return false;
...
size_t
PointHashGridSearcher2::getHashKeyFromBucketIndex(
...
void
PointHashGridSearcher2::getNearbyKeys(const Vector2D& position,
