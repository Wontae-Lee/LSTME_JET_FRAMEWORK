...
#include <generated/point_simple_list_searcher3_generated.hpp>
#include <pch.hpp>
...
void
PointSimpleListSearcher3::forEachNearbyPoint(
...
bool
PointSimpleListSearcher3::hasNearbyPoint(const Vector3D& origin,
                                         double radius) const
{
  double radiusSquared = radius * radius;
  for (size_t i = 0; i < _points.size(); ++i) {
