...
#ifndef INCLUDE_LSTME_ZHU_BRIDSON_POINTS_TO_IMPLICIT2_H_
#define INCLUDE_LSTME_ZHU_BRIDSON_POINTS_TO_IMPLICIT2_H_
...
typedef std::shared_ptr<ZhuBridsonPointsToImplicit2>
  ZhuBridsonPointsToImplicit2Ptr;

} // namespace lstme

#endif // INCLUDE_LSTME_ZHU_BRIDSON_POINTS_TO_IMPLICIT2_H_
