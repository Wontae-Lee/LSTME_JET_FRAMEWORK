...
#ifndef INCLUDE_LSTME_ZHU_BRIDSON_POINTS_TO_IMPLICIT3_H_
#define INCLUDE_LSTME_ZHU_BRIDSON_POINTS_TO_IMPLICIT3_H_
...
typedef std::shared_ptr<ZhuBridsonPointsToImplicit3>
  ZhuBridsonPointsToImplicit3Ptr;

} // namespace lstme

#endif // INCLUDE_LSTME_ZHU_BRIDSON_POINTS_TO_IMPLICIT3_H_
