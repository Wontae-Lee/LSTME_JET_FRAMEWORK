...
#ifndef INCLUDE_LSTME_SPH_POINTS_TO_IMPLICIT3_H_
#define INCLUDE_LSTME_SPH_POINTS_TO_IMPLICIT3_H_
...
public:
  ...
  SphPointsToImplicit3(double kernelRadius = 1.0,
...
#endif // INCLUDE_LSTME_SPH_POINTS_TO_IMPLICIT3_H_
