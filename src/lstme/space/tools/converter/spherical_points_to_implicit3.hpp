...
#ifndef INCLUDE_LSTME_SPHERICAL_POINTS_TO_IMPLICIT3_H_
#define INCLUDE_LSTME_SPHERICAL_POINTS_TO_IMPLICIT3_H_
...
#endif // INCLUDE_LSTME_SPHERICAL_POINTS_TO_IMPLICIT3_H_
