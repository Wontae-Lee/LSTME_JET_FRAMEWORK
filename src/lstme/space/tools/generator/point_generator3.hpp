...
#ifndef INCLUDE_LSTME_POINT_GENERATOR3_H_
#define INCLUDE_LSTME_POINT_GENERATOR3_H_
...
public:
  ...
  void generate(const BoundingBox3D& boundingBox,
                double spacing,
...
#endif // INCLUDE_LSTME_POINT_GENERATOR3_H_
