...
#ifndef INCLUDE_LSTME_POINT_GENERATOR2_H_
#define INCLUDE_LSTME_POINT_GENERATOR2_H_
...
public:
  ...
  void generate(const BoundingBox2D& boundingBox,
                double spacing,
...
#endif // INCLUDE_LSTME_POINT_GENERATOR2_H_
