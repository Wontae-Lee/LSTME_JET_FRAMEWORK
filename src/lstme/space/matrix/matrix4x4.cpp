...
{
  _elements[0] = _elements[4] = _elements[8] = _elements[12] = _elements[1] =
    _elements[5] = _elements[9] = _elements[13] = _elements[2] = _elements[6] =
      _elements[10] = _elements[14] = _elements[3] = _elements[7] =
        _elements[11] = _elements[15] = s;
}

template<typename T>
void
Matrix<T, 4, 4>::set(T m00,
                     T m01,
                     T m02,
                     T m10,
                     T m11,
...
Matrix<T, 4, 4>::set(const std::initializer_list<std::initializer_list<U>>& lst)
{
  ...
  LSTME_ASSERT(width == 4);
  LSTME_ASSERT(height == 4);

  auto rowIter = lst.begin();
  for (size_t i = 0; i < height; ++i) {
    LSTME_ASSERT(width == rowIter->size());
...
{
  _elements[1] = _elements[2] = _elements[3] = _elements[4] = _elements[6] =
    _elements[7] = _elements[8] = _elements[9] = _elements[11] = _elements[12] =
      _elements[13] = _elements[14] = s;
}
...
{
  return Matrix<T, 3, 3>(_elements[0],
                         _elements[1],
                         _elements[2],
                         _elements[4],
                         _elements[5],
...
{
  return Vector<T, 4>(_elements[0] * v.x + _elements[1] * v.y +
                        _elements[2] * v.z + _elements[3] * v.w,
                      _elements[4] * v.x + _elements[5] * v.y +
                        _elements[6] * v.z + _elements[7] * v.w,
                      _elements[8] * v.x + _elements[9] * v.y +
                        _elements[10] * v.z + _elements[11] * v.w,
                      _elements[12] * v.x + _elements[13] * v.y +
                        _elements[14] * v.z + _elements[15] * v.w);
}
...
{
  return Matrix(
    _elements[0] * m._elements[0] + _elements[1] * m._elements[4] +
      _elements[2] * m._elements[8] + _elements[3] * m._elements[12],
    _elements[0] * m._elements[1] + _elements[1] * m._elements[5] +
      _elements[2] * m._elements[9] + _elements[3] * m._elements[13],
    _elements[0] * m._elements[2] + _elements[1] * m._elements[6] +
      _elements[2] * m._elements[10] + _elements[3] * m._elements[14],
    _elements[0] * m._elements[3] + _elements[1] * m._elements[7] +
      _elements[2] * m._elements[11] + _elements[3] * m._elements[15],

    _elements[4] * m._elements[0] + _elements[5] * m._elements[4] +
      _elements[6] * m._elements[8] + _elements[7] * m._elements[12],
    _elements[4] * m._elements[1] + _elements[5] * m._elements[5] +
      _elements[6] * m._elements[9] + _elements[7] * m._elements[13],
    _elements[4] * m._elements[2] + _elements[5] * m._elements[6] +
      _elements[6] * m._elements[10] + _elements[7] * m._elements[14],
    _elements[4] * m._elements[3] + _elements[5] * m._elements[7] +
      _elements[6] * m._elements[11] + _elements[7] * m._elements[15],

    _elements[8] * m._elements[0] + _elements[9] * m._elements[4] +
      _elements[10] * m._elements[8] + _elements[11] * m._elements[12],
    _elements[8] * m._elements[1] + _elements[9] * m._elements[5] +
      _elements[10] * m._elements[9] + _elements[11] * m._elements[13],
    _elements[8] * m._elements[2] + _elements[9] * m._elements[6] +
      _elements[10] * m._elements[10] + _elements[11] * m._elements[14],
    _elements[8] * m._elements[3] + _elements[9] * m._elements[7] +
      _elements[10] * m._elements[11] + _elements[11] * m._elements[15],

    _elements[12] * m._elements[0] + _elements[13] * m._elements[4] +
      _elements[14] * m._elements[8] + _elements[15] * m._elements[12],
    _elements[12] * m._elements[1] + _elements[13] * m._elements[5] +
      _elements[14] * m._elements[9] + _elements[15] * m._elements[13],
    _elements[12] * m._elements[2] + _elements[13] * m._elements[6] +
      _elements[14] * m._elements[10] + _elements[15] * m._elements[14],
    _elements[12] * m._elements[3] + _elements[13] * m._elements[7] +
      _elements[14] * m._elements[11] + _elements[15] * m._elements[15]);
}
...
Matrix<T, 4, 4>::operator==(const Matrix& m) const
{
  return _elements[0] == m._elements[0] && _elements[1] == m._elements[1] &&
         ...
         _elements[8] == m._elements[8] && _elements[9] == m._elements[9] &&
         _elements[10] == m._elements[10] && _elements[11] == m._elements[11] &&
         _elements[12] == m._elements[12] && _elements[13] == m._elements[13] &&
         _elements[14] == m._elements[14] && _elements[15] == m._elements[15];
}
