...
#ifndef INCLUDE_LSTME_MATRIX4X4_H_
#define INCLUDE_LSTME_MATRIX4X4_H_
...
template<typename T>
Matrix4x4<T>
operator+(const Matrix4x4<T>& a, T b);

//! Returns a' + b, where every element of matrix a' is a.
template<typename T>
Matrix4x4<T>
operator+(T a, const Matrix4x4<T>& b);
...
template<typename T>
Vector3<T>
operator*(const Matrix4x4<T>& a, const Vector3<T>& b);

//! Returns a * b.
template<typename T>
Vector4<T>
operator*(const Matrix4x4<T>& a, const Vector4<T>& b);

//! Returns a * b.
template<typename T>
Matrix4x4<T>
operator*(const Matrix4x4<T>& a, const Matrix3x3<T>& b);

//! Returns a * b.
template<typename T>
Matrix4x4<T>
operator*(const Matrix3x3<T>& a, const Matrix4x4<T>& b);
...
template<typename T>
Matrix4x4<T>
operator/(const T& a, const Matrix4x4<T>& b);
...
#endif // INCLUDE_LSTME_MATRIX4X4_H_
