...
template<typename T>
Matrix3x3<T>
operator+(const Matrix3x3<T>& a, T b);

//! Returns a' + b, where every element of matrix a' is a.
template<typename T>
Matrix3x3<T>
operator+(T a, const Matrix3x3<T>& b);
...
template<typename T>
Vector3<T>
operator*(const Matrix3x3<T>& a, const Vector3<T>& b);
...
#endif // INCLUDE_LSTME_MATRIX3X3_H_
