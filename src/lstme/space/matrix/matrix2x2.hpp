...
#ifndef INCLUDE_LSTME_MATRIX2X2_H_
#define INCLUDE_LSTME_MATRIX2X2_H_
...
template<typename T>
Matrix2x2<T>
operator-(const Matrix2x2<T>& a);

//! Returns a + b (element-size).
template<typename T>
Matrix2x2<T>
operator+(const Matrix2x2<T>& a, const Matrix2x2<T>& b);

//! Returns a + b', where every element of matrix b' is b.
template<typename T>
Matrix2x2<T>
operator+(const Matrix2x2<T>& a, const T& b);

//! Returns a' + b, where every element of matrix a' is a.
template<typename T>
Matrix2x2<T>
operator+(const T& a, const Matrix2x2<T>& b);
...
template<typename T>
Matrix2x2<T>
operator-(const Matrix2x2<T>& a, T b);

//! Returns a' - b, where every element of matrix a' is a.
template<typename T>
Matrix2x2<T>
operator-(T a, const Matrix2x2<T>& b);
...
template<typename T>
Vector2<T>
operator*(const Matrix2x2<T>& a, const Vector2<T>& b);
...
#endif // INCLUDE_LSTME_MATRIX2X2_H_
