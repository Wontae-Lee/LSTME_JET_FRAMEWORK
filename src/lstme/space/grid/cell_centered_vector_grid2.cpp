  ...
  ExecutionPolicy policy)
{
  ...
  parallelFor(
    ...
    kZeroSize,
    size.y,
    [&func, &acc, &pos](size_t i, size_t j) { acc(i, j) = func(pos(i, j)); },
    policy);
}
...
CellCenteredVectorGrid2::Builder&
CellCenteredVectorGrid2::Builder::withOrigin(double gridOriginX,
                                             double gridOriginY)
{
...
CellCenteredVectorGrid2::Builder::build() const
{
  return CellCenteredVectorGrid2(
    _resolution, _gridSpacing, _gridOrigin, _initialVal);
}
                                        ...
                                        const Vector2D& initialVal) const
{
  return std::shared_ptr<CellCenteredVectorGrid2>(
    new CellCenteredVectorGrid2(
      resolution, gridSpacing, gridOrigin, initialVal),
