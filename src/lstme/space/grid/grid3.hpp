...
#ifndef INCLUDE_LSTME_GRID3_H_
#define INCLUDE_LSTME_GRID3_H_
...
protected:
  ...
  //! origin.
  void setSizeParameters(const Size3& resolution,
...
#define LSTME_GRID3_TYPE_NAME(DerivedClassName)                                \
