...
#ifndef INCLUDE_LSTME_FACE_CENTERED_GRID3_H_
#define INCLUDE_LSTME_FACE_CENTERED_GRID3_H_
...
{
public:
  LSTME_GRID3_TYPE_NAME(FaceCenteredGrid3)
...
#endif // INCLUDE_LSTME_FACE_CENTERED_GRID3_H_
