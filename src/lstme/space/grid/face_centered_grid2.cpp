...
FaceCenteredGrid2::FaceCenteredGrid2()
  ...
  , _uLinearSampler(LinearArraySampler2<double, double>(_dataU.constAccessor(),
                                                        Vector2D(1, 1),
                                                        _dataOriginU))
  , _vLinearSampler(LinearArraySampler2<double, double>(_dataV.constAccessor(),
                                                        Vector2D(1, 1),
                                                        _dataOriginV))
{
}
...
{
  LSTME_ASSERT(i < resolution().x && j < resolution().y);
...
void
FaceCenteredGrid2::fill(const std::function<Vector2D(const Vector2D&)>& func,
...
void
FaceCenteredGrid2::forEachUIndex(
...
void
FaceCenteredGrid2::parallelForEachUIndex(
  const std::function<void(size_t, size_t)>& func) const
{
...
void
FaceCenteredGrid2::forEachVIndex(
  const std::function<void(size_t, size_t)>& func) const
{
...
void
FaceCenteredGrid2::parallelForEachVIndex(
  const std::function<void(size_t, size_t)>& func) const
{
...
void
FaceCenteredGrid2::onResize(const Size2& resolution,
                            const Vector2D& gridSpacing,
                            const Vector2D& origin,
                            const Vector2D& initialValue)
{
...
{
  LSTME_ASSERT(uSize().x * uSize().y + vSize().x * vSize().y == data.size());
...
FaceCenteredGrid2::Builder&
FaceCenteredGrid2::Builder::withResolution(size_t resolutionX,
                                           size_t resolutionY)
{
...
FaceCenteredGrid2::Builder&
FaceCenteredGrid2::Builder::withGridSpacing(double gridSpacingX,
                                            double gridSpacingY)
{
...
FaceCenteredGrid2::Builder&
FaceCenteredGrid2::Builder::withInitialValue(double initialValX,
                                             double initialValY)
{
...
VectorGrid2Ptr
FaceCenteredGrid2::Builder::build(const Size2& resolution,
                                  const Vector2D& gridSpacing,
