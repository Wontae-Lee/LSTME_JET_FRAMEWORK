...
void
CollocatedVectorGrid2::forEachDataPointIndex(
...
void
CollocatedVectorGrid2::parallelForEachDataPointIndex(
  const std::function<void(size_t, size_t)>& func) const
{
...
void
CollocatedVectorGrid2::setCollocatedVectorGrid(
...
void
CollocatedVectorGrid2::onResize(const Size2& resolution,
...
{
  LSTME_ASSERT(2 * dataSize().x * dataSize().y == data.size());
