...
#include <generated/scalar_grid3_generated.hpp>
...
ScalarGrid3::ScalarGrid3()
  : _linearSampler(LinearArraySampler3<double, double>(_data.constAccessor(),
                                                       Vector3D(1, 1, 1),
                                                       Vector3D()))
{
}
...
void
ScalarGrid3::resize(const Size3& resolution,
...
void
ScalarGrid3::resize(double gridSpacingX,
                    double gridSpacingY,
                    double gridSpacingZ,
                    double originX,
                    double originY,
...
void
ScalarGrid3::fill(const std::function<double(const Vector3D&)>& func,
...
void
ScalarGrid3::forEachDataPointIndex(
...
void
ScalarGrid3::parallelForEachDataPointIndex(
  const std::function<void(size_t, size_t, size_t)>& func) const
{
...
{
  LSTME_ASSERT(dataSize().x * dataSize().y * dataSize().z == data.size());
