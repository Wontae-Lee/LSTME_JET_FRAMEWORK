...
#include <generated/vector_grid3_generated.hpp>
...
void
VectorGrid3::resize(const Size3& resolution,
...
void
VectorGrid3::resize(double gridSpacingX,
                    double gridSpacingY,
                    double gridSpacingZ,
                    double originX,
                    double originY,
...
VectorGrid3::serialize(std::vector<uint8_t>* buffer) const
{
  ...
  auto fbsGrid = fbs::CreateVectorGrid3(
