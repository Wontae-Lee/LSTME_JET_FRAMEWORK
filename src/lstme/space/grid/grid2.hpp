...
#ifndef INCLUDE_LSTME_GRID2_H_
#define INCLUDE_LSTME_GRID2_H_
...
protected:
  ...
  //! origin.
  void setSizeParameters(const Size2& resolution,
...
#define LSTME_GRID2_TYPE_NAME(DerivedClassName)                                \
