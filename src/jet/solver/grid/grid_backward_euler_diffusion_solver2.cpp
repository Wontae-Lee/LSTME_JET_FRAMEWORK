...
void
GridBackwardEulerDiffusionSolver2::solve(const ScalarGrid2& source,
...
void
GridBackwardEulerDiffusionSolver2::solve(const CollocatedVectorGrid2& source,
                                         double diffusionCoefficient,
                                         double timeIntervalInSeconds,
...
void
GridBackwardEulerDiffusionSolver2::solve(const FaceCenteredGrid2& source,
                                         double diffusionCoefficient,
                                         double timeIntervalInSeconds,
...
void
GridBackwardEulerDiffusionSolver2::setLinearSystemSolver(const FdmLinearSystemSolver2Ptr& solver)
{
  _systemSolver = solver;
}

void
GridBackwardEulerDiffusionSolver2::buildMarkers(const Size2& size,
...
void
GridBackwardEulerDiffusionSolver2::buildMatrix(const Size2& size, const Vector2D& c)
{
...
void
GridBackwardEulerDiffusionSolver2::buildVectors(const ConstArrayAccessor2<double>& f, const Vector2D& c)
{
  Size2 size = f.size();
...
void
GridBackwardEulerDiffusionSolver2::buildVectors(const ConstArrayAccessor2<Vector2D>& f, const Vector2D& c, size_t component)
{
  Size2 size = f.size();
