...
void
GridBlockedBoundaryConditionSolver2::constrainVelocity(FaceCenteredGrid2* velocity, unsigned int extrapolationDepth)
{
...
const Array2<char>&
GridBlockedBoundaryConditionSolver2::marker() const
{
  return _marker;
}

void
GridBlockedBoundaryConditionSolver2::onColliderUpdated(const Size2& gridSize, const Vector2D& gridSpacing, const Vector2D& gridOrigin)
{
