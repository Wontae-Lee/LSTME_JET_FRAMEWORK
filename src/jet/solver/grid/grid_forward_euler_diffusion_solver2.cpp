...
template<typename T>
inline T
laplacian(const ConstArrayAccessor2<T>& data, const Array2<char>& marker, const Vector2D& gridSpacing, size_t i, size_t j)
{
...
void
GridForwardEulerDiffusionSolver2::solve(const ScalarGrid2& source,
...
void
GridForwardEulerDiffusionSolver2::solve(const CollocatedVectorGrid2& source,
                                        double diffusionCoefficient,
                                        double timeIntervalInSeconds,
...
void
GridForwardEulerDiffusionSolver2::solve(const FaceCenteredGrid2& source,
                                        double diffusionCoefficient,
                                        double timeIntervalInSeconds,
...
void
GridForwardEulerDiffusionSolver2::buildMarkers(const Size2& size,
