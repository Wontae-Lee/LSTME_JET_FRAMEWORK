...
void
buildSingleSystem(FdmMatrix2* A, FdmVector2* b, const Array2<char>& markers, const FaceCenteredGrid2& input)
{
...
void
buildSingleSystem(MatrixCsrD* A, VectorND* x, VectorND* b, const Array2<char>& markers, const FaceCenteredGrid2& input)
{
  Size2 size = input.resolution();
  Vector2D invH = 1.0 / input.gridSpacing();
  Vector2D invHSqr = invH * invH;
...
void
GridSinglePhasePressureSolver2::solve(const FaceCenteredGrid2& input,
...
void
GridSinglePhasePressureSolver2::setLinearSystemSolver(const FdmLinearSystemSolver2Ptr& solver)
{
...
const FdmVector2&
GridSinglePhasePressureSolver2::pressure() const
{
  if (_mgSystemSolver == nullptr) {
    return _system.x;
  } else {
...
void
GridSinglePhasePressureSolver2::buildMarkers(const Size2& size,
...
void
GridSinglePhasePressureSolver2::decompressSolution()
{
...
void
GridSinglePhasePressureSolver2::buildSystem(const FaceCenteredGrid2& input, bool useCompressed)
{
  Size2 size = input.resolution();
  size_t numLevels = 1;
...
void
GridSinglePhasePressureSolver2::applyPressureGradient(const FaceCenteredGrid2& input, FaceCenteredGrid2* output)
{
  Size2 size = input.resolution();
