...
template<typename T>
T
laplacian(const ConstArrayAccessor3<T>& data, const Array3<char>& marker, const Vector3D& gridSpacing, size_t i, size_t j, size_t k)
{
...
void
GridForwardEulerDiffusionSolver3::solve(const ScalarGrid3& source,
...
void
GridForwardEulerDiffusionSolver3::solve(const CollocatedVectorGrid3& source,
                                        double diffusionCoefficient,
                                        double timeIntervalInSeconds,
...
void
GridForwardEulerDiffusionSolver3::solve(const FaceCenteredGrid3& source,
                                        double diffusionCoefficient,
                                        double timeIntervalInSeconds,
...
void
GridForwardEulerDiffusionSolver3::buildMarkers(const Size3& size,
