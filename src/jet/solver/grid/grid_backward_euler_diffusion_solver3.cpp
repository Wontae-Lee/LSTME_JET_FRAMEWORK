...
void
GridBackwardEulerDiffusionSolver3::solve(const ScalarGrid3& source,
...
void
GridBackwardEulerDiffusionSolver3::solve(const CollocatedVectorGrid3& source,
                                         double diffusionCoefficient,
                                         double timeIntervalInSeconds,
...
void
GridBackwardEulerDiffusionSolver3::solve(const FaceCenteredGrid3& source,
                                         double diffusionCoefficient,
                                         double timeIntervalInSeconds,
...
void
GridBackwardEulerDiffusionSolver3::setLinearSystemSolver(const FdmLinearSystemSolver3Ptr& solver)
{
  _systemSolver = solver;
}

void
GridBackwardEulerDiffusionSolver3::buildMarkers(const Size3& size,
...
void
GridBackwardEulerDiffusionSolver3::buildMatrix(const Size3& size, const Vector3D& c)
{
...
void
GridBackwardEulerDiffusionSolver3::buildVectors(const ConstArrayAccessor3<double>& f, const Vector3D& c)
{
  Size3 size = f.size();
...
void
GridBackwardEulerDiffusionSolver3::buildVectors(const ConstArrayAccessor3<Vector3D>& f, const Vector3D& c, size_t component)
{
  Size3 size = f.size();
