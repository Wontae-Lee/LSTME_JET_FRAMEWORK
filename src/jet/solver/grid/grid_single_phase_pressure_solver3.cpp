...
void
buildSingleSystem(FdmMatrix3* A, FdmVector3* b, const Array3<char>& markers, const FaceCenteredGrid3& input)
{
...
void
buildSingleSystem(MatrixCsrD* A, VectorND* x, VectorND* b, const Array3<char>& markers, const FaceCenteredGrid3& input)
{
  Size3 size = input.resolution();
  Vector3D invH = 1.0 / input.gridSpacing();
  Vector3D invHSqr = invH * invH;
...
void
GridSinglePhasePressureSolver3::solve(const FaceCenteredGrid3& input,
...
void
GridSinglePhasePressureSolver3::setLinearSystemSolver(const FdmLinearSystemSolver3Ptr& solver)
{
...
const FdmVector3&
GridSinglePhasePressureSolver3::pressure() const
{
  if (_mgSystemSolver == nullptr) {
    return _system.x;
  } else {
...
void
GridSinglePhasePressureSolver3::buildMarkers(const Size3& size,
...
void
GridSinglePhasePressureSolver3::decompressSolution()
{
...
void
GridSinglePhasePressureSolver3::buildSystem(const FaceCenteredGrid3& input, bool useCompressed)
{
  Size3 size = input.resolution();
  size_t numLevels = 1;
...
void
GridSinglePhasePressureSolver3::applyPressureGradient(const FaceCenteredGrid3& input, FaceCenteredGrid3* output)
{
  Size3 size = input.resolution();
