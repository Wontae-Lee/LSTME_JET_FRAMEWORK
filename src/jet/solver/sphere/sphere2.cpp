...
Vector2D
Sphere2::closestPointLocal(const Vector2D& otherPoint) const
{
  return radius * closestNormalLocal(otherPoint) + center;
}

double
Sphere2::closestDistanceLocal(const Vector2D& otherPoint) const
{
  return std::fabs(center.distanceTo(otherPoint) - radius);
}

Vector2D
Sphere2::closestNormalLocal(const Vector2D& otherPoint) const
{
...
bool
Sphere2::intersectsLocal(const Ray2D& ray) const
{
...
Sphere2::closestIntersectionLocal(const Ray2D& ray) const
{
...
BoundingBox2D
Sphere2::boundingBoxLocal() const
{
...
Sphere2::Builder&
Sphere2::Builder::withCenter(const Vector2D& center)
{
  _center = center;
  return *this;
}
...
Sphere2::Builder&
Sphere2::Builder::withRadius(double radius)
{
  _radius = radius;
  return *this;
}
...
Sphere2
Sphere2::Builder::build() const
{
  return Sphere2(_center, _radius, _transform, _isNormalFlipped);
}

Sphere2Ptr
Sphere2::Builder::makeShared() const
{
