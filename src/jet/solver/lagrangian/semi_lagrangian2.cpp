...
void
SemiLagrangian2::advect(const ScalarGrid2& input, const VectorField2& flow, double dt, ScalarGrid2* output, const ScalarField2& boundarySdf)
{
...
void
SemiLagrangian2::advect(const CollocatedVectorGrid2& input,
...
void
SemiLagrangian2::advect(const FaceCenteredGrid2& input,
                        const VectorField2& flow,
                        double dt,
...
Vector2D
SemiLagrangian2::backTrace(const VectorField2& flow, double dt, double h, const Vector2D& startPt, const ScalarField2& boundarySdf)
{
...
SemiLagrangian2::getVectorSamplerFunc(const CollocatedVectorGrid2& input) const
{
  return input.sampler();
}
