...
#include "jet/primitive/field/constant_vector_field2.h"
...
void ParticleSystemSolver2::setDragCoefficient(double newDragCoefficient) { _dragCoefficient = std::max(newDragCoefficient, 0.0); }

double ParticleSystemSolver2::restitutionCoefficient() const { return _restitutionCoefficient; }

void ParticleSystemSolver2::setRestitutionCoefficient(double newRestitutionCoefficient) { _restitutionCoefficient = clamp(newRestitutionCoefficient, 0.0, 1.0); }
...
void ParticleSystemSolver2::onBeginAdvanceTimeStep(double timeStepInSeconds) { UNUSED_VARIABLE(timeStepInSeconds); }

void ParticleSystemSolver2::onEndAdvanceTimeStep(double timeStepInSeconds) { UNUSED_VARIABLE(timeStepInSeconds); }

void ParticleSystemSolver2::resolveCollision() { resolveCollision(_newPositions.accessor(), _newVelocities.accessor()); }

void ParticleSystemSolver2::resolveCollision(ArrayAccessor1<Vector2D> newPositions, ArrayAccessor1<Vector2D> newVelocities) {
...
void ParticleSystemSolver2::setParticleSystemData(const ParticleSystemData2Ptr& newParticles) { _particleSystemData = newParticles; }
...
ParticleSystemSolver2::Builder ParticleSystemSolver2::builder() { return Builder(); }

ParticleSystemSolver2 ParticleSystemSolver2::Builder::build() const { return ParticleSystemSolver2(_radius, _mass); }
