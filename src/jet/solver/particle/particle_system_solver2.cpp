...
#include "jet/math/field/constant_vector_field2.h"
#include "jet/parallel/parallel.h"
#include "jet/solver/particle/particle_system_solver2.h"
...
double
ParticleSystemSolver2::dragCoefficient() const
{
  return _dragCoefficient;
}

void
ParticleSystemSolver2::setDragCoefficient(double newDragCoefficient)
{
  _dragCoefficient = std::max(newDragCoefficient, 0.0);
}

double
ParticleSystemSolver2::restitutionCoefficient() const
{
  return _restitutionCoefficient;
}

void
ParticleSystemSolver2::setRestitutionCoefficient(double newRestitutionCoefficient)
{
  _restitutionCoefficient = clamp(newRestitutionCoefficient, 0.0, 1.0);
}

const Vector2D&
ParticleSystemSolver2::gravity() const
{
  return _gravity;
}

void
ParticleSystemSolver2::setGravity(const Vector2D& newGravity)
{
  _gravity = newGravity;
}
...
const Collider2Ptr&
ParticleSystemSolver2::collider() const
{
  return _collider;
}

void
ParticleSystemSolver2::setCollider(const Collider2Ptr& newCollider)
{
  _collider = newCollider;
}

const ParticleEmitter2Ptr&
ParticleSystemSolver2::emitter() const
{
  return _emitter;
}

void
ParticleSystemSolver2::setEmitter(const ParticleEmitter2Ptr& newEmitter)
{
  _emitter = newEmitter;
  newEmitter->setTarget(_particleSystemData);
}

const VectorField2Ptr&
ParticleSystemSolver2::wind() const
{
  return _wind;
}

void
ParticleSystemSolver2::setWind(const VectorField2Ptr& newWind)
{
  _wind = newWind;
}

void
ParticleSystemSolver2::onInitialize()
{
...
void
ParticleSystemSolver2::onAdvanceTimeStep(double timeStepInSeconds)
{
...
void
ParticleSystemSolver2::accumulateForces(double timeStepInSeconds)
{
...
void
ParticleSystemSolver2::beginAdvanceTimeStep(double timeStepInSeconds)
{
  // Clear forces
...
void
ParticleSystemSolver2::endAdvanceTimeStep(double timeStepInSeconds)
{
  // Update data
  size_t n = _particleSystemData->numberOfParticles();
...
void
ParticleSystemSolver2::onBeginAdvanceTimeStep(double timeStepInSeconds)
{
  UNUSED_VARIABLE(timeStepInSeconds);
}

void
ParticleSystemSolver2::onEndAdvanceTimeStep(double timeStepInSeconds)
{
  UNUSED_VARIABLE(timeStepInSeconds);
}
...
void
ParticleSystemSolver2::resolveCollision(ArrayAccessor1<Vector2D> newPositions, ArrayAccessor1<Vector2D> newVelocities)
{
...
void
ParticleSystemSolver2::setParticleSystemData(const ParticleSystemData2Ptr& newParticles)
{
  _particleSystemData = newParticles;
}

void
ParticleSystemSolver2::accumulateExternalForces()
{
  size_t n = _particleSystemData->numberOfParticles();
  auto forces = _particleSystemData->forces();
  auto velocities = _particleSystemData->velocities();
...
void
ParticleSystemSolver2::timeIntegration(double timeStepInSeconds)
{
  size_t n = _particleSystemData->numberOfParticles();
  auto forces = _particleSystemData->forces();
  auto velocities = _particleSystemData->velocities();
...
void
ParticleSystemSolver2::updateCollider(double timeStepInSeconds)
{
  if (_collider != nullptr) {
...
void
ParticleSystemSolver2::updateEmitter(double timeStepInSeconds)
{
  if (_emitter != nullptr) {
...
ParticleSystemSolver2::Builder::build() const
{
  return ParticleSystemSolver2(_radius, _mass);
}

ParticleSystemSolver2Ptr
ParticleSystemSolver2::Builder::makeShared() const
{
  return std::shared_ptr<ParticleSystemSolver2>(new ParticleSystemSolver2(_radius, _mass), [](ParticleSystemSolver2* obj) { delete obj; });
}
