                           ...
                           bool useRedBlackOrdering)
{
  ...
  if (useRedBlackOrdering) {
    _mgParams.relaxFunc =
      [sorFactor](const FdmMatrix3& A, const FdmVector3& b, unsigned int numberOfIterations, double maxTolerance, FdmVector3* x, FdmVector3* buffer) {
...
const MgParameters<FdmBlas3>&
FdmMgSolver3::params() const
{
  return _mgParams;
}

double
FdmMgSolver3::sorFactor() const
{
  return _sorFactor;
}

bool
FdmMgSolver3::useRedBlackOrdering() const
{
  return _useRedBlackOrdering;
}

bool
FdmMgSolver3::solve(FdmLinearSystem3* system)
{
...
bool
FdmMgSolver3::solve(FdmMgLinearSystem3* system)
{
