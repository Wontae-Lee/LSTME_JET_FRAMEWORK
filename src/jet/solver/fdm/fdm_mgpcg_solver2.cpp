...
void
FdmMgpcgSolver2::Preconditioner::build(FdmMgLinearSystem2* system_, MgParameters<FdmBlas2> mgParams_)
{
  system = system_;
  mgParams = mgParams_;
}
...
void
FdmMgpcgSolver2::Preconditioner::solve(const FdmVector2& b, FdmVector2* x)
{
  // Copy dimension
...
bool
FdmMgpcgSolver2::solve(FdmMgLinearSystem2* system)
{
...
unsigned int
FdmMgpcgSolver2::maxNumberOfIterations() const
{
  return _maxNumberOfIterations;
}

unsigned int
FdmMgpcgSolver2::lastNumberOfIterations() const
{
  return _lastNumberOfIterations;
}

double
FdmMgpcgSolver2::tolerance() const
{
  return _tolerance;
}

double
FdmMgpcgSolver2::lastResidual() const
{
