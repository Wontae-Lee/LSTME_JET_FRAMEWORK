...
FdmJacobiSolver3::FdmJacobiSolver3(unsigned int maxNumberOfIterations, unsigned int residualCheckInterval, double tolerance)
...
bool
FdmJacobiSolver3::solve(FdmLinearSystem3* system)
{
...
bool
FdmJacobiSolver3::solveCompressed(FdmCompressedLinearSystem3* system)
{
...
unsigned int
FdmJacobiSolver3::maxNumberOfIterations() const
{
  return _maxNumberOfIterations;
}

unsigned int
FdmJacobiSolver3::lastNumberOfIterations() const
{
  return _lastNumberOfIterations;
}

double
FdmJacobiSolver3::tolerance() const
{
  return _tolerance;
}

double
FdmJacobiSolver3::lastResidual() const
{
  return _lastResidual;
}

void
FdmJacobiSolver3::relax(const FdmMatrix3& A, const FdmVector3& b, FdmVector3* x_, FdmVector3* xTemp_)
{
  Size3 size = A.size();
  FdmVector3& x = *x_;
...
void
FdmJacobiSolver3::relax(const MatrixCsrD& A, const VectorND& b, VectorND* x_, VectorND* xTemp_)
{
...
void
FdmJacobiSolver3::clearUncompressedVectors()
{
  _xTempComp.clear();
  _residualComp.clear();
}
...
void
FdmJacobiSolver3::clearCompressedVectors()
{
  _xTemp.clear();
  _residual.clear();
}
