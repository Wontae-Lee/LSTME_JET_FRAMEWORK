...
void
FdmMgpcgSolver3::Preconditioner::build(FdmMgLinearSystem3* system_, MgParameters<FdmBlas3> mgParams_)
{
  system = system_;
  mgParams = mgParams_;
}
...
void
FdmMgpcgSolver3::Preconditioner::solve(const FdmVector3& b, FdmVector3* x)
{
  // Copy dimension
...
bool
FdmMgpcgSolver3::solve(FdmMgLinearSystem3* system)
{
...
unsigned int
FdmMgpcgSolver3::maxNumberOfIterations() const
{
  return _maxNumberOfIterations;
}

unsigned int
FdmMgpcgSolver3::lastNumberOfIterations() const
{
  return _lastNumberOfIterations;
}

double
FdmMgpcgSolver3::tolerance() const
{
  return _tolerance;
}

double
FdmMgpcgSolver3::lastResidual() const
{
