                           ...
                           bool useRedBlackOrdering)
{
  ...
  if (useRedBlackOrdering) {
    _mgParams.relaxFunc =
      [sorFactor](const FdmMatrix2& A, const FdmVector2& b, unsigned int numberOfIterations, double maxTolerance, FdmVector2* x, FdmVector2* buffer) {
...
const MgParameters<FdmBlas2>&
FdmMgSolver2::params() const
{
  return _mgParams;
}

double
FdmMgSolver2::sorFactor() const
{
  return _sorFactor;
}

bool
FdmMgSolver2::useRedBlackOrdering() const
{
  return _useRedBlackOrdering;
}

bool
FdmMgSolver2::solve(FdmLinearSystem2* system)
{
...
bool
FdmMgSolver2::solve(FdmMgLinearSystem2* system)
{
