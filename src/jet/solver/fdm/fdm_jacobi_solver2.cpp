...
FdmJacobiSolver2::FdmJacobiSolver2(unsigned int maxNumberOfIterations, unsigned int residualCheckInterval, double tolerance)
...
bool
FdmJacobiSolver2::solve(FdmLinearSystem2* system)
{
...
bool
FdmJacobiSolver2::solveCompressed(FdmCompressedLinearSystem2* system)
{
...
unsigned int
FdmJacobiSolver2::maxNumberOfIterations() const
{
  return _maxNumberOfIterations;
}

unsigned int
FdmJacobiSolver2::lastNumberOfIterations() const
{
  return _lastNumberOfIterations;
}

double
FdmJacobiSolver2::tolerance() const
{
  return _tolerance;
}

double
FdmJacobiSolver2::lastResidual() const
{
  return _lastResidual;
}

void
FdmJacobiSolver2::relax(const FdmMatrix2& A, const FdmVector2& b, FdmVector2* x_, FdmVector2* xTemp_)
{
  Size2 size = A.size();
  FdmVector2& x = *x_;
...
void
FdmJacobiSolver2::relax(const MatrixCsrD& A, const VectorND& b, VectorND* x_, VectorND* xTemp_)
{
...
void
FdmJacobiSolver2::clearUncompressedVectors()
{
  _xTempComp.clear();
  _residualComp.clear();
}
...
void
FdmJacobiSolver2::clearCompressedVectors()
{
  _xTemp.clear();
  _residual.clear();
}
