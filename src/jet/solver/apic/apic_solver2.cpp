...
ApicSolver2::ApicSolver2(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& gridOrigin) : PicSolver2(resolution, gridSpacing, gridOrigin) {}
...
ApicSolver2 ApicSolver2::Builder::build() const { return ApicSolver2(_resolution, getGridSpacing(), _gridOrigin); }
