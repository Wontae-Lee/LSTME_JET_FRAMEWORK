...
void SphSolver2::setEosExponent(double newEosExponent) { _eosExponent = std::max(newEosExponent, 1.0); }

double SphSolver2::negativePressureScale() const { return _negativePressureScale; }

void SphSolver2::setNegativePressureScale(double newNegativePressureScale) { _negativePressureScale = clamp(newNegativePressureScale, 0.0, 1.0); }

double SphSolver2::viscosityCoefficient() const { return _viscosityCoefficient; }

void SphSolver2::setViscosityCoefficient(double newViscosityCoefficient) { _viscosityCoefficient = std::max(newViscosityCoefficient, 0.0); }

double SphSolver2::pseudoViscosityCoefficient() const { return _pseudoViscosityCoefficient; }

void SphSolver2::setPseudoViscosityCoefficient(double newPseudoViscosityCoefficient) { _pseudoViscosityCoefficient = std::max(newPseudoViscosityCoefficient, 0.0); }

double SphSolver2::speedOfSound() const { return _speedOfSound; }

void SphSolver2::setSpeedOfSound(double newSpeedOfSound) { _speedOfSound = std::max(newSpeedOfSound, kEpsilonD); }

double SphSolver2::timeStepLimitScale() const { return _timeStepLimitScale; }

void SphSolver2::setTimeStepLimitScale(double newScale) { _timeStepLimitScale = std::max(newScale, 0.0); }

SphSystemData2Ptr SphSolver2::sphSystemData() const { return std::dynamic_pointer_cast<SphSystemData2>(particleSystemData()); }
...
void SphSolver2::accumulatePressureForce(const ConstArrayAccessor1<Vector2D>& positions, const ConstArrayAccessor1<double>& densities, const ConstArrayAccessor1<double>& pressures,
...
SphSolver2 SphSolver2::Builder::build() const { return SphSolver2(_targetDensity, _targetSpacing, _relativeKernelRadius); }
