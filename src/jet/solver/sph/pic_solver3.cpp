...
PicSolver3::PicSolver3(const Size3& resolution, const Vector3D& gridSpacing, const Vector3D& gridOrigin) : GridFluidSolver3(resolution, gridSpacing, gridOrigin) {
...
ScalarGrid3Ptr PicSolver3::signedDistanceField() const { return gridSystemData()->scalarDataAt(_signedDistanceFieldId); }

const ParticleSystemData3Ptr& PicSolver3::particleSystemData() const { return _particles; }

const ParticleEmitter3Ptr& PicSolver3::particleEmitter() const { return _particleEmitter; }
...
PicSolver3 PicSolver3::Builder::build() const { return PicSolver3(_resolution, getGridSpacing(), _gridOrigin); }
