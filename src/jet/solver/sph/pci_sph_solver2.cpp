...
PciSphSolver2::PciSphSolver2(double targetDensity, double targetSpacing, double relativeKernelRadius) : SphSolver2(targetDensity, targetSpacing, relativeKernelRadius) {
...
void PciSphSolver2::setMaxDensityErrorRatio(double ratio) { _maxDensityErrorRatio = std::max(ratio, 0.0); }
...
PciSphSolver2 PciSphSolver2::Builder::build() const { return PciSphSolver2(_targetDensity, _targetSpacing, _relativeKernelRadius); }

PciSphSolver2Ptr PciSphSolver2::Builder::makeShared() const {
    return std::shared_ptr<PciSphSolver2>(new PciSphSolver2(_targetDensity, _targetSpacing, _relativeKernelRadius), [](PciSphSolver2* obj) { delete obj; });
}
