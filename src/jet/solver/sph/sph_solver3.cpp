...
double
SphSolver3::eosExponent() const
{
  return _eosExponent;
}

void
SphSolver3::setEosExponent(double newEosExponent)
{
  _eosExponent = std::max(newEosExponent, 1.0);
}

double
SphSolver3::negativePressureScale() const
{
  return _negativePressureScale;
}

void
SphSolver3::setNegativePressureScale(double newNegativePressureScale)
{
  _negativePressureScale = clamp(newNegativePressureScale, 0.0, 1.0);
}

double
SphSolver3::viscosityCoefficient() const
{
  return _viscosityCoefficient;
}

void
SphSolver3::setViscosityCoefficient(double newViscosityCoefficient)
{
  _viscosityCoefficient = std::max(newViscosityCoefficient, 0.0);
}

double
SphSolver3::pseudoViscosityCoefficient() const
{
  return _pseudoViscosityCoefficient;
}

void
SphSolver3::setPseudoViscosityCoefficient(double newPseudoViscosityCoefficient)
{
  _pseudoViscosityCoefficient = std::max(newPseudoViscosityCoefficient, 0.0);
}

double
SphSolver3::speedOfSound() const
{
  return _speedOfSound;
}

void
SphSolver3::setSpeedOfSound(double newSpeedOfSound)
{
  _speedOfSound = std::max(newSpeedOfSound, kEpsilonD);
}

double
SphSolver3::timeStepLimitScale() const
{
  return _timeStepLimitScale;
}

void
SphSolver3::setTimeStepLimitScale(double newScale)
{
  _timeStepLimitScale = std::max(newScale, 0.0);
}

SphSystemData3Ptr
SphSolver3::sphSystemData() const
{
  return std::dynamic_pointer_cast<SphSystemData3>(particleSystemData());
}

unsigned int
SphSolver3::numberOfSubTimeSteps(double timeIntervalInSeconds) const
{
...
void
SphSolver3::accumulateForces(double timeStepInSeconds)
{
...
void
SphSolver3::onBeginAdvanceTimeStep(double timeStepInSeconds)
{
...
void
SphSolver3::onEndAdvanceTimeStep(double timeStepInSeconds)
{
...
void
SphSolver3::accumulateNonPressureForces(double timeStepInSeconds)
{
...
void
SphSolver3::accumulatePressureForce(double timeStepInSeconds)
{
  UNUSED_VARIABLE(timeStepInSeconds);
...
void
SphSolver3::accumulatePressureForce(const ConstArrayAccessor1<Vector3D>& positions,
...
void
SphSolver3::accumulateViscosityForce()
{
  auto particles = sphSystemData();
  size_t numberOfParticles = particles->numberOfParticles();
  auto x = particles->positions();
...
void
SphSolver3::computePseudoViscosity(double timeStepInSeconds)
{
  auto particles = sphSystemData();
  size_t numberOfParticles = particles->numberOfParticles();
  auto x = particles->positions();
