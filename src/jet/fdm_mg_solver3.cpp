...
FdmMgSolver3::FdmMgSolver3(size_t maxNumberOfLevels, unsigned int numberOfRestrictionIter, unsigned int numberOfCorrectionIter, unsigned int numberOfCoarsestIter, unsigned int numberOfFinalIter,
    ...
    if (useRedBlackOrdering) {
        _mgParams.relaxFunc = [sorFactor](const FdmMatrix3& A, const FdmVector3& b, unsigned int numberOfIterations, double maxTolerance, FdmVector3* x, FdmVector3* buffer) {
