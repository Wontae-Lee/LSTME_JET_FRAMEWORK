...
PciSphSolver3::PciSphSolver3(double targetDensity, double targetSpacing, double relativeKernelRadius) : SphSolver3(targetDensity, targetSpacing, relativeKernelRadius) {
...
void PciSphSolver3::setMaxDensityErrorRatio(double ratio) { _maxDensityErrorRatio = std::max(ratio, 0.0); }
...
PciSphSolver3 PciSphSolver3::Builder::build() const { return PciSphSolver3(_targetDensity, _targetSpacing, _relativeKernelRadius); }

PciSphSolver3Ptr PciSphSolver3::Builder::makeShared() const {
    return std::shared_ptr<PciSphSolver3>(new PciSphSolver3(_targetDensity, _targetSpacing, _relativeKernelRadius), [](PciSphSolver3* obj) { delete obj; });
}
