...
FaceCenteredGrid3::FaceCenteredGrid3()
    : _dataOriginU(0.0, 0.5, 0.5), _dataOriginV(0.5, 0.0, 0.5),
...
void FaceCenteredGrid3::fill(const Vector3D &value, ExecutionPolicy policy) {
  parallelFor(
      kZeroSize, _dataU.width(), kZeroSize, _dataU.height(), kZeroSize,
      _dataU.depth(),
      ...
      policy);
  parallelFor(
      kZeroSize, _dataV.width(), kZeroSize, _dataV.height(), kZeroSize,
      _dataV.depth(),
      [this, value](size_t i, size_t j, size_t k) {
      ...
      policy);
  parallelFor(
      kZeroSize, _dataW.width(), kZeroSize, _dataW.height(), kZeroSize,
      _dataW.depth(),
      [this, value](size_t i, size_t j, size_t k) {
...
FaceCenteredGrid3::Builder &
FaceCenteredGrid3::Builder::withOrigin(double gridOriginX, double gridOriginY,
                                       double gridOriginZ) {
