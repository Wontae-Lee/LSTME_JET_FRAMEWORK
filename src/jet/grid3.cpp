...
bool Grid3::hasSameShape(const Grid3& other) const {
    return _resolution.x == other._resolution.x && _resolution.y == other._resolution.y && _resolution.z == other._resolution.z && similar(_gridSpacing.x, other._gridSpacing.x) &&
           similar(_gridSpacing.y, other._gridSpacing.y) && similar(_gridSpacing.z, other._gridSpacing.z) && similar(_origin.x, other._origin.x) && similar(_origin.y, other._origin.y) &&
