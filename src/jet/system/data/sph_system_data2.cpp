...
SphSystemData2::SphSystemData2(size_t numberOfParticles) : ParticleSystemData2(numberOfParticles) {
...
ConstArrayAccessor1<double> SphSystemData2::densities() const { return scalarDataAt(_densityIdx); }

ArrayAccessor1<double> SphSystemData2::densities() { return scalarDataAt(_densityIdx); }

ConstArrayAccessor1<double> SphSystemData2::pressures() const { return scalarDataAt(_pressureIdx); }

ArrayAccessor1<double> SphSystemData2::pressures() { return scalarDataAt(_pressureIdx); }
...
double SphSystemData2::relativeKernelRadius() const { return _kernelRadiusOverTargetSpacing; }
...
void SphSystemData2::buildNeighborSearcher() { ParticleSystemData2::buildNeighborSearcher(_kernelRadius); }

void SphSystemData2::buildNeighborLists() { ParticleSystemData2::buildNeighborLists(_kernelRadius); }
...
void SphSystemData2::serialize(std::vector<uint8_t>* buffer) const {
    ...
    auto fbsSphSystemData = fbs::CreateSphSystemData2(builder, fbsParticleSystemData, _targetDensity, _targetSpacing, _kernelRadiusOverTargetSpacing, _kernelRadius, _pressureIdx, _densityIdx);
