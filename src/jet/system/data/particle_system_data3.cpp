...
#include "jet/searcher/point_parallel_hash_grid_searcher3.h"
...
void
ParticleSystemData3::resize(size_t newNumberOfParticles)
{
...
size_t
ParticleSystemData3::numberOfParticles() const
{
  return _numberOfParticles;
}

size_t
ParticleSystemData3::addScalarData(double initialVal)
{
...
size_t
ParticleSystemData3::addVectorData(const Vector3D& initialVal)
{
...
double
ParticleSystemData3::radius() const
{
  return _radius;
}

void
ParticleSystemData3::setRadius(double newRadius)
{
  _radius = std::max(newRadius, 0.0);
}

double
ParticleSystemData3::mass() const
{
  return _mass;
}

void
ParticleSystemData3::setMass(double newMass)
{
  _mass = std::max(newMass, 0.0);
}

ConstArrayAccessor1<Vector3D>
ParticleSystemData3::positions() const
{
  return vectorDataAt(_positionIdx);
}

ArrayAccessor1<Vector3D>
ParticleSystemData3::positions()
{
  return vectorDataAt(_positionIdx);
}

ConstArrayAccessor1<Vector3D>
ParticleSystemData3::velocities() const
{
  return vectorDataAt(_velocityIdx);
}

ArrayAccessor1<Vector3D>
ParticleSystemData3::velocities()
{
  return vectorDataAt(_velocityIdx);
}

ConstArrayAccessor1<Vector3D>
ParticleSystemData3::forces() const
{
  return vectorDataAt(_forceIdx);
}

ArrayAccessor1<Vector3D>
ParticleSystemData3::forces()
{
  return vectorDataAt(_forceIdx);
}

ConstArrayAccessor1<double>
ParticleSystemData3::scalarDataAt(size_t idx) const
{
  return _scalarDataList[idx].constAccessor();
}

ArrayAccessor1<double>
ParticleSystemData3::scalarDataAt(size_t idx)
{
  return _scalarDataList[idx].accessor();
}

ConstArrayAccessor1<Vector3D>
ParticleSystemData3::vectorDataAt(size_t idx) const
{
  return _vectorDataList[idx].constAccessor();
}

ArrayAccessor1<Vector3D>
ParticleSystemData3::vectorDataAt(size_t idx)
{
  return _vectorDataList[idx].accessor();
}

void
ParticleSystemData3::addParticle(const Vector3D& newPosition, const Vector3D& newVelocity, const Vector3D& newForce)
{
...
void
ParticleSystemData3::addParticles(const ConstArrayAccessor1<Vector3D>& newPositions,
...
const PointNeighborSearcher3Ptr&
ParticleSystemData3::neighborSearcher() const
{
  return _neighborSearcher;
}

void
ParticleSystemData3::setNeighborSearcher(const PointNeighborSearcher3Ptr& newNeighborSearcher)
{
...
void
ParticleSystemData3::buildNeighborSearcher(double maxSearchRadius)
{
  Timer timer;
  ...
  _neighborSearcher->build(static_cast<ConstArrayAccessor<Vector3D ,1>>(positions()));

  JET_INFO << "Building neighbor searcher took: " << timer.durationInSeconds() << " seconds";
}

void
ParticleSystemData3::buildNeighborLists(double maxSearchRadius)
{
  Timer timer;
...
void
ParticleSystemData3::serialize(std::vector<uint8_t>* buffer) const
{
...
void
ParticleSystemData3::deserialize(const std::vector<uint8_t>& buffer)
{
...
void
ParticleSystemData3::set(const ParticleSystemData3& other)
{
...
void
ParticleSystemData3::serializeParticleSystemData(flatbuffers::FlatBufferBuilder* builder,
                                                 flatbuffers::Offset<fbs::ParticleSystemData3>* fbsParticleSystemData) const
{
  ...
  for (const auto& vectorData : _vectorDataList) {
    ...
    auto fbsVectorData = fbs::CreateVectorParticleData3(*builder, builder->CreateVectorOfStructs(newVectorData.data(), newVectorData.size()));
  ...
  for (const auto& neighbors : _neighborLists) {
    ...
    flatbuffers::Offset<fbs::ParticleNeighborList3> fbsNeighborList =
      fbs::CreateParticleNeighborList3(*builder, builder->CreateVector(neighbors64.data(), neighbors64.size()));
...
void
ParticleSystemData3::deserializeParticleSystemData(const fbs::ParticleSystemData3* fbsParticleSystemData)
{
