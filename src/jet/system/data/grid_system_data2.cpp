...
#include "jet/system/data/grid_system_data2.h"
...
void
GridSystemData2::resize(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& origin)
{
...
size_t
GridSystemData2::addScalarData(const ScalarGridBuilder2Ptr& builder, double initialVal)
{
...
size_t
GridSystemData2::addVectorData(const VectorGridBuilder2Ptr& builder, const Vector2D& initialVal)
{
...
size_t
GridSystemData2::addAdvectableScalarData(const ScalarGridBuilder2Ptr& builder, double initialVal)
{
...
size_t
GridSystemData2::addAdvectableVectorData(const VectorGridBuilder2Ptr& builder, const Vector2D& initialVal)
{
...
GridSystemData2::serialize(std::vector<uint8_t>* buffer) const
{
  ...
  serializeGrid(&builder, _advectableScalarDataList, fbs::CreateScalarGridSerialized2, &advScalarDataList);
  serializeGrid(&builder, _advectableVectorDataList, fbs::CreateVectorGridSerialized2, &advVectorDataList);

  auto gsd = fbs::CreateGridSystemData2(builder,
                                        &resolution,
                                        &gridSpacing,
                                        &origin,
                                        _velocityIdx,
...
GridSystemData2::deserialize(const std::vector<uint8_t>& buffer)
{
  ...
  deserializeGrid(gsd->advectableScalarData(), Factory::buildScalarGrid2, &_advectableScalarDataList);
  deserializeGrid(gsd->advectableVectorData(), Factory::buildVectorGrid2, &_advectableVectorDataList);
