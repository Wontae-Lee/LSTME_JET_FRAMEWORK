...
#include "jet/system/data/grid_system_data3.h"
...
void
GridSystemData3::resize(const Size3& resolution, const Vector3D& gridSpacing, const Vector3D& origin)
{
...
Size3
GridSystemData3::resolution() const
{
  return _resolution;
}

Vector3D
GridSystemData3::gridSpacing() const
{
  return _gridSpacing;
}

Vector3D
GridSystemData3::origin() const
{
  return _origin;
}

BoundingBox3D
GridSystemData3::boundingBox() const
{
  return _velocity->boundingBox();
}

size_t
GridSystemData3::addScalarData(const ScalarGridBuilder3Ptr& builder, double initialVal)
{
...
size_t
GridSystemData3::addVectorData(const VectorGridBuilder3Ptr& builder, const Vector3D& initialVal)
{
...
size_t
GridSystemData3::addAdvectableScalarData(const ScalarGridBuilder3Ptr& builder, double initialVal)
{
...
size_t
GridSystemData3::addAdvectableVectorData(const VectorGridBuilder3Ptr& builder, const Vector3D& initialVal)
{
...
GridSystemData3::velocity() const
{
  return _velocity;
}

size_t
GridSystemData3::velocityIndex() const
{
  return _velocityIdx;
}

const ScalarGrid3Ptr&
GridSystemData3::scalarDataAt(size_t idx) const
{
  return _scalarDataList[idx];
}

const VectorGrid3Ptr&
GridSystemData3::vectorDataAt(size_t idx) const
{
...
size_t
GridSystemData3::numberOfScalarData() const
{
  return _scalarDataList.size();
}

size_t
GridSystemData3::numberOfVectorData() const
{
  return _vectorDataList.size();
}

size_t
GridSystemData3::numberOfAdvectableScalarData() const
{
  return _advectableScalarDataList.size();
}

size_t
GridSystemData3::numberOfAdvectableVectorData() const
{
  return _advectableVectorDataList.size();
}

void
GridSystemData3::serialize(std::vector<uint8_t>* buffer) const
{
  ...
  serializeGrid(&builder, _scalarDataList, fbs::CreateScalarGridSerialized3, &scalarDataList);
  serializeGrid(&builder, _vectorDataList, fbs::CreateVectorGridSerialized3, &vectorDataList);
  serializeGrid(&builder, _advectableScalarDataList, fbs::CreateScalarGridSerialized3, &advScalarDataList);
  serializeGrid(&builder, _advectableVectorDataList, fbs::CreateVectorGridSerialized3, &advVectorDataList);

  auto gsd = fbs::CreateGridSystemData3(builder,
                                        &resolution,
                                        &gridSpacing,
                                        &origin,
                                        _velocityIdx,
...
void
GridSystemData3::deserialize(const std::vector<uint8_t>& buffer)
{
  ...
  deserializeGrid(gsd->scalarData(), Factory::buildScalarGrid3, &_scalarDataList);
  deserializeGrid(gsd->vectorData(), Factory::buildVectorGrid3, &_vectorDataList);
  deserializeGrid(gsd->advectableScalarData(), Factory::buildScalarGrid3, &_advectableScalarDataList);
  deserializeGrid(gsd->advectableVectorData(), Factory::buildVectorGrid3, &_advectableVectorDataList);

  _velocityIdx = static_cast<size_t>(gsd->velocityIdx());
  _velocity = std::dynamic_pointer_cast<FaceCenteredGrid3>(_advectableVectorDataList[_velocityIdx]);
}
