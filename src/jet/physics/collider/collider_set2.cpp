...
size_t ColliderSet2::numberOfColliders() const { return _colliders.size(); }

Collider2Ptr ColliderSet2::collider(size_t i) const { return _colliders[i]; }

ColliderSet2::Builder ColliderSet2::builder() { return Builder(); }
...
ColliderSet2 ColliderSet2::Builder::build() const { return ColliderSet2(_colliders); }

ColliderSet2Ptr ColliderSet2::Builder::makeShared() const {
    return std::shared_ptr<ColliderSet2>(new ColliderSet2(_colliders), [](ColliderSet2* obj) { delete obj; });
}
