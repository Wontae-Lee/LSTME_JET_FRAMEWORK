...
RigidBodyCollider2::RigidBodyCollider2(const Surface2Ptr& surface, const Vector2D& linearVelocity_, double angularVelocity_)
...
Vector2D
RigidBodyCollider2::velocityAt(const Vector2D& point) const
{
