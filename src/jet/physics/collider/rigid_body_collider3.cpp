...
Vector3D
RigidBodyCollider3::velocityAt(const Vector3D& point) const
{
...
RigidBodyCollider3
RigidBodyCollider3::Builder::build() const
{
  return RigidBodyCollider3(_surface, _linearVelocity, _angularVelocity);
}

RigidBodyCollider3Ptr
RigidBodyCollider3::Builder::makeShared() const
{
  return std::shared_ptr<RigidBodyCollider3>(new RigidBodyCollider3(_surface, _linearVelocity, _angularVelocity),
