...
VolumeGridEmitter2::VolumeGridEmitter2(const ImplicitSurface2Ptr& sourceRegion, bool isOneShot) : _sourceRegion(sourceRegion), _isOneShot(isOneShot) {}
...
void VolumeGridEmitter2::addTarget(const ScalarGrid2Ptr& scalarGridTarget, const ScalarMapper& customMapper) { _customScalarTargets.emplace_back(scalarGridTarget, customMapper); }

void VolumeGridEmitter2::addTarget(const VectorGrid2Ptr& vectorGridTarget, const VectorMapper& customMapper) { _customVectorTargets.emplace_back(vectorGridTarget, customMapper); }
