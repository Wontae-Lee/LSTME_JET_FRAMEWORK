...
size_t
PointParticleEmitter2::maxNumberOfNewParticlesPerSecond() const
{
  return _maxNumberOfNewParticlesPerSecond;
}

void
PointParticleEmitter2::setMaxNumberOfNewParticlesPerSecond(size_t rate)
{
  _maxNumberOfNewParticlesPerSecond = rate;
}

size_t
PointParticleEmitter2::maxNumberOfParticles() const
{
  return _maxNumberOfParticles;
}

void
PointParticleEmitter2::setMaxNumberOfParticles(size_t maxNumberOfParticles)
{
  _maxNumberOfParticles = maxNumberOfParticles;
}

void
PointParticleEmitter2::onUpdate(double currentTimeInSeconds, double timeIntervalInSeconds)
{
...
void
PointParticleEmitter2::emit(Array1<Vector2D>* newPositions, Array1<Vector2D>* newVelocities, size_t maxNewNumberOfParticles)
{
...
PointParticleEmitter2::Builder&
PointParticleEmitter2::Builder::withSpreadAngleInDegrees(double spreadAngleInDegrees)
{
...
PointParticleEmitter2::Builder&
PointParticleEmitter2::Builder::withMaxNumberOfNewParticlesPerSecond(size_t maxNumOfNewParticlesPerSec)
{
  _maxNumberOfNewParticlesPerSecond = maxNumOfNewParticlesPerSec;
  return *this;
}
...
PointParticleEmitter2::Builder&
PointParticleEmitter2::Builder::withMaxNumberOfParticles(size_t maxNumberOfParticles)
{
  _maxNumberOfParticles = maxNumberOfParticles;
  return *this;
}
...
PointParticleEmitter2::Builder::build() const
{
  return PointParticleEmitter2(_origin, _direction, _speed, _spreadAngleInDegrees, _maxNumberOfNewParticlesPerSecond, _maxNumberOfParticles, _seed);
}

PointParticleEmitter2Ptr
PointParticleEmitter2::Builder::makeShared() const
{
  return std::shared_ptr<PointParticleEmitter2>(
    new PointParticleEmitter2(_origin, _direction, _speed, _spreadAngleInDegrees, _maxNumberOfNewParticlesPerSecond, _maxNumberOfParticles, _seed),
