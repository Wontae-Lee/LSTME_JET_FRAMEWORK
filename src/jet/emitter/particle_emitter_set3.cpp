...
ParticleEmitterSet3::ParticleEmitterSet3(const std::vector<ParticleEmitter3Ptr>& emitters) : _emitters(emitters) {}
...
ParticleEmitterSet3::Builder ParticleEmitterSet3::builder() { return Builder(); }
