...
#include "jet/searcher/point_hash_grid_searcher3.h"
...
void
VolumeParticleEmitter3::onUpdate(double currentTimeInSeconds, double timeIntervalInSeconds)
{
...
void
VolumeParticleEmitter3::emit(const ParticleSystemData3Ptr& particles, Array1<Vector3D>* newPositions, Array1<Vector3D>* newVelocities)
{
  if (!_implicitSurface) {
    return;
  }
...
void
VolumeParticleEmitter3::setPointGenerator(const PointGenerator3Ptr& newPointsGen)
{
  _pointsGen = newPointsGen;
}

const ImplicitSurface3Ptr&
VolumeParticleEmitter3::surface() const
{
  return _implicitSurface;
}

void
VolumeParticleEmitter3::setSurface(const ImplicitSurface3Ptr& newSurface)
{
  _implicitSurface = newSurface;
}

const BoundingBox3D&
VolumeParticleEmitter3::maxRegion() const
{
  return _bounds;
}

void
VolumeParticleEmitter3::setMaxRegion(const BoundingBox3D& newMaxRegion)
{
  _bounds = newMaxRegion;
}

double
VolumeParticleEmitter3::jitter() const
{
  return _jitter;
}

void
VolumeParticleEmitter3::setJitter(double newJitter)
{
  _jitter = clamp(newJitter, 0.0, 1.0);
}

bool
VolumeParticleEmitter3::isOneShot() const
{
  return _isOneShot;
}

void
VolumeParticleEmitter3::setIsOneShot(bool newValue)
{
  _isOneShot = newValue;
}

bool
VolumeParticleEmitter3::allowOverlapping() const
{
  return _allowOverlapping;
}

void
VolumeParticleEmitter3::setAllowOverlapping(bool newValue)
{
  _allowOverlapping = newValue;
}

size_t
VolumeParticleEmitter3::maxNumberOfParticles() const
{
  return _maxNumberOfParticles;
}

void
VolumeParticleEmitter3::setMaxNumberOfParticles(size_t newMaxNumberOfParticles)
{
  _maxNumberOfParticles = newMaxNumberOfParticles;
}

double
VolumeParticleEmitter3::spacing() const
{
  return _spacing;
}

void
VolumeParticleEmitter3::setSpacing(double newSpacing)
{
  _spacing = newSpacing;
}

Vector3D
VolumeParticleEmitter3::initialVelocity() const
{
  return _initialVel;
}

void
VolumeParticleEmitter3::setInitialVelocity(const Vector3D& newInitialVel)
{
  _initialVel = newInitialVel;
}

Vector3D
VolumeParticleEmitter3::linearVelocity() const
{
  return _linearVel;
}

void
VolumeParticleEmitter3::setLinearVelocity(const Vector3D& newLinearVel)
{
  _linearVel = newLinearVel;
}

Vector3D
VolumeParticleEmitter3::angularVelocity() const
{
  return _angularVel;
}

void
VolumeParticleEmitter3::setAngularVelocity(const Vector3D& newAngularVel)
{
  _angularVel = newAngularVel;
}

double
VolumeParticleEmitter3::random()
{
...
Vector3D
VolumeParticleEmitter3::velocityAt(const Vector3D& point) const
{
...
VolumeParticleEmitter3::Builder&
VolumeParticleEmitter3::Builder::withSurface(const Surface3Ptr& surface)
{
...
VolumeParticleEmitter3::Builder&
VolumeParticleEmitter3::Builder::withMaxNumberOfParticles(size_t maxNumberOfParticles)
{
  _maxNumberOfParticles = maxNumberOfParticles;
  return *this;
}
...
VolumeParticleEmitter3::Builder::build() const
{
  return VolumeParticleEmitter3(
    _implicitSurface, _bounds, _spacing, _initialVel, _linearVel, _angularVel, _maxNumberOfParticles, _jitter, _isOneShot, _allowOverlapping, _seed);
}

VolumeParticleEmitter3Ptr
VolumeParticleEmitter3::Builder::makeShared() const
{
  return std::shared_ptr<VolumeParticleEmitter3>(
    new VolumeParticleEmitter3(
      _implicitSurface, _bounds, _spacing, _initialVel, _linearVel, _angularVel, _maxNumberOfParticles, _jitter, _isOneShot, _allowOverlapping),
