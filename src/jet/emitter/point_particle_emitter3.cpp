...
size_t
PointParticleEmitter3::maxNumberOfNewParticlesPerSecond() const
{
  return _maxNumberOfNewParticlesPerSecond;
}

void
PointParticleEmitter3::setMaxNumberOfNewParticlesPerSecond(size_t rate)
{
  _maxNumberOfNewParticlesPerSecond = rate;
}

size_t
PointParticleEmitter3::maxNumberOfParticles() const
{
  return _maxNumberOfParticles;
}

void
PointParticleEmitter3::setMaxNumberOfParticles(size_t maxNumberOfParticles)
{
  _maxNumberOfParticles = maxNumberOfParticles;
}

void
PointParticleEmitter3::onUpdate(double currentTimeInSeconds, double timeIntervalInSeconds)
{
  ...
  size_t newMaxTotalNumberOfEmittedParticles =
    static_cast<size_t>(std::ceil((elapsedTimeInSeconds + timeIntervalInSeconds) * _maxNumberOfNewParticlesPerSecond));
...
void
PointParticleEmitter3::emit(Array1<Vector3D>* newPositions, Array1<Vector3D>* newVelocities, size_t maxNewNumberOfParticles)
{
...
PointParticleEmitter3::Builder&
PointParticleEmitter3::Builder::withSpreadAngleInDegrees(double spreadAngleInDegrees)
{
...
PointParticleEmitter3::Builder&
PointParticleEmitter3::Builder::withMaxNumberOfNewParticlesPerSecond(size_t maxNumOfNewParticlesPerSec)
{
  _maxNumberOfNewParticlesPerSecond = maxNumOfNewParticlesPerSec;
  return *this;
}
...
PointParticleEmitter3::Builder&
PointParticleEmitter3::Builder::withMaxNumberOfParticles(size_t maxNumberOfParticles)
{
  _maxNumberOfParticles = maxNumberOfParticles;
  return *this;
}
...
PointParticleEmitter3::Builder::build() const
{
  return PointParticleEmitter3(_origin, _direction, _speed, _spreadAngleInDegrees, _maxNumberOfNewParticlesPerSecond, _maxNumberOfParticles, _seed);
}

PointParticleEmitter3Ptr
PointParticleEmitter3::Builder::makeShared() const
{
  return std::shared_ptr<PointParticleEmitter3>(
    new PointParticleEmitter3(_origin, _direction, _speed, _spreadAngleInDegrees, _maxNumberOfNewParticlesPerSecond, _maxNumberOfParticles, _seed),
