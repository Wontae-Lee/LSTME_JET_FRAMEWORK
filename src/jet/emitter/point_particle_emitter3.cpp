...
PointParticleEmitter3::PointParticleEmitter3(const Vector3D& origin, const Vector3D& direction, double speed, double spreadAngleInDegrees, size_t maxNumOfNewParticlesPerSec, size_t maxNumOfParticles,
                                             uint32_t seed)
    : _rng(seed),
...
void PointParticleEmitter3::setMaxNumberOfNewParticlesPerSecond(size_t rate) { _maxNumberOfNewParticlesPerSecond = rate; }
...
void PointParticleEmitter3::emit(Array1<Vector3D>* newPositions, Array1<Vector3D>* newVelocities, size_t maxNewNumberOfParticles) {
...
PointParticleEmitter3Ptr PointParticleEmitter3::Builder::makeShared() const {
    return std::shared_ptr<PointParticleEmitter3>(new PointParticleEmitter3(_origin, _direction, _speed, _spreadAngleInDegrees, _maxNumberOfNewParticlesPerSecond, _maxNumberOfParticles, _seed),
