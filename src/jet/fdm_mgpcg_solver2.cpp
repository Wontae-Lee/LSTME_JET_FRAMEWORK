...
FdmMgpcgSolver2::FdmMgpcgSolver2(
    ...
    : FdmMgSolver2(maxNumberOfLevels, numberOfRestrictionIter,
                   ...
                   useRedBlackOrdering),
      _maxNumberOfIterations(numberOfCgIter), _lastNumberOfIterations(0),
      _tolerance(maxTolerance), _lastResidualNorm(kMaxD) {}
bool FdmMgpcgSolver2::solve(FdmMgLinearSystem2 *system) {
  ...
  pcg<FdmBlas2, Preconditioner>(
      ...
      _maxNumberOfIterations, _tolerance, &_precond, &system->x.levels.front(),
