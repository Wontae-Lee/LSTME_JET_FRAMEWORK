...
#include "jet/primitive/grid/cell_centered_scalar_grid3.h"
...
#include "jet/primitive/grid/vertex_centered_scalar_grid2.h"
#include "jet/primitive/grid/vertex_centered_scalar_grid3.h"
#include "jet/primitive/grid/vertex_centered_vector_grid2.h"
...
#include "jet/searcher/point_simple_list_searcher2.h"
#include "jet/searcher/point_simple_list_searcher3.h"
...
#define REGISTER_BUILDER(map, ClassName) map.emplace(#ClassName, std::make_shared<ClassName::Builder>());

#define REGISTER_SCALAR_GRID2_BUILDER(ClassName) REGISTER_BUILDER(sScalarGrid2Builders, ClassName)

#define REGISTER_SCALAR_GRID3_BUILDER(ClassName) REGISTER_BUILDER(sScalarGrid3Builders, ClassName)

#define REGISTER_VECTOR_GRID2_BUILDER(ClassName) REGISTER_BUILDER(sVectorGrid2Builders, ClassName)

#define REGISTER_VECTOR_GRID3_BUILDER(ClassName) REGISTER_BUILDER(sVectorGrid3Builders, ClassName)

#define REGISTER_POINT_NEIGHBOR_SEARCHER2_BUILDER(ClassName) REGISTER_BUILDER(sPointNeighborSearcher2Builders, ClassName)

#define REGISTER_POINT_NEIGHBOR_SEARCHER3_BUILDER(ClassName) REGISTER_BUILDER(sPointNeighborSearcher3Builders, ClassName)
...
ScalarGrid2Ptr
Factory::buildScalarGrid2(const std::string& name)
{
...
ScalarGrid3Ptr
Factory::buildScalarGrid3(const std::string& name)
{
...
VectorGrid2Ptr
Factory::buildVectorGrid2(const std::string& name)
{
...
VectorGrid3Ptr
Factory::buildVectorGrid3(const std::string& name)
{
...
Factory::buildPointNeighborSearcher2(const std::string& name)
{
...
Factory::buildPointNeighborSearcher3(const std::string& name)
{
