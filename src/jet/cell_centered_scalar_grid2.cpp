...
CellCenteredScalarGrid2::CellCenteredScalarGrid2(
  ...
  resize(resolutionX, resolutionY, gridSpacingX, gridSpacingY, originX, originY,
         initialValue);
}
...
CellCenteredScalarGrid2 CellCenteredScalarGrid2::Builder::build() const {
  return CellCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin,
                                 _initialVal);
}
...
CellCenteredScalarGrid2::Builder::makeShared() const {
  return std::shared_ptr<CellCenteredScalarGrid2>(
      new CellCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin,
                                  _initialVal),
      [](CellCenteredScalarGrid2 *obj) { delete obj; });
}
