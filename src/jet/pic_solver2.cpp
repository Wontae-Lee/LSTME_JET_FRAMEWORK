...
PicSolver2::PicSolver2(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& gridOrigin) : GridFluidSolver2(resolution, gridSpacing, gridOrigin) {
...
ScalarGrid2Ptr PicSolver2::signedDistanceField() const { return gridSystemData()->scalarDataAt(_signedDistanceFieldId); }

const ParticleSystemData2Ptr& PicSolver2::particleSystemData() const { return _particles; }

const ParticleEmitter2Ptr& PicSolver2::particleEmitter() const { return _particleEmitter; }
...
ScalarField2Ptr PicSolver2::fluidSdf() const { return signedDistanceField(); }
...
PicSolver2::Builder PicSolver2::builder() { return Builder(); }

PicSolver2 PicSolver2::Builder::build() const { return PicSolver2(_resolution, getGridSpacing(), _gridOrigin); }
