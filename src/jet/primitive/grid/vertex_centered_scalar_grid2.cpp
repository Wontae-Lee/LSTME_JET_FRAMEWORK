...
Size2
VertexCenteredScalarGrid2::dataSize() const
{
...
Vector2D
VertexCenteredScalarGrid2::dataOrigin() const
{
  return origin();
}

std::shared_ptr<ScalarGrid2>
VertexCenteredScalarGrid2::clone() const
{
  return CLONE_W_CUSTOM_DELETER(VertexCenteredScalarGrid2);
}

void
VertexCenteredScalarGrid2::swap(Grid2* other)
{
...
void
VertexCenteredScalarGrid2::set(const VertexCenteredScalarGrid2& other)
{
  setScalarGrid(other);
}
...
VertexCenteredScalarGrid2::Builder&
VertexCenteredScalarGrid2::Builder::withResolution(size_t resolutionX, size_t resolutionY)
{
...
VertexCenteredScalarGrid2::Builder&
VertexCenteredScalarGrid2::Builder::withGridSpacing(double gridSpacingX, double gridSpacingY)
{
...
VertexCenteredScalarGrid2::Builder&
VertexCenteredScalarGrid2::Builder::withOrigin(double gridOriginX, double gridOriginY)
{
...
VertexCenteredScalarGrid2
VertexCenteredScalarGrid2::Builder::build() const
{
...
{
  return std::shared_ptr<VertexCenteredScalarGrid2>(new VertexCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal),
                                                    [](VertexCenteredScalarGrid2* obj) { delete obj; });
}

ScalarGrid2Ptr
VertexCenteredScalarGrid2::Builder::build(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& gridOrigin, double initialVal) const
{
  return std::shared_ptr<VertexCenteredScalarGrid2>(new VertexCenteredScalarGrid2(resolution, gridSpacing, gridOrigin, initialVal),
                                                    [](VertexCenteredScalarGrid2* obj) { delete obj; });
}
