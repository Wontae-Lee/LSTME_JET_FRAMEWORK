...
Vector2D CollocatedVectorGrid2::sample(const Vector2D& x) const { return _sampler(x); }
...
std::function<Vector2D(const Vector2D&)> CollocatedVectorGrid2::sampler() const { return _sampler; }
...
void CollocatedVectorGrid2::forEachDataPointIndex(const std::function<void(size_t, size_t)>& func) const { _data.forEachIndex(func); }

void CollocatedVectorGrid2::parallelForEachDataPointIndex(const std::function<void(size_t, size_t)>& func) const { _data.parallelForEachIndex(func); }
...
void CollocatedVectorGrid2::onResize(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& origin, const Vector2D& initialValue) {
