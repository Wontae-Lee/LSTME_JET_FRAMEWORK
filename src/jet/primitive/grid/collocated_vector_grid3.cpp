...
Vector3D CollocatedVectorGrid3::sample(const Vector3D& x) const { return _sampler(x); }
...
std::function<Vector3D(const Vector3D&)> CollocatedVectorGrid3::sampler() const { return _sampler; }
...
void CollocatedVectorGrid3::forEachDataPointIndex(const std::function<void(size_t, size_t, size_t)>& func) const { _data.forEachIndex(func); }

void CollocatedVectorGrid3::parallelForEachDataPointIndex(const std::function<void(size_t, size_t, size_t)>& func) const { _data.parallelForEachIndex(func); }
...
void CollocatedVectorGrid3::onResize(const Size3& resolution, const Vector3D& gridSpacing, const Vector3D& origin, const Vector3D& initialValue) {
