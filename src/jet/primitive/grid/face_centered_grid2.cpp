...
FaceCenteredGrid2::FaceCenteredGrid2(size_t resolutionX, size_t resolutionY, double gridSpacingX, double gridSpacingY, double originX, double originY, double initialValueU, double initialValueV)
    : FaceCenteredGrid2(Size2(resolutionX, resolutionY), Vector2D(gridSpacingX, gridSpacingY), Vector2D(originX, originY), Vector2D(initialValueU, initialValueV)) {}
...
void FaceCenteredGrid2::forEachUIndex(const std::function<void(size_t, size_t)>& func) const { _dataU.forEachIndex(func); }

void FaceCenteredGrid2::parallelForEachUIndex(const std::function<void(size_t, size_t)>& func) const { _dataU.parallelForEachIndex(func); }

void FaceCenteredGrid2::forEachVIndex(const std::function<void(size_t, size_t)>& func) const { _dataV.forEachIndex(func); }

void FaceCenteredGrid2::parallelForEachVIndex(const std::function<void(size_t, size_t)>& func) const { _dataV.parallelForEachIndex(func); }

Vector2D FaceCenteredGrid2::sample(const Vector2D& x) const { return _sampler(x); }

std::function<Vector2D(const Vector2D&)> FaceCenteredGrid2::sampler() const { return _sampler; }
...
void FaceCenteredGrid2::onResize(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& origin, const Vector2D& initialValue) {
...
FaceCenteredGrid2 FaceCenteredGrid2::Builder::build() const { return FaceCenteredGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal); }

FaceCenteredGrid2Ptr FaceCenteredGrid2::Builder::makeShared() const {
    return std::shared_ptr<FaceCenteredGrid2>(new FaceCenteredGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal), [](FaceCenteredGrid2* obj) { delete obj; });
}

VectorGrid2Ptr FaceCenteredGrid2::Builder::build(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& gridOrigin, const Vector2D& initialVal) const {
    return std::shared_ptr<FaceCenteredGrid2>(new FaceCenteredGrid2(resolution, gridSpacing, gridOrigin, initialVal), [](FaceCenteredGrid2* obj) { delete obj; });
}
