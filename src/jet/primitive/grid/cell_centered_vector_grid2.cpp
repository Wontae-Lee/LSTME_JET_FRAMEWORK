...
Size2
CellCenteredVectorGrid2::dataSize() const
{
  return resolution();
}

Vector2D
CellCenteredVectorGrid2::dataOrigin() const
{
  return origin() + 0.5 * gridSpacing();
}

void
CellCenteredVectorGrid2::swap(Grid2* other)
{
...
void
CellCenteredVectorGrid2::set(const CellCenteredVectorGrid2& other)
{
...
void
CellCenteredVectorGrid2::fill(const Vector2D& value, ExecutionPolicy policy)
{
  Size2 size = dataSize();
...
void
CellCenteredVectorGrid2::fill(const std::function<Vector2D(const Vector2D&)>& func, ExecutionPolicy policy)
{
  Size2 size = dataSize();
  auto acc = dataAccessor();
...
CellCenteredVectorGrid2::clone() const
{
...
CellCenteredVectorGrid2::Builder&
CellCenteredVectorGrid2::Builder::withResolution(size_t resolutionX, size_t resolutionY)
{
...
CellCenteredVectorGrid2::Builder&
CellCenteredVectorGrid2::Builder::withGridSpacing(double gridSpacingX, double gridSpacingY)
{
...
CellCenteredVectorGrid2::Builder&
CellCenteredVectorGrid2::Builder::withOrigin(double gridOriginX, double gridOriginY)
{
...
CellCenteredVectorGrid2::Builder&
CellCenteredVectorGrid2::Builder::withInitialValue(double initialValX, double initialValY)
{
...
CellCenteredVectorGrid2
CellCenteredVectorGrid2::Builder::build() const
{
  return CellCenteredVectorGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal);
}

VectorGrid2Ptr
CellCenteredVectorGrid2::Builder::build(const Size2& resolution,
                                        const Vector2D& gridSpacing,
                                        const Vector2D& gridOrigin,
                                        const Vector2D& initialVal) const
{
  return std::shared_ptr<CellCenteredVectorGrid2>(new CellCenteredVectorGrid2(resolution, gridSpacing, gridOrigin, initialVal),
                                                  [](CellCenteredVectorGrid2* obj) { delete obj; });
}

CellCenteredVectorGrid2Ptr
CellCenteredVectorGrid2::Builder::makeShared() const
{
  return std::shared_ptr<CellCenteredVectorGrid2>(new CellCenteredVectorGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal),
                                                  [](CellCenteredVectorGrid2* obj) { delete obj; });
}
