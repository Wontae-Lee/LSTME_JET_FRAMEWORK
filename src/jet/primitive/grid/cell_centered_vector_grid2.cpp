...
CellCenteredVectorGrid2::CellCenteredVectorGrid2(size_t resolutionX, size_t resolutionY, double gridSpacingX, double gridSpacingY, double originX, double originY, double initialValueU,
                                                 double initialValueV) {
    resize(resolutionX, resolutionY, gridSpacingX, gridSpacingY, originX, originY, initialValueU, initialValueV);
}

CellCenteredVectorGrid2::CellCenteredVectorGrid2(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& origin, const Vector2D& initialValue) {
...
Vector2D CellCenteredVectorGrid2::dataOrigin() const { return origin() + 0.5 * gridSpacing(); }
...
std::shared_ptr<VectorGrid2> CellCenteredVectorGrid2::clone() const { return CLONE_W_CUSTOM_DELETER(CellCenteredVectorGrid2); }
...
CellCenteredVectorGrid2 CellCenteredVectorGrid2::Builder::build() const { return CellCenteredVectorGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal); }

VectorGrid2Ptr CellCenteredVectorGrid2::Builder::build(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& gridOrigin, const Vector2D& initialVal) const {
    return std::shared_ptr<CellCenteredVectorGrid2>(new CellCenteredVectorGrid2(resolution, gridSpacing, gridOrigin, initialVal), [](CellCenteredVectorGrid2* obj) { delete obj; });
}

CellCenteredVectorGrid2Ptr CellCenteredVectorGrid2::Builder::makeShared() const {
    return std::shared_ptr<CellCenteredVectorGrid2>(new CellCenteredVectorGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal), [](CellCenteredVectorGrid2* obj) { delete obj; });
}
