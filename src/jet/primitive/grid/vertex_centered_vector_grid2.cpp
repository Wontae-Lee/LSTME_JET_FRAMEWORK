...
Size2
VertexCenteredVectorGrid2::dataSize() const
{
...
Vector2D
VertexCenteredVectorGrid2::dataOrigin() const
{
  return origin();
}

void
VertexCenteredVectorGrid2::swap(Grid2* other)
{
...
void
VertexCenteredVectorGrid2::set(const VertexCenteredVectorGrid2& other)
{
...
void
VertexCenteredVectorGrid2::fill(const Vector2D& value, ExecutionPolicy policy)
{
  Size2 size = dataSize();
...
void
VertexCenteredVectorGrid2::fill(const std::function<Vector2D(const Vector2D&)>& func, ExecutionPolicy policy)
{
  Size2 size = dataSize();
  auto acc = dataAccessor();
...
VertexCenteredVectorGrid2::clone() const
{
...
VertexCenteredVectorGrid2::Builder&
VertexCenteredVectorGrid2::Builder::withResolution(size_t resolutionX, size_t resolutionY)
{
...
VertexCenteredVectorGrid2::Builder&
VertexCenteredVectorGrid2::Builder::withGridSpacing(double gridSpacingX, double gridSpacingY)
{
...
VertexCenteredVectorGrid2::Builder&
VertexCenteredVectorGrid2::Builder::withOrigin(double gridOriginX, double gridOriginY)
{
...
VertexCenteredVectorGrid2::Builder&
VertexCenteredVectorGrid2::Builder::withInitialValue(double initialValX, double initialValY)
{
...
VertexCenteredVectorGrid2
VertexCenteredVectorGrid2::Builder::build() const
{
...
{
  return std::shared_ptr<VertexCenteredVectorGrid2>(new VertexCenteredVectorGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal),
                                                    [](VertexCenteredVectorGrid2* obj) { delete obj; });
}

VectorGrid2Ptr
VertexCenteredVectorGrid2::Builder::build(const Size2& resolution,
                                          const Vector2D& gridSpacing,
                                          const Vector2D& gridOrigin,
                                          const Vector2D& initialVal) const
{
  return std::shared_ptr<VertexCenteredVectorGrid2>(new VertexCenteredVectorGrid2(resolution, gridSpacing, gridOrigin, initialVal),
                                                    [](VertexCenteredVectorGrid2* obj) { delete obj; });
}
