...
CellCenteredScalarGrid2::CellCenteredScalarGrid2(size_t resolutionX, size_t resolutionY, double gridSpacingX, double gridSpacingY, double originX, double originY, double initialValue) {
    resize(resolutionX, resolutionY, gridSpacingX, gridSpacingY, originX, originY, initialValue);
}

CellCenteredScalarGrid2::CellCenteredScalarGrid2(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& origin, double initialValue) {
...
Vector2D CellCenteredScalarGrid2::dataOrigin() const { return origin() + 0.5 * gridSpacing(); }

std::shared_ptr<ScalarGrid2> CellCenteredScalarGrid2::clone() const { return CLONE_W_CUSTOM_DELETER(CellCenteredScalarGrid2); }
...
CellCenteredScalarGrid2::Builder CellCenteredScalarGrid2::builder() { return Builder(); }
...
CellCenteredScalarGrid2 CellCenteredScalarGrid2::Builder::build() const { return CellCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal); }

ScalarGrid2Ptr CellCenteredScalarGrid2::Builder::build(const Size2& resolution, const Vector2D& gridSpacing, const Vector2D& gridOrigin, double initialVal) const {
    return std::shared_ptr<CellCenteredScalarGrid2>(new CellCenteredScalarGrid2(resolution, gridSpacing, gridOrigin, initialVal), [](CellCenteredScalarGrid2* obj) { delete obj; });
}

CellCenteredScalarGrid2Ptr CellCenteredScalarGrid2::Builder::makeShared() const {
    return std::shared_ptr<CellCenteredScalarGrid2>(new CellCenteredScalarGrid2(_resolution, _gridSpacing, _gridOrigin, _initialVal), [](CellCenteredScalarGrid2* obj) { delete obj; });
}
