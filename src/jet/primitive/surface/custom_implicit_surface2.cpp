...
CustomImplicitSurface2::CustomImplicitSurface2(const std::function<double(const Vector2D&)>& func, const BoundingBox2D& domain, double resolution, double rayMarchingResolution,
                                               unsigned int maxNumOfIterations, const Transform2& transform, bool isNormalFlipped)
...
CustomImplicitSurface2Ptr CustomImplicitSurface2::Builder::makeShared() const {
    return std::shared_ptr<CustomImplicitSurface2>(new CustomImplicitSurface2(_func, _domain, _resolution, _rayMarchingResolution, _maxNumOfIterations, _transform, _isNormalFlipped),
