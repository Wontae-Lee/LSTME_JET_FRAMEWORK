...
SurfaceSet2::SurfaceSet2(const std::vector<Surface2Ptr>& others, const Transform2& transform, bool isNormalFlipped) : Surface2(transform, isNormalFlipped), _surfaces(others) {
...
SurfaceSet2::SurfaceSet2(const SurfaceSet2& other) : Surface2(other), _surfaces(other._surfaces), _unboundedSurfaces(other._unboundedSurfaces) { invalidateBvh(); }
