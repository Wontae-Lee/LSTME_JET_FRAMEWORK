...
double
ConstantScalarField2::sample(const Vector2D& x) const
{
  UNUSED_VARIABLE(x);
...
ConstantScalarField2::sampler() const
{
  double value = _value;
...
ConstantScalarField2::Builder::build() const
{
  return ConstantScalarField2(_value);
}

ConstantScalarField2Ptr
ConstantScalarField2::Builder::makeShared() const
{
  return std::shared_ptr<ConstantScalarField2>(new ConstantScalarField2(_value), [](ConstantScalarField2* obj) { delete obj; });
}
