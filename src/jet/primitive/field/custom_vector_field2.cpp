...
CustomVectorField2::CustomVectorField2(const std::function<Vector2D(const Vector2D&)>& customFunction,
...
Vector2D
CustomVectorField2::sample(const Vector2D& x) const
{
  return _customFunction(x);
}

std::function<Vector2D(const Vector2D&)>
CustomVectorField2::sampler() const
{
  return _customFunction;
}

double
CustomVectorField2::divergence(const Vector2D& x) const
{
...
double
CustomVectorField2::curl(const Vector2D& x) const
{
...
CustomVectorField2::Builder&
CustomVectorField2::Builder::withFunction(const std::function<Vector2D(const Vector2D&)>& func)
{
...
CustomVectorField2::Builder&
CustomVectorField2::Builder::withDivergenceFunction(const std::function<double(const Vector2D&)>& func)
{
...
CustomVectorField2::Builder&
CustomVectorField2::Builder::withCurlFunction(const std::function<double(const Vector2D&)>& func)
{
...
CustomVectorField2
CustomVectorField2::Builder::build() const
{
  if (_customCurlFunction) {
...
CustomVectorField2::Builder::makeShared() const
{
  if (_customCurlFunction) {
    return std::shared_ptr<CustomVectorField2>(new CustomVectorField2(_customFunction, _customDivergenceFunction, _customCurlFunction),
                                               [](CustomVectorField2* obj) { delete obj; });
  } else {
    return std::shared_ptr<CustomVectorField2>(new CustomVectorField2(_customFunction, _customDivergenceFunction, _resolution),
                                               [](CustomVectorField2* obj) { delete obj; });
  }
}
