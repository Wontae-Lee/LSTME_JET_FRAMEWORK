...
double
ConstantScalarField3::sample(const Vector3D& x) const
{
  UNUSED_VARIABLE(x);
...
ConstantScalarField3::sampler() const
{
  double value = _value;
...
ConstantScalarField3::Builder::build() const
{
  return ConstantScalarField3(_value);
}

ConstantScalarField3Ptr
ConstantScalarField3::Builder::makeShared() const
{
  return std::shared_ptr<ConstantScalarField3>(new ConstantScalarField3(_value), [](ConstantScalarField3* obj) { delete obj; });
}
