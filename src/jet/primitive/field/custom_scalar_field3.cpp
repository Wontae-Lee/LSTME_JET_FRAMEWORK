...
CustomScalarField3::CustomScalarField3(const std::function<double(const Vector3D&)>& customFunction,
...
double
CustomScalarField3::sample(const Vector3D& x) const
{
  return _customFunction(x);
}

std::function<double(const Vector3D&)>
CustomScalarField3::sampler() const
{
  return _customFunction;
}

Vector3D
CustomScalarField3::gradient(const Vector3D& x) const
{
...
double
CustomScalarField3::laplacian(const Vector3D& x) const
{
...
CustomScalarField3::Builder&
CustomScalarField3::Builder::withFunction(const std::function<double(const Vector3D&)>& func)
{
...
CustomScalarField3::Builder&
CustomScalarField3::Builder::withGradientFunction(const std::function<Vector3D(const Vector3D&)>& func)
{
...
CustomScalarField3::Builder&
CustomScalarField3::Builder::withLaplacianFunction(const std::function<double(const Vector3D&)>& func)
{
...
CustomScalarField3
CustomScalarField3::Builder::build() const
{
  if (_customLaplacianFunction) {
...
CustomScalarField3::Builder::makeShared() const
{
  if (_customLaplacianFunction) {
    return std::shared_ptr<CustomScalarField3>(new CustomScalarField3(_customFunction, _customGradientFunction, _customLaplacianFunction),
                                               [](CustomScalarField3* obj) { delete obj; });
  } else {
    return std::shared_ptr<CustomScalarField3>(new CustomScalarField3(_customFunction, _customGradientFunction, _resolution),
                                               [](CustomScalarField3* obj) { delete obj; });
  }
}
