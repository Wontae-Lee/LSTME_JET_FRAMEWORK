...
CustomScalarField2::CustomScalarField2(const std::function<double(const Vector2D&)>& customFunction,
...
CustomScalarField2::Builder&
CustomScalarField2::Builder::withFunction(const std::function<double(const Vector2D&)>& func)
{
...
CustomScalarField2::Builder&
CustomScalarField2::Builder::withGradientFunction(const std::function<Vector2D(const Vector2D&)>& func)
{
...
CustomScalarField2::Builder&
CustomScalarField2::Builder::withLaplacianFunction(const std::function<double(const Vector2D&)>& func)
{
...
{
  if (_customLaplacianFunction) {
    return std::shared_ptr<CustomScalarField2>(new CustomScalarField2(_customFunction, _customGradientFunction, _customLaplacianFunction),
                                               [](CustomScalarField2* obj) { delete obj; });
  } else {
    return std::shared_ptr<CustomScalarField2>(new CustomScalarField2(_customFunction, _customGradientFunction, _resolution),
                                               [](CustomScalarField2* obj) { delete obj; });
  }
}
