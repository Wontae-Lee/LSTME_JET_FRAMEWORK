...
void GridSystemData2::serialize(std::vector<uint8_t> *buffer) const {
  ...
  std::vector<flatbuffers::Offset<fbs::VectorGridSerialized2>>
      advVectorDataList;
  serializeGrid(&builder, _scalarDataList, fbs::CreateScalarGridSerialized2,
                &scalarDataList);
  serializeGrid(&builder, _vectorDataList, fbs::CreateVectorGridSerialized2,
                &vectorDataList);
  serializeGrid(&builder, _advectableScalarDataList,
                fbs::CreateScalarGridSerialized2, &advScalarDataList);
  serializeGrid(&builder, _advectableVectorDataList,
...
void GridSystemData2::deserialize(const std::vector<uint8_t> &buffer) {
  ...
  resize(fbsToJet(*gsd->resolution()), fbsToJet(*gsd->gridSpacing()),
         fbsToJet(*gsd->origin()));
