...
PointParallelHashGridSearcher3::PointParallelHashGridSearcher3(size_t resolutionX, size_t resolutionY, size_t resolutionZ, double gridSpacing) : _gridSpacing(gridSpacing) {
...
PointParallelHashGridSearcher3::PointParallelHashGridSearcher3(const PointParallelHashGridSearcher3& other) { set(other); }
...
PointNeighborSearcher3Ptr PointParallelHashGridSearcher3::clone() const { return CLONE_W_CUSTOM_DELETER(PointParallelHashGridSearcher3); }
...
void PointParallelHashGridSearcher3::serialize(std::vector<uint8_t>* buffer) const {
    ...
    // Copy the searcher
    auto fbsSearcher = fbs::CreatePointParallelHashGridSearcher3(builder, _gridSpacing, &fbsResolution, fbsPoints, fbsKeys, fbsStartIndexTable, fbsEndIndexTable, fbsSortedIndices);
...
PointParallelHashGridSearcher3 PointParallelHashGridSearcher3::Builder::build() const { return PointParallelHashGridSearcher3(_resolution, _gridSpacing); }

PointParallelHashGridSearcher3Ptr PointParallelHashGridSearcher3::Builder::makeShared() const {
    return std::shared_ptr<PointParallelHashGridSearcher3>(new PointParallelHashGridSearcher3(_resolution, _gridSpacing), [](PointParallelHashGridSearcher3* obj) { delete obj; });
}

PointNeighborSearcher3Ptr PointParallelHashGridSearcher3::Builder::buildPointNeighborSearcher() const { return makeShared(); }
