...
void
PointParallelHashGridSearcher2::build(const ConstArrayAccessor1<Vector2D>& points)
{
  _points.clear();
  _keys.clear();
...
void
PointParallelHashGridSearcher2::forEachNearbyPoint(const Vector2D& origin, double radius, const ForEachNearbyPointFunc& callback) const
{
  size_t nearbyKeys[4];
...
bool
PointParallelHashGridSearcher2::hasNearbyPoint(const Vector2D& origin, double radius) const
{
  size_t nearbyKeys[4];
  getNearbyKeys(origin, nearbyKeys);
...
PointParallelHashGridSearcher2::keys() const
{
  return _keys;
}
...
Point2I
PointParallelHashGridSearcher2::getBucketIndex(const Vector2D& position) const
{
  Point2I bucketIndex;
...
size_t
PointParallelHashGridSearcher2::getHashKeyFromPosition(const Vector2D& position) const
{
...
size_t
PointParallelHashGridSearcher2::getHashKeyFromBucketIndex(const Point2I& bucketIndex) const
{
...
void
PointParallelHashGridSearcher2::getNearbyKeys(const Vector2D& position, size_t* nearbyKeys) const
{
...
PointParallelHashGridSearcher2::clone() const
{
...
void
PointParallelHashGridSearcher2::set(const PointParallelHashGridSearcher2& other)
{
...
void
PointParallelHashGridSearcher2::serialize(std::vector<uint8_t>* buffer) const
{
...
void
PointParallelHashGridSearcher2::deserialize(const std::vector<uint8_t>& buffer)
{
...
{
  return std::shared_ptr<PointParallelHashGridSearcher2>(new PointParallelHashGridSearcher2(_resolution, _gridSpacing),
