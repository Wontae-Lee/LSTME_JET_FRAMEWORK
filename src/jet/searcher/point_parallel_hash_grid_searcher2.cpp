...
PointParallelHashGridSearcher2::PointParallelHashGridSearcher2(const Size2& resolution, double gridSpacing) : PointParallelHashGridSearcher2(resolution.x, resolution.y, gridSpacing) {}

PointParallelHashGridSearcher2::PointParallelHashGridSearcher2(size_t resolutionX, size_t resolutionY, double gridSpacing) : _gridSpacing(gridSpacing) {
...
PointParallelHashGridSearcher2::PointParallelHashGridSearcher2(const PointParallelHashGridSearcher2& other) { set(other); }
...
void PointParallelHashGridSearcher2::build(const ConstArrayAccessor1<Vector2D>& points) {
    ...
    parallelSort(_sortedIndices.begin(), _sortedIndices.end(), [&tempKeys](size_t indexA, size_t indexB) { return tempKeys[indexA] < tempKeys[indexB]; });
    ...
    JET_INFO << "Average number of points per non-empty bucket: " << static_cast<float>(sumNumberOfPointsPerBucket) / static_cast<float>(numberOfNonEmptyBucket);
...
PointNeighborSearcher2Ptr PointParallelHashGridSearcher2::clone() const { return CLONE_W_CUSTOM_DELETER(PointParallelHashGridSearcher2); }
...
void PointParallelHashGridSearcher2::serialize(std::vector<uint8_t>* buffer) const {
    ...
    // Copy the searcher
    auto fbsSearcher = fbs::CreatePointParallelHashGridSearcher2(builder, _gridSpacing, &fbsResolution, fbsPoints, fbsKeys, fbsStartIndexTable, fbsEndIndexTable, fbsSortedIndices);
...
PointParallelHashGridSearcher2 PointParallelHashGridSearcher2::Builder::build() const { return PointParallelHashGridSearcher2(_resolution, _gridSpacing); }

PointParallelHashGridSearcher2Ptr PointParallelHashGridSearcher2::Builder::makeShared() const {
    return std::shared_ptr<PointParallelHashGridSearcher2>(new PointParallelHashGridSearcher2(_resolution, _gridSpacing), [](PointParallelHashGridSearcher2* obj) { delete obj; });
}

PointNeighborSearcher2Ptr PointParallelHashGridSearcher2::Builder::buildPointNeighborSearcher() const { return makeShared(); }
