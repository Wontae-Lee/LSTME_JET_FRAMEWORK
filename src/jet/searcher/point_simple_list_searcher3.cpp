...
void PointSimpleListSearcher3::forEachNearbyPoint(const Vector3D& origin, double radius, const std::function<void(size_t, const Vector3D&)>& callback) const {
...
PointNeighborSearcher3Ptr PointSimpleListSearcher3::clone() const { return CLONE_W_CUSTOM_DELETER(PointSimpleListSearcher3); }
...
PointSimpleListSearcher3 PointSimpleListSearcher3::Builder::build() const { return PointSimpleListSearcher3(); }
