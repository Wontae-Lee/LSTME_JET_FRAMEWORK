...
#include "jet/generator/grid_point_generator2.h"
#include <pch.h>

namespace jet {

void GridPointGenerator2::forEachPoint(const BoundingBox2D& boundingBox, double spacing, const std::function<bool(const Vector2D&)>& callback) const {
    Vector2D position;
