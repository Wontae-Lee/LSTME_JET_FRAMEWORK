...
#include "jet/figure/triangle3.h"
...
Triangle3::Triangle3(const Transform3& transform_, bool isNormalFlipped_) : Surface3(transform_, isNormalFlipped_) {}

Triangle3::Triangle3(const std::array<Vector3D, 3>& newPoints, const std::array<Vector3D, 3>& newNormals, const std::array<Vector2D, 3>& newUvs, const Transform3& transform_, bool isNormalFlipped_)
    : Surface3(transform_, isNormalFlipped_), points(newPoints), normals(newNormals), uvs(newUvs) {}

Triangle3::Triangle3(const Triangle3& other) : Surface3(other), points(other.points), normals(other.normals), uvs(other.uvs) {}
