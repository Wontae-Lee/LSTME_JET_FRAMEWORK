...
CreateSphSystemData2(flatbuffers::FlatBufferBuilder& _fbb,
...
inline const jet::fbs::SphSystemData2*
...
inline const jet::fbs::SphSystemData2*
GetSizePrefixedSphSystemData2(const void* buf)
{
...
inline bool
VerifySizePrefixedSphSystemData2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::SphSystemData2>(nullptr);
}

inline void
FinishSphSystemData2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::SphSystemData2> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedSphSystemData2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::SphSystemData2> root)
{
