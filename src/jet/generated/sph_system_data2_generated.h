...
struct SphSystemData2Builder {
  ...
  void add_targetDensity(double targetDensity) {
    fbb_.AddElement<double>(SphSystemData2::VT_TARGETDENSITY, targetDensity,
                            0.0);
  }
  void add_targetSpacing(double targetSpacing) {
    fbb_.AddElement<double>(SphSystemData2::VT_TARGETSPACING, targetSpacing,
                            0.0);
  }
  ...
  SphSystemData2Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline bool VerifySphSystemData2Buffer(flatbuffers::Verifier &verifier) {
