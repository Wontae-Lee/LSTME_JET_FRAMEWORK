...
CreatePointParallelHashGridSearcher2(flatbuffers::FlatBufferBuilder& _fbb,
...
inline flatbuffers::Offset<PointParallelHashGridSearcher2>
CreatePointParallelHashGridSearcher2Direct(flatbuffers::FlatBufferBuilder& _fbb,
                                           double gridSpacing = 0.0,
                                           const jet::fbs::Size2* resolution = nullptr,
...
inline const jet::fbs::PointParallelHashGridSearcher2*
...
inline const jet::fbs::PointParallelHashGridSearcher2*
GetSizePrefixedPointParallelHashGridSearcher2(const void* buf)
{
...
inline bool
VerifySizePrefixedPointParallelHashGridSearcher2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::PointParallelHashGridSearcher2>(nullptr);
}

inline void
FinishPointParallelHashGridSearcher2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::PointParallelHashGridSearcher2> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedPointParallelHashGridSearcher2Buffer(flatbuffers::FlatBufferBuilder& fbb,
