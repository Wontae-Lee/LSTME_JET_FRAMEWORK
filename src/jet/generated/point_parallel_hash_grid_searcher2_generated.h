...
struct PointParallelHashGridSearcher2Builder {
  ...
  void add_gridSpacing(double gridSpacing) {
    fbb_.AddElement<double>(PointParallelHashGridSearcher2::VT_GRIDSPACING,
                            gridSpacing, 0.0);
  }
  ...
  PointParallelHashGridSearcher2Builder &
  operator=(const PointParallelHashGridSearcher2Builder &);
...
VerifyPointParallelHashGridSearcher2Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<jet::fbs::PointParallelHashGridSearcher2>(
      nullptr);
}
