...
struct PointSimpleListSearcher3Builder {
    ...
    void add_points(flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector3D *>> points) { fbb_.AddOffset(PointSimpleListSearcher3::VT_POINTS, points); }
...
inline const jet::fbs::PointSimpleListSearcher3 *GetPointSimpleListSearcher3(const void *buf) { return flatbuffers::GetRoot<jet::fbs::PointSimpleListSearcher3>(buf); }

inline bool VerifyPointSimpleListSearcher3Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::PointSimpleListSearcher3>(nullptr); }

inline void FinishPointSimpleListSearcher3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::PointSimpleListSearcher3> root) { fbb.Finish(root); }
