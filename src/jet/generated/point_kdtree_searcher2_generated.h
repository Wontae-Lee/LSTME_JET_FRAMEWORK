...
struct PointKdTreeSearcher2 FLATBUFFERS_FINAL_CLASS
  ...
  const flatbuffers::Vector<const PointKdTreeSearcherNode2 *> *nodes() const {
    return GetPointer<
        const flatbuffers::Vector<const PointKdTreeSearcherNode2 *> *>(
        VT_NODES);
  }
...
CreatePointKdTreeSearcher2Direct(
  ...
  return jet::fbs::CreatePointKdTreeSearcher2(
      _fbb, points ? _fbb.CreateVector<const jet::fbs::Vector2D *>(*points) : 0,
...
inline bool VerifyPointKdTreeSearcher2Buffer(flatbuffers::Verifier &verifier) {
