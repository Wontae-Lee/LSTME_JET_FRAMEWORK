...
struct PointParallelHashGridSearcher3Builder {
  ...
  void add_gridSpacing(double gridSpacing) {
    fbb_.AddElement<double>(PointParallelHashGridSearcher3::VT_GRIDSPACING,
                            gridSpacing, 0.0);
  }
  ...
  void add_points(
      flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector3D *>>
          points) {
  ...
  PointParallelHashGridSearcher3Builder &
  operator=(const PointParallelHashGridSearcher3Builder &);
...
VerifyPointParallelHashGridSearcher3Buffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<jet::fbs::PointParallelHashGridSearcher3>(
      nullptr);
}
