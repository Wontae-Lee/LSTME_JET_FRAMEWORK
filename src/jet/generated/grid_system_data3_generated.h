...
struct GridSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  scalarData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<ScalarGridSerialized3>> *>(VT_SCALARDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>> *
  vectorData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<VectorGridSerialized3>> *>(VT_VECTORDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized3>> *
  advectableScalarData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<ScalarGridSerialized3>> *>(VT_ADVECTABLESCALARDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized3>> *
  advectableVectorData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<VectorGridSerialized3>> *>(VT_ADVECTABLEVECTORDATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
...
struct GridSystemData3Builder {
  ...
  GridSystemData3Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3(
    flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size3 *resolution = 0,
...
inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3Direct(
  ...
  return jet::fbs::CreateGridSystemData3(
      _fbb, resolution, gridSpacing, origin, velocityIdx,
      scalarData
...
inline bool VerifyGridSystemData3Buffer(flatbuffers::Verifier &verifier) {
