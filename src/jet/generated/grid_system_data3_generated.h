...
inline ::flatbuffers::Offset<GridSystemData3> CreateGridSystemData3Direct(
  ...
  auto advectableScalarData__ = advectableScalarData ? _fbb.CreateVector<::flatbuffers::Offset<jet::fbs::ScalarGridSerialized3>>(*advectableScalarData) : 0;
  auto advectableVectorData__ = advectableVectorData ? _fbb.CreateVector<::flatbuffers::Offset<jet::fbs::VectorGridSerialized3>>(*advectableVectorData) : 0;
...
inline const jet::fbs::GridSystemData3 *GetSizePrefixedGridSystemData3(const void *buf) {
...
inline bool VerifySizePrefixedGridSystemData3Buffer(
    ::flatbuffers::Verifier &verifier) {
...
inline void FinishSizePrefixedGridSystemData3Buffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<jet::fbs::GridSystemData3> root) {
