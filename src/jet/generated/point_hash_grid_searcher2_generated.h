...
struct PointHashGridSearcherBucket2Builder {
  ...
  PointHashGridSearcherBucket2Builder &
  operator=(const PointHashGridSearcherBucket2Builder &);
...
struct PointHashGridSearcher2Builder {
  ...
  void add_gridSpacing(double gridSpacing) {
    fbb_.AddElement<double>(PointHashGridSearcher2::VT_GRIDSPACING, gridSpacing,
                            0.0);
  }
  ...
  void add_points(
      flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector2D *>>
          points) {
    fbb_.AddOffset(PointHashGridSearcher2::VT_POINTS, points);
  }
  void add_buckets(flatbuffers::Offset<flatbuffers::Vector<
                       flatbuffers::Offset<PointHashGridSearcherBucket2>>>
                       buckets) {
  ...
  PointHashGridSearcher2Builder &
  operator=(const PointHashGridSearcher2Builder &);
...
inline flatbuffers::Offset<PointHashGridSearcher2> CreatePointHashGridSearcher2(
    flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0,
...
CreatePointHashGridSearcher2Direct(
  ...
  return jet::fbs::CreatePointHashGridSearcher2(
      _fbb, gridSpacing, resolution,
      points ? _fbb.CreateVector<const jet::fbs::Vector2D *>(*points) : 0,
      buckets ? _fbb.CreateVector<
                    flatbuffers::Offset<PointHashGridSearcherBucket2>>(*buckets)
              : 0);
}
inline const jet::fbs::PointHashGridSearcher2 *
