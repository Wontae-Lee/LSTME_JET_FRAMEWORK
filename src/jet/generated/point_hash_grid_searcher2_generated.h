...
CreatePointHashGridSearcherBucket2(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::Vector<uint64_t>> data = 0)
{
...
inline flatbuffers::Offset<PointHashGridSearcherBucket2>
CreatePointHashGridSearcherBucket2Direct(flatbuffers::FlatBufferBuilder& _fbb, const std::vector<uint64_t>* data = nullptr)
{
  auto data__ = data ? _fbb.CreateVector<uint64_t>(*data) : 0;
  return jet::fbs::CreatePointHashGridSearcherBucket2(_fbb, data__);
}
...
struct PointHashGridSearcher2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table
{
  ...
  bool Verify(flatbuffers::Verifier& verifier) const
  {
    return VerifyTableStart(verifier) && VerifyField<double>(verifier, VT_GRIDSPACING, 8) &&
           VerifyField<jet::fbs::Size2>(verifier, VT_RESOLUTION, 8) && VerifyOffset(verifier, VT_POINTS) && verifier.VerifyVector(points()) &&
...
CreatePointHashGridSearcher2(flatbuffers::FlatBufferBuilder& _fbb,
...
inline flatbuffers::Offset<PointHashGridSearcher2>
CreatePointHashGridSearcher2Direct(flatbuffers::FlatBufferBuilder& _fbb,
                                   double gridSpacing = 0.0,
                                   const jet::fbs::Size2* resolution = nullptr,
                                   ...
                                   const std::vector<flatbuffers::Offset<jet::fbs::PointHashGridSearcherBucket2>>* buckets = nullptr)
{
  ...
  return jet::fbs::CreatePointHashGridSearcher2(_fbb, gridSpacing, resolution, points__, buckets__);
}
...
inline const jet::fbs::PointHashGridSearcher2*
GetSizePrefixedPointHashGridSearcher2(const void* buf)
{
...
inline bool
VerifySizePrefixedPointHashGridSearcher2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::PointHashGridSearcher2>(nullptr);
}

inline void
FinishPointHashGridSearcher2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::PointHashGridSearcher2> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedPointHashGridSearcher2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::PointHashGridSearcher2> root)
{
