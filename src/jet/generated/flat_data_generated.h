...
CreateFlatData(flatbuffers::FlatBufferBuilder& _fbb, flatbuffers::Offset<flatbuffers::Vector<uint8_t>> data = 0)
{
...
inline flatbuffers::Offset<FlatData>
CreateFlatDataDirect(flatbuffers::FlatBufferBuilder& _fbb, const std::vector<uint8_t>* data = nullptr)
{
  auto data__ = data ? _fbb.CreateVector<uint8_t>(*data) : 0;
  return jet::fbs::CreateFlatData(_fbb, data__);
}

inline const jet::fbs::FlatData*
GetFlatData(const void* buf)
{
  return flatbuffers::GetRoot<jet::fbs::FlatData>(buf);
}

inline const jet::fbs::FlatData*
GetSizePrefixedFlatData(const void* buf)
{
  return flatbuffers::GetSizePrefixedRoot<jet::fbs::FlatData>(buf);
}

inline bool
VerifyFlatDataBuffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<jet::fbs::FlatData>(nullptr);
}

inline bool
VerifySizePrefixedFlatDataBuffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::FlatData>(nullptr);
}

inline void
FinishFlatDataBuffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::FlatData> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedFlatDataBuffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::FlatData> root)
{
