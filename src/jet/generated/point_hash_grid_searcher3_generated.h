...
struct PointHashGridSearcherBucket3Builder {
  ...
  PointHashGridSearcherBucket3Builder &
  operator=(const PointHashGridSearcherBucket3Builder &);
...
struct PointHashGridSearcher3Builder {
  ...
  void add_gridSpacing(double gridSpacing) {
    fbb_.AddElement<double>(PointHashGridSearcher3::VT_GRIDSPACING, gridSpacing,
                            0.0);
  }
  ...
  void add_buckets(flatbuffers::Offset<flatbuffers::Vector<
                       flatbuffers::Offset<PointHashGridSearcherBucket3>>>
                       buckets) {
  ...
  PointHashGridSearcher3Builder &
  operator=(const PointHashGridSearcher3Builder &);
...
CreatePointHashGridSearcher3Direct(
  ...
  return jet::fbs::CreatePointHashGridSearcher3(
      ...
      buckets ? _fbb.CreateVector<
                    flatbuffers::Offset<PointHashGridSearcherBucket3>>(*buckets)
              : 0);
}
