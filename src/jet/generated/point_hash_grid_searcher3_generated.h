...
inline flatbuffers::Offset<PointHashGridSearcherBucket3> CreatePointHashGridSearcherBucket3(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::Vector<uint64_t>> data = 0) {
    PointHashGridSearcherBucket3Builder builder_(_fbb);
    builder_.add_data(data);
    return builder_.Finish();
}

inline flatbuffers::Offset<PointHashGridSearcherBucket3> CreatePointHashGridSearcherBucket3Direct(flatbuffers::FlatBufferBuilder &_fbb, const std::vector<uint64_t> *data = nullptr) {
    return jet::fbs::CreatePointHashGridSearcherBucket3(_fbb, data ? _fbb.CreateVector<uint64_t>(*data) : 0);
}
...
struct PointHashGridSearcher3Builder {
    ...
    void add_points(flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector3D *>> points) { fbb_.AddOffset(PointHashGridSearcher3::VT_POINTS, points); }
...
inline flatbuffers::Offset<PointHashGridSearcher3> CreatePointHashGridSearcher3(flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0, const jet::fbs::Size3 *resolution = 0,
...
inline flatbuffers::Offset<PointHashGridSearcher3> CreatePointHashGridSearcher3Direct(flatbuffers::FlatBufferBuilder &_fbb, double gridSpacing = 0.0, const jet::fbs::Size3 *resolution = 0,
    ...
    return jet::fbs::CreatePointHashGridSearcher3(_fbb, gridSpacing, resolution, points ? _fbb.CreateVector<const jet::fbs::Vector3D *>(*points) : 0,
                                                  buckets ? _fbb.CreateVector<flatbuffers::Offset<PointHashGridSearcherBucket3>>(*buckets) : 0);
}

inline const jet::fbs::PointHashGridSearcher3 *GetPointHashGridSearcher3(const void *buf) { return flatbuffers::GetRoot<jet::fbs::PointHashGridSearcher3>(buf); }

inline bool VerifyPointHashGridSearcher3Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::PointHashGridSearcher3>(nullptr); }

inline void FinishPointHashGridSearcher3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::PointHashGridSearcher3> root) { fbb.Finish(root); }
