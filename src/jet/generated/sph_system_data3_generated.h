...
inline const jet::fbs::SphSystemData3 *GetSizePrefixedSphSystemData3(const void *buf) {
...
inline bool VerifySizePrefixedSphSystemData3Buffer(
    ::flatbuffers::Verifier &verifier) {
...
inline void FinishSizePrefixedSphSystemData3Buffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<jet::fbs::SphSystemData3> root) {
