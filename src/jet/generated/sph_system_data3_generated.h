...
struct SphSystemData3Builder {
  ...
  void add_targetDensity(double targetDensity) {
    fbb_.AddElement<double>(SphSystemData3::VT_TARGETDENSITY, targetDensity,
                            0.0);
  }
  void add_targetSpacing(double targetSpacing) {
    fbb_.AddElement<double>(SphSystemData3::VT_TARGETSPACING, targetSpacing,
                            0.0);
  }
  void add_kernelRadiusOverTargetSpacing(double kernelRadiusOverTargetSpacing) {
    fbb_.AddElement<double>(SphSystemData3::VT_KERNELRADIUSOVERTARGETSPACING,
                            kernelRadiusOverTargetSpacing, 0.0);
  }
  ...
  SphSystemData3Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<SphSystemData3> CreateSphSystemData3(
    ...
    double targetDensity = 0.0, double targetSpacing = 0.0,
    double kernelRadiusOverTargetSpacing = 0.0, double kernelRadius = 0.0,
