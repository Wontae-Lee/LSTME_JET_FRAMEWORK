...
inline flatbuffers::Offset<SphSystemData3> CreateSphSystemData3(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<jet::fbs::ParticleSystemData3> base = 0, double targetDensity = 0.0,
...
inline const jet::fbs::SphSystemData3 *GetSphSystemData3(const void *buf) { return flatbuffers::GetRoot<jet::fbs::SphSystemData3>(buf); }

inline bool VerifySphSystemData3Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::SphSystemData3>(nullptr); }

inline void FinishSphSystemData3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::SphSystemData3> root) { fbb.Finish(root); }
