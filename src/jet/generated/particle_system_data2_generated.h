...
struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    enum { VT_DATA = 4 };
    const flatbuffers::Vector<const jet::fbs::Vector2D *> *data() const { return GetPointer<const flatbuffers::Vector<const jet::fbs::Vector2D *> *>(VT_DATA); }
    bool Verify(flatbuffers::Verifier &verifier) const { return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_DATA) && verifier.Verify(data()) && verifier.EndTable(); }
};
...
inline flatbuffers::Offset<PointNeighborSearcherSerialized2> CreatePointNeighborSearcherSerialized2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> type = 0,
...
inline flatbuffers::Offset<PointNeighborSearcherSerialized2> CreatePointNeighborSearcherSerialized2Direct(flatbuffers::FlatBufferBuilder &_fbb, const char *type = nullptr,
...
inline flatbuffers::Offset<ParticleSystemData2> CreateParticleSystemData2(flatbuffers::FlatBufferBuilder &_fbb, double radius = 0.0, double mass = 0.0, uint64_t positionIdx = 0,
...
inline flatbuffers::Offset<ParticleSystemData2> CreateParticleSystemData2Direct(flatbuffers::FlatBufferBuilder &_fbb, double radius = 0.0, double mass = 0.0, uint64_t positionIdx = 0,
                                                                                uint64_t velocityIdx = 0, uint64_t forceIdx = 0,
    ...
    return jet::fbs::CreateParticleSystemData2(_fbb, radius, mass, positionIdx, velocityIdx, forceIdx,
                                               scalarDataList ? _fbb.CreateVector<flatbuffers::Offset<ScalarParticleData2>>(*scalarDataList) : 0,
                                               vectorDataList ? _fbb.CreateVector<flatbuffers::Offset<VectorParticleData2>>(*vectorDataList) : 0, neighborSearcher,
                                               neighborLists ? _fbb.CreateVector<flatbuffers::Offset<ParticleNeighborList2>>(*neighborLists) : 0);
}

inline const jet::fbs::ParticleSystemData2 *GetParticleSystemData2(const void *buf) { return flatbuffers::GetRoot<jet::fbs::ParticleSystemData2>(buf); }

inline bool VerifyParticleSystemData2Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::ParticleSystemData2>(nullptr); }

inline void FinishParticleSystemData2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::ParticleSystemData2> root) { fbb.Finish(root); }
