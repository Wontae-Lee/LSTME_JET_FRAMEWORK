...
struct ScalarParticleData2 FLATBUFFERS_FINAL_CLASS
...
struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS
    : private flatbuffers::Table {
  enum { VT_DATA = 4 };
  const flatbuffers::Vector<const jet::fbs::Vector2D *> *data() const {
    return GetPointer<const flatbuffers::Vector<const jet::fbs::Vector2D *> *>(
        VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_DATA) &&
...
struct VectorParticleData2Builder {
  ...
  flatbuffers::uoffset_t start_;
  void
  add_data(flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector2D *>>
               data) {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<const jet::fbs::Vector2D *>> data =
        0) {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2Direct(
  ...
  return jet::fbs::CreateVectorParticleData2(
      _fbb, data ? _fbb.CreateVector<const jet::fbs::Vector2D *>(*data) : 0);
}
...
struct PointNeighborSearcherSerialized2Builder {
  ...
  PointNeighborSearcherSerialized2Builder &
  operator=(const PointNeighborSearcherSerialized2Builder &);
...
struct ParticleSystemData2 FLATBUFFERS_FINAL_CLASS
    : private flatbuffers::Table {
  enum {
    VT_RADIUS = 4,
    VT_MASS = 6,
  ...
  neighborLists() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<ParticleNeighborList2>> *>(VT_NEIGHBORLISTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
...
struct ParticleSystemData2Builder {
  ...
  void add_positionIdx(uint64_t positionIdx) {
    fbb_.AddElement<uint64_t>(ParticleSystemData2::VT_POSITIONIDX, positionIdx,
                              0);
  }
  void add_velocityIdx(uint64_t velocityIdx) {
    fbb_.AddElement<uint64_t>(ParticleSystemData2::VT_VELOCITYIDX, velocityIdx,
                              0);
  }
...
inline flatbuffers::Offset<ParticleSystemData2> CreateParticleSystemData2Direct(
    ...
    double mass = 0.0, uint64_t positionIdx = 0, uint64_t velocityIdx = 0,
    uint64_t forceIdx = 0,
    const std::vector<flatbuffers::Offset<ScalarParticleData2>>
        *scalarDataList = nullptr,
    const std::vector<flatbuffers::Offset<VectorParticleData2>>
        *vectorDataList = nullptr,
    flatbuffers::Offset<PointNeighborSearcherSerialized2> neighborSearcher = 0,
    const std::vector<flatbuffers::Offset<ParticleNeighborList2>>
