...
inline flatbuffers::Offset<ScalarGrid2>
CreateScalarGrid2(flatbuffers::FlatBufferBuilder& _fbb,
...
inline flatbuffers::Offset<ScalarGrid2>
CreateScalarGrid2Direct(flatbuffers::FlatBufferBuilder& _fbb,
                        const jet::fbs::Size2* resolution = nullptr,
                        const jet::fbs::Vector2D* gridSpacing = nullptr,
                        const jet::fbs::Vector2D* origin = nullptr,
                        const std::vector<double>* data = nullptr)
{
  ...
  return jet::fbs::CreateScalarGrid2(_fbb, resolution, gridSpacing, origin, data__);
}

inline const jet::fbs::ScalarGrid2*
GetScalarGrid2(const void* buf)
{
  return flatbuffers::GetRoot<jet::fbs::ScalarGrid2>(buf);
}

inline const jet::fbs::ScalarGrid2*
GetSizePrefixedScalarGrid2(const void* buf)
{
  return flatbuffers::GetSizePrefixedRoot<jet::fbs::ScalarGrid2>(buf);
}

inline bool
VerifyScalarGrid2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifyBuffer<jet::fbs::ScalarGrid2>(nullptr);
}

inline bool
VerifySizePrefixedScalarGrid2Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::ScalarGrid2>(nullptr);
}

inline void
FinishScalarGrid2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::ScalarGrid2> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedScalarGrid2Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::ScalarGrid2> root)
{
