...
struct ScalarGrid2Builder {
    ...
    void add_resolution(const jet::fbs::Size2 *resolution) { fbb_.AddStruct(ScalarGrid2::VT_RESOLUTION, resolution); }
    void add_gridSpacing(const jet::fbs::Vector2D *gridSpacing) { fbb_.AddStruct(ScalarGrid2::VT_GRIDSPACING, gridSpacing); }
    void add_origin(const jet::fbs::Vector2D *origin) { fbb_.AddStruct(ScalarGrid2::VT_ORIGIN, origin); }
...
inline flatbuffers::Offset<ScalarGrid2> CreateScalarGrid2(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size2 *resolution = 0, const jet::fbs::Vector2D *gridSpacing = 0,
...
inline flatbuffers::Offset<ScalarGrid2> CreateScalarGrid2Direct(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size2 *resolution = 0, const jet::fbs::Vector2D *gridSpacing = 0,
                                                                const jet::fbs::Vector2D *origin = 0, const std::vector<double> *data = nullptr) {
    return jet::fbs::CreateScalarGrid2(_fbb, resolution, gridSpacing, origin, data ? _fbb.CreateVector<double>(*data) : 0);
}

inline const jet::fbs::ScalarGrid2 *GetScalarGrid2(const void *buf) { return flatbuffers::GetRoot<jet::fbs::ScalarGrid2>(buf); }

inline bool VerifyScalarGrid2Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::ScalarGrid2>(nullptr); }

inline void FinishScalarGrid2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::ScalarGrid2> root) { fbb.Finish(root); }
