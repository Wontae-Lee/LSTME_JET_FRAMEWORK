...
struct ScalarGridSerialized2Builder {
    ...
    ScalarGridSerialized2Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<ScalarGridSerialized2> CreateScalarGridSerialized2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> type = 0,
...
struct VectorGridSerialized2Builder {
    ...
    VectorGridSerialized2Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<VectorGridSerialized2> CreateVectorGridSerialized2(flatbuffers::FlatBufferBuilder &_fbb, flatbuffers::Offset<flatbuffers::String> type = 0,
                                                                              flatbuffers::Offset<flatbuffers::Vector<uint8_t>> data = 0) {
...
struct GridSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) && VerifyField<jet::fbs::Size2>(verifier, VT_RESOLUTION) && VerifyField<jet::fbs::Vector2D>(verifier, VT_GRIDSPACING) &&
               VerifyField<jet::fbs::Vector2D>(verifier, VT_ORIGIN) && VerifyField<uint64_t>(verifier, VT_VELOCITYIDX) && VerifyOffset(verifier, VT_SCALARDATA) && verifier.Verify(scalarData()) &&
...
struct GridSystemData2Builder {
    ...
    void add_scalarData(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized2>>> scalarData) { fbb_.AddOffset(GridSystemData2::VT_SCALARDATA, scalarData); }
    void add_vectorData(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized2>>> vectorData) { fbb_.AddOffset(GridSystemData2::VT_VECTORDATA, vectorData); }
    ...
    GridSystemData2Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size2 *resolution = 0, const jet::fbs::Vector2D *gridSpacing = 0,
                                                                  const jet::fbs::Vector2D *origin = 0, uint64_t velocityIdx = 0,
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2Direct(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size2 *resolution = 0, const jet::fbs::Vector2D *gridSpacing = 0,
                                                                        const jet::fbs::Vector2D *origin = 0, uint64_t velocityIdx = 0,
...
inline const jet::fbs::GridSystemData2 *GetGridSystemData2(const void *buf) { return flatbuffers::GetRoot<jet::fbs::GridSystemData2>(buf); }

inline bool VerifyGridSystemData2Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::GridSystemData2>(nullptr); }

inline void FinishGridSystemData2Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::GridSystemData2> root) { fbb.Finish(root); }
