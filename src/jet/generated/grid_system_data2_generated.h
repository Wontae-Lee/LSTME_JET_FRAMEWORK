...
struct GridSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  scalarData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<ScalarGridSerialized2>> *>(VT_SCALARDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized2>> *
  vectorData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<VectorGridSerialized2>> *>(VT_VECTORDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<ScalarGridSerialized2>> *
  advectableScalarData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<ScalarGridSerialized2>> *>(VT_ADVECTABLESCALARDATA);
  }
  const flatbuffers::Vector<flatbuffers::Offset<VectorGridSerialized2>> *
  advectableVectorData() const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<VectorGridSerialized2>> *>(VT_ADVECTABLEVECTORDATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2(
    flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size2 *resolution = 0,
