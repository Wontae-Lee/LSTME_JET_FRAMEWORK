...
inline ::flatbuffers::Offset<GridSystemData2> CreateGridSystemData2Direct(
  ...
  auto advectableScalarData__ = advectableScalarData ? _fbb.CreateVector<::flatbuffers::Offset<jet::fbs::ScalarGridSerialized2>>(*advectableScalarData) : 0;
  auto advectableVectorData__ = advectableVectorData ? _fbb.CreateVector<::flatbuffers::Offset<jet::fbs::VectorGridSerialized2>>(*advectableVectorData) : 0;
...
inline const jet::fbs::GridSystemData2 *GetSizePrefixedGridSystemData2(const void *buf) {
