...
struct VectorGrid3Builder {
  ...
  VectorGrid3Builder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
CreateVectorGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb,
  ...
  return jet::fbs::CreateVectorGrid3(_fbb, resolution, gridSpacing, origin,
...
inline bool VerifyVectorGrid3Buffer(flatbuffers::Verifier &verifier) {
