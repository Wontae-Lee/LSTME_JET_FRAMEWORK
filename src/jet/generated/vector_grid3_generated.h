                        ...
                        const std::vector<double>* data = nullptr)
{
  ...
  return jet::fbs::CreateVectorGrid3(_fbb, resolution, gridSpacing, origin, data__);
}

inline const jet::fbs::VectorGrid3*
...
inline const jet::fbs::VectorGrid3*
GetSizePrefixedVectorGrid3(const void* buf)
{
...
inline bool
VerifySizePrefixedVectorGrid3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::VectorGrid3>(nullptr);
}

inline void
FinishVectorGrid3Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::VectorGrid3> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedVectorGrid3Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::VectorGrid3> root)
{
