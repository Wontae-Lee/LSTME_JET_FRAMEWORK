...
PointKdTreeSearcherNode3 FLATBUFFERS_FINAL_CLASS
{
private:
  uint64_t flags_;
  uint64_t child_;
                                 ...
                                 const std::vector<jet::fbs::PointKdTreeSearcherNode3>* nodes = nullptr)
{
  ...
  return jet::fbs::CreatePointKdTreeSearcher3(_fbb, points__, nodes__);
}

inline const jet::fbs::PointKdTreeSearcher3*
...
inline const jet::fbs::PointKdTreeSearcher3*
GetSizePrefixedPointKdTreeSearcher3(const void* buf)
{
...
inline bool
VerifySizePrefixedPointKdTreeSearcher3Buffer(flatbuffers::Verifier& verifier)
{
  return verifier.VerifySizePrefixedBuffer<jet::fbs::PointKdTreeSearcher3>(nullptr);
}

inline void
FinishPointKdTreeSearcher3Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::PointKdTreeSearcher3> root)
{
  fbb.Finish(root);
}

inline void
FinishSizePrefixedPointKdTreeSearcher3Buffer(flatbuffers::FlatBufferBuilder& fbb, flatbuffers::Offset<jet::fbs::PointKdTreeSearcher3> root)
{
