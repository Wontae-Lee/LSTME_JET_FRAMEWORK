...
struct PointKdTreeSearcher3 FLATBUFFERS_FINAL_CLASS
  ...
  const flatbuffers::Vector<const PointKdTreeSearcherNode3 *> *nodes() const {
    return GetPointer<
        const flatbuffers::Vector<const PointKdTreeSearcherNode3 *> *>(
        VT_NODES);
  }
...
CreatePointKdTreeSearcher3Direct(
  ...
  return jet::fbs::CreatePointKdTreeSearcher3(
      _fbb, points ? _fbb.CreateVector<const jet::fbs::Vector3D *>(*points) : 0,
