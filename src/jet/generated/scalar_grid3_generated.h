...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size3 *resolution = 0, const jet::fbs::Vector3D *gridSpacing = 0,
...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3Direct(flatbuffers::FlatBufferBuilder &_fbb, const jet::fbs::Size3 *resolution = 0, const jet::fbs::Vector3D *gridSpacing = 0,
                                                                const jet::fbs::Vector3D *origin = 0, const std::vector<double> *data = nullptr) {
    return jet::fbs::CreateScalarGrid3(_fbb, resolution, gridSpacing, origin, data ? _fbb.CreateVector<double>(*data) : 0);
}

inline const jet::fbs::ScalarGrid3 *GetScalarGrid3(const void *buf) { return flatbuffers::GetRoot<jet::fbs::ScalarGrid3>(buf); }

inline bool VerifyScalarGrid3Buffer(flatbuffers::Verifier &verifier) { return verifier.VerifyBuffer<jet::fbs::ScalarGrid3>(nullptr); }

inline void FinishScalarGrid3Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<jet::fbs::ScalarGrid3> root) { fbb.Finish(root); }
