...
inline const jet::fbs::ScalarGrid3 *GetSizePrefixedScalarGrid3(const void *buf) {
...
inline bool VerifySizePrefixedScalarGrid3Buffer(
    flatbuffers::Verifier &verifier) {
...
inline void FinishSizePrefixedScalarGrid3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<jet::fbs::ScalarGrid3> root) {
