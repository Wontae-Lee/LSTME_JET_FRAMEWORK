...
#include "jet/generator/fcc_lattice_point_generator.h"
#include "jet/helpers/pch.h"

namespace jet {

void FccLatticePointGenerator::forEachPoint(const BoundingBox3D& boundingBox, double spacing, const std::function<bool(const Vector3D&)>& callback) const {
