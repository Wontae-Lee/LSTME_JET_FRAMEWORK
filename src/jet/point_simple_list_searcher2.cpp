...
void PointSimpleListSearcher2::forEachNearbyPoint(const Vector2D& origin, double radius, const ForEachNearbyPointFunc& callback) const {
...
PointNeighborSearcher2Ptr PointSimpleListSearcher2::clone() const { return CLONE_W_CUSTOM_DELETER(PointSimpleListSearcher2); }
...
PointSimpleListSearcher2 PointSimpleListSearcher2::Builder::build() const { return PointSimpleListSearcher2(); }
