...
BENCHMARK_REGISTER_F(PointHashGridSearcher3, Build)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 20);
...
BENCHMARK_REGISTER_F(PointHashGridSearcher3, ForEachNearbyPoints)->Arg(1 << 5)->Arg(1 << 10)->Arg(1 << 20);
