...
#define JET_TESTS(testSetName)                                                 \
    ...
    {                                                                          \
      ...
      protected:                                                               \
        ...
        {                                                                      \
            _testCollectionDir =                                               \
                pystring::os::path::join(JET_TESTS_OUTPUT_DIR, #testSetName);  \
        ...
        {                                                                      \
            char filename[256];                                                \
            snprintf(                                                          \
                filename, sizeof(filename), "data.#grid2,%04d.npy", frameNum); \
        ...
        {                                                                      \
            char filename[256];                                                \
            snprintf(                                                          \
                filename, sizeof(filename), "data.#grid3,%04d.npy", frameNum); \
            saveData(data, filename);                                          \
        }                                                                      \
