...
JET_BEGIN_TEST_F(TriangleMeshToSdf, Cube) {
    ...
    VertexCenteredScalarGrid3 grid(64, 64, 64, 3.0 / 64, 3.0 / 64, 3.0 / 64, -1.0, -1.0, -1.0);
...
JET_BEGIN_TEST_F(TriangleMeshToSdf, Bunny) {
    ...
    VertexCenteredScalarGrid3 grid(100, 100, 100, box.width() / 100, box.height() / 100, box.depth() / 100, box.lowerCorner.x, box.lowerCorner.y, box.lowerCorner.z);
