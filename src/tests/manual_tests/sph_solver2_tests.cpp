...
JET_BEGIN_TEST_F(SphSolver2, SteadyState) {
    ...
    auto emitter = std::make_shared<VolumeParticleEmitter2>(std::make_shared<SurfaceToImplicit2>(std::make_shared<Sphere2>(Vector2D(), 10.0)), initialBound, particles->targetSpacing(), Vector2D());
