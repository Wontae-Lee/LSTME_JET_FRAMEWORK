...
TEST(CustomImplicitSurface3, SignedDistance) {
    CustomImplicitSurface3 cis([](const Vector3D& pt) { return (pt - Vector3D(0.5, 0.5, 0.5)).length() - 0.25; }, BoundingBox3D({0, 0, 0}, {1, 1, 1}), 1e-3);
...
TEST(CustomImplicitSurface3, CloseestPoint) {
    ...
    CustomImplicitSurface3 cis1([&](const Vector3D& pt) { return refSurf.signedDistance(pt); }, BoundingBox3D({0, 0, 0}, {1, 1, 1}), 1e-3);
...
TEST(CustomImplicitSurface3, ClosestIntersection) {
    ...
    CustomImplicitSurface3 cis1([&](const Vector3D& pt) { return refSurf.signedDistance(pt); }, BoundingBox3D({0, 0, 0}, {1, 1, 1}), 1e-3, 1e-3);
