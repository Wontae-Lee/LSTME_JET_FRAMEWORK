...
TEST(Box3, ClosestIntersection) {
    Box3 box(Vector3D(-1, 2, 3), Vector3D(5, 3, 7), Transform3(Vector3D(1, -3, 2), QuaternionD()));

    SurfaceRayIntersection3 result0 = box.closestIntersection(Ray3D(Vector3D(2, 1, 7), Vector3D(-1, -1, -1).normalized()));
    ...
    SurfaceRayIntersection3 result1 = box.closestIntersection(Ray3D(Vector3D(2, -0.5, 8), Vector3D(-1, -1, 1).normalized()));
    ...
    SurfaceRayIntersection3 result2 = box.closestIntersection(Ray3D(Vector3D(2, -2, 4), Vector3D(-1, -1, -1).normalized()));
