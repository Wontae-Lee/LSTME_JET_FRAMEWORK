...
TEST(CellCenteredVectorGrid2, Builder) {
    {
        auto grid1 = CellCenteredVectorGrid2::builder().build(Size2(3, 8), Vector2D(2.0, 3.0), Vector2D(1.0, 5.0), {4.0, 7.0});
    ...
    {
        auto grid1 = CellCenteredVectorGrid2::builder().withResolution(3, 8).withGridSpacing(2, 3).withOrigin(1, 5).withInitialValue(4, 7).build();
