...
TEST(FdmUtils, ScalarToGradient2)
{
    ...
    Vector2D grad =
        gradient2(grid.constDataAccessor(), grid.gridSpacing(), 5, 3);
...
TEST(FdmUtils, ScalarToGradient3)
{
    ...
    Vector3D grad =
        gradient3(grid.constDataAccessor(), grid.gridSpacing(), 5, 3, 4);
    EXPECT_DOUBLE_EQ(-5.0, grad.x);
    EXPECT_DOUBLE_EQ(4.0, grad.y);
...
TEST(FdmUtils, ScalarToLaplacian2)
{
    ...
    double lapl =
        laplacian2(grid.constDataAccessor(), grid.gridSpacing(), 5, 3);
...
TEST(FdmUtils, ScalarToLaplacian3)
{
    ...
    double lapl =
        laplacian3(grid.constDataAccessor(), grid.gridSpacing(), 5, 3, 4);
