...
TEST(Box2, ClosestIntersection) {
    Box2 box(Vector2D(-1, 2), Vector2D(5, 3), Transform2(Vector2D(1.0, -3.0), 0));

    SurfaceRayIntersection2 result0 = box.closestIntersection(Ray2D(Vector2D(2, 1), Vector2D(-1, -1).normalized()));
    ...
    SurfaceRayIntersection2 result1 = box.closestIntersection(Ray2D(Vector2D(2, -0.5), Vector2D(-1, -1).normalized()));
    ...
    SurfaceRayIntersection2 result2 = box.closestIntersection(Ray2D(Vector2D(2, -2), Vector2D(-1, -1).normalized()));
