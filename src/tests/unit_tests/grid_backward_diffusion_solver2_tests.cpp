...
TEST(GridBackwardEulerDiffusionSolver2, Solve) {
    ...
    Array2<double> solution = {{0.012987, 0.064935, 0.012987}, {0.064935, 0.688312, 0.064935}, {0.012987, 0.064935, 0.012987}};

    dst.forEachDataPointIndex([&](size_t i, size_t j) { EXPECT_NEAR(solution(i, j), dst(i, j), 1e-6); });
}
