...
void printInfo(size_t numberOfParticles) { printf("Number of particles: %zu\n", numberOfParticles); }

void particlesToXml(const Array1<Vector3D>& positions, const std::string& xmlFilename) {
...
int main(int argc, char* argv[]) {
    ...
    // Parsing
    auto parser = clara::Help(showHelp) | clara::Opt(inputFilename, "inputFilename")["-i"]["--input"]("input particle pos/xyz file name") |
                  clara::Opt(outputFilename, "outputFilename")["-o"]["--output"]("output xml file name");
