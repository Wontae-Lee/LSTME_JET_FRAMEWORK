...
void
runExample1(const std::string& rootDir, double targetSpacing, int numberOfFrames, const std::string& format, double fps)
{
...
void
runExample2(const std::string& rootDir, double targetSpacing, int numberOfFrames, const std::string& format, double fps)
{
  // Initial condition
  BoundingBox3D domain(Vector3D(), Vector3D(1, 2, 1));
...
void
runExample3(const std::string& rootDir, double targetSpacing, int numberOfFrames, const std::string& format, double fps)
{
