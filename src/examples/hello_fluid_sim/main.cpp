...
void
updateWave(const double timeInterval, double* x, double* speed)
{
...
void
accumulateWaveToHeightField(const double x, const double waveLength, const double maxHeight, array<double, kBufferSize>* heightField)
{
...
void
draw(const array<double, kBufferSize>& heightField)
{
