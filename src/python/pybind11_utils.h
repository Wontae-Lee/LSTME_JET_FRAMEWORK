...
#include "jet/primitive/point/point2.h"
...
inline pybind11::tuple size2ToTuple(const Size2& sz) { return pybind11::make_tuple(sz.x, sz.y); };

inline pybind11::tuple size3ToTuple(const Size3& sz) { return pybind11::make_tuple(sz.x, sz.y, sz.z); };
...
inline Vector2F tupleToVector2F(pybind11::tuple tpl) { return tupleToVector<float, 2>(tpl); }

inline Vector2F tupleToVector2F(pybind11::list tpl) { return tupleToVector<float, 2>(tpl); }

inline Vector3F tupleToVector3F(pybind11::tuple tpl) { return tupleToVector<float, 3>(tpl); }

inline Vector3F tupleToVector3F(pybind11::list tpl) { return tupleToVector<float, 3>(tpl); }

inline Vector4F tupleToVector4F(pybind11::tuple tpl) { return tupleToVector<float, 4>(tpl); }

inline Vector4F tupleToVector4F(pybind11::list tpl) { return tupleToVector<float, 4>(tpl); }

inline QuaternionF tupleToQuaternionF(pybind11::tuple tpl) { return tupleToQuaternion<float>(tpl); }

inline QuaternionF tupleToQuaternionF(pybind11::list tpl) { return tupleToQuaternion<float>(tpl); }

inline Vector2D tupleToVector2D(pybind11::tuple tpl) { return tupleToVector<double, 2>(tpl); }

inline Vector2D tupleToVector2D(pybind11::list tpl) { return tupleToVector<double, 2>(tpl); }

inline Vector3D tupleToVector3D(pybind11::tuple tpl) { return tupleToVector<double, 3>(tpl); }

inline Vector3D tupleToVector3D(pybind11::list tpl) { return tupleToVector<double, 3>(tpl); }

inline Vector4D tupleToVector4D(pybind11::tuple tpl) { return tupleToVector<double, 4>(tpl); }

inline Vector4D tupleToVector4D(pybind11::list tpl) { return tupleToVector<double, 4>(tpl); }
...
inline QuaternionD tupleToQuaternionD(pybind11::tuple tpl) { return tupleToQuaternion<double>(tpl); }

inline QuaternionD tupleToQuaternionD(pybind11::list tpl) { return tupleToQuaternion<double>(tpl); }
...
inline void parseGridResizeParams(pybind11::args args, pybind11::kwargs kwargs, Size2& resolution, Vector2D& gridSpacing, Vector2D& gridOrigin) {
...
inline void parseGridResizeParams(pybind11::args args, pybind11::kwargs kwargs, Size3& resolution, Vector3D& gridSpacing, Vector3D& gridOrigin) {
    // See if we have list of parameters
    if (args.size() <= 3) {
        if (args.size() > 0) {
