...
namespace jet {
inline Size2
tupleToSize2(pybind11::tuple tpl)
{
    Size2 ret;
    if (tpl.size() == 2) {
...
inline Size2
tupleToSize2(pybind11::list lst)
{
    Size2 ret;
    if (lst.size() == 2) {
        for (size_t i = 0; i < 2; ++i) {
...
inline Size3
tupleToSize3(pybind11::tuple tpl)
{
    Size3 ret;
    if (tpl.size() == 3) {
...
inline Size3
tupleToSize3(pybind11::list lst)
{
    Size3 ret;
    if (lst.size() == 3) {
        for (size_t i = 0; i < 3; ++i) {
...
inline Point2UI
tupleToPoint2UI(pybind11::tuple tpl)
{
    Point2UI ret;
    if (tpl.size() == 2) {
        for (size_t i = 0; i < 2; ++i) {
...
inline Point2UI
tupleToPoint2UI(pybind11::list lst)
{
    Point2UI ret;
    if (lst.size() == 2) {
        for (size_t i = 0; i < 2; ++i) {
...
inline Point3UI
tupleToPoint3UI(pybind11::tuple tpl)
{
    Point3UI ret;
    if (tpl.size() == 3) {
        for (size_t i = 0; i < 3; ++i) {
...
inline Point3UI
tupleToPoint3UI(pybind11::list lst)
{
    Point3UI ret;
    if (lst.size() == 3) {
        for (size_t i = 0; i < 3; ++i) {
...
inline pybind11::tuple
size2ToTuple(const Size2& sz)
{
    return pybind11::make_tuple(sz.x, sz.y);
};
inline pybind11::tuple
size3ToTuple(const Size3& sz)
{
...
inline Vector<T, N>
tupleToVector(pybind11::tuple tpl)
{
    Vector<T, N> ret;
    if (tpl.size() == N) {
...
template<typename T, size_t N>
inline Vector<T, N>
tupleToVector(pybind11::list tpl)
{
    Vector<T, N> ret;
    if (tpl.size() == N) {
        for (size_t i = 0; i < N; ++i) {
...
template<typename T>
inline Quaternion<T>
tupleToQuaternion(pybind11::tuple tpl)
{
    Quaternion<T> ret;
...
template<typename T>
inline Quaternion<T>
tupleToQuaternion(pybind11::list tpl)
{
    Quaternion<T> ret;
    for (size_t i = 0; i < 4; ++i) {
        ret[i] = tpl[i].cast<T>();
...
inline Vector2F
tupleToVector2F(pybind11::tuple tpl)
{
    return tupleToVector<float, 2>(tpl);
}
inline Vector2F
tupleToVector2F(pybind11::list tpl)
{
    return tupleToVector<float, 2>(tpl);
}
inline Vector3F
tupleToVector3F(pybind11::tuple tpl)
{
    return tupleToVector<float, 3>(tpl);
}
inline Vector3F
tupleToVector3F(pybind11::list tpl)
{
    return tupleToVector<float, 3>(tpl);
}
inline Vector4F
tupleToVector4F(pybind11::tuple tpl)
{
    return tupleToVector<float, 4>(tpl);
}
inline Vector4F
tupleToVector4F(pybind11::list tpl)
{
    return tupleToVector<float, 4>(tpl);
}
inline QuaternionF
tupleToQuaternionF(pybind11::tuple tpl)
{
    return tupleToQuaternion<float>(tpl);
}
inline QuaternionF
tupleToQuaternionF(pybind11::list tpl)
{
    return tupleToQuaternion<float>(tpl);
}
inline Vector2D
tupleToVector2D(pybind11::tuple tpl)
{
    return tupleToVector<double, 2>(tpl);
}
inline Vector2D
tupleToVector2D(pybind11::list tpl)
{
    return tupleToVector<double, 2>(tpl);
}
inline Vector3D
tupleToVector3D(pybind11::tuple tpl)
{
    return tupleToVector<double, 3>(tpl);
}
inline Vector3D
tupleToVector3D(pybind11::list tpl)
{
    return tupleToVector<double, 3>(tpl);
}
inline Vector4D
tupleToVector4D(pybind11::tuple tpl)
{
    return tupleToVector<double, 4>(tpl);
}
inline Vector4D
tupleToVector4D(pybind11::list tpl)
{
    return tupleToVector<double, 4>(tpl);
}
template<typename T>
inline pybind11::tuple
vector2ToTuple(const Vector<T, 2>& vec)
{
    return pybind11::make_tuple(vec.x, vec.y);
};
template<typename T>
inline pybind11::tuple
vector3ToTuple(const Vector<T, 3>& vec)
{
    return pybind11::make_tuple(vec.x, vec.y, vec.z);
};
template<typename T>
inline pybind11::tuple
vector4ToTuple(const Vector<T, 4>& vec)
{
    return pybind11::make_tuple(vec.x, vec.y, vec.z, vec.w);
};
////////////////////////////////////////////////////////////////////////////////
inline QuaternionD
tupleToQuaternionD(pybind11::tuple tpl)
{
    return tupleToQuaternion<double>(tpl);
}
inline QuaternionD
tupleToQuaternionD(pybind11::list tpl)
{
    return tupleToQuaternion<double>(tpl);
}
////////////////////////////////////////////////////////////////////////////////
inline Size2
objectToSize2(const pybind11::object& obj)
{
...
inline Size3
objectToSize3(const pybind11::object& obj)
{
...
////////////////////////////////////////////////////////////////////////////////
inline Point2UI
objectToPoint2UI(const pybind11::object& obj)
{
...
inline Point3UI
objectToPoint3UI(const pybind11::object& obj)
{
...
////////////////////////////////////////////////////////////////////////////////
inline Vector2F
objectToVector2F(const pybind11::object& obj)
{
...
inline Vector2D
objectToVector2D(const pybind11::object& obj)
{
...
inline Vector3F
objectToVector3F(const pybind11::object& obj)
{
...
inline Vector3D
objectToVector3D(const pybind11::object& obj)
{
...
inline Vector4F
objectToVector4F(const pybind11::object& obj)
{
...
inline Vector4D
objectToVector4D(const pybind11::object& obj)
{
...
inline QuaternionF
objectToQuaternionF(const pybind11::object& obj)
{
...
inline QuaternionD
objectToQuaternionD(const pybind11::object& obj)
{
...
////////////////////////////////////////////////////////////////////////////////
inline void
parseGridResizeParams(pybind11::args args,
