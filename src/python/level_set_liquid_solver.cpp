...
using namespace jet;
void
addLevelSetLiquidSolver2(py::module& m)
{
    py::class_<LevelSetLiquidSolver2,
        ...
        .def(
            "__init__",
            [](LevelSetLiquidSolver2& instance,
               py::args args,
               py::kwargs kwargs) {
        ...
        .def_property("levelSetSolver",
                      &LevelSetLiquidSolver2::levelSetSolver,
        ...
        .def("setIsGlobalCompensationEnabled",
             ...
             py::arg("isEnabled"))
        .def("computeVolume",
             &LevelSetLiquidSolver2::computeVolume,
             R"pbdoc(
...
void
addLevelSetLiquidSolver3(py::module& m)
{
    py::class_<LevelSetLiquidSolver3,
        ...
        .def(
            "__init__",
            [](LevelSetLiquidSolver3& instance,
               py::args args,
               py::kwargs kwargs) {
        ...
        .def_property_readonly("signedDistanceField",
                               ...
                               R"pbdoc(The signed-distance field.)pbdoc")
        .def_property("levelSetSolver",
                      &LevelSetLiquidSolver3::levelSetSolver,
        ...
        .def("setIsGlobalCompensationEnabled",
             ...
             py::arg("isEnabled"))
        .def("computeVolume",
             &LevelSetLiquidSolver3::computeVolume,
             R"pbdoc(
             Returns liquid volume measured by smeared Heaviside function.
