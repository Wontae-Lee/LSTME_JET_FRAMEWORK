...
void addLevelSetLiquidSolver2(py::module& m) {
    py::class_<LevelSetLiquidSolver2, LevelSetLiquidSolver2Ptr, GridFluidSolver2>(m, "LevelSetLiquidSolver2",
                                                                                  R"pbdoc(
        ...
        .def(
            "__init__",
            [](LevelSetLiquidSolver2& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("signedDistanceField", &LevelSetLiquidSolver2::signedDistanceField, R"pbdoc(The signed-distance field.)pbdoc")
        .def_property("levelSetSolver", &LevelSetLiquidSolver2::levelSetSolver, &LevelSetLiquidSolver2::setLevelSetSolver, R"pbdoc(The level set solver.)pbdoc")
        .def("setMinReinitializeDistance", &LevelSetLiquidSolver2::setMinReinitializeDistance, R"pbdoc(Sets minimum reinitialization distance.)pbdoc")
...
void addLevelSetLiquidSolver3(py::module& m) {
    py::class_<LevelSetLiquidSolver3, LevelSetLiquidSolver3Ptr, GridFluidSolver3>(m, "LevelSetLiquidSolver3",
                                                                                  R"pbdoc(
        ...
        .def(
            "__init__",
            [](LevelSetLiquidSolver3& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("signedDistanceField", &LevelSetLiquidSolver3::signedDistanceField, R"pbdoc(The signed-distance field.)pbdoc")
        .def_property("levelSetSolver", &LevelSetLiquidSolver3::levelSetSolver, &LevelSetLiquidSolver3::setLevelSetSolver, R"pbdoc(The level set solver.)pbdoc")
        .def("setMinReinitializeDistance", &LevelSetLiquidSolver3::setMinReinitializeDistance, R"pbdoc(Sets minimum reinitialization distance.)pbdoc")
