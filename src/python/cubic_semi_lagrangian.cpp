...
void addCubicSemiLagrangian2(py::module& m) {
    py::class_<CubicSemiLagrangian2, CubicSemiLagrangian2Ptr, SemiLagrangian2>(m, "CubicSemiLagrangian2",
                                                                               R"pbdoc(
...
void addCubicSemiLagrangian3(py::module& m) {
    py::class_<CubicSemiLagrangian3, CubicSemiLagrangian3Ptr, SemiLagrangian3>(m, "CubicSemiLagrangian3",
                                                                               R"pbdoc(
