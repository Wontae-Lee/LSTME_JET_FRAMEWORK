...
using namespace jet;
void
addConstantScalarField2(py::module& m)
{
    py::class_<ConstantScalarField2, ConstantScalarField2Ptr, ScalarField2>(
        m, "ConstantScalarField2", R"pbdoc(2-D constant scalar field.)pbdoc")
        .def(
            py::init<double>(),
...
void
addConstantScalarField3(py::module& m)
{
    py::class_<ConstantScalarField3, ConstantScalarField3Ptr, ScalarField3>(
        m, "ConstantScalarField3", R"pbdoc(3-D constant scalar field.)pbdoc")
        .def(
            py::init<double>(),
            R"pbdoc(Constructs a constant scalar field with given `value`.)pbdoc",
            py::arg("value"))
