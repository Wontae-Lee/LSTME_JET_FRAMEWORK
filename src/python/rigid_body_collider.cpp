...
using namespace jet;
void
addRigidBodyCollider2(py::module& m)
{
    py::class_<RigidBodyCollider2, RigidBodyCollider2Ptr, Collider2>(
        ...
        .def(
            "__init__",
            [](RigidBodyCollider2& instance,
               const Surface2Ptr& surface,
               py::object linearVelocity,
            ...
            py::arg("surface"),
            py::arg("linearVelocity") = Vector2D{},
        ...
        .def_readwrite("angularVelocity",
                       &RigidBodyCollider2::angularVelocity,
                       R"pbdoc(Angular velocity of the collider.)pbdoc");
}
void
addRigidBodyCollider3(py::module& m)
{
    py::class_<RigidBodyCollider3, RigidBodyCollider3Ptr, Collider3>(
        ...
        .def(
            "__init__",
            [](RigidBodyCollider3& instance,
               const Surface3Ptr& surface,
               py::object linearVelocity,
               py::object angularVelocity) {
                new (&instance)
                    RigidBodyCollider3(surface,
                                       objectToVector3D(linearVelocity),
            ...
            py::arg("surface"),
            py::arg("linearVelocity") = Vector3D{},
