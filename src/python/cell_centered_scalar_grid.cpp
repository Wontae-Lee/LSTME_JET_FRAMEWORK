...
using namespace jet;
void
addCellCenteredScalarGrid2(py::module& m)
{
    py::class_<CellCenteredScalarGrid2,
        ...
        .def(
            "__init__",
            [](CellCenteredScalarGrid2& instance,
               py::args args,
               py::kwargs kwargs) {
        ...
        .def_property_readonly(
            "dataSize",
            &CellCenteredScalarGrid2::dataSize,
...
void
addCellCenteredScalarGrid3(py::module& m)
{
    py::class_<CellCenteredScalarGrid3,
        ...
        .def(
            "__init__",
            [](CellCenteredScalarGrid3& instance,
               py::args args,
               py::kwargs kwargs) {
        ...
        .def_property_readonly(
            "dataSize",
            &CellCenteredScalarGrid3::dataSize,
            R"pbdoc(Returns the actual data point size.)pbdoc")
        .def_property_readonly("dataOrigin",
