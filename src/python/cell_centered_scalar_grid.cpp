...
void addCellCenteredScalarGrid2(py::module& m) {
    py::class_<CellCenteredScalarGrid2, CellCenteredScalarGrid2Ptr, ScalarGrid2>(m, "CellCenteredScalarGrid2",
                                                                                 R"pbdoc(
        ...
        .def(
            "__init__",
            [](CellCenteredScalarGrid2& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &CellCenteredScalarGrid2::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
...
void addCellCenteredScalarGrid3(py::module& m) {
    py::class_<CellCenteredScalarGrid3, CellCenteredScalarGrid3Ptr, ScalarGrid3>(m, "CellCenteredScalarGrid3",
                                                                                 R"pbdoc(
        ...
        .def(
            "__init__",
            [](CellCenteredScalarGrid3& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &CellCenteredScalarGrid3::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
