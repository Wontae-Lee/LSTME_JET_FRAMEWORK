...
using namespace jet;
void
addConstantVectorField2(py::module& m)
{
    py::class_<ConstantVectorField2, ConstantVectorField2Ptr, VectorField2>(
        m, "ConstantVectorField2", R"pbdoc(2-D constant vector field.)pbdoc")
        .def(
            py::init<Vector2D>(),
...
void
addConstantVectorField3(py::module& m)
{
    py::class_<ConstantVectorField3, ConstantVectorField3Ptr, VectorField3>(
        m, "ConstantVectorField3", R"pbdoc(3-D constant vector field.)pbdoc")
        .def(
            py::init<Vector3D>(),
            R"pbdoc(Constructs a constant vector field with given `value`.)pbdoc",
            py::arg("value"))
