...
void addCylinder3(pybind11::module& m) {
    py::class_<Cylinder3, Cylinder3Ptr, Surface3>(m, "Cylinder3")
        ...
        .def(
            "__init__",
            [](Cylinder3& instance, py::object center, double radius, double height, const Transform3& transform, bool isNormalFlipped) {
            ...
            py::arg("center") = Vector3D(0, 0, 0), py::arg("radius") = 1.0, py::arg("height") = 1.0, py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
