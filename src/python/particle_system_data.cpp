...
using namespace jet;
void
addParticleSystemData2(py::module& m)
{
    py::class_<ParticleSystemData2, ParticleSystemData2Ptr, Serializable>(
        ...
        .def("addScalarData",
             &ParticleSystemData2::addScalarData,
             R"pbdoc(
        ...
        .def_property("radius",
                      &ParticleSystemData2::radius,
                      &ParticleSystemData2::setRadius,
                      R"pbdoc(
             The radius of the particles.
             )pbdoc")
        .def_property("mass",
                      &ParticleSystemData2::mass,
        ...
        .def(
            ...
            [](ParticleSystemData2& instance,
               ...
               py::object v,
               py::object f) {
                instance.addParticle(objectToVector2D(p),
                                     objectToVector2D(v),
                                     objectToVector2D(f));
            },
            R"pbdoc(
...
void
addParticleSystemData3(py::module& m)
{
    py::class_<ParticleSystemData3, ParticleSystemData3Ptr, Serializable>(
        ...
        .def("addScalarData",
             &ParticleSystemData3::addScalarData,
             R"pbdoc(
             Adds a scalar data layer and returns its index.
             This function adds a new scalar data layer to the system. It can be used
             for adding a scalar attribute, such as temperature, to the particles.
        ...
        .def_property("radius",
                      &ParticleSystemData3::radius,
                      &ParticleSystemData3::setRadius,
                      R"pbdoc(
             The radius of the particles.
             )pbdoc")
        .def_property("mass",
                      &ParticleSystemData3::mass,
        ...
        .def(
            ...
            [](ParticleSystemData3& instance,
               ...
               py::object v,
               py::object f) {
                instance.addParticle(objectToVector3D(p),
                                     objectToVector3D(v),
                                     objectToVector3D(f));
            },
            R"pbdoc(
