...
void addParticleSystemData2(py::module& m) {
    py::class_<ParticleSystemData2, ParticleSystemData2Ptr, Serializable>(m, "ParticleSystemData2", R"pbdoc(
        ...
        .def_property_readonly("numberOfParticles", &ParticleSystemData2::numberOfParticles,
                               R"pbdoc(
        ...
        .def(
            "addVectorData", [](ParticleSystemData2& instance, py::object object) { return instance.addVectorData(objectToVector2D(object)); },
            R"pbdoc(
        ...
        .def_property("radius", &ParticleSystemData2::radius, &ParticleSystemData2::setRadius,
                      R"pbdoc(
             The radius of the particles.
             )pbdoc")
        .def_property("mass", &ParticleSystemData2::mass, &ParticleSystemData2::setMass,
                      R"pbdoc(
             The mass of a particle.
             )pbdoc")
        .def_property_readonly(
            "positions", [](ParticleSystemData2& instance) { return instance.positions(); },
            R"pbdoc(
             Returns the position array (mutable).
             )pbdoc")
        .def_property_readonly(
            "velocities", [](ParticleSystemData2& instance) { return instance.velocities(); },
            R"pbdoc(
             Returns the velocity array (mutable).
             )pbdoc")
        .def_property_readonly(
            "forces", [](ParticleSystemData2& instance) { return instance.forces(); },
            R"pbdoc(
             Returns the force array (mutable).
             )pbdoc")
        .def(
            "scalarDataAt", [](ParticleSystemData2& instance, size_t idx) { return instance.scalarDataAt(idx); },
            R"pbdoc(
             Returns custom scalar data layer at given index (mutable).
             )pbdoc")
        .def(
            "vectorDataAt", [](ParticleSystemData2& instance, size_t idx) { return instance.vectorDataAt(idx); },
            R"pbdoc(
             Returns custom vector data layer at given index (mutable).
             )pbdoc")
        .def(
            "addParticle", [](ParticleSystemData2& instance, py::object p, py::object v, py::object f) { instance.addParticle(objectToVector2D(p), objectToVector2D(v), objectToVector2D(f)); },
            R"pbdoc(
            ...
            py::arg("newPosition"), py::arg("newVelocity") = Vector2D(), py::arg("newForce") = Vector2D())
        .def(
            "addParticles",
            [](ParticleSystemData2& instance, py::list ps, py::list vs, py::list fs) {
        ...
        .def_property("neighborSearcher", &ParticleSystemData2::neighborSearcher, &ParticleSystemData2::setNeighborSearcher,
                      R"pbdoc(
        ...
        .def(
            "set", [](ParticleSystemData2& instance, const ParticleSystemData2Ptr& other) { instance.set(*other); },
            R"pbdoc(
...
void addParticleSystemData3(py::module& m) {
    py::class_<ParticleSystemData3, ParticleSystemData3Ptr, Serializable>(m, "ParticleSystemData3", R"pbdoc(
        This class is the key data structure for storing particle system data. A
        single particle has position, velocity, and force attributes by default. But
        it can also have additional custom scalar or vector attributes.
        )pbdoc")
        ...
        .def("addScalarData", &ParticleSystemData3::addScalarData,
             ...
             py::arg("initialVal") = 0.0)
        .def(
            "addVectorData", [](ParticleSystemData3& instance, py::object object) { return instance.addVectorData(objectToVector3D(object)); },
            R"pbdoc(
             Adds a vector data layer and returns its index.
        ...
        .def_property("radius", &ParticleSystemData3::radius, &ParticleSystemData3::setRadius,
                      R"pbdoc(
             The radius of the particles.
             )pbdoc")
        .def_property("mass", &ParticleSystemData3::mass, &ParticleSystemData3::setMass,
                      R"pbdoc(
             The mass of a particle.
             )pbdoc")
        .def_property_readonly(
            "positions", [](ParticleSystemData3& instance) { return instance.positions(); },
            R"pbdoc(
             Returns the position array (mutable).
             )pbdoc")
        .def_property_readonly(
            "velocities", [](ParticleSystemData3& instance) { return instance.velocities(); },
            R"pbdoc(
             Returns the velocity array (mutable).
             )pbdoc")
        .def_property_readonly(
            "forces", [](ParticleSystemData3& instance) { return instance.forces(); },
            R"pbdoc(
             Returns the force array (mutable).
             )pbdoc")
        .def(
            "scalarDataAt", [](ParticleSystemData3& instance, size_t idx) { return instance.scalarDataAt(idx); },
            R"pbdoc(
             Returns custom scalar data layer at given index (mutable).
             )pbdoc")
        .def(
            "vectorDataAt", [](ParticleSystemData3& instance, size_t idx) { return instance.vectorDataAt(idx); },
            R"pbdoc(
             Returns custom vector data layer at given index (mutable).
             )pbdoc")
        .def(
            "addParticle", [](ParticleSystemData3& instance, py::object p, py::object v, py::object f) { instance.addParticle(objectToVector3D(p), objectToVector3D(v), objectToVector3D(f)); },
            R"pbdoc(
             Adds a particle to the data structure.
            ...
            py::arg("newPosition"), py::arg("newVelocity") = Vector3D(), py::arg("newForce") = Vector3D())
        .def(
            "addParticles",
            [](ParticleSystemData3& instance, py::list ps, py::list vs, py::list fs) {
                if (vs.size() > 0 && vs.size() != ps.size()) {
                    throw std::invalid_argument("Wrong input size for velocities list.");
                }
                if (fs.size() > 0 && fs.size() != ps.size()) {
        ...
        .def_property("neighborSearcher", &ParticleSystemData3::neighborSearcher, &ParticleSystemData3::setNeighborSearcher,
                      R"pbdoc(
             The neighbor searcher.
        ...
        .def(
            "set", [](ParticleSystemData3& instance, const ParticleSystemData3Ptr& other) { instance.set(*other); },
            R"pbdoc(
             Copies from other particle system data.
             )pbdoc");
}
