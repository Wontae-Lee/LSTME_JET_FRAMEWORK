...
using namespace jet;
void
addTriangleMesh3(pybind11::module& m)
{
    py::class_<TriangleMesh3, TriangleMesh3Ptr, Surface3>(m,
                                                          "TriangleMesh3",
                                                          R"pbdoc(
        ...
        .def(
            "__init__",
            [](TriangleMesh3& instance,
               py::list points,
               py::list normals,
               py::list uvs,
               py::list pointIndices,
               py::list normalIndices,
               py::list uvIndices,
               ...
               bool isNormalFlipped) {
                ...
                new (&instance) TriangleMesh3(points_,
                                              normals_,
                                              uvs_,
                                              pointIndices_,
                                              normalIndices_,
        ...
        .def(
            ...
            py::arg("i"))
        .def("numberOfPoints",
             &TriangleMesh3::numberOfPoints,
             R"pbdoc(
             Returns number of points.
             )pbdoc")
        .def("numberOfNormals",
             &TriangleMesh3::numberOfNormals,
             R"pbdoc(
             Returns number of normals.
             )pbdoc")
        .def("numberOfUvs",
             &TriangleMesh3::numberOfUvs,
             R"pbdoc(
             Returns number of UV coordinates.
             )pbdoc")
        .def("numberOfTriangles",
             &TriangleMesh3::numberOfTriangles,
             R"pbdoc(
             Returns number of triangles.
             )pbdoc")
        .def("hasNormals",
             &TriangleMesh3::hasNormals,
             R"pbdoc(
             Returns true if the mesh has normals.
             )pbdoc")
        .def("hasUvs",
             &TriangleMesh3::hasUvs,
             R"pbdoc(
