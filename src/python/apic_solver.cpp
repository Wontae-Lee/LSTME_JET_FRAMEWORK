...
using namespace jet;
void
addApicSolver2(py::module& m)
{
    py::class_<ApicSolver2, ApicSolver2Ptr, PicSolver2>(m,
                                                        "ApicSolver2",
                                                        R"pbdoc(
...
void
addApicSolver3(py::module& m)
{
    py::class_<ApicSolver3, ApicSolver3Ptr, PicSolver3>(m,
                                                        "ApicSolver3",
                                                        R"pbdoc(
