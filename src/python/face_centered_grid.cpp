...
using namespace jet;
void
addFaceCenteredGrid2(py::module& m)
{
    py::class_<FaceCenteredGrid2, FaceCenteredGrid2Ptr, VectorGrid2>(
        ...
        .def(
            ...
            [](FaceCenteredGrid2& instance, py::args args, py::kwargs kwargs) {
                ...
                parseGridResizeParams(
                    args, kwargs, resolution, gridSpacing, gridOrigin);
                new (&instance)
        ...
        .def(
            "u",
            [](const FaceCenteredGrid2& instance,
               size_t i,
...
void
addFaceCenteredGrid3(py::module& m)
{
    py::class_<FaceCenteredGrid3, FaceCenteredGrid3Ptr, VectorGrid3>(
        ...
        .def(
            "u",
            [](const FaceCenteredGrid3& instance, size_t i, size_t j, size_t k)
                -> double { return instance.u(i, j, k); },
            R"pbdoc(
             Returns u-value at given data point.
             Parameters
             ----------
        ...
        .def(
            "v",
            [](const FaceCenteredGrid3& instance, size_t i, size_t j, size_t k)
                -> double { return instance.v(i, j, k); },
            R"pbdoc(
             Returns v-value at given data point.
             Parameters
             ----------
        ...
        .def(
            "w",
            [](const FaceCenteredGrid3& instance, size_t i, size_t j, size_t k)
                -> double { return instance.w(i, j, k); },
            R"pbdoc(
             Returns v-value at given data point.
             Parameters
             ----------
        ...
        .def("uPosition",
             &FaceCenteredGrid3::uPosition,
             R"pbdoc(
            The function object that maps u data point to its actual position.
            )pbdoc")
        .def("vPosition",
             &FaceCenteredGrid3::vPosition,
             R"pbdoc(
            The function object that maps v data point to its actual position.
            )pbdoc")
        .def("wPosition",
             &FaceCenteredGrid3::wPosition,
             R"pbdoc(
            The function object that maps w data point to its actual position.
            )pbdoc")
        .def("uSize",
             &FaceCenteredGrid3::uSize,
             R"pbdoc(Returns data size of the u component.)pbdoc")
        .def("vSize",
             &FaceCenteredGrid3::vSize,
             R"pbdoc(Returns data size of the v component.)pbdoc")
        .def("wSize",
             &FaceCenteredGrid3::wSize,
             R"pbdoc(Returns data size of the w component.)pbdoc")
        .def("uOrigin",
             &FaceCenteredGrid3::uOrigin,
             R"pbdoc(
             Returns u-data position for the grid point at (0, 0).
             Note that this is different from origin() since origin() returns
             the lower corner point of the bounding box.
