...
using namespace jet;
void
addCustomScalarField2(py::module& m)
{
    py::class_<CustomScalarField2, CustomScalarField2Ptr, ScalarField2>(
        ...
        .def(
            "__init__",
            [](CustomScalarField2& instance,
               py::function func,
               py::function gradFunc,
               py::function lapFunc) {
                if (!gradFunc) {
                    new (&instance)
...
void
addCustomScalarField3(py::module& m)
{
