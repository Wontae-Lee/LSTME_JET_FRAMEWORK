...
using namespace jet;
void
addPciSphSolver2(py::module& m)
{
    py::class_<PciSphSolver2, PciSphSolver2Ptr, SphSolver2>(m,
                                                            "PciSphSolver2",
                                                            R"pbdoc(
        2-D PCISPH solver.
...
void
addPciSphSolver3(py::module& m)
{
    py::class_<PciSphSolver3, PciSphSolver3Ptr, SphSolver3>(m,
                                                            "PciSphSolver3",
                                                            R"pbdoc(
        3-D PCISPH solver.
