...
void addPciSphSolver2(py::module& m) {
    py::class_<PciSphSolver2, PciSphSolver2Ptr, SphSolver2>(m, "PciSphSolver2",
        ...
        .def_property("maxDensityErrorRatio", &PciSphSolver2::maxDensityErrorRatio, &PciSphSolver2::setMaxDensityErrorRatio,
                      R"pbdoc(
        ...
        .def_property("maxNumberOfIterations", &PciSphSolver2::maxNumberOfIterations, &PciSphSolver2::setMaxNumberOfIterations,
                      R"pbdoc(
...
void addPciSphSolver3(py::module& m) {
    py::class_<PciSphSolver3, PciSphSolver3Ptr, SphSolver3>(m, "PciSphSolver3",
        ...
        .def(py::init<double, double, double>(),
             ...
             py::arg("targetDensity") = kWaterDensity, py::arg("targetSpacing") = 0.1, py::arg("relativeKernelRadius") = 1.8)
        .def_property("maxDensityErrorRatio", &PciSphSolver3::maxDensityErrorRatio, &PciSphSolver3::setMaxDensityErrorRatio,
                      R"pbdoc(
             The max allowed density error ratio.
        ...
        .def_property("maxNumberOfIterations", &PciSphSolver3::maxNumberOfIterations, &PciSphSolver3::setMaxNumberOfIterations,
                      R"pbdoc(
             The max number of PCISPH iterations.
