...
void addTriangle3(pybind11::module& m) {
    py::class_<Triangle3, Triangle3Ptr, Surface3>(m, "Triangle3",
        ...
        .def(
            "__init__",
            [](Triangle3& instance, py::list points, py::list normals, py::list uvs, const Transform3& transform, bool isNormalFlipped) {
                if (points.size() != 3) {
            ...
            py::arg("points"), py::arg("normals"), py::arg("uvs"), py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
