...
using namespace jet;
void
addFdmMgpcgSolver2(py::module& m)
{
...
void
addFdmMgpcgSolver3(py::module& m)
{
    py::class_<FdmMgpcgSolver3, FdmMgpcgSolver3Ptr, FdmLinearSystemSolver3>(
        ...
        .def_property_readonly("tolerance",
                               &FdmMgpcgSolver3::tolerance,
                               R"pbdoc(
            The max residual tolerance for the MGPCG method.
            )pbdoc")
        .def_property_readonly("lastResidual",
                               &FdmMgpcgSolver3::lastResidual,
                               R"pbdoc(
            The last residual after the MGPCG iterations.
            )pbdoc")
