...
void addTransform2(pybind11::module& m) {
    py::class_<Transform2>(m, "Transform2")
        ...
        .def(
            "__init__",
            [](Transform2& instance, py::object translation, double orientation) {
            ...
            py::arg("translation") = Vector2D(0, 0), py::arg("orientation") = 0.0);
}
...
void addTransform3(pybind11::module& m) {
    py::class_<Transform3>(m, "Transform3")
        ...
        .def(
            "__init__",
            [](Transform3& instance, py::object translation, py::object orientation) {
            ...
            py::arg("translation") = Vector3D(0, 0, 0), py::arg("orientation") = QuaternionD());
}
