...
using namespace jet;
void
addFdmJacobiSolver2(py::module& m)
{
...
void
addFdmJacobiSolver3(py::module& m)
{
    py::class_<FdmJacobiSolver3, FdmJacobiSolver3Ptr, FdmLinearSystemSolver3>(
        ...
        .def_property_readonly("tolerance",
                               &FdmJacobiSolver3::tolerance,
                               R"pbdoc(
            The max residual tolerance for the CG method.
            )pbdoc")
        .def_property_readonly("lastResidual",
                               &FdmJacobiSolver3::lastResidual,
                               R"pbdoc(
            The last residual after the CG iterations.
            )pbdoc");
}
