...
void addVector2F(pybind11::module& m) {
    py::class_<Vector2F>(m, "Vector2F")
        // CTOR
        .def(
            "__init__", [](Vector2F& instance, float x, float y) { new (&instance) Vector2F(x, y); },
            R"pbdoc(
             Constructs Vector2F.
        ...
        .def("dot", [](const Vector2F& instance, py::object other) { return instance.dot(objectToVector2F(other)); })
        .def("cross", [](const Vector2F& instance, py::object other) { return instance.cross(objectToVector2F(other)); })
        ...
        .def("distanceTo", [](const Vector2F& instance, py::object other) { return instance.distanceTo(objectToVector2F(other)); })
        .def("distanceSquaredTo", [](const Vector2F& instance, py::object other) { return instance.distanceSquaredTo(objectToVector2F(other)); })
        .def("reflected", [](const Vector2F& instance, py::object other) { return instance.reflected(objectToVector2F(other)); })
        .def("projected", [](const Vector2F& instance, py::object other) { return instance.projected(objectToVector2F(other)); })
        ...
        .def("__iter__", [](const Vector2F& instance) { return py::make_iterator(&instance.x, &instance.y + 1); })
        .def("__str__", [](const Vector2F& instance) { return std::string(std::to_string(instance.x) + ", " + std::to_string(instance.y)); })
...
void addVector2D(pybind11::module& m) {
    py::class_<Vector2D>(m, "Vector2D")
        // CTOR
        .def(
            "__init__", [](Vector2D& instance, double x, double y) { new (&instance) Vector2D(x, y); },
            R"pbdoc(
             Constructs Vector2D.
        ...
        .def("dot", [](const Vector2D& instance, py::object other) { return instance.dot(objectToVector2D(other)); })
        .def("cross", [](const Vector2D& instance, py::object other) { return instance.cross(objectToVector2D(other)); })
        ...
        .def("distanceTo", [](const Vector2D& instance, py::object other) { return instance.distanceTo(objectToVector2D(other)); })
        .def("distanceSquaredTo", [](const Vector2D& instance, py::object other) { return instance.distanceSquaredTo(objectToVector2D(other)); })
        .def("reflected", [](const Vector2D& instance, py::object other) { return instance.reflected(objectToVector2D(other)); })
        .def("projected", [](const Vector2D& instance, py::object other) { return instance.projected(objectToVector2D(other)); })
        ...
        .def("__iter__", [](const Vector2D& instance) { return py::make_iterator(&instance.x, &instance.y + 1); })
        .def("__str__", [](const Vector2D& instance) { return std::string(std::to_string(instance.x) + ", " + std::to_string(instance.y)); })
...
void addVector3F(pybind11::module& m) {
    py::class_<Vector3F>(m, "Vector3F")
        // CTOR
        .def(
            "__init__", [](Vector3F& instance, float x, float y, float z) { new (&instance) Vector3F(x, y, z); },
            R"pbdoc(
             Constructs Vector3F.
        ...
        .def("dot", [](const Vector3F& instance, py::object other) { return instance.dot(objectToVector3F(other)); })
        .def("cross", [](const Vector3F& instance, py::object other) { return instance.cross(objectToVector3F(other)); })
        ...
        .def("distanceTo", [](const Vector3F& instance, py::object other) { return instance.distanceTo(objectToVector3F(other)); })
        .def("distanceSquaredTo", [](const Vector3F& instance, py::object other) { return instance.distanceSquaredTo(objectToVector3F(other)); })
        .def("reflected", [](const Vector3F& instance, py::object other) { return instance.reflected(objectToVector3F(other)); })
        .def("projected", [](const Vector3F& instance, py::object other) { return instance.projected(objectToVector3F(other)); })
        ...
        .def("__iter__", [](const Vector3F& instance) { return py::make_iterator(&instance.x, &instance.z + 1); })
        .def("__str__", [](const Vector3F& instance) { return std::string(std::to_string(instance.x) + ", " + std::to_string(instance.y) + ", " + std::to_string(instance.z)); })
...
void addVector3D(pybind11::module& m) {
    py::class_<Vector3D>(m, "Vector3D")
        // CTOR
        .def(
            "__init__", [](Vector3D& instance, double x, double y, double z) { new (&instance) Vector3D(x, y, z); },
            R"pbdoc(
             Constructs Vector3D.
        ...
        .def("dot", [](const Vector3D& instance, py::object other) { return instance.dot(objectToVector3D(other)); })
        .def("cross", [](const Vector3D& instance, py::object other) { return instance.cross(objectToVector3D(other)); })
        ...
        .def("distanceTo", [](const Vector3D& instance, py::object other) { return instance.distanceTo(objectToVector3D(other)); })
        .def("distanceSquaredTo", [](const Vector3D& instance, py::object other) { return instance.distanceSquaredTo(objectToVector3D(other)); })
        .def("reflected", [](const Vector3D& instance, py::object other) { return instance.reflected(objectToVector3D(other)); })
        .def("projected", [](const Vector3D& instance, py::object other) { return instance.projected(objectToVector3D(other)); })
        ...
        .def("__iter__", [](const Vector3D& instance) { return py::make_iterator(&instance.x, &instance.z + 1); })
        .def("__str__", [](const Vector3D& instance) { return std::string(std::to_string(instance.x) + ", " + std::to_string(instance.y) + ", " + std::to_string(instance.z)); })
