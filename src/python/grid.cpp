...
using namespace jet;
void
addGrid2(py::module& m)
{
    py::class_<Grid2, Grid2Ptr, Serializable>(m,
                                              "Grid2",
                                              R"pbdoc(
...
void
addGrid3(py::module& m)
{
    py::class_<Grid3, Grid3Ptr, Serializable>(m,
                                              "Grid3",
                                              R"pbdoc(
        ...
        .def_property_readonly("resolution",
                               ...
                               R"pbdoc(Resolution of the grid.)pbdoc")
        .def_property_readonly(
            "origin", &Grid3::origin, R"pbdoc(Origin of the grid.)pbdoc")
        .def_property_readonly("gridSpacing",
                               &Grid3::gridSpacing,
                               R"pbdoc(Spacing between grid points.)pbdoc")
        .def_property_readonly("boundingBox",
