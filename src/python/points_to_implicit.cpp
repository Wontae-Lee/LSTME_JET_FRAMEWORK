...
using namespace jet;
void
addPointsToImplicit2(pybind11::module& m)
{
    py::class_<PointsToImplicit2, PointsToImplicit2Ptr>(m,
                                                        "PointsToImplicit2",
                                                        R"pbdoc(
        ...
        .def(
            "convert",
            [](const PointsToImplicit2& instance,
...
void
addPointsToImplicit3(pybind11::module& m)
{
    py::class_<PointsToImplicit3, PointsToImplicit3Ptr>(m,
                                                        "PointsToImplicit3",
                                                        R"pbdoc(
        ...
        .def(
            "convert",
            [](const PointsToImplicit3& instance,
               const py::list& points,
