...
#include "jet/transfer/points_to_implicit2.h"
#include "jet/transfer/points_to_implicit3.h"
...
void addPointsToImplicit2(pybind11::module& m) {
    py::class_<PointsToImplicit2, PointsToImplicit2Ptr>(m, "PointsToImplicit2",
        ...
        .def(
            "convert",
            [](const PointsToImplicit2& instance, const py::list& points, ScalarGrid2Ptr output) {
...
void addPointsToImplicit3(pybind11::module& m) {
    py::class_<PointsToImplicit3, PointsToImplicit3Ptr>(m, "PointsToImplicit3",
        ...
        .def(
            "convert",
            [](const PointsToImplicit3& instance, const py::list& points, ScalarGrid3Ptr output) {
