...
template<typename T>
void
addArrayAccessor1Scalar(py::module m, const char* name)
{
...
void
addArrayAccessor1Vector(py::module m, const char* name)
{
...
template<typename T>
void
addArrayAccessor2Scalar(py::module m, const char* name)
{
...
template<typename T>
void
addArrayAccessor3Scalar(py::module m, const char* name)
{
