...
void addSurfaceSet2(py::module& m) {
    py::class_<SurfaceSet2, SurfaceSet2Ptr, Surface2>(m, "SurfaceSet2",
        ...
        .def(
            "__init__",
            [](SurfaceSet2& instance, py::list others, const Transform2& transform, bool isNormalFlipped) {
            ...
            py::arg("others") = py::list(), py::arg("transform") = Transform2(), py::arg("isNormalFlipped") = false)
...
void addSurfaceSet3(py::module& m) {
    py::class_<SurfaceSet3, SurfaceSet3Ptr, Surface3>(m, "SurfaceSet3",
        ...
        .def(
            "__init__",
            [](SurfaceSet3& instance, py::list others, const Transform3& transform, bool isNormalFlipped) {
            ...
            py::arg("others") = py::list(), py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
