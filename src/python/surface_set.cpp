...
using namespace jet;
void
addSurfaceSet2(py::module& m)
{
    py::class_<SurfaceSet2, SurfaceSet2Ptr, Surface2>(m,
                                                      "SurfaceSet2",
                                                      R"pbdoc(
         2-D surface set.
        ...
        .def("numberOfSurfaces",
             &SurfaceSet2::numberOfSurfaces,
             R"pbdoc(
             Returns the number of surfaces.
             )pbdoc")
        .def("surfaceAt",
             &SurfaceSet2::surfaceAt,
             R"pbdoc(
             Returns the `i`-th surface.
             )pbdoc",
             py::arg("i"))
        .def("addSurface",
             &SurfaceSet2::addSurface,
             R"pbdoc(
...
void
addSurfaceSet3(py::module& m)
{
    py::class_<SurfaceSet3, SurfaceSet3Ptr, Surface3>(m,
                                                      "SurfaceSet3",
                                                      R"pbdoc(
         3-D surface set.
        ...
        .def(
            ...
            py::arg("isNormalFlipped") = false)
        .def("numberOfSurfaces",
             &SurfaceSet3::numberOfSurfaces,
             R"pbdoc(
             Returns the number of surfaces.
             )pbdoc")
        .def("surfaceAt",
             &SurfaceSet3::surfaceAt,
             R"pbdoc(
             Returns the `i`-th surface.
             )pbdoc",
             py::arg("i"))
        .def("addSurface",
             &SurfaceSet3::addSurface,
             R"pbdoc(
             Adds a surface instance.
             )pbdoc",
             py::arg("surface"));
