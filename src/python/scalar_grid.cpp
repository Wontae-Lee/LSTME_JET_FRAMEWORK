...
void addScalarGrid2(py::module& m) {
    py::class_<ScalarGrid2, ScalarGrid2Ptr, ScalarField2, Grid2>(m, "ScalarGrid2", R"pbdoc(Abstract base class for 2-D scalar grid structure.)pbdoc")
        ...
        .def("clone", &ScalarGrid2::clone, R"pbdoc(Returns the copy of the grid instance.)pbdoc")
        .def("clear", &ScalarGrid2::clear, R"pbdoc(Clears the contents of the grid.)pbdoc")
        .def(
            "resize",
        ...
        .def("laplacianAtDataPoint", &ScalarGrid2::laplacianAtDataPoint,
             ...
             py::arg("i"), py::arg("j"))
        .def("dataAccessor", &ScalarGrid2::dataAccessor, R"pbdoc(The data array accessor.)pbdoc")
        .def("dataPosition", &ScalarGrid2::dataPosition, R"pbdoc(The function that maps data point to its position.)pbdoc")
        .def(
            "fill", [](ScalarGrid2& instance, double value) { instance.fill(value, ExecutionPolicy::kSerial); }, R"pbdoc(Fills the grid with given value.)pbdoc")
        .def(
            "fill",
            [](ScalarGrid2& instance, py::object obj) {
                if (py::isinstance<py::function>(obj)) {
                    auto func = obj.cast<py::function>();
                    instance.fill([func](const Vector2D& pt) -> double { return func(pt).cast<double>(); }, ExecutionPolicy::kSerial);
                } else {
        ...
        .def(
            "forEachDataPointIndex", [](ScalarGrid2& instance, py::function func) { instance.forEachDataPointIndex(func); },
            R"pbdoc(
            ...
            py::arg("func"))
        .def(
            "sample", [](const ScalarGrid2& instance, py::object obj) { return instance.sample(objectToVector2D(obj)); }, R"pbdoc(Returns sampled value at given position `x`.)pbdoc", py::arg("x"))
        .def(
            "gradient", [](const ScalarGrid2& instance, py::object obj) { return instance.gradient(objectToVector2D(obj)); }, R"pbdoc(Returns the gradient vector at given position `x`.)pbdoc",
            py::arg("x"))
        .def(
            "laplacian", [](const ScalarGrid2& instance, py::object obj) { return instance.laplacian(objectToVector2D(obj)); }, R"pbdoc(Returns the Laplacian value at given position `x`.)pbdoc",
            py::arg("x"));
}

void addScalarGrid3(py::module& m) {
    py::class_<ScalarGrid3, ScalarGrid3Ptr, ScalarField3, Grid3>(m, "ScalarGrid3", R"pbdoc(Abstract base class for 3-D scalar grid structure.)pbdoc")
        ...
        .def("clone", &ScalarGrid3::clone, R"pbdoc(Returns the copy of the grid instance.)pbdoc")
        .def("clear", &ScalarGrid3::clear, R"pbdoc(Clears the contents of the grid.)pbdoc")
        .def(
            "resize",
        ...
        .def("laplacianAtDataPoint", &ScalarGrid3::laplacianAtDataPoint,
             ...
             py::arg("i"), py::arg("j"), py::arg("k"))
        .def("dataAccessor", &ScalarGrid3::dataAccessor, R"pbdoc(The data array accessor.)pbdoc")
        .def("dataPosition", &ScalarGrid3::dataPosition, R"pbdoc(The function that maps data point to its position.)pbdoc")
        .def(
            "fill", [](ScalarGrid3& instance, double value) { instance.fill(value, ExecutionPolicy::kSerial); }, R"pbdoc(Fills the grid with given value.)pbdoc")
        .def(
            "fill",
            [](ScalarGrid3& instance, py::object obj) {
                if (py::isinstance<py::function>(obj)) {
                    auto func = obj.cast<py::function>();
                    instance.fill([func](const Vector3D& pt) -> double { return func(pt).cast<double>(); }, ExecutionPolicy::kSerial);
                } else {
                    throw std::invalid_argument(
                        "Input type must be double or function object -> "
                        "double");
            ...
            R"pbdoc(Fills the grid with given function.)pbdoc")
        .def(
            "forEachDataPointIndex", [](ScalarGrid3& instance, py::function func) { instance.forEachDataPointIndex(func); },
            R"pbdoc(
             Invokes the given function `func` for each data point.
            ...
            py::arg("func"))
        .def(
            "sample", [](const ScalarGrid3& instance, py::object obj) { return instance.sample(objectToVector3D(obj)); }, R"pbdoc(Returns sampled value at given position `x`.)pbdoc", py::arg("x"))
        .def(
            "gradient", [](const ScalarGrid3& instance, py::object obj) { return instance.gradient(objectToVector3D(obj)); }, R"pbdoc(Returns the gradient vector at given position `x`.)pbdoc",
            py::arg("x"))
        .def(
            "laplacian", [](const ScalarGrid3& instance, py::object obj) { return instance.laplacian(objectToVector3D(obj)); }, R"pbdoc(Returns the Laplacian value at given position `x`.)pbdoc",
            py::arg("x"));
}
