...
using namespace jet;
void
addVolumeParticleEmitter2(py::module& m)
{
    py::class_<VolumeParticleEmitter2,
        ...
        .def(
            ...
            [](VolumeParticleEmitter2& instance,
               ...
               py::kwargs kwargs) {
                ...
                new (&instance) VolumeParticleEmitter2(implicitSurface,
                                                       maxRegion,
                                                       spacing,
                                                       initialVel,
                                                       linearVel,
        ...
        .def_property("surface",
                      &VolumeParticleEmitter2::surface,
                      &VolumeParticleEmitter2::setSurface,
                      R"pbdoc(
             Source surface.
             )pbdoc")
        .def_property("maxRegion",
                      &VolumeParticleEmitter2::maxRegion,
                      &VolumeParticleEmitter2::setMaxRegion,
                      R"pbdoc(
             Max particle gen region.
             )pbdoc")
        .def_property("jitter",
                      &VolumeParticleEmitter2::jitter,
                      &VolumeParticleEmitter2::setJitter,
                      R"pbdoc(
             Jitter amount between 0 and 1.
             )pbdoc")
        .def_property("isOneShot",
                      &VolumeParticleEmitter2::isOneShot,
                      &VolumeParticleEmitter2::setIsOneShot,
                      R"pbdoc(
             True if particles should be emitted just once.
             )pbdoc")
        .def_property("allowOverlapping",
                      &VolumeParticleEmitter2::allowOverlapping,
                      &VolumeParticleEmitter2::setAllowOverlapping,
                      R"pbdoc(
             True if particles can be overlapped.
             )pbdoc")
        .def_property("maxNumberOfParticles",
                      &VolumeParticleEmitter2::maxNumberOfParticles,
                      &VolumeParticleEmitter2::setMaxNumberOfParticles,
                      R"pbdoc(
             Max number of particles to be emitted.
             )pbdoc")
        .def_property("spacing",
                      &VolumeParticleEmitter2::spacing,
                      &VolumeParticleEmitter2::setSpacing,
                      R"pbdoc(
             The spacing between particles.
             )pbdoc")
        .def_property(
            "initialVelocity",
            &VolumeParticleEmitter2::initialVelocity,
        ...
        .def_property(
            "linearVelocity",
            &VolumeParticleEmitter2::linearVelocity,
        ...
        .def_property(
            "angularVelocity",
            &VolumeParticleEmitter2::angularVelocity,
...
void
addVolumeParticleEmitter3(py::module& m)
{
    py::class_<VolumeParticleEmitter3,
        ...
        .def(
            ...
            [](VolumeParticleEmitter3& instance,
               ...
               py::kwargs kwargs) {
                ...
                new (&instance) VolumeParticleEmitter3(implicitSurface,
                                                       maxRegion,
                                                       spacing,
                                                       initialVel,
                                                       linearVel,
        ...
        .def_property("surface",
                      &VolumeParticleEmitter3::surface,
                      &VolumeParticleEmitter3::setSurface,
                      R"pbdoc(
             Source surface.
             )pbdoc")
        .def_property("maxRegion",
                      &VolumeParticleEmitter3::maxRegion,
                      &VolumeParticleEmitter3::setMaxRegion,
                      R"pbdoc(
             Max particle gen region.
             )pbdoc")
        .def_property("jitter",
                      &VolumeParticleEmitter3::jitter,
                      &VolumeParticleEmitter3::setJitter,
                      R"pbdoc(
             Jitter amount between 0 and 1.
             )pbdoc")
        .def_property("isOneShot",
                      &VolumeParticleEmitter3::isOneShot,
                      &VolumeParticleEmitter3::setIsOneShot,
                      R"pbdoc(
             True if particles should be emitted just once.
             )pbdoc")
        .def_property("allowOverlapping",
                      &VolumeParticleEmitter3::allowOverlapping,
                      &VolumeParticleEmitter3::setAllowOverlapping,
                      R"pbdoc(
             True if particles can be overlapped.
             )pbdoc")
        .def_property("maxNumberOfParticles",
                      &VolumeParticleEmitter3::maxNumberOfParticles,
                      &VolumeParticleEmitter3::setMaxNumberOfParticles,
                      R"pbdoc(
             Max number of particles to be emitted.
             )pbdoc")
        .def_property("spacing",
                      &VolumeParticleEmitter3::spacing,
                      &VolumeParticleEmitter3::setSpacing,
                      R"pbdoc(
             The spacing between particles.
             )pbdoc")
        .def_property(
            "initialVelocity",
            &VolumeParticleEmitter3::initialVelocity,
        ...
        .def_property(
            "linearVelocity",
            &VolumeParticleEmitter3::linearVelocity,
        ...
        .def_property(
            "angularVelocity",
            &VolumeParticleEmitter3::angularVelocity,
