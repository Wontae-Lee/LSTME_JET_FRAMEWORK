...
#include "jet/emitter/volume_particle_emitter3.h"
...
void addVolumeParticleEmitter2(py::module& m) {
    py::class_<VolumeParticleEmitter2, VolumeParticleEmitter2Ptr, ParticleEmitter2>(m, "VolumeParticleEmitter2")
        // CTOR
        .def(
            "__init__",
            [](VolumeParticleEmitter2& instance, py::args args, py::kwargs kwargs) {
                ...
                new (&instance) VolumeParticleEmitter2(implicitSurface, maxRegion, spacing, initialVel, linearVel, angularVel, maxNumberOfParticles, jitter, isOneShot, allowOverlapping, seed);
            },
            R"pbdoc(
        ...
        .def_property("surface", &VolumeParticleEmitter2::surface, &VolumeParticleEmitter2::setSurface, R"pbdoc(
             Source surface.
             )pbdoc")
        .def_property("maxRegion", &VolumeParticleEmitter2::maxRegion, &VolumeParticleEmitter2::setMaxRegion, R"pbdoc(
             Max particle gen region.
             )pbdoc")
        .def_property("jitter", &VolumeParticleEmitter2::jitter, &VolumeParticleEmitter2::setJitter, R"pbdoc(
             Jitter amount between 0 and 1.
             )pbdoc")
        .def_property("isOneShot", &VolumeParticleEmitter2::isOneShot, &VolumeParticleEmitter2::setIsOneShot, R"pbdoc(
             True if particles should be emitted just once.
             )pbdoc")
        .def_property("allowOverlapping", &VolumeParticleEmitter2::allowOverlapping, &VolumeParticleEmitter2::setAllowOverlapping, R"pbdoc(
             True if particles can be overlapped.
             )pbdoc")
        .def_property("maxNumberOfParticles", &VolumeParticleEmitter2::maxNumberOfParticles, &VolumeParticleEmitter2::setMaxNumberOfParticles, R"pbdoc(
             Max number of particles to be emitted.
             )pbdoc")
        .def_property("spacing", &VolumeParticleEmitter2::spacing, &VolumeParticleEmitter2::setSpacing, R"pbdoc(
             The spacing between particles.
             )pbdoc")
        .def_property(
            "initialVelocity", &VolumeParticleEmitter2::initialVelocity,
            [](VolumeParticleEmitter2& instance, py::object newInitialVel) { instance.setInitialVelocity(objectToVector2D(newInitialVel)); },
            R"pbdoc(
             The initial velocity of the particles.
             )pbdoc")
        .def_property(
            "linearVelocity", &VolumeParticleEmitter2::linearVelocity, [](VolumeParticleEmitter2& instance, py::object newLinearVel) { instance.setLinearVelocity(objectToVector2D(newLinearVel)); },
            R"pbdoc(
             The linear velocity of the emitter.
             )pbdoc")
        .def_property(
            "angularVelocity", &VolumeParticleEmitter2::angularVelocity, [](VolumeParticleEmitter2& instance, double newAngularVel) { instance.setAngularVelocity(newAngularVel); },
            R"pbdoc(
...
void addVolumeParticleEmitter3(py::module& m) {
    py::class_<VolumeParticleEmitter3, VolumeParticleEmitter3Ptr, ParticleEmitter3>(m, "VolumeParticleEmitter3")
        // CTOR
        .def(
            "__init__",
            [](VolumeParticleEmitter3& instance, py::args args, py::kwargs kwargs) {
                ...
                new (&instance) VolumeParticleEmitter3(implicitSurface, maxRegion, spacing, initialVel, linearVel, angularVel, maxNumberOfParticles, jitter, isOneShot, allowOverlapping, seed);
            },
            R"pbdoc(
        ...
        .def_property("surface", &VolumeParticleEmitter3::surface, &VolumeParticleEmitter3::setSurface, R"pbdoc(
             Source surface.
             )pbdoc")
        .def_property("maxRegion", &VolumeParticleEmitter3::maxRegion, &VolumeParticleEmitter3::setMaxRegion, R"pbdoc(
             Max particle gen region.
             )pbdoc")
        .def_property("jitter", &VolumeParticleEmitter3::jitter, &VolumeParticleEmitter3::setJitter, R"pbdoc(
             Jitter amount between 0 and 1.
             )pbdoc")
        .def_property("isOneShot", &VolumeParticleEmitter3::isOneShot, &VolumeParticleEmitter3::setIsOneShot, R"pbdoc(
             True if particles should be emitted just once.
             )pbdoc")
        .def_property("allowOverlapping", &VolumeParticleEmitter3::allowOverlapping, &VolumeParticleEmitter3::setAllowOverlapping, R"pbdoc(
             True if particles can be overlapped.
             )pbdoc")
        .def_property("maxNumberOfParticles", &VolumeParticleEmitter3::maxNumberOfParticles, &VolumeParticleEmitter3::setMaxNumberOfParticles, R"pbdoc(
             Max number of particles to be emitted.
             )pbdoc")
        .def_property("spacing", &VolumeParticleEmitter3::spacing, &VolumeParticleEmitter3::setSpacing, R"pbdoc(
             The spacing between particles.
             )pbdoc")
        .def_property(
            "initialVelocity", &VolumeParticleEmitter3::initialVelocity,
            [](VolumeParticleEmitter3& instance, py::object newInitialVel) { instance.setInitialVelocity(objectToVector3D(newInitialVel)); },
            R"pbdoc(
             The initial velocity of the particles.
             )pbdoc")
        .def_property(
            "linearVelocity", &VolumeParticleEmitter3::linearVelocity, [](VolumeParticleEmitter3& instance, py::object newLinearVel) { instance.setLinearVelocity(objectToVector3D(newLinearVel)); },
            R"pbdoc(
             The linear velocity of the emitter.
             )pbdoc")
        .def_property(
            "angularVelocity", &VolumeParticleEmitter3::angularVelocity,
            [](VolumeParticleEmitter3& instance, py::object newAngularVel) { instance.setAngularVelocity(objectToVector3D(newAngularVel)); },
            R"pbdoc(
             The angular velocity of the emitter.
             )pbdoc");
}
