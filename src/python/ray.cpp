...
addRay2F(pybind11::module& m)
{
    py::class_<Ray2F>(m, "Ray2F")
        ...
        .def_readwrite(
            "origin", &Ray2F::origin, R"pbdoc(Origin of the ray.)pbdoc")
...
addRay2D(pybind11::module& m)
{
    py::class_<Ray2D>(m, "Ray2D")
        ...
        .def_readwrite(
            "origin", &Ray2D::origin, R"pbdoc(Origin of the ray.)pbdoc")
        .def_readwrite("direction",
                       &Ray2D::direction,
                       R"pbdoc(Direction of the ray.)pbdoc");
}
...
addRay3F(pybind11::module& m)
{
    py::class_<Ray3F>(m, "Ray3F")
        ...
        .def_readwrite(
            "origin", &Ray3F::origin, R"pbdoc(Origin of the ray.)pbdoc")
        .def_readwrite("direction",
                       &Ray3F::direction,
                       R"pbdoc(Direction of the ray.)pbdoc");
}
...
addRay3D(pybind11::module& m)
{
    py::class_<Ray3D>(m, "Ray3D")
        ...
        .def_readwrite(
            "origin", &Ray3D::origin, R"pbdoc(Origin of the ray.)pbdoc")
        .def_readwrite("direction",
                       &Ray3D::direction,
                       R"pbdoc(Direction of the ray.)pbdoc");
}
