...
#include "jet/transfer/zhu_bridson_points_to_implicit2.h"
#include "jet/transfer/zhu_bridson_points_to_implicit3.h"

namespace py = pybind11;
using namespace jet;

void addZhuBridsonPointsToImplicit2(pybind11::module& m) {
    py::class_<ZhuBridsonPointsToImplicit2, PointsToImplicit2, ZhuBridsonPointsToImplicit2Ptr>(m, "ZhuBridsonPointsToImplicit2",
                                                                                               R"pbdoc(
        ...
        .def(py::init<double, double, bool>(),
             ...
             py::arg("kernelRadius") = 1.0, py::arg("cutOffThreshold") = 0.25, py::arg("isOutputSdf") = true);
}

void addZhuBridsonPointsToImplicit3(pybind11::module& m) {
    py::class_<ZhuBridsonPointsToImplicit3, PointsToImplicit3, ZhuBridsonPointsToImplicit3Ptr>(m, "ZhuBridsonPointsToImplicit3",
                                                                                               R"pbdoc(
