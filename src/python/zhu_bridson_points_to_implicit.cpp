...
using namespace jet;
void
addZhuBridsonPointsToImplicit2(pybind11::module& m)
{
    py::class_<ZhuBridsonPointsToImplicit2,
               PointsToImplicit2,
               ZhuBridsonPointsToImplicit2Ptr>(m,
        ...
        .def(py::init<double, double, bool>(),
             ...
             py::arg("kernelRadius") = 1.0,
             py::arg("cutOffThreshold") = 0.25,
             py::arg("isOutputSdf") = true);
}
void
addZhuBridsonPointsToImplicit3(pybind11::module& m)
{
    py::class_<ZhuBridsonPointsToImplicit3,
               PointsToImplicit3,
               ZhuBridsonPointsToImplicit3Ptr>(m,
