...
void addFmmLevelSetSolver2(py::module& m) {
    py::class_<FmmLevelSetSolver2, FmmLevelSetSolver2Ptr, LevelSetSolver2>(m, "FmmLevelSetSolver2",
                                                                           R"pbdoc(
        ...
        .def(
            "reinitialize",
            [](FmmLevelSetSolver2& instance, const ScalarGrid2Ptr& inputSdf, double maxDistance, ScalarGrid2Ptr outputSdf) { instance.reinitialize(*inputSdf, maxDistance, outputSdf.get()); },
            R"pbdoc(
        ...
        .def(
            "extrapolate",
            [](FmmLevelSetSolver2& instance, const Grid2Ptr& input, const ScalarGrid2Ptr& sdf, double maxDistance, Grid2Ptr output) {
...
void addFmmLevelSetSolver3(py::module& m) {
    py::class_<FmmLevelSetSolver3, FmmLevelSetSolver3Ptr, LevelSetSolver3>(m, "FmmLevelSetSolver3",
                                                                           R"pbdoc(
        ...
        .def(
            "reinitialize",
            [](FmmLevelSetSolver3& instance, const ScalarGrid3Ptr& inputSdf, double maxDistance, ScalarGrid3Ptr outputSdf) { instance.reinitialize(*inputSdf, maxDistance, outputSdf.get()); },
            R"pbdoc(
             Reinitializes given scalar field to signed-distance field.
        ...
        .def(
            "extrapolate",
            [](FmmLevelSetSolver3& instance, const Grid3Ptr& input, const ScalarGrid3Ptr& sdf, double maxDistance, Grid3Ptr output) {
