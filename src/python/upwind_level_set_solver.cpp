...
void addUpwindLevelSetSolver2(py::module& m) {
    py::class_<UpwindLevelSetSolver2, UpwindLevelSetSolver2Ptr, IterativeLevelSetSolver2>(m, "UpwindLevelSetSolver2",
                                                                                          R"pbdoc(
...
void addUpwindLevelSetSolver3(py::module& m) {
    py::class_<UpwindLevelSetSolver3, UpwindLevelSetSolver3Ptr, IterativeLevelSetSolver3>(m, "UpwindLevelSetSolver3",
                                                                                          R"pbdoc(
