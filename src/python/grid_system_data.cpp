...
using namespace jet;
void
addGridSystemData2(py::module& m)
{
...
addGridSystemData3(py::module& m)
{
    py::class_<GridSystemData3, GridSystemData3Ptr, Serializable>(
        ...
        .def(py::init<>())
        .def_property_readonly("resolution",
                               &GridSystemData3::resolution,
                               R"pbdoc(Resolution of the grid.)pbdoc")
        .def_property_readonly("origin",
                               &GridSystemData3::origin,
                               R"pbdoc(Origin of the grid.)pbdoc")
        .def_property_readonly("gridSpacing",
                               &GridSystemData3::gridSpacing,
                               R"pbdoc(Spacing between grid points.)pbdoc")
        .def_property_readonly("boundingBox",
                               &GridSystemData3::boundingBox,
                               R"pbdoc(Bounding box of the entire grid.)pbdoc");
}
