...
void addVertexCenteredScalarGrid2(py::module& m) {
    py::class_<VertexCenteredScalarGrid2, VertexCenteredScalarGrid2Ptr, ScalarGrid2>(m, "VertexCenteredScalarGrid2",
                                                                                     R"pbdoc(
        ...
        .def(
            "__init__",
            [](VertexCenteredScalarGrid2& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &VertexCenteredScalarGrid2::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
...
void addVertexCenteredScalarGrid3(py::module& m) {
    py::class_<VertexCenteredScalarGrid3, VertexCenteredScalarGrid3Ptr, ScalarGrid3>(m, "VertexCenteredScalarGrid3",
                                                                                     R"pbdoc(
        ...
        .def(
            "__init__",
            [](VertexCenteredScalarGrid3& instance, py::args args, py::kwargs kwargs) {
                Size3 resolution{1, 1, 1};
                Vector3D gridSpacing{1, 1, 1};
                Vector3D gridOrigin{0, 0, 0};
                parseGridResizeParams(args, kwargs, resolution, gridSpacing, gridOrigin);
                new (&instance) VertexCenteredScalarGrid3(resolution, gridSpacing, gridOrigin);
            },
            R"pbdoc(
             Constructs grid.
        ...
        .def_property_readonly("dataSize", &VertexCenteredScalarGrid3::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
