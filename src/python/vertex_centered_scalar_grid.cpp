...
using namespace jet;
void
addVertexCenteredScalarGrid2(py::module& m)
{
    py::class_<VertexCenteredScalarGrid2,
        ...
        .def(
            "__init__",
            [](VertexCenteredScalarGrid2& instance,
               py::args args,
               py::kwargs kwargs) {
        ...
        .def_property_readonly(
            "dataSize",
            &VertexCenteredScalarGrid2::dataSize,
...
void
addVertexCenteredScalarGrid3(py::module& m)
{
    py::class_<VertexCenteredScalarGrid3,
        ...
        .def(
            "__init__",
            [](VertexCenteredScalarGrid3& instance,
               py::args args,
               py::kwargs kwargs) {
        ...
        .def_property_readonly(
            "dataSize",
            &VertexCenteredScalarGrid3::dataSize,
            R"pbdoc(Returns the actual data point size.)pbdoc")
        .def_property_readonly("dataOrigin",
