...
using namespace jet;
void
addGridFluidSolver2(py::module& m)
{
    py::class_<GridFluidSolver2, GridFluidSolver2Ptr, PhysicsAnimation>(
        ...
        .def_property("advectionSolver",
                      &GridFluidSolver2::advectionSolver,
                      &GridFluidSolver2::setAdvectionSolver,
                      R"pbdoc(The advection solver.)pbdoc")
        .def_property("diffusionSolver",
                      &GridFluidSolver2::diffusionSolver,
                      &GridFluidSolver2::setDiffusionSolver,
                      R"pbdoc(The diffusion solver instance.)pbdoc")
        .def_property("pressureSolver",
                      &GridFluidSolver2::pressureSolver,
        ...
        .def_property_readonly("gridSpacing",
                               &GridFluidSolver2::gridSpacing,
                               R"pbdoc(
...
void
addGridFluidSolver3(py::module& m)
{
    py::class_<GridFluidSolver3, GridFluidSolver3Ptr, PhysicsAnimation>(
        ...
        .def_property(
            ...
            R"pbdoc(True if the solver is using compressed linear system.)pbdoc")
        .def_property("advectionSolver",
                      &GridFluidSolver3::advectionSolver,
                      &GridFluidSolver3::setAdvectionSolver,
                      R"pbdoc(The advection solver.)pbdoc")
        .def_property("diffusionSolver",
                      &GridFluidSolver3::diffusionSolver,
                      &GridFluidSolver3::setDiffusionSolver,
                      R"pbdoc(The diffusion solver instance.)pbdoc")
        .def_property("pressureSolver",
                      &GridFluidSolver3::pressureSolver,
