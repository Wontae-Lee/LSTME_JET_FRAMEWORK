...
void addPlane2(pybind11::module& m) {
    py::class_<Plane2, Plane2Ptr, Surface2>(m, "Plane2",
        ...
        .def(
            "__init__",
            [](Plane2& instance, py::object normal, py::object point, const Transform2& transform, bool isNormalFlipped) {
            ...
            py::arg("normal"), py::arg("point"), py::arg("transform") = Transform2(), py::arg("isNormalFlipped") = false)
...
void addPlane3(pybind11::module& m) {
    py::class_<Plane3, Plane3Ptr, Surface3>(m, "Plane3",
        ...
        .def(
            "__init__",
            [](Plane3& instance, py::object normal, py::object point, const Transform3& transform, bool isNormalFlipped) {
            ...
            py::arg("normal"), py::arg("point"), py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
