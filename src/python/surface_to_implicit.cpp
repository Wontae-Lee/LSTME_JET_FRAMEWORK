...
void addSurfaceToImplicit2(py::module& m) {
    py::class_<SurfaceToImplicit2, SurfaceToImplicit2Ptr, ImplicitSurface2>(m, "SurfaceToImplicit2",
                                                                            R"pbdoc(
        ...
        .def(py::init<Surface2Ptr, Transform2, bool>(),
             ...
             py::arg("surface"), py::arg("transform") = Transform2(), py::arg("isNormalFlipped") = false)
...
void addSurfaceToImplicit3(py::module& m) {
    py::class_<SurfaceToImplicit3, SurfaceToImplicit3Ptr, ImplicitSurface3>(m, "SurfaceToImplicit3",
                                                                            R"pbdoc(
        ...
        .def(py::init<Surface3Ptr, Transform3, bool>(),
             ...
             py::arg("surface"), py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
