...
void addSemiLagrangian2(py::module& m) {
    py::class_<SemiLagrangian2, SemiLagrangian2Ptr, AdvectionSolver2>(m, "SemiLagrangian2",
                                                                      R"pbdoc(
        ...
        .def(
            "solve",
            [](SemiLagrangian2& instance, const Grid2Ptr& input, const VectorField2Ptr& flow, double dt, Grid2Ptr output, const ScalarField2Ptr& boundarySdf) {
            ...
            py::arg("input"), py::arg("flow"), py::arg("dt"), py::arg("output"), py::arg("boundarySdf") = ConstantScalarField2::builder().withValue(kMaxD).makeShared());
}

void addSemiLagrangian3(py::module& m) {
    py::class_<SemiLagrangian3, SemiLagrangian3Ptr, AdvectionSolver3>(m, "SemiLagrangian3",
                                                                      R"pbdoc(
        ...
        .def(
            "solve",
            [](SemiLagrangian3& instance, const Grid3Ptr& input, const VectorField3Ptr& flow, double dt, Grid3Ptr output, const ScalarField3Ptr& boundarySdf) {
            ...
            py::arg("input"), py::arg("flow"), py::arg("dt"), py::arg("output"), py::arg("boundarySdf") = ConstantScalarField3::builder().withValue(kMaxD).makeShared());
}
