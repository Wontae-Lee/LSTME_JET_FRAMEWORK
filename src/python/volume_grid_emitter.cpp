...
using namespace jet;
void
addVolumeGridEmitter2(py::module& m)
{
    py::class_<VolumeGridEmitter2, VolumeGridEmitter2Ptr, GridEmitter2>(
        ...
        .def_property_readonly("isOneShot",
                               &VolumeGridEmitter2::isOneShot,
                               R"pbdoc(
             True if this emits only once.
             )pbdoc");
}
void
addVolumeGridEmitter3(py::module& m)
{
