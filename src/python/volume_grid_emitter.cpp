...
void addVolumeGridEmitter2(py::module& m) {
    py::class_<VolumeGridEmitter2, VolumeGridEmitter2Ptr, GridEmitter2>(m, "VolumeGridEmitter2", R"pbdoc(2-D grid-based volumetric emitter.)pbdoc")
        .def(
            "__init__",
            [](VolumeGridEmitter2& instance, const Surface2Ptr& sourceRegion, bool isOneShot) {
        ...
        .def("addStepFunctionTarget", &VolumeGridEmitter2::addStepFunctionTarget,
             ...
             py::arg("scalarGridTarget"), py::arg("minValue"), py::arg("maxValue"))
        .def(
            "addTarget",
            [](VolumeGridEmitter2& instance, py::object obj, py::function mapper) {
                if (py::isinstance<ScalarGrid2Ptr>(obj)) {
                    instance.addTarget(obj.cast<ScalarGrid2Ptr>(), [mapper](double ds, const Vector2D& l, double old) -> double { return mapper(ds, l, old).cast<double>(); });
                } else if (py::isinstance<VectorGrid2Ptr>(obj)) {
                    instance.addTarget(obj.cast<VectorGrid2Ptr>(), [mapper](double ds, const Vector2D& l, const Vector2D& old) -> Vector2D { return mapper(ds, l, old).cast<Vector2D>(); });
                } else {
        ...
        .def_property_readonly("sourceRegion", &VolumeGridEmitter2::sourceRegion,
                               R"pbdoc(
...
void addVolumeGridEmitter3(py::module& m) {
    py::class_<VolumeGridEmitter3, VolumeGridEmitter3Ptr, GridEmitter3>(m, "VolumeGridEmitter3", R"pbdoc(3-D grid-based volumetric emitter.)pbdoc")
        .def(
            "__init__",
            [](VolumeGridEmitter3& instance, const Surface3Ptr& sourceRegion, bool isOneShot) {
                ImplicitSurface3Ptr sourceRegion_;
        ...
        .def(
            "addTarget",
            [](VolumeGridEmitter3& instance, py::object obj, py::function mapper) {
                if (py::isinstance<ScalarGrid3Ptr>(obj)) {
                    instance.addTarget(obj.cast<ScalarGrid3Ptr>(), [mapper](double ds, const Vector3D& l, double old) -> double { return mapper(ds, l, old).cast<double>(); });
                } else if (py::isinstance<VectorGrid3Ptr>(obj)) {
                    instance.addTarget(obj.cast<VectorGrid3Ptr>(), [mapper](double ds, const Vector3D& l, const Vector3D& old) -> Vector3D { return mapper(ds, l, old).cast<Vector3D>(); });
                } else {
                    throw std::invalid_argument("Unknown grid type.");
                }
            },
            ...
            py::arg("scalarGridTarget"), py::arg("customMapper"))
        .def_property_readonly("sourceRegion", &VolumeGridEmitter3::sourceRegion,
                               R"pbdoc(
             Implicit surface which defines the source region.
             )pbdoc")
