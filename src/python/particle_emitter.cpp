...
using namespace jet;
void
addParticleEmitter2(py::module& m)
{
    py::class_<ParticleEmitter2, ParticleEmitter2Ptr>(m,
                                                      "ParticleEmitter2",
                                                      R"pbdoc(
        ...
        .def("update",
            ...
            time-step.
             ...
             py::arg("currentTimeInSeconds"),
             py::arg("timeIntervalInSeconds"))
        .def_property("target",
                      &ParticleEmitter2::target,
...
void
addParticleEmitter3(py::module& m)
{
    py::class_<ParticleEmitter3, ParticleEmitter3Ptr>(m,
                                                      "ParticleEmitter3",
                                                      R"pbdoc(
