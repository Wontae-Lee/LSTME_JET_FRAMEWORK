...
void addParticleEmitter2(py::module& m) {
    py::class_<ParticleEmitter2, ParticleEmitter2Ptr>(m, "ParticleEmitter2",
        ...
        .def_property("target", &ParticleEmitter2::target, &ParticleEmitter2::setTarget, R"pbdoc(
            The target particle system to emit.
            )pbdoc")
        .def_property("isEnabled", &ParticleEmitter2::isEnabled, &ParticleEmitter2::setIsEnabled, R"pbdoc(True/false if the emitter is enabled/disabled.)pbdoc")
    ...
    py::class_<ParticleEmitter3, ParticleEmitter3Ptr>(m, "ParticleEmitter3",
        ...
        .def("update", &ParticleEmitter3::update, R"pbdoc(
            ...
            time-step.
             ...
             py::arg("currentTimeInSeconds"), py::arg("timeIntervalInSeconds"))
        .def_property("target", &ParticleEmitter3::target, &ParticleEmitter3::setTarget, R"pbdoc(
            The target particle system to emit.
            )pbdoc")
        .def_property("isEnabled", &ParticleEmitter3::isEnabled, &ParticleEmitter3::setIsEnabled, R"pbdoc(True/false if the emitter is enabled/disabled.)pbdoc")
