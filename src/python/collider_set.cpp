...
using namespace jet;
void
addColliderSet2(py::module& m)
{
    py::class_<ColliderSet2, ColliderSet2Ptr, Collider2>(m,
                                                         "ColliderSet2",
                                                         R"pbdoc(
...
void
addColliderSet3(py::module& m)
{
    py::class_<ColliderSet3, ColliderSet3Ptr, Collider3>(m,
                                                         "ColliderSet3",
                                                         R"pbdoc(
