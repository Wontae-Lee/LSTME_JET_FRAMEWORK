...
#include "jet/solver/grid/grid_boundary_condition_solver2.h"
#include "jet/solver/grid/grid_boundary_condition_solver3.h"

namespace py = pybind11;
using namespace jet;

void addGridBoundaryConditionSolver2(py::module& m) {
    py::class_<GridBoundaryConditionSolver2, GridBoundaryConditionSolver2Ptr>(m, "GridBoundaryConditionSolver2",
                                                                              R"pbdoc(
        ...
        .def_property_readonly("collider", &GridBoundaryConditionSolver2::collider)
        .def(
            "updateCollider",
            [](GridBoundaryConditionSolver2& instance, const Collider2Ptr& collider, py::object gridSize, py::object gridSpacing, py::object gridOrigin) {
            ...
            py::arg("collider"), py::arg("gridSize"), py::arg("gridSpacing"), py::arg("gridOrigin"))
        .def_property("closedDomainBoundaryFlag", &GridBoundaryConditionSolver2::closedDomainBoundaryFlag, &GridBoundaryConditionSolver2::setClosedDomainBoundaryFlag,
                      R"pbdoc(Closed domain boundary flag.)pbdoc");
}

void addGridBoundaryConditionSolver3(py::module& m) {
    py::class_<GridBoundaryConditionSolver3, GridBoundaryConditionSolver3Ptr>(m, "GridBoundaryConditionSolver3",
                                                                              R"pbdoc(
        ...
        .def_property_readonly("collider", &GridBoundaryConditionSolver3::collider)
        .def(
            "updateCollider",
            [](GridBoundaryConditionSolver3& instance, const Collider3Ptr& collider, py::object gridSize, py::object gridSpacing, py::object gridOrigin) {
            ...
            py::arg("collider"), py::arg("gridSize"), py::arg("gridSpacing"), py::arg("gridOrigin"))
        .def_property("closedDomainBoundaryFlag", &GridBoundaryConditionSolver3::closedDomainBoundaryFlag, &GridBoundaryConditionSolver3::setClosedDomainBoundaryFlag,
                      R"pbdoc(Closed domain boundary flag.)pbdoc");
}
