...
using namespace jet;
void
addGridBoundaryConditionSolver2(py::module& m)
{
    py::class_<GridBoundaryConditionSolver2, GridBoundaryConditionSolver2Ptr>(
        ...
        .def(
            ...
            [](GridBoundaryConditionSolver2& instance,
               const Collider2Ptr& collider,
               py::object gridSize,
               py::object gridSpacing,
               py::object gridOrigin) {
                instance.updateCollider(collider,
                                        objectToSize2(gridSize),
...
void
addGridBoundaryConditionSolver3(py::module& m)
{
    py::class_<GridBoundaryConditionSolver3, GridBoundaryConditionSolver3Ptr>(
        ...
        .def(
            ...
            [](GridBoundaryConditionSolver3& instance,
               const Collider3Ptr& collider,
               py::object gridSize,
               py::object gridSpacing,
               py::object gridOrigin) {
                instance.updateCollider(collider,
                                        objectToSize3(gridSize),
