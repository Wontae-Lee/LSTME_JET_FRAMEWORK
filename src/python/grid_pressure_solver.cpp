...
using namespace jet;
void
addGridPressureSolver2(py::module& m)
{
    py::class_<GridPressureSolver2, GridPressureSolver2Ptr>(
        m,
        "GridPressureSolver2",
        R"pbdoc(
...
void
addGridPressureSolver3(py::module& m)
{
    py::class_<GridPressureSolver3, GridPressureSolver3Ptr>(
        m,
        "GridPressureSolver3",
        R"pbdoc(
