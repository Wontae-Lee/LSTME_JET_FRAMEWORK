...
void addGridSinglePhasePressureSolver2(py::module& m) {
    py::class_<GridSinglePhasePressureSolver2, GridSinglePhasePressureSolver2Ptr, GridPressureSolver2>(m, "GridSinglePhasePressureSolver2",
                                                                                                       R"pbdoc(
        ...
        .def(py::init<>())
        .def_property("linearSystemSolver", &GridSinglePhasePressureSolver2::linearSystemSolver, &GridSinglePhasePressureSolver2::setLinearSystemSolver,
                      R"pbdoc(
...
void addGridSinglePhasePressureSolver3(py::module& m) {
    py::class_<GridSinglePhasePressureSolver3, GridSinglePhasePressureSolver3Ptr, GridPressureSolver3>(m, "GridSinglePhasePressureSolver3",
                                                                                                       R"pbdoc(
        ...
        .def(py::init<>())
        .def_property("linearSystemSolver", &GridSinglePhasePressureSolver3::linearSystemSolver, &GridSinglePhasePressureSolver3::setLinearSystemSolver,
                      R"pbdoc(
            "The linear system solver."
            )pbdoc");
}
