...
void addCollider2(py::module& m) {
    py::class_<Collider2, Collider2Ptr>(m, "Collider2", R"pbdoc(
        ...
        .def_property("frictionCoefficient", &Collider2::frictionCoefficient, &Collider2::setFrictionCoefficient, R"pbdoc(
        ...
        .def(
            "velocityAt", [](const Collider2& instance, py::object obj) { return instance.velocityAt(objectToVector2D(obj)); }, R"pbdoc(Returns the velocity of the collider at given point.)pbdoc",
            py::arg("point"));
}
...
void addCollider3(py::module& m) {
    py::class_<Collider3, Collider3Ptr>(m, "Collider3", R"pbdoc(
        ...
        .def_property("frictionCoefficient", &Collider3::frictionCoefficient, &Collider3::setFrictionCoefficient, R"pbdoc(
            The friction coefficient.
        ...
        .def(
            "velocityAt", [](const Collider3& instance, py::object obj) { return instance.velocityAt(objectToVector3D(obj)); }, R"pbdoc(Returns the velocity of the collider at given point.)pbdoc",
            py::arg("point"));
}
