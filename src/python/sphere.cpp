        ...
        .def(
            ...
            [](Sphere2& instance,
               ...
               bool isNormalFlipped) {
                new (&instance) Sphere2(objectToVector2D(center),
                                        radius,
                                        transform,
                                        isNormalFlipped);
            },
    ...
    py::class_<Sphere3, Sphere3Ptr, Surface3>(m, "Sphere3")
        ...
        .def(
            ...
            [](Sphere3& instance,
               ...
               bool isNormalFlipped) {
                new (&instance) Sphere3(objectToVector3D(center),
                                        radius,
                                        transform,
                                        isNormalFlipped);
            },
