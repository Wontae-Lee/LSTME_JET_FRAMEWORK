...
void addSphere2(pybind11::module& m) {
    py::class_<Sphere2, Sphere2Ptr, Surface2>(m, "Sphere2")
        ...
        .def(
            "__init__",
            [](Sphere2& instance, py::object center, double radius, const Transform2& transform, bool isNormalFlipped) {
            ...
            py::arg("center") = Vector2D{}, py::arg("radius") = 1.0, py::arg("transform") = Transform2(), py::arg("isNormalFlipped") = false)
...
void addSphere3(pybind11::module& m) {
    py::class_<Sphere3, Sphere3Ptr, Surface3>(m, "Sphere3")
        ...
        .def(
            "__init__",
            [](Sphere3& instance, py::object center, double radius, const Transform3& transform, bool isNormalFlipped) {
            ...
            py::arg("center") = Vector3D{}, py::arg("radius") = 1.0, py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
