...
using namespace jet;
void
addFlipSolver2(py::module& m)
{
    py::class_<FlipSolver2, FlipSolver2Ptr, PicSolver2>(m,
                                                        "FlipSolver2",
                                                        R"pbdoc(
        ...
        .def_property("picBlendingFactor",
                      &FlipSolver2::picBlendingFactor,
...
void
addFlipSolver3(py::module& m)
{
    py::class_<FlipSolver3, FlipSolver3Ptr, PicSolver3>(m,
                                                        "FlipSolver3",
                                                        R"pbdoc(
