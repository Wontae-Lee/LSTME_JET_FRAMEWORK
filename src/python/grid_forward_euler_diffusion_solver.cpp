...
void addGridForwardEulerDiffusionSolver2(py::module& m) {
    py::class_<GridForwardEulerDiffusionSolver2, GridForwardEulerDiffusionSolver2Ptr, GridDiffusionSolver2>(m, "GridForwardEulerDiffusionSolver2",
                                                                                                            R"pbdoc(
        ...
        .def(
            "solver",
            [](GridForwardEulerDiffusionSolver2& instance, Grid2Ptr source, double diffusionCoefficient, double timeIntervalInSeconds, Grid2Ptr dest, py::kwargs kwargs) {
                ...
                ScalarField2Ptr boundarySdf = ConstantScalarField2::builder().withValue(kMaxD).makeShared();
                ScalarField2Ptr fluidSdf = ConstantScalarField2::builder().withValue(-kMaxD).makeShared();
            ...
            py::arg("source"), py::arg("diffusionCoefficient"), py::arg("timeIntervalInSeconds"), py::arg("dest"));
}

void addGridForwardEulerDiffusionSolver3(py::module& m) {
    py::class_<GridForwardEulerDiffusionSolver3, GridForwardEulerDiffusionSolver3Ptr, GridDiffusionSolver3>(m, "GridForwardEulerDiffusionSolver3",
                                                                                                            R"pbdoc(
        ...
        .def(
            "solver",
            [](GridForwardEulerDiffusionSolver3& instance, Grid3Ptr source, double diffusionCoefficient, double timeIntervalInSeconds, Grid3Ptr dest, py::kwargs kwargs) {
                ...
                ScalarField3Ptr boundarySdf = ConstantScalarField3::builder().withValue(kMaxD).makeShared();
                ScalarField3Ptr fluidSdf = ConstantScalarField3::builder().withValue(-kMaxD).makeShared();
