...
using namespace jet;
void
addGridForwardEulerDiffusionSolver2(py::module& m)
{
    py::class_<GridForwardEulerDiffusionSolver2,
        ...
        .def(
            "solver",
            [](GridForwardEulerDiffusionSolver2& instance,
               Grid2Ptr source,
...
void
addGridForwardEulerDiffusionSolver3(py::module& m)
{
    py::class_<GridForwardEulerDiffusionSolver3,
        ...
        .def(
            "solver",
            [](GridForwardEulerDiffusionSolver3& instance,
               Grid3Ptr source,
               double diffusionCoefficient,
               double timeIntervalInSeconds,
               Grid3Ptr dest,
