...
using namespace jet;
void
addCollocatedVectorGrid2(py::module& m)
{
    py::class_<CollocatedVectorGrid2, CollocatedVectorGrid2Ptr, VectorGrid2>(
        ...
        .def(
            "__setitem__",
            [](CollocatedVectorGrid2& instance,
               py::object obj,
               const Vector2D& val) {
                if (py::isinstance<py::tuple>(obj)) {
                    auto tidx = obj.cast<py::tuple>();
        ...
        .def("dataPosition",
             &CollocatedVectorGrid2::dataPosition,
...
void
addCollocatedVectorGrid3(py::module& m)
{
    py::class_<CollocatedVectorGrid3, CollocatedVectorGrid3Ptr, VectorGrid3>(
        ...
        .def(
            "__setitem__",
            [](CollocatedVectorGrid3& instance,
               py::object obj,
               const Vector3D& val) {
                if (py::isinstance<py::tuple>(obj)) {
                    auto tidx = obj.cast<py::tuple>();
        ...
        .def("dataAccessor",
             ...
             R"pbdoc(The data array accessor.)pbdoc")
        .def("dataPosition",
             &CollocatedVectorGrid3::dataPosition,
             R"pbdoc(The function that maps data point to its position.)pbdoc")
        .def(
            "forEachDataPointIndex",
