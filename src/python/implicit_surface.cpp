...
void addImplicitSurface2(py::module& m) {
    py::class_<ImplicitSurface2, ImplicitSurface2Ptr, Surface2>(m, "ImplicitSurface2",
        ...
        .def(
            "signedDistance", [](const ImplicitSurface2& instance, py::object otherPoint) { return instance.signedDistance(objectToVector2D(otherPoint)); },
            R"pbdoc(
...
void addImplicitSurface3(py::module& m) {
    py::class_<ImplicitSurface3, ImplicitSurface3Ptr, Surface3>(m, "ImplicitSurface3",
        ...
        .def(
            "signedDistance", [](const ImplicitSurface3& instance, py::object otherPoint) { return instance.signedDistance(objectToVector3D(otherPoint)); },
            R"pbdoc(
             Returns signed distance from the given point otherPoint.
             )pbdoc",
            py::arg("otherPoint"));
