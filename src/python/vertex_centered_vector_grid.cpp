...
void addVertexCenteredVectorGrid2(py::module& m) {
    py::class_<VertexCenteredVectorGrid2, VertexCenteredVectorGrid2Ptr, CollocatedVectorGrid2>(m, "VertexCenteredVectorGrid2",
                                                                                               R"pbdoc(
        ...
        .def(
            "__init__",
            [](VertexCenteredVectorGrid2& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &VertexCenteredVectorGrid2::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
        .def_property_readonly("dataOrigin", &VertexCenteredVectorGrid2::dataOrigin,
                               R"pbdoc(
...
void addVertexCenteredVectorGrid3(py::module& m) {
    py::class_<VertexCenteredVectorGrid3, VertexCenteredVectorGrid3Ptr, CollocatedVectorGrid3>(m, "VertexCenteredVectorGrid3",
                                                                                               R"pbdoc(
        ...
        .def(
            "__init__",
            [](VertexCenteredVectorGrid3& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &VertexCenteredVectorGrid3::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
        .def_property_readonly("dataOrigin", &VertexCenteredVectorGrid3::dataOrigin,
                               R"pbdoc(
