...
using namespace jet;
void
addVertexCenteredVectorGrid2(py::module& m)
{
    py::class_<VertexCenteredVectorGrid2,
               VertexCenteredVectorGrid2Ptr,
               CollocatedVectorGrid2>(m,
        ...
        .def(
            "__init__",
            [](VertexCenteredVectorGrid2& instance,
               py::args args,
               py::kwargs kwargs) {
...
void
addVertexCenteredVectorGrid3(py::module& m)
{
    py::class_<VertexCenteredVectorGrid3,
               VertexCenteredVectorGrid3Ptr,
               CollocatedVectorGrid3>(m,
        ...
        .def(
            "__init__",
            [](VertexCenteredVectorGrid3& instance,
               py::args args,
               py::kwargs kwargs) {
