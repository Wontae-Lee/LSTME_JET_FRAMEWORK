...
using namespace jet;
void
addFdmGaussSeidelSolver2(py::module& m)
{
    py::class_<FdmGaussSeidelSolver2,
               FdmGaussSeidelSolver2Ptr,
               FdmLinearSystemSolver2>(m,
        ...
        .def(py::init<uint32_t, uint32_t, double, double, bool>(),
             py::arg("maxNumberOfIterations"),
             py::arg("residualCheckInterval"),
             py::arg("tolerance"),
             py::arg("sorFactor") = 1.0,
        ...
        .def_property_readonly("tolerance",
                               &FdmGaussSeidelSolver2::tolerance,
                               R"pbdoc(
        ...
        .def_property_readonly("sorFactor",
                               &FdmGaussSeidelSolver2::sorFactor,
                               R"pbdoc(
...
void
addFdmGaussSeidelSolver3(py::module& m)
{
    py::class_<FdmGaussSeidelSolver3,
               FdmGaussSeidelSolver3Ptr,
               FdmLinearSystemSolver3>(m,
        ...
        .def_property_readonly("tolerance",
                               &FdmGaussSeidelSolver3::tolerance,
                               R"pbdoc(
            The max residual tolerance for the CG method.
            )pbdoc")
        .def_property_readonly("lastResidual",
        ...
        .def_property_readonly("sorFactor",
                               &FdmGaussSeidelSolver3::sorFactor,
                               R"pbdoc(
            Returns the SOR (Successive Over Relaxation) factor.
            )pbdoc")
        .def_property_readonly("useRedBlackOrdering",
