...
using namespace jet;
void
addParticleSystemSolver2(py::module& m)
{
    py::class_<ParticleSystemSolver2,
        ...
        .def_property("collider",
                      &ParticleSystemSolver2::collider,
                      &ParticleSystemSolver2::setCollider,
                      R"pbdoc(
             The collider.
             )pbdoc")
        .def_property("emitter",
                      &ParticleSystemSolver2::emitter,
                      &ParticleSystemSolver2::setEmitter,
                      R"pbdoc(
             The emitter.
             )pbdoc")
        .def_property("wind",
                      &ParticleSystemSolver2::wind,
...
void
addParticleSystemSolver3(py::module& m)
{
    py::class_<ParticleSystemSolver3,
        ...
        .def_property("collider",
                      &ParticleSystemSolver3::collider,
                      &ParticleSystemSolver3::setCollider,
                      R"pbdoc(
             The collider.
             )pbdoc")
        .def_property("emitter",
                      &ParticleSystemSolver3::emitter,
                      &ParticleSystemSolver3::setEmitter,
                      R"pbdoc(
             The emitter.
             )pbdoc")
        .def_property("wind",
                      &ParticleSystemSolver3::wind,
