...
void addFdmIccgSolver2(py::module& m) {
    py::class_<FdmIccgSolver2, FdmIccgSolver2Ptr, FdmLinearSystemSolver2>(m, "FdmIccgSolver2",
                                                                          R"pbdoc(
        ...
        .def_property_readonly("maxNumberOfIterations", &FdmIccgSolver2::maxNumberOfIterations,
                               R"pbdoc(
            Max number of ICCG iterations.
            )pbdoc")
        .def_property_readonly("lastNumberOfIterations", &FdmIccgSolver2::lastNumberOfIterations,
                               R"pbdoc(
...
void addFdmIccgSolver3(py::module& m) {
    py::class_<FdmIccgSolver3, FdmIccgSolver3Ptr, FdmLinearSystemSolver3>(m, "FdmIccgSolver3",
                                                                          R"pbdoc(
        3-D finite difference-type linear system solver using conjugate gradient.
        )pbdoc")
        .def(py::init<uint32_t, double>(), py::arg("maxNumberOfIterations"), py::arg("tolerance"))
        .def_property_readonly("maxNumberOfIterations", &FdmIccgSolver3::maxNumberOfIterations,
                               R"pbdoc(
            Max number of ICCG iterations.
            )pbdoc")
        .def_property_readonly("lastNumberOfIterations", &FdmIccgSolver3::lastNumberOfIterations,
                               R"pbdoc(
            The last number of ICCG iterations the solver made.
            )pbdoc")
