...
addFdmIccgSolver3(py::module& m)
{
    py::class_<FdmIccgSolver3, FdmIccgSolver3Ptr, FdmLinearSystemSolver3>(
        ...
        .def_property_readonly("tolerance",
                               &FdmIccgSolver3::tolerance,
                               R"pbdoc(
            The max residual tolerance for the ICCG method.
            )pbdoc")
        .def_property_readonly("lastResidual",
                               &FdmIccgSolver3::lastResidual,
                               R"pbdoc(
            The last residual after the ICCG iterations.
            )pbdoc");
}
