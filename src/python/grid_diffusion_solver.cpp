...
using namespace jet;
void
addGridDiffusionSolver2(py::module& m)
{
    py::class_<GridDiffusionSolver2, GridDiffusionSolver2Ptr>(
        m,
...
void
addGridDiffusionSolver3(py::module& m)
{
    py::class_<GridDiffusionSolver3, GridDiffusionSolver3Ptr>(
        m,
