...
void addIterativeLevelSetSolver2(py::module& m) {
    py::class_<IterativeLevelSetSolver2, IterativeLevelSetSolver2Ptr, LevelSetSolver2>(m, "IterativeLevelSetSolver2",
                                                                                       R"pbdoc(
        ...
        .def(
            "reinitialize",
            [](IterativeLevelSetSolver2& instance, const ScalarGrid2Ptr& inputSdf, double maxDistance, ScalarGrid2Ptr outputSdf) { instance.reinitialize(*inputSdf, maxDistance, outputSdf.get()); },
            R"pbdoc(
        ...
        .def(
            "extrapolate",
            [](IterativeLevelSetSolver2& instance, const Grid2Ptr& input, const ScalarGrid2Ptr& sdf, double maxDistance, Grid2Ptr output) {
            ...
            py::arg("input"), py::arg("sdf"), py::arg("maxDistance"), py::arg("output"))
        .def_property("maxCfl", &IterativeLevelSetSolver2::maxCfl, &IterativeLevelSetSolver2::setMaxCfl, R"pbdoc(The maximum CFL limit.)pbdoc");
}

void addIterativeLevelSetSolver3(py::module& m) {
    py::class_<IterativeLevelSetSolver3, IterativeLevelSetSolver3Ptr, LevelSetSolver3>(m, "IterativeLevelSetSolver3",
                                                                                       R"pbdoc(
        ...
        .def(
            "reinitialize",
            [](IterativeLevelSetSolver3& instance, const ScalarGrid3Ptr& inputSdf, double maxDistance, ScalarGrid3Ptr outputSdf) { instance.reinitialize(*inputSdf, maxDistance, outputSdf.get()); },
            R"pbdoc(
             Reinitializes given scalar field to signed-distance field.
        ...
        .def(
            "extrapolate",
            [](IterativeLevelSetSolver3& instance, const Grid3Ptr& input, const ScalarGrid3Ptr& sdf, double maxDistance, Grid3Ptr output) {
            ...
            py::arg("input"), py::arg("sdf"), py::arg("maxDistance"), py::arg("output"))
        .def_property("maxCfl", &IterativeLevelSetSolver3::maxCfl, &IterativeLevelSetSolver3::setMaxCfl, R"pbdoc(The maximum CFL limit.)pbdoc");
}
