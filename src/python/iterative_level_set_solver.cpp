...
using namespace jet;
void
addIterativeLevelSetSolver2(py::module& m)
{
    py::class_<IterativeLevelSetSolver2,
        ...
        .def(
            "extrapolate",
            [](IterativeLevelSetSolver2& instance,
               const Grid2Ptr& input,
               const ScalarGrid2Ptr& sdf,
               double maxDistance,
               Grid2Ptr output) {
                ...
                if (inputSG != nullptr && outputSG != nullptr) {
                    instance.extrapolate(
                        *inputSG, *sdf, maxDistance, outputSG.get());
                } else if (inputCG != nullptr && outputCG != nullptr) {
                    instance.extrapolate(
                        *inputCG, *sdf, maxDistance, outputCG.get());
                } else if (inputFG != nullptr && outputFG != nullptr) {
                    instance.extrapolate(
                        *inputFG, *sdf, maxDistance, outputFG.get());
                } else {
            ...
            py::arg("output"))
        .def_property("maxCfl",
                      &IterativeLevelSetSolver2::maxCfl,
                      &IterativeLevelSetSolver2::setMaxCfl,
                      R"pbdoc(The maximum CFL limit.)pbdoc");
}
void
addIterativeLevelSetSolver3(py::module& m)
{
    py::class_<IterativeLevelSetSolver3,
        ...
        .def(
            ...
            py::arg("output"))
        .def_property("maxCfl",
                      &IterativeLevelSetSolver3::maxCfl,
