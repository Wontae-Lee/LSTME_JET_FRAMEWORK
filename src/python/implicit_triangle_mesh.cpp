...
void addImplicitTriangleMesh3(pybind11::module& m) {
    py::class_<ImplicitTriangleMesh3, ImplicitTriangleMesh3Ptr, ImplicitSurface3>(m, "ImplicitTriangleMesh3",
                                                                                  R"pbdoc(
        ...
        .def(py::init<TriangleMesh3Ptr, size_t, double, Transform3, bool>(),
             ...
             py::arg("mesh"), py::arg("resolutionX") = 32, py::arg("margin") = 0.2, py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
        .def_property_readonly("grid", &ImplicitTriangleMesh3::grid, R"pbdoc(The grid data.)pbdoc");
}
