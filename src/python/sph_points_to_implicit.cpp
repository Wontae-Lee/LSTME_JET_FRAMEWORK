...
#include "jet/solver/sph/sph_points_to_implicit2.h"
#include "jet/solver/sph/sph_points_to_implicit3.h"

namespace py = pybind11;
using namespace jet;

void addSphPointsToImplicit2(pybind11::module& m) {
    py::class_<SphPointsToImplicit2, PointsToImplicit2, SphPointsToImplicit2Ptr>(m, "SphPointsToImplicit2",
                                                                                 R"pbdoc(
        ...
        .def(py::init<double, double, bool>(),
             ...
             py::arg("kernelRadius") = 1.0, py::arg("cutOffDensity") = 0.5, py::arg("isOutputSdf") = true);
}

void addSphPointsToImplicit3(pybind11::module& m) {
    py::class_<SphPointsToImplicit3, PointsToImplicit3, SphPointsToImplicit3Ptr>(m, "SphPointsToImplicit3",
                                                                                 R"pbdoc(
