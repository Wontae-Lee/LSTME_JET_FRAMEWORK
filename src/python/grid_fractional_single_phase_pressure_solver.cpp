...
void addGridFractionalSinglePhasePressureSolver2(py::module& m) {
    py::class_<GridFractionalSinglePhasePressureSolver2, GridFractionalSinglePhasePressureSolver2Ptr, GridPressureSolver2>(m, "GridFractionalSinglePhasePressureSolver2",
                                                                                                                           R"pbdoc(
        ...
        .def(py::init<>())
        .def_property("linearSystemSolver", &GridFractionalSinglePhasePressureSolver2::linearSystemSolver, &GridFractionalSinglePhasePressureSolver2::setLinearSystemSolver,
                      R"pbdoc(
...
void addGridFractionalSinglePhasePressureSolver3(py::module& m) {
    py::class_<GridFractionalSinglePhasePressureSolver3, GridFractionalSinglePhasePressureSolver3Ptr, GridPressureSolver3>(m, "GridFractionalSinglePhasePressureSolver3",
                                                                                                                           R"pbdoc(
        ...
        .def(py::init<>())
        .def_property("linearSystemSolver", &GridFractionalSinglePhasePressureSolver3::linearSystemSolver, &GridFractionalSinglePhasePressureSolver3::setLinearSystemSolver,
                      R"pbdoc(
            "The linear system solver."
            )pbdoc");
}
