...
using namespace jet;
void
addGridSmokeSolver2(py::module& m)
{
    py::class_<GridSmokeSolver2, GridSmokeSolver2Ptr, GridFluidSolver2>(
        ...
        .def_property("smokeDecayFactor",
                      &GridSmokeSolver2::smokeDecayFactor,
...
addGridSmokeSolver3(py::module& m)
{
    py::class_<GridSmokeSolver3, GridSmokeSolver3Ptr, GridFluidSolver3>(
        ...
        .def_property("smokeDecayFactor",
                      &GridSmokeSolver3::smokeDecayFactor,
        ...
        .def_property_readonly("smokeDensity",
                               &GridSmokeSolver3::smokeDensity,
                               R"pbdoc(Returns smoke density field.)pbdoc")
        .def_property_readonly("temperature",
                               &GridSmokeSolver3::temperature,
                               R"pbdoc(Returns temperature field.)pbdoc");
}
