...
void addPicSolver2(py::module& m) {
    py::class_<PicSolver2, PicSolver2Ptr, GridFluidSolver2>(m, "PicSolver2")
        ...
        .def_property_readonly("particleSystemData", &PicSolver2::particleSystemData, R"pbdoc(Returns particleSystemData.)pbdoc")
        .def_property("particleEmitter", &PicSolver2::particleEmitter, &PicSolver2::setParticleEmitter, R"pbdoc(Particle emitter property.)pbdoc");
}
...
void addPicSolver3(py::module& m) {
    py::class_<PicSolver3, PicSolver3Ptr, GridFluidSolver3>(m, "PicSolver3")
        ...
        .def_property_readonly("particleSystemData", &PicSolver3::particleSystemData, R"pbdoc(Returns particleSystemData.)pbdoc")
        .def_property("particleEmitter", &PicSolver3::particleEmitter, &PicSolver3::setParticleEmitter, R"pbdoc(Particle emitter property.)pbdoc");
}
