...
void addBox2(pybind11::module& m) {
    py::class_<Box2, Box2Ptr, Surface2>(m, "Box2", R"pbdoc(
        ...
        .def(
            "__init__",
            [](Box2& instance, py::object lowerCorner, py::object upperCorner, const Transform2& transform, bool isNormalFlipped) {
            ...
            py::arg("lowerCorner") = Vector2D(0, 0), py::arg("upperCorner") = Vector2D(1, 1), py::arg("transform") = Transform2(), py::arg("isNormalFlipped") = false)
...
void addBox3(pybind11::module& m) {
    py::class_<Box3, Box3Ptr, Surface3>(m, "Box3", R"pbdoc(
        ...
        .def(
            "__init__",
            [](Box3& instance, py::object lowerCorner, py::object upperCorner, const Transform3& transform, bool isNormalFlipped) {
            ...
            py::arg("lowerCorner") = Vector3D(0, 0, 0), py::arg("upperCorner") = Vector3D(1, 1, 1), py::arg("transform") = Transform3(), py::arg("isNormalFlipped") = false)
