...
void addSphSolver2(py::module& m) {
    py::class_<SphSolver2, SphSolver2Ptr, ParticleSystemSolver2>(m, "SphSolver2",
                                                                 R"pbdoc(
        2-D SPH solver.
        ...
        .def(py::init<double, double, double>(),
             ...
             py::arg("targetDensity") = kWaterDensity, py::arg("targetSpacing") = 0.1, py::arg("relativeKernelRadius") = 1.8)
        .def_property("eosExponent", &SphSolver2::eosExponent, &SphSolver2::setEosExponent,
                      R"pbdoc(
        ...
        .def_property("negativePressureScale", &SphSolver2::negativePressureScale, &SphSolver2::setNegativePressureScale,
                      R"pbdoc(
        ...
        .def_property("viscosityCoefficient", &SphSolver2::viscosityCoefficient, &SphSolver2::setViscosityCoefficient,
                      R"pbdoc(
             The viscosity coefficient.
             )pbdoc")
        .def_property("pseudoViscosityCoefficient", &SphSolver2::pseudoViscosityCoefficient, &SphSolver2::setPseudoViscosityCoefficient,
                      R"pbdoc(
        ...
        .def_property("speedOfSound", &SphSolver2::speedOfSound, &SphSolver2::setSpeedOfSound,
                      R"pbdoc(
             The speed of sound.
        ...
        .def_property("timeStepLimitScale", &SphSolver2::timeStepLimitScale, &SphSolver2::setTimeStepLimitScale,
                      R"pbdoc(
...
void addSphSolver3(py::module& m) {
    py::class_<SphSolver3, SphSolver3Ptr, ParticleSystemSolver3>(m, "SphSolver3",
                                                                 R"pbdoc(
        3-D SPH solver.
        ...
        .def(py::init<double, double, double>(),
             ...
             py::arg("targetDensity") = kWaterDensity, py::arg("targetSpacing") = 0.1, py::arg("relativeKernelRadius") = 1.8)
        .def_property("eosExponent", &SphSolver3::eosExponent, &SphSolver3::setEosExponent,
                      R"pbdoc(
             The exponent part of the equation-of-state.
        ...
        .def_property("negativePressureScale", &SphSolver3::negativePressureScale, &SphSolver3::setNegativePressureScale,
                      R"pbdoc(
             The negative pressure scale.
        ...
        .def_property("viscosityCoefficient", &SphSolver3::viscosityCoefficient, &SphSolver3::setViscosityCoefficient,
                      R"pbdoc(
             The viscosity coefficient.
             )pbdoc")
        .def_property("pseudoViscosityCoefficient", &SphSolver3::pseudoViscosityCoefficient, &SphSolver3::setPseudoViscosityCoefficient,
                      R"pbdoc(
             The pseudo viscosity coefficient.
        ...
        .def_property("speedOfSound", &SphSolver3::speedOfSound, &SphSolver3::setSpeedOfSound,
                      R"pbdoc(
             The speed of sound.
        ...
        .def_property("timeStepLimitScale", &SphSolver3::timeStepLimitScale, &SphSolver3::setTimeStepLimitScale,
                      R"pbdoc(
             Multiplier that scales the max allowed time-step.
