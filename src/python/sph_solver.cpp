...
addSphSolver2(py::module& m)
{
    py::class_<SphSolver2, SphSolver2Ptr, ParticleSystemSolver2>(m,
        ...
        .def_property("eosExponent",
                      &SphSolver2::eosExponent,
        ...
        .def_property("viscosityCoefficient",
                      &SphSolver2::viscosityCoefficient,
        ...
        .def_property("speedOfSound",
                      &SphSolver2::speedOfSound,
        ...
        .def_property("timeStepLimitScale",
                      &SphSolver2::timeStepLimitScale,
        ...
        .def_property_readonly("sphSystemData",
                               &SphSolver2::sphSystemData,
                               R"pbdoc(
             The SPH system data.
             )pbdoc");
}
void
addSphSolver3(py::module& m)
{
    py::class_<SphSolver3, SphSolver3Ptr, ParticleSystemSolver3>(m,
        ...
        .def_property("viscosityCoefficient",
                      &SphSolver3::viscosityCoefficient,
