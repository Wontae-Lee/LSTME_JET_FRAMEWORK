...
using namespace jet;
void
addSphericalPointsToImplicit2(pybind11::module& m)
{
    py::class_<SphericalPointsToImplicit2,
               PointsToImplicit2,
               SphericalPointsToImplicit2Ptr>(m,
...
void
addSphericalPointsToImplicit3(pybind11::module& m)
{
    py::class_<SphericalPointsToImplicit3,
               PointsToImplicit3,
               SphericalPointsToImplicit3Ptr>(m,
