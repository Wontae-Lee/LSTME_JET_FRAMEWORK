...
void addSphericalPointsToImplicit2(pybind11::module& m) {
    py::class_<SphericalPointsToImplicit2, PointsToImplicit2, SphericalPointsToImplicit2Ptr>(m, "SphericalPointsToImplicit2",
                                                                                             R"pbdoc(
...
void addSphericalPointsToImplicit3(pybind11::module& m) {
    py::class_<SphericalPointsToImplicit3, PointsToImplicit3, SphericalPointsToImplicit3Ptr>(m, "SphericalPointsToImplicit3",
                                                                                             R"pbdoc(
