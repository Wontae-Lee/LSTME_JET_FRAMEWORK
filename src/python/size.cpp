...
void addSize2(pybind11::module& m) {
    py::class_<Size2>(m, "Size2")
        // CTOR
        .def(
            "__init__", [](Size2& instance, size_t x, size_t y) { new (&instance) Size2(x, y); },
            R"pbdoc(
             Constructs Size2
        ...
        .def("__iter__", [](const Size2& instance) { return py::make_iterator(&instance.x, &instance.y + 1); })
...
void addSize3(pybind11::module& m) {
    py::class_<Size3>(m, "Size3")
        // CTOR
        .def(
            "__init__", [](Size3& instance, size_t x, size_t y, size_t z) { new (&instance) Size3(x, y, z); },
            R"pbdoc(
             Constructs Size3
        ...
        .def("__iter__", [](const Size3& instance) { return py::make_iterator(&instance.x, &instance.z + 1); })
