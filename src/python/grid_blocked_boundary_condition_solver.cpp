...
void addGridBlockedBoundaryConditionSolver2(py::module& m) {
    py::class_<GridBlockedBoundaryConditionSolver2, GridBlockedBoundaryConditionSolver2Ptr, GridBoundaryConditionSolver2>(m, "GridBlockedBoundaryConditionSolver2",
                                                                                                                          R"pbdoc(
        ...
        .def(
            "constrainVelocity",
            [](GridBlockedBoundaryConditionSolver2& instance, FaceCenteredGrid2Ptr velocity, unsigned int extrapolationDepth) { instance.constrainVelocity(velocity.get(), extrapolationDepth); },
            R"pbdoc(
...
void addGridBlockedBoundaryConditionSolver3(py::module& m) {
    py::class_<GridBlockedBoundaryConditionSolver3, GridBlockedBoundaryConditionSolver3Ptr, GridBoundaryConditionSolver3>(m, "GridBlockedBoundaryConditionSolver3",
                                                                                                                          R"pbdoc(
        ...
        .def(
            "constrainVelocity",
            [](GridBlockedBoundaryConditionSolver3& instance, FaceCenteredGrid3Ptr velocity, unsigned int extrapolationDepth) { instance.constrainVelocity(velocity.get(), extrapolationDepth); },
            R"pbdoc(
             Constrains the velocity field to conform the collider boundary.
