...
void addParticleEmitterSet2(py::module& m) {
    py::class_<ParticleEmitterSet2, ParticleEmitterSet2Ptr, ParticleEmitter2>(m, "ParticleEmitterSet2",
                                                                              R"pbdoc(
...
void addParticleEmitterSet3(py::module& m) {
    py::class_<ParticleEmitterSet3, ParticleEmitterSet3Ptr, ParticleEmitter3>(m, "ParticleEmitterSet3",
                                                                              R"pbdoc(
