...
void addGridFractionalBoundaryConditionSolver2(py::module& m) {
    py::class_<GridFractionalBoundaryConditionSolver2, GridFractionalBoundaryConditionSolver2Ptr, GridBoundaryConditionSolver2>(m, "GridFractionalBoundaryConditionSolver2",
                                                                                                                                R"pbdoc(
        ...
        .def(
            "constrainVelocity",
            [](GridFractionalBoundaryConditionSolver2& instance, FaceCenteredGrid2Ptr velocity, unsigned int extrapolationDepth) { instance.constrainVelocity(velocity.get(), extrapolationDepth); },
            R"pbdoc(
        ...
        .def_property_readonly("colliderSdf", &GridFractionalBoundaryConditionSolver2::collider,
                               R"pbdoc(
...
void addGridFractionalBoundaryConditionSolver3(py::module& m) {
    py::class_<GridFractionalBoundaryConditionSolver3, GridFractionalBoundaryConditionSolver3Ptr, GridBoundaryConditionSolver3>(m, "GridFractionalBoundaryConditionSolver3",
                                                                                                                                R"pbdoc(
        ...
        .def(
            "constrainVelocity",
            [](GridFractionalBoundaryConditionSolver3& instance, FaceCenteredGrid3Ptr velocity, unsigned int extrapolationDepth) { instance.constrainVelocity(velocity.get(), extrapolationDepth); },
            R"pbdoc(
             Constrains the velocity field to conform the collider boundary.
            ...
            py::arg("velocity"), py::arg("extrapolationDepth") = 5)
        .def_property_readonly("colliderSdf", &GridFractionalBoundaryConditionSolver3::collider,
                               R"pbdoc(
            Signed distance field of the collider.
            )pbdoc")
