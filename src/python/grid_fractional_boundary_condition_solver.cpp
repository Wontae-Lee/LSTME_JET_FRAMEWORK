...
using namespace jet;
void
addGridFractionalBoundaryConditionSolver2(py::module& m)
{
    py::class_<GridFractionalBoundaryConditionSolver2,
        ...
        .def(
            ...
            py::arg("velocity"),
            py::arg("extrapolationDepth") = 5)
        .def_property_readonly(
            "colliderSdf",
            &GridFractionalBoundaryConditionSolver2::collider,
            R"pbdoc(
...
void
addGridFractionalBoundaryConditionSolver3(py::module& m)
{
    py::class_<GridFractionalBoundaryConditionSolver3,
        ...
        .def_property_readonly(
            "colliderSdf",
            &GridFractionalBoundaryConditionSolver3::collider,
            R"pbdoc(
            Signed distance field of the collider.
            )pbdoc")
        .def_property_readonly(
