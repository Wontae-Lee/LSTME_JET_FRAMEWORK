...
using namespace jet;
void
addPointParticleEmitter2(py::module& m)
{
    py::class_<PointParticleEmitter2, PointParticleEmitter2Ptr>(
        ...
        .def(
            "__init__",
            [](PointParticleEmitter2& instance,
               py::object origin,
               py::object direction,
               double speed,
               ...
               uint32_t seed) {
                new (&instance)
                    PointParticleEmitter2(objectToVector2D(origin),
                                          objectToVector2D(direction),
                                          speed,
                                          spreadAngleInDegrees,
                                          maxNumOfNewParticlesPerSec,
                                          maxNumOfParticles,
                                          seed);
            },
            R"pbdoc(
...
void
addPointParticleEmitter3(py::module& m)
{
    py::class_<PointParticleEmitter3, PointParticleEmitter3Ptr>(
        ...
        .def(
            "__init__",
            [](PointParticleEmitter3& instance,
               py::object origin,
               py::object direction,
               double speed,
               double spreadAngleInDegrees,
               ...
               uint32_t seed) {
                new (&instance)
                    PointParticleEmitter3(objectToVector3D(origin),
