...
void addBoundingBox2F(pybind11::module& m) {
    py::class_<BoundingBoxRayIntersection2F>(m, "BoundingBoxRayIntersection2F",
        ...
        .def_readwrite("isIntersecting", &BoundingBoxRayIntersection2F::isIntersecting, R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear", &BoundingBoxRayIntersection2F::tNear, R"pbdoc(Distance to the first intersection point.)pbdoc")
    ...
    py::class_<BoundingBox2F>(m, "BoundingBox2F", R"pbdoc(
        ...
        .def_property_readonly("height", &BoundingBox2F::height, R"pbdoc(Height of the box.)pbdoc")
        ...
        .def("overlaps", &BoundingBox2F::overlaps, R"pbdoc(
             ...
             py::arg("other"))
        .def(
            "contains", [](const BoundingBox2F& instance, py::object point) { return instance.contains(objectToVector2F(point)); },
            R"pbdoc(
        ...
        .def(
            ...
            [](BoundingBox2F& instance, py::object other) {
                if (py::isinstance<py::tuple>(other) || py::isinstance<Vector2F>(other)) {
...
void addBoundingBox2D(pybind11::module& m) {
    py::class_<BoundingBoxRayIntersection2D>(m, "BoundingBoxRayIntersection2D",
        ...
        .def_readwrite("isIntersecting", &BoundingBoxRayIntersection2D::isIntersecting, R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear", &BoundingBoxRayIntersection2D::tNear, R"pbdoc(Distance to the first intersection point.)pbdoc")
    ...
    py::class_<BoundingBox2D>(m, "BoundingBox2D", R"pbdoc(
        ...
        .def_property_readonly("width", &BoundingBox2D::width, R"pbdoc(
             Width of the box.)pbdoc")
        .def_property_readonly("height", &BoundingBox2D::height, R"pbdoc(Height of the box.)pbdoc")
        ...
        .def("overlaps", &BoundingBox2D::overlaps, R"pbdoc(
             ...
             py::arg("other"))
        .def(
            "contains", [](const BoundingBox2D& instance, py::object point) { return instance.contains(objectToVector2D(point)); },
            R"pbdoc(
             Returns true if the input vector is inside of this box.
        ...
        .def(
            ...
            [](BoundingBox2D& instance, py::object other) {
                if (py::isinstance<py::tuple>(other) || py::isinstance<Vector2D>(other)) {
...
void addBoundingBox3F(pybind11::module& m) {
    py::class_<BoundingBoxRayIntersection3F>(m, "BoundingBoxRayIntersection3F",
        ...
        .def_readwrite("isIntersecting", &BoundingBoxRayIntersection3F::isIntersecting, R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear", &BoundingBoxRayIntersection3F::tNear, R"pbdoc(Distance to the first intersection point.)pbdoc")
    ...
    py::class_<BoundingBox3F>(m, "BoundingBox3F", R"pbdoc(
        ...
        .def_property_readonly("width", &BoundingBox3F::width, R"pbdoc(
             Width of the box.)pbdoc")
        .def_property_readonly("height", &BoundingBox3F::height, R"pbdoc(Height of the box.)pbdoc")
        ...
        .def("overlaps", &BoundingBox3F::overlaps, R"pbdoc(
             ...
             py::arg("other"))
        .def(
            "contains", [](const BoundingBox3F& instance, py::object point) { return instance.contains(objectToVector3F(point)); },
            R"pbdoc(
             Returns true if the input vector is inside of this box.
        ...
        .def(
            ...
            [](BoundingBox3F& instance, py::object other) {
                if (py::isinstance<py::tuple>(other) || py::isinstance<Vector3F>(other)) {
...
void addBoundingBox3D(pybind11::module& m) {
    py::class_<BoundingBoxRayIntersection3D>(m, "BoundingBoxRayIntersection3D",
        ...
        .def_readwrite("isIntersecting", &BoundingBoxRayIntersection3D::isIntersecting, R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear", &BoundingBoxRayIntersection3D::tNear, R"pbdoc(Distance to the first intersection point.)pbdoc")
    ...
    py::class_<BoundingBox3D>(m, "BoundingBox3D", R"pbdoc(
        ...
        .def_property_readonly("width", &BoundingBox3D::width, R"pbdoc(
             Width of the box.)pbdoc")
        .def_property_readonly("height", &BoundingBox3D::height, R"pbdoc(Height of the box.)pbdoc")
        ...
        .def("overlaps", &BoundingBox3D::overlaps, R"pbdoc(
             ...
             py::arg("other"))
        .def(
            "contains", [](const BoundingBox3D& instance, py::object point) { return instance.contains(objectToVector3D(point)); },
            R"pbdoc(
             Returns true if the input vector is inside of this box.
        ...
        .def(
            ...
            [](BoundingBox3D& instance, py::object other) {
                if (py::isinstance<py::tuple>(other) || py::isinstance<Vector3D>(other)) {
