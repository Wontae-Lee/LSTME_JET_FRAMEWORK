...
{
    py::class_<BoundingBoxRayIntersection2F>(m,
        ...
        .def_readwrite("tNear",
                       &BoundingBoxRayIntersection2F::tNear,
                       R"pbdoc(Distance to the first intersection point.)pbdoc")
        .def_readwrite("tFar",
                       &BoundingBoxRayIntersection2F::tFar,
                       R"pbdoc(
    ...
    py::class_<BoundingBox2F>(m, "BoundingBox2F", R"pbdoc(
        ...
        .def_property_readonly(
            "height", &BoundingBox2F::height, R"pbdoc(Height of the box.)pbdoc")
        .def("length",
             &BoundingBox2F::length,
             R"pbdoc(
        ...
        .def("closestIntersection",
             &BoundingBox2F::closestIntersection,
             R"pbdoc(
        ...
        .def("diagonalLengthSquared",
             &BoundingBox2F::diagonalLengthSquared,
             R"pbdoc(
...
{
    py::class_<BoundingBoxRayIntersection2D>(m,
        ...
        .def_readwrite("isIntersecting",
                       ...
                       R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear",
                       &BoundingBoxRayIntersection2D::tNear,
                       R"pbdoc(Distance to the first intersection point.)pbdoc")
        .def_readwrite("tFar",
                       &BoundingBoxRayIntersection2D::tFar,
                       R"pbdoc(
                       Distance to the second (and the last) intersection point.
                       )pbdoc");
    py::class_<BoundingBox2D>(m, "BoundingBox2D", R"pbdoc(
        ...
        .def_property_readonly("width", &BoundingBox2D::width, R"pbdoc(
             Width of the box.)pbdoc")
        .def_property_readonly(
            "height", &BoundingBox2D::height, R"pbdoc(Height of the box.)pbdoc")
        .def("length",
             &BoundingBox2D::length,
             R"pbdoc(
             Returns length of the box in given axis.
             Parameters
             ----------
        ...
        .def("intersects",
             ...
             py::arg("ray"))
        .def("closestIntersection",
             &BoundingBox2D::closestIntersection,
             R"pbdoc(
             Returns closest intersection for given ray.
             Returns intersection.isIntersecting = true if the input ray is
             intersecting with this box. If interesects, intersection.tNear is
        ...
        .def("diagonalLength", &BoundingBox2D::diagonalLength, R"pbdoc(
             Returns diagonal length of this box.)pbdoc")
        .def("diagonalLengthSquared",
             &BoundingBox2D::diagonalLengthSquared,
             R"pbdoc(
             Returns squared diagonal length of this box.
             )pbdoc")
...
{
    py::class_<BoundingBoxRayIntersection3F>(m,
        ...
        .def_readwrite("isIntersecting",
                       ...
                       R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear",
                       &BoundingBoxRayIntersection3F::tNear,
                       R"pbdoc(Distance to the first intersection point.)pbdoc")
        .def_readwrite("tFar",
                       &BoundingBoxRayIntersection3F::tFar,
                       R"pbdoc(
                       Distance to the second (and the last) intersection point.
                       )pbdoc");
    py::class_<BoundingBox3F>(m, "BoundingBox3F", R"pbdoc(
        ...
        .def_property_readonly("width", &BoundingBox3F::width, R"pbdoc(
             Width of the box.)pbdoc")
        .def_property_readonly(
            "height", &BoundingBox3F::height, R"pbdoc(Height of the box.)pbdoc")
        .def_property_readonly("depth", &BoundingBox3F::depth, R"pbdoc(
             Depth of the box.)pbdoc")
        .def("length",
             &BoundingBox3F::length,
             R"pbdoc(
             Returns length of the box in given axis.
             Parameters
             ----------
        ...
        .def("intersects",
             ...
             py::arg("ray"))
        .def("closestIntersection",
             &BoundingBox3F::closestIntersection,
             R"pbdoc(
             Returns closest intersection for given ray.
             Returns intersection.isIntersecting = true if the input ray is
             intersecting with this box. If interesects, intersection.tNear is
        ...
        .def("diagonalLength", &BoundingBox3F::diagonalLength, R"pbdoc(
             Returns diagonal length of this box.)pbdoc")
        .def("diagonalLengthSquared",
             &BoundingBox3F::diagonalLengthSquared,
             R"pbdoc(
             Returns squared diagonal length of this box.
             )pbdoc")
...
{
    py::class_<BoundingBoxRayIntersection3D>(m,
        ...
        .def_readwrite("isIntersecting",
                       ...
                       R"pbdoc(True if the box and ray intersects.)pbdoc")
        .def_readwrite("tNear",
                       &BoundingBoxRayIntersection3D::tNear,
                       R"pbdoc(Distance to the first intersection point.)pbdoc")
        .def_readwrite("tFar",
                       &BoundingBoxRayIntersection3D::tFar,
                       R"pbdoc(
                       Distance to the second (and the last) intersection point.
                       )pbdoc");
    py::class_<BoundingBox3D>(m, "BoundingBox3D", R"pbdoc(
        ...
        .def_property_readonly("width", &BoundingBox3D::width, R"pbdoc(
             Width of the box.)pbdoc")
        .def_property_readonly(
            "height", &BoundingBox3D::height, R"pbdoc(Height of the box.)pbdoc")
        ...
        .def("intersects",
             ...
             py::arg("ray"))
        .def("closestIntersection",
             &BoundingBox3D::closestIntersection,
             R"pbdoc(
             Returns closest intersection for given ray.
             Returns intersection.isIntersecting = true if the input ray is
             intersecting with this box. If interesects, intersection.tNear is
        ...
        .def("diagonalLength", &BoundingBox3D::diagonalLength, R"pbdoc(
             Returns diagonal length of this box.)pbdoc")
        .def("diagonalLengthSquared",
             &BoundingBox3D::diagonalLengthSquared,
             R"pbdoc(
             Returns squared diagonal length of this box.
             )pbdoc")
