...
addSphSystemData2(py::module& m)
{
    py::class_<SphSystemData2, SphSystemData2Ptr, ParticleSystemData2>(
        ...
        .def_property("targetDensity",
                      &SphSystemData2::targetDensity,
                      &SphSystemData2::setTargetDensity,
                      R"pbdoc(
             The target density of this particle system.
             )pbdoc")
        .def_property("targetSpacing",
                      &SphSystemData2::targetSpacing,
        ...
        .def_property("kernelRadius",
                      &SphSystemData2::kernelRadius,
...
addSphSystemData3(py::module& m)
{
    py::class_<SphSystemData3, SphSystemData3Ptr, ParticleSystemData3>(
        ...
        .def_property("targetDensity",
                      &SphSystemData3::targetDensity,
                      &SphSystemData3::setTargetDensity,
                      R"pbdoc(
             The target density of this particle system.
             )pbdoc")
        .def_property("targetSpacing",
                      &SphSystemData3::targetSpacing,
