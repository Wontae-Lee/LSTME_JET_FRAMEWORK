...
void addSphSystemData2(py::module& m) {
    py::class_<SphSystemData2, SphSystemData2Ptr, ParticleSystemData2>(m, "SphSystemData2", R"pbdoc(
        ...
        .def_property_readonly(
            "densities", [](SphSystemData2& instance) { return instance.densities(); },
            R"pbdoc(
             The density array accessor.
             )pbdoc")
        .def_property_readonly(
            "pressures", [](SphSystemData2& instance) { return instance.pressures(); },
            R"pbdoc(
        ...
        .def_property("targetDensity", &SphSystemData2::targetDensity, &SphSystemData2::setTargetDensity,
                      R"pbdoc(
             The target density of this particle system.
             )pbdoc")
        .def_property("targetSpacing", &SphSystemData2::targetSpacing, &SphSystemData2::setTargetSpacing,
                      R"pbdoc(
        ...
        .def_property("relativeKernelRadius", &SphSystemData2::relativeKernelRadius, &SphSystemData2::setRelativeKernelRadius,
                      R"pbdoc(
        ...
        .def_property("kernelRadius", &SphSystemData2::kernelRadius, &SphSystemData2::setKernelRadius,
                      R"pbdoc(
...
void addSphSystemData3(py::module& m) {
    py::class_<SphSystemData3, SphSystemData3Ptr, ParticleSystemData3>(m, "SphSystemData3", R"pbdoc(
        ...
        .def(py::init<size_t>(),
             ...
             py::arg("numberOfParticles") = 0)
        .def_property_readonly(
            "densities", [](SphSystemData3& instance) { return instance.densities(); },
            R"pbdoc(
             The density array accessor.
             )pbdoc")
        .def_property_readonly(
            "pressures", [](SphSystemData3& instance) { return instance.pressures(); },
            R"pbdoc(
             The pressure array accessor.
             )pbdoc")
        ...
        .def_property("targetDensity", &SphSystemData3::targetDensity, &SphSystemData3::setTargetDensity,
                      R"pbdoc(
             The target density of this particle system.
             )pbdoc")
        .def_property("targetSpacing", &SphSystemData3::targetSpacing, &SphSystemData3::setTargetSpacing,
                      R"pbdoc(
             The target particle spacing in meters.
        ...
        .def_property("relativeKernelRadius", &SphSystemData3::relativeKernelRadius, &SphSystemData3::setRelativeKernelRadius,
                      R"pbdoc(
             The relative kernel radius.
        ...
        .def_property("kernelRadius", &SphSystemData3::kernelRadius, &SphSystemData3::setKernelRadius,
                      R"pbdoc(
             The kernel radius in meters unit.
