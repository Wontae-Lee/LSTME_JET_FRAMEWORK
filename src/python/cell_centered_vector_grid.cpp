...
void addCellCenteredVectorGrid2(py::module& m) {
    py::class_<CellCenteredVectorGrid2, CellCenteredVectorGrid2Ptr, CollocatedVectorGrid2>(m, "CellCenteredVectorGrid2",
                                                                                           R"pbdoc(
        ...
        .def(
            "__init__",
            [](CellCenteredVectorGrid2& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &CellCenteredVectorGrid2::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
...
void addCellCenteredVectorGrid3(py::module& m) {
    py::class_<CellCenteredVectorGrid3, CellCenteredVectorGrid3Ptr, CollocatedVectorGrid3>(m, "CellCenteredVectorGrid3",
                                                                                           R"pbdoc(
        ...
        .def(
            "__init__",
            [](CellCenteredVectorGrid3& instance, py::args args, py::kwargs kwargs) {
        ...
        .def_property_readonly("dataSize", &CellCenteredVectorGrid3::dataSize, R"pbdoc(Returns the actual data point size.)pbdoc")
