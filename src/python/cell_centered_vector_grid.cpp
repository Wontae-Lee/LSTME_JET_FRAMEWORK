...
using namespace jet;
void
addCellCenteredVectorGrid2(py::module& m)
{
    py::class_<CellCenteredVectorGrid2,
        ...
        .def(
            "__init__",
            [](CellCenteredVectorGrid2& instance,
               py::args args,
               py::kwargs kwargs) {
...
void
addCellCenteredVectorGrid3(py::module& m)
{
    py::class_<CellCenteredVectorGrid3,
        ...
        .def(
            "__init__",
            [](CellCenteredVectorGrid3& instance,
               py::args args,
               py::kwargs kwargs) {
