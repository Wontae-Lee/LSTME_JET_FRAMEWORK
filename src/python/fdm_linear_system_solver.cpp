...
void addFdmLinearSystemSolver2(py::module& m) {
    py::class_<FdmLinearSystemSolver2, FdmLinearSystemSolver2Ptr>(m, "FdmLinearSystemSolver2",
                                                                  R"pbdoc(
...
void addFdmLinearSystemSolver3(py::module& m) {
    py::class_<FdmLinearSystemSolver3, FdmLinearSystemSolver3Ptr>(m, "FdmLinearSystemSolver3",
                                                                  R"pbdoc(
