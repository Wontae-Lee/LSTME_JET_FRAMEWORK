...
void addGridBackwardEulerDiffusionSolver2(py::module& m) {
    py::class_<GridBackwardEulerDiffusionSolver2, GridBackwardEulerDiffusionSolver2Ptr, GridDiffusionSolver2>(m, "GridBackwardEulerDiffusionSolver2",
                                                                                                              R"pbdoc(
        ...
        .def(
            "solver",
            [](GridBackwardEulerDiffusionSolver2& instance, Grid2Ptr source, double diffusionCoefficient, double timeIntervalInSeconds, Grid2Ptr dest, py::kwargs kwargs) {
...
void addGridBackwardEulerDiffusionSolver3(py::module& m) {
    py::class_<GridBackwardEulerDiffusionSolver3, GridBackwardEulerDiffusionSolver3Ptr, GridDiffusionSolver3>(m, "GridBackwardEulerDiffusionSolver3",
                                                                                                              R"pbdoc(
        ...
        .def(
            "solver",
            [](GridBackwardEulerDiffusionSolver3& instance, Grid3Ptr source, double diffusionCoefficient, double timeIntervalInSeconds, Grid3Ptr dest, py::kwargs kwargs) {
