...
addGridBackwardEulerDiffusionSolver2(py::module& m)
{
    py::class_<GridBackwardEulerDiffusionSolver2,
        ...
        .def(
            "solver",
            [](GridBackwardEulerDiffusionSolver2& instance,
               Grid2Ptr source,
...
addGridBackwardEulerDiffusionSolver3(py::module& m)
{
    py::class_<GridBackwardEulerDiffusionSolver3,
        ...
        .def(
            "solver",
            [](GridBackwardEulerDiffusionSolver3& instance,
               Grid3Ptr source,
               double diffusionCoefficient,
               double timeIntervalInSeconds,
               Grid3Ptr dest,
