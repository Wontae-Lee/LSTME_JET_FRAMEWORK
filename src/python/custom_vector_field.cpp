...
using namespace jet;
void
addCustomVectorField2(py::module& m)
{
    py::class_<CustomVectorField2, CustomVectorField2Ptr, VectorField2>(
        ...
        .def(
            "__init__",
            [](CustomVectorField2& instance,
               py::function func,
               py::function divFunc,
               py::function curlFunc) {
                if (!divFunc) {
...
void
addCustomVectorField3(py::module& m)
{
