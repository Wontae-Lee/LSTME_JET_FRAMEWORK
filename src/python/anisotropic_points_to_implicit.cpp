...
void addAnisotropicPointsToImplicit2(pybind11::module& m) {
    py::class_<AnisotropicPointsToImplicit2, PointsToImplicit2, AnisotropicPointsToImplicit2Ptr>(m, "AnisotropicPointsToImplicit2",
                                                                                                 R"pbdoc(
        ...
        .def(py::init<double, double, double, size_t, bool>(),
             ...
             py::arg("kernelRadius") = 1.0, py::arg("cutOffDensity") = 0.5, py::arg("positionSmoothingFactor") = 0.5, py::arg("minNumNeighbors") = 8, py::arg("isOutputSdf") = true);
}

void addAnisotropicPointsToImplicit3(pybind11::module& m) {
    py::class_<AnisotropicPointsToImplicit3, PointsToImplicit3, AnisotropicPointsToImplicit3Ptr>(m, "AnisotropicPointsToImplicit3",
                                                                                                 R"pbdoc(
        ...
        .def(py::init<double, double, double, size_t, bool>(),
             ...
             py::arg("kernelRadius") = 1.0, py::arg("cutOffDensity") = 0.5, py::arg("positionSmoothingFactor") = 0.5, py::arg("minNumNeighbors") = 25, py::arg("isOutputSdf") = true);
}
