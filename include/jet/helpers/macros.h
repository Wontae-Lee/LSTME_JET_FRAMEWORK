...
#define JET_DISABLE_MSVC_WARNING(gcc_option)
#define JET_ENABLE_MSVC_WARNING(gcc_option)
#define JET_DISABLE_GCC_WARNING(gcc_option) JET_DIAG_PRAGMA(GCC, ignored JET_DIAG_JOINSTR(-W, gcc_option))
#define JET_ENABLE_GCC_WARNING(gcc_option) JET_DIAG_PRAGMA(GCC, warning JET_DIAG_JOINSTR(-W, gcc_option))
#endif
#endif
