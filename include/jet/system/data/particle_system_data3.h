...
#include "jet/searcher/point_neighbor_searcher3.h"
...
class ParticleSystemData3 : public Serializable {
 public:
    ...
    //!
    void addParticles(const ConstArrayAccessor1<Vector3D>& newPositions, const ConstArrayAccessor1<Vector3D>& newVelocities = ConstArrayAccessor1<Vector3D>(),
