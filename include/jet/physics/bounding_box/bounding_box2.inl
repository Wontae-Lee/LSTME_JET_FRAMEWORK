...
template<typename T>
T
BoundingBox<T, 2>::length(size_t axis)
{
...
template<typename T>
bool
BoundingBox<T, 2>::overlaps(const BoundingBox& other) const
{
...
template<typename T>
bool
BoundingBox<T, 2>::contains(const Vector2<T>& point) const
{
...
template<typename T>
bool
BoundingBox<T, 2>::intersects(const Ray2<T>& ray) const
{
  T tMin = 0;
...
BoundingBox<T, 2>::closestIntersection(const Ray2<T>& ray) const
{
...
template<typename T>
Vector2<T>
BoundingBox<T, 2>::midPoint() const
{
...
template<typename T>
T
BoundingBox<T, 2>::diagonalLength() const
{
...
template<typename T>
T
BoundingBox<T, 2>::diagonalLengthSquared() const
{
...
template<typename T>
void
BoundingBox<T, 2>::merge(const Vector2<T>& point)
{
...
template<typename T>
void
BoundingBox<T, 2>::merge(const BoundingBox& other)
{
...
template<typename T>
void
BoundingBox<T, 2>::expand(T delta)
{
  lowerCorner -= delta;
  upperCorner += delta;
}
...
template<typename T>
Vector2<T>
BoundingBox<T, 2>::corner(size_t idx) const
{
...
template<typename T>
Vector2<T>
BoundingBox<T, 2>::clamp(const Vector2<T>& pt) const
{
