...
template<typename T>
BoundingBox<T, 3>::BoundingBox(const BoundingBox<T, 3>& other)
...
template<typename T>
bool
BoundingBox<T, 3>::overlaps(const BoundingBox<T, 3>& other) const
{
...
template<typename T>
bool
BoundingBox<T, 3>::contains(const Vector3<T>& point) const
{
...
template<typename T>
bool
BoundingBox<T, 3>::intersects(const Ray3<T>& ray) const
{
  T tMin = 0;
...
template<typename T>
BoundingBoxRayIntersection3<T>
BoundingBox<T, 3>::closestIntersection(const Ray3<T>& ray) const
{
...
template<typename T>
Vector3<T>
BoundingBox<T, 3>::midPoint() const
{
...
template<typename T>
T
BoundingBox<T, 3>::diagonalLength() const
{
...
template<typename T>
T
BoundingBox<T, 3>::diagonalLengthSquared() const
{
...
template<typename T>
void
BoundingBox<T, 3>::merge(const Vector3<T>& point)
{
...
template<typename T>
void
BoundingBox<T, 3>::merge(const BoundingBox<T, 3>& other)
{
...
template<typename T>
void
BoundingBox<T, 3>::expand(T delta)
{
  lowerCorner -= delta;
  upperCorner += delta;
}
...
template<typename T>
Vector3<T>
BoundingBox<T, 3>::clamp(const Vector3<T>& pt) const
{
