...
Matrix<T, 3, 3> Matrix<T, 3, 3>::add(T s) const {
    return Matrix(_elements[0] + s, _elements[1] + s, _elements[2] + s, _elements[3] + s, _elements[4] + s, _elements[5] + s, _elements[6] + s, _elements[7] + s, _elements[8] + s);
}
...
Matrix<T, 3, 3> Matrix<T, 3, 3>::add(const Matrix& m) const {
    return Matrix(_elements[0] + m._elements[0], _elements[1] + m._elements[1], _elements[2] + m._elements[2], _elements[3] + m._elements[3], _elements[4] + m._elements[4],
                  _elements[5] + m._elements[5], _elements[6] + m._elements[6], _elements[7] + m._elements[7], _elements[8] + m._elements[8]);
}
...
Vector<T, 3> Matrix<T, 3, 3>::mul(const Vector<T, 3>& v) const {
    return Vector<T, 3>(_elements[0] * v.x + _elements[1] * v.y + _elements[2] * v.z, _elements[3] * v.x + _elements[4] * v.y + _elements[5] * v.z,
...
Matrix<T, 3, 3> Matrix<T, 3, 3>::mul(const Matrix& m) const {
    return Matrix(
        _elements[0] * m._elements[0] + _elements[1] * m._elements[3] + _elements[2] * m._elements[6], _elements[0] * m._elements[1] + _elements[1] * m._elements[4] + _elements[2] * m._elements[7],
        _elements[0] * m._elements[2] + _elements[1] * m._elements[5] + _elements[2] * m._elements[8],

        _elements[3] * m._elements[0] + _elements[4] * m._elements[3] + _elements[5] * m._elements[6], _elements[3] * m._elements[1] + _elements[4] * m._elements[4] + _elements[5] * m._elements[7],
        _elements[3] * m._elements[2] + _elements[4] * m._elements[5] + _elements[5] * m._elements[8],

        _elements[6] * m._elements[0] + _elements[7] * m._elements[3] + _elements[8] * m._elements[6], _elements[6] * m._elements[1] + _elements[7] * m._elements[4] + _elements[8] * m._elements[7],
...
Matrix<T, 3, 3> Matrix<T, 3, 3>::radd(T s) const {
    return Matrix(s + _elements[0], s + _elements[1], s + _elements[2], s + _elements[3], s + _elements[4], s + _elements[5], s + _elements[6], s + _elements[7], s + _elements[8]);
}
...
Matrix<T, 3, 3> Matrix<T, 3, 3>::radd(const Matrix& m) const {
    return Matrix(m._elements[0] + _elements[0], m._elements[1] + _elements[1], m._elements[2] + _elements[2], m._elements[3] + _elements[3], m._elements[4] + _elements[4],
                  m._elements[5] + _elements[5], m._elements[6] + _elements[6], m._elements[7] + _elements[7], m._elements[8] + _elements[8]);
}
...
T Matrix<T, 3, 3>::determinant() const {
    return _elements[0] * _elements[4] * _elements[8] - _elements[0] * _elements[5] * _elements[7] + _elements[1] * _elements[5] * _elements[6] - _elements[1] * _elements[3] * _elements[8] +
...
T Matrix<T, 3, 3>::frobeniusNorm() const {
    return std::sqrt(_elements[0] * _elements[0] + _elements[1] * _elements[1] + _elements[2] * _elements[2] + _elements[3] * _elements[3] + _elements[4] * _elements[4] + _elements[5] * _elements[5] +
...
Matrix<U, 3, 3> Matrix<T, 3, 3>::castTo() const {
    return Matrix<U, 3, 3>(static_cast<U>(_elements[0]), static_cast<U>(_elements[1]), static_cast<U>(_elements[2]), static_cast<U>(_elements[3]), static_cast<U>(_elements[4]),
                           static_cast<U>(_elements[5]), static_cast<U>(_elements[6]), static_cast<U>(_elements[7]), static_cast<U>(_elements[8]));
}
...
Matrix<T, 3, 3> Matrix<T, 3, 3>::makeRotationMatrix(const Vector<T, 3>& axis, T rad) {
    return Matrix(1 + (1 - std::cos(rad)) * (axis.x * axis.x - 1), -axis.z * std::sin(rad) + (1 - std::cos(rad)) * axis.x * axis.y, axis.y * std::sin(rad) + (1 - std::cos(rad)) * axis.x * axis.z,

                  axis.z * std::sin(rad) + (1 - std::cos(rad)) * axis.x * axis.y, 1 + (1 - std::cos(rad)) * (axis.y * axis.y - 1), -axis.x * std::sin(rad) + (1 - std::cos(rad)) * axis.y * axis.z,

                  -axis.y * std::sin(rad) + (1 - std::cos(rad)) * axis.x * axis.z, axis.x * std::sin(rad) + (1 - std::cos(rad)) * axis.y * axis.z, 1 + (1 - std::cos(rad)) * (axis.z * axis.z - 1));
}
