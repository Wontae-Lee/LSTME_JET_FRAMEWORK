...
template <typename T>
void ArrayAccessor<T, 2>::set(const ArrayAccessor<T,2>& other) {
...
template <typename T>
void ArrayAccessor<T, 2>::swap(ArrayAccessor<T,2>& other) {
...
template <typename T>
ArrayAccessor<T, 2>& ArrayAccessor<T, 2>::operator=(const ArrayAccessor<T,2>& other) {
    set(other);
    return *this;
}
