...
template<typename T>
void
Array<T, 3>::set(const Array<T, 3>& other)
{
...
template<typename T>
void
Array<T, 3>::set(const std::initializer_list<std::initializer_list<std::initializer_list<T>>>& lst)
{
...
template<typename T>
void
Array<T, 3>::resize(const Size3& size, const T& initVal)
{
  Array grid;
...
template<typename T>
void
Array<T, 3>::resize(size_t width, size_t height, size_t depth, const T& initVal)
{
...
template<typename T>
T&
Array<T, 3>::at(const Point3UI& pt)
{
...
template<typename T>
const T&
Array<T, 3>::at(const Point3UI& pt) const
{
  return at(pt.x, pt.y, pt.z);
}
...
template<typename T>
T&
Array<T, 3>::at(size_t i, size_t j, size_t k)
{
...
template<typename T>
const T&
Array<T, 3>::at(size_t i, size_t j, size_t k) const
{
  JET_ASSERT(i < _size.x && j < _size.y && k < _size.z);
  return _data[i + _size.x * (j + _size.y * k)];
}
...
template<typename T>
const T* const
Array<T, 3>::data() const
{
  return _data.data();
}

template<typename T>
typename Array<T, 3>::ContainerType::iterator
Array<T, 3>::begin()
{
  return _data.begin();
}
...
template<typename T>
typename Array<T, 3>::ContainerType::const_iterator
Array<T, 3>::begin() const
{
  return _data.cbegin();
}
...
template<typename T>
ConstArrayAccessor3<T>
Array<T, 3>::constAccessor() const
{
...
template<typename T>
void
Array<T, 3>::swap(Array<T, 3>& other)
{
...
void
Array<T, 3>::forEach(Callback func) const
{
...
template<typename Callback>
void
Array<T, 3>::forEachIndex(Callback func) const
{
...
template<typename Callback>
void
Array<T, 3>::parallelForEach(Callback func)
{
...
template<typename Callback>
void
Array<T, 3>::parallelForEachIndex(Callback func) const
{
...
template<typename T>
const T&
Array<T, 3>::operator[](size_t i) const
{
  return _data[i];
}
...
template<typename T>
T&
Array<T, 3>::operator()(size_t i, size_t j, size_t k)
{
  JET_ASSERT(i < _size.x && j < _size.y && k < _size.z);
  return _data[i + _size.x * (j + _size.y * k)];
}
...
template<typename T>
const T&
Array<T, 3>::operator()(size_t i, size_t j, size_t k) const
{
  JET_ASSERT(i < _size.x && j < _size.y && k < _size.z);
  return _data[i + _size.x * (j + _size.y * k)];
}
...
template<typename T>
T&
Array<T, 3>::operator()(const Point3UI& pt)
{
...
template<typename T>
const T&
Array<T, 3>::operator()(const Point3UI& pt) const
{
  JET_ASSERT(pt.x < _size.x && pt.y < _size.y && pt.z < _size.z);
  return _data[pt.x + _size.x * (pt.y + _size.y * pt.z)];
}
...
template<typename T>
Array<T, 3>&
Array<T, 3>::operator=(const T& value)
{
  set(value);
  return *this;
}
...
template<typename T>
Array<T, 3>&
Array<T, 3>::operator=(const Array<T, 3>& other)
{
  set(other);
  return *this;
}
...
template<typename T>
Array<T, 3>&
Array<T, 3>::operator=(Array<T, 3>&& other)
{
...
template<typename T>
Array<T, 3>&
Array<T, 3>::operator=(const std::initializer_list<std::initializer_list<std::initializer_list<T>>>& lst)
{
  set(lst);
  return *this;
}
