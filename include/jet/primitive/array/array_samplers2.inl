...
NearestArraySampler2<T, R>::NearestArraySampler(const ConstArrayAccessor2<T>& accessor, const Vector2<R>& gridSpacing, const Vector2<R>& gridOrigin)
{
...
template<typename T, typename R>
NearestArraySampler2<T, R>::NearestArraySampler(const NearestArraySampler<T, R, 2>& other)
{
...
template<typename T, typename R>
T
NearestArraySampler2<T, R>::operator()(const Vector2<R>& x) const
{
  ssize_t i, j;
  R fx, fy;
...
template<typename T, typename R>
void
NearestArraySampler2<T, R>::getCoordinate(const Vector2<R>& x, Point2UI* index) const
{
  ssize_t i, j;
  R fx, fy;
...
template<typename T, typename R>
LinearArraySampler2<T, R>::LinearArraySampler(const ConstArrayAccessor2<T>& accessor, const Vector2<R>& gridSpacing, const Vector2<R>& gridOrigin)
{
  _gridSpacing = gridSpacing;
...
template<typename T, typename R>
LinearArraySampler2<T, R>::LinearArraySampler(const LinearArraySampler<T, R, 2>& other)
{
  _gridSpacing = other._gridSpacing;
...
template<typename T, typename R>
T
LinearArraySampler2<T, R>::operator()(const Vector2<R>& x) const
{
  ssize_t i, j;
  R fx, fy;
...
template<typename T, typename R>
void
LinearArraySampler2<T, R>::getCoordinatesAndWeights(const Vector2<R>& x, std::array<Point2UI, 4>* indices, std::array<R, 4>* weights) const
{
  ssize_t i, j;
  R fx, fy;
...
template<typename T, typename R>
void
LinearArraySampler2<T, R>::getCoordinatesAndGradientWeights(const Vector2<R>& x,
...
template<typename T, typename R>
std::function<T(const Vector2<R>&)>
LinearArraySampler2<T, R>::functor() const
{
...
template<typename T, typename R>
CubicArraySampler2<T, R>::CubicArraySampler(const ConstArrayAccessor2<T>& accessor, const Vector2<R>& gridSpacing, const Vector2<R>& gridOrigin)
{
  _gridSpacing = gridSpacing;
  _origin = gridOrigin;
  _accessor = accessor;
...
template<typename T, typename R>
CubicArraySampler2<T, R>::CubicArraySampler(const CubicArraySampler<T, R, 2>& other)
{
  _gridSpacing = other._gridSpacing;
  _origin = other._origin;
  _accessor = other._accessor;
...
template<typename T, typename R>
T
CubicArraySampler2<T, R>::operator()(const Vector2<R>& x) const
{
  ssize_t i, j;
  const ssize_t iSize = static_cast<ssize_t>(_accessor.size().x);
  const ssize_t jSize = static_cast<ssize_t>(_accessor.size().y);
  ...
  T values[4];
  for (int n = 0; n < 4; ++n) {
    values[n] = monotonicCatmullRom(_accessor(is[0], js[n]), _accessor(is[1], js[n]), _accessor(is[2], js[n]), _accessor(is[3], js[n]), fx);
  }
...
template<typename T, typename R>
std::function<T(const Vector2<R>&)>
CubicArraySampler2<T, R>::functor() const
{
