...
template <typename T, typename R>
std::function<T(const Vector2<R>&)> NearestArraySampler2<T, R>::functor() const {
...
template <typename T, typename R>
void LinearArraySampler2<T, R>::getCoordinatesAndWeights(const Vector2<R>& x, std::array<Point2UI, 4>* indices, std::array<R, 4>* weights) const {
    ssize_t i, j;
    R fx, fy;
...
template <typename T, typename R>
void LinearArraySampler2<T, R>::getCoordinatesAndGradientWeights(const Vector2<R>& x, std::array<Point2UI, 4>* indices, std::array<Vector2<R>, 4>* weights) const {
    ssize_t i, j;
    R fx, fy;
