...
template<typename T>
void
Quadtree<T>::build(const std::vector<T>& items, const BoundingBox2D& bound, const BoxIntersectionTestFunc2<T>& testFunc, size_t maxDepth)
{
  // Reset items
  _maxDepth = maxDepth;
  _items = items;
...
Quadtree<T>::nearest(const Vector2D& pt, const NearestNeighborDistanceFunc2<T>& distanceFunc) const
{
...
template<typename T>
bool
Quadtree<T>::intersects(const BoundingBox2D& box, const BoxIntersectionTestFunc2<T>& testFunc) const
{
...
template<typename T>
bool
Quadtree<T>::intersects(const Ray2D& ray, const RayIntersectionTestFunc2<T>& testFunc) const
{
...
template<typename T>
void
Quadtree<T>::forEachIntersectingItem(const BoundingBox2D& box,
...
template<typename T>
void
Quadtree<T>::forEachIntersectingItem(const Ray2D& ray,
...
template<typename T>
void
Quadtree<T>::build(size_t nodeIdx, size_t depth, const BoundingBox2D& bound, const BoxIntersectionTestFunc2<T>& testFunc)
{
...
template<typename T>
bool
Quadtree<T>::intersects(const BoundingBox2D& box, const BoxIntersectionTestFunc2<T>& testFunc, size_t nodeIdx, const BoundingBox2D& bound) const
{
...
template<typename T>
bool
Quadtree<T>::intersects(const Ray2D& ray, const RayIntersectionTestFunc2<T>& testFunc, size_t nodeIdx, const BoundingBox2D& bound) const
{
