...
template<typename T>
void
Octree<T>::build(const std::vector<T>& items, const BoundingBox3D& bound, const BoxIntersectionTestFunc3<T>& testFunc, size_t maxDepth)
{
  // Reset items
  _maxDepth = maxDepth;
  _items = items;
...
Octree<T>::nearest(const Vector3D& pt, const NearestNeighborDistanceFunc3<T>& distanceFunc) const
{
  ...
  while (node != nullptr) {
    if (node->isLeaf()) {
      ...
      std::sort(childDistSqrPairs.begin(), childDistSqrPairs.end(), [](const NodeDistBox& a, const NodeDistBox& b) {
...
template<typename T>
bool
Octree<T>::intersects(const BoundingBox3D& box, const BoxIntersectionTestFunc3<T>& testFunc) const
{
...
template<typename T>
bool
Octree<T>::intersects(const Ray3D& ray, const RayIntersectionTestFunc3<T>& testFunc) const
{
...
template<typename T>
void
Octree<T>::forEachIntersectingItem(const BoundingBox3D& box,
...
template<typename T>
void
Octree<T>::forEachIntersectingItem(const Ray3D& ray,
...
template<typename T>
typename Octree<T>::ConstIterator
Octree<T>::begin() const
{
  return _items.begin();
}
...
Octree<T>::itemsAtNode(size_t nodeIdx) const
{
...
template<typename T>
size_t
Octree<T>::childIndex(size_t nodeIdx, size_t childIdx) const
{
...
template<typename T>
void
Octree<T>::build(size_t nodeIdx, size_t depth, const BoundingBox3D& bound, const BoxIntersectionTestFunc3<T>& testFunc)
{
...
template<typename T>
bool
Octree<T>::intersects(const BoundingBox3D& box, const BoxIntersectionTestFunc3<T>& testFunc, size_t nodeIdx, const BoundingBox3D& bound) const
{
...
template<typename T>
bool
Octree<T>::intersects(const Ray3D& ray, const RayIntersectionTestFunc3<T>& testFunc, size_t nodeIdx, const BoundingBox3D& bound) const
{
...
template<typename T>
ClosestIntersectionQueryResult3<T>
Octree<T>::closestIntersection(const Ray3D& ray,
