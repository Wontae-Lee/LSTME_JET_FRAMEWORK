...
// Basic setters
inline void
Size2::set(size_t newX, size_t newY)
{
  x = newX;
  y = newY;
}
...
template<typename U>
inline void
Size2::set(const std::initializer_list<U>& lst)
{
  assert(lst.size() >= 2);
...
inline size_t
Size2::dominantAxis() const
{
  return (x > y) ? 0 : 1;
}

inline size_t
Size2::subminantAxis() const
{
  return (x < y) ? 0 : 1;
}

inline bool
Size2::isEqual(const Size2& other) const
{
...
inline bool
Size2::operator==(const Size2& v) const
{
  return isEqual(v);
}
...
// Math functions
inline Size2
operator+(const Size2& a)
{
  return a;
}

inline Size2
operator+(const Size2& a, size_t b)
{
  return a.add(b);
}

inline Size2
operator+(size_t a, const Size2& b)
{
  return b.add(a);
}

inline Size2
operator+(const Size2& a, const Size2& b)
{
  return a.add(b);
}
...
inline Size2
min(const Size2& a, const Size2& b)
{
  return Size2(std::min(a.x, b.x), std::min(a.y, b.y));
}

inline Size2
max(const Size2& a, const Size2& b)
{
  return Size2(std::max(a.x, b.x), std::max(a.y, b.y));
}

inline Size2
clamp(const Size2& v, const Size2& low, const Size2& high)
{
