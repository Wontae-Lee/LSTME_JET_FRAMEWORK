...
inline Size3 min(const Size3& a, const Size3& b) { return Size3(std::min(a.x, b.x), std::min(a.y, b.y), std::min(a.z, b.z)); }

inline Size3 max(const Size3& a, const Size3& b) { return Size3(std::max(a.x, b.x), std::max(a.y, b.y), std::max(a.z, b.z)); }

inline Size3 clamp(const Size3& v, const Size3& low, const Size3& high) { return Size3(clamp(v.x, low.x, high.x), clamp(v.y, low.y, high.y), clamp(v.z, low.z, high.z)); }
