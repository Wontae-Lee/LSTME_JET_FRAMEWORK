...
class VertexCenteredVectorGrid2 final : public CollocatedVectorGrid2 {
 public:
    ...
    //! initial value.
    VertexCenteredVectorGrid2(size_t resolutionX, size_t resolutionY, double gridSpacingX = 1.0, double gridSpacingY = 1.0, double originX = 0.0, double originY = 0.0, double initialValueU = 0.0,
