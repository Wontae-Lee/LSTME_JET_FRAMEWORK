...
class TriangleMesh3 final : public Surface3 {
 public:
    ...
    TriangleMesh3(const PointArray& points, const NormalArray& normals, const UvArray& uvs, const IndexArray& pointIndices, const IndexArray& normalIndices, const IndexArray& uvIndices,
                  const Transform3& transform_ = Transform3(), bool isNormalFlipped = false);
 ...
 private:
    ...
    double fastWindingNumber(const Vector3D& queryPoint, size_t rootNodeIndex, double accuracy) const;
};
