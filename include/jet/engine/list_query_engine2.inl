...
template<typename T>
bool
ListQueryEngine2<T>::intersects(const BoundingBox2D& box, const BoxIntersectionTestFunc2<T>& testFunc) const
{
...
template<typename T>
bool
ListQueryEngine2<T>::intersects(const Ray2D& ray, const RayIntersectionTestFunc2<T>& testFunc) const
{
  for (const auto& item : _items) {
...
template<typename T>
void
ListQueryEngine2<T>::forEachIntersectingItem(const BoundingBox2D& box,
...
template<typename T>
void
ListQueryEngine2<T>::forEachIntersectingItem(const Ray2D& ray,
...
ListQueryEngine2<T>::nearest(const Vector2D& pt, const NearestNeighborDistanceFunc2<T>& distanceFunc) const
{
