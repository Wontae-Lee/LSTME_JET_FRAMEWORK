...
template<typename T>
bool
ListQueryEngine3<T>::intersects(const BoundingBox3D& box, const BoxIntersectionTestFunc3<T>& testFunc) const
{
...
template<typename T>
bool
ListQueryEngine3<T>::intersects(const Ray3D& ray, const RayIntersectionTestFunc3<T>& testFunc) const
{
  for (const auto& item : _items) {
...
template<typename T>
void
ListQueryEngine3<T>::forEachIntersectingItem(const BoundingBox3D& box,
...
template<typename T>
void
ListQueryEngine3<T>::forEachIntersectingItem(const Ray3D& ray,
...
ListQueryEngine3<T>::nearest(const Vector3D& pt, const NearestNeighborDistanceFunc3<T>& distanceFunc) const
{
