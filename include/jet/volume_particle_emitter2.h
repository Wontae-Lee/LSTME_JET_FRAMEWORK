...
class VolumeParticleEmitter2 final : public ParticleEmitter2 {
 public:
    ...
    //! \param[in]  initialVel              The initial velocity of new
    //! particles. \param[in]  linearVel               The linear velocity of
    //! the emitter. \param[in]  angularVel              The angular velocity of
    //! the emitter. \param[in]  maxNumberOfParticles    The max number of
    //! particles to be
    //!                                     emitted.
    //! \param[in]  jitter                  The jitter amount between 0 and 1.
    //! \param[in]  isOneShot               True if emitter gets disabled after
    //! one shot. \param[in]  allowOverlapping        True if particles can be
    //! overlapped. \param[in]  seed                    The random seed.
    //!
