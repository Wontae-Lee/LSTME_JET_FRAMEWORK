...
NearestArraySampler2<T, R>::NearestArraySampler(const ConstArrayAccessor2<T> &accessor, const Vector2<R> &gridSpacing,
...
template <typename T, typename R> NearestArraySampler2<T, R>::NearestArraySampler(const NearestArraySampler &other)
{
...
template <typename T, typename R> T NearestArraySampler2<T, R>::operator()(const Vector2<R> &x) const
{
    ssize_t i, j;
    R fx, fy;
...
template <typename T, typename R>
void NearestArraySampler2<T, R>::getCoordinate(const Vector2<R> &x, Point2UI *index) const
{
    ssize_t i, j;
    R fx, fy;
    JET_ASSERT(_gridSpacing.x > std::numeric_limits<R>::epsilon() &&
...
template <typename T, typename R> std::function<T(const Vector2<R> &)> NearestArraySampler2<T, R>::functor() const
{
...
template <typename T, typename R>
LinearArraySampler2<T, R>::LinearArraySampler(const ConstArrayAccessor2<T> &accessor, const Vector2<R> &gridSpacing,
                                              const Vector2<R> &gridOrigin)
{
    _gridSpacing = gridSpacing;
...
template <typename T, typename R> LinearArraySampler2<T, R>::LinearArraySampler(const LinearArraySampler &other)
{
    _gridSpacing = other._gridSpacing;
...
template <typename T, typename R> T LinearArraySampler2<T, R>::operator()(const Vector2<R> &x) const
{
    ssize_t i, j;
    R fx, fy;
    JET_ASSERT(_gridSpacing.x > std::numeric_limits<R>::epsilon() &&
...
template <typename T, typename R>
void LinearArraySampler2<T, R>::getCoordinatesAndWeights(const Vector2<R> &x, std::array<Point2UI, 4> *indices,
...
template <typename T, typename R>
void LinearArraySampler2<T, R>::getCoordinatesAndGradientWeights(const Vector2<R> &x, std::array<Point2UI, 4> *indices,
...
template <typename T, typename R> std::function<T(const Vector2<R> &)> LinearArraySampler2<T, R>::functor() const
{
...
template <typename T, typename R>
CubicArraySampler2<T, R>::CubicArraySampler(const ConstArrayAccessor2<T> &accessor, const Vector2<R> &gridSpacing,
                                            const Vector2<R> &gridOrigin)
{
    _gridSpacing = gridSpacing;
    _origin = gridOrigin;
...
template <typename T, typename R> CubicArraySampler2<T, R>::CubicArraySampler(const CubicArraySampler &other)
{
    _gridSpacing = other._gridSpacing;
    _origin = other._origin;
    _accessor = other._accessor;
...
template <typename T, typename R> T CubicArraySampler2<T, R>::operator()(const Vector2<R> &x) const
{
    ssize_t i, j;
    const ssize_t iSize = static_cast<ssize_t>(_accessor.size().x);
    const ssize_t jSize = static_cast<ssize_t>(_accessor.size().y);
...
template <typename T, typename R> std::function<T(const Vector2<R> &)> CubicArraySampler2<T, R>::functor() const
{
