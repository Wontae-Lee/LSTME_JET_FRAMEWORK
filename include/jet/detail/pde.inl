...
template <typename T> T upwind1(T *D0, T dx, bool isDirectionPositive)
{
    T invdx = 1 / dx;
    return isDirectionPositive ? (invdx * (D0[1] - D0[0])) : invdx * (D0[2] - D0[1]);
}

template <typename T> T cd2(T *D0, T dx)
{
    T hinvdx = 0.5f / dx;
    return hinvdx * (D0[2] - D0[0]);
}

template <typename T> std::array<T, 2> eno3(T *D0, T dx)
{
    T invdx = 1 / dx;
    T hinvdx = invdx / 2;
    T tinvdx = invdx / 3;
...
template <typename T> T eno3(T *D0, T dx, bool isDirectionPositive)
{
    T invdx = 1 / dx;
    T hinvdx = invdx / 2;
    T tinvdx = invdx / 3;
...
template <typename T> std::array<T, 2> weno5(T *v, T h, T eps)
{
...
template <typename T> T weno5(T *v, T h, bool isDirectionPositive, T eps)
{
    static const T c_1_3 = T(1.0 / 3.0), c_1_4 = T(0.25), c_1_6 = T(1.0 / 6.0);
    static const T c_5_6 = T(5.0 / 6.0), c_7_6 = T(7.0 / 6.0), c_11_6 = T(11.0 / 6.0);
    static const T c_13_12 = T(13.0 / 12.0);
