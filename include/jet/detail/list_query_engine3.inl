...
namespace jet
{
template <typename T> void ListQueryEngine3<T>::add(const T &item)
{
    _items.push_back(item);
}

template <typename T> void ListQueryEngine3<T>::add(const std::vector<T> &items)
{
...
template <typename T>
NearestNeighborQueryResult3<T> ListQueryEngine3<T>::nearest(const Vector3D &pt,
