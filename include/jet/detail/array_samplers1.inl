...
template <typename T, typename R> NearestArraySampler1<T, R>::NearestArraySampler(const NearestArraySampler &other)
{
...
template <typename T, typename R> T NearestArraySampler1<T, R>::operator()(R x) const
{
    ssize_t i;
    R fx;
...
template <typename T, typename R> void NearestArraySampler1<T, R>::getCoordinate(R x, size_t *i) const
{
    R fx;
...
template <typename T, typename R> std::function<T(R)> NearestArraySampler1<T, R>::functor() const
{
...
template <typename T, typename R> LinearArraySampler1<T, R>::LinearArraySampler(const LinearArraySampler &other)
{
    _gridSpacing = other._gridSpacing;
    _origin = other._origin;
    _accessor = other._accessor;
...
template <typename T, typename R> T LinearArraySampler1<T, R>::operator()(R x) const
{
    ssize_t i;
    R fx;
    assert(_gridSpacing > std::numeric_limits<R>::epsilon());
...
template <typename T, typename R> std::function<T(R)> LinearArraySampler1<T, R>::functor() const
{
...
template <typename T, typename R> CubicArraySampler1<T, R>::CubicArraySampler(const CubicArraySampler &other)
{
    _gridSpacing = other._gridSpacing;
    _origin = other._origin;
    _accessor = other._accessor;
...
template <typename T, typename R> T CubicArraySampler1<T, R>::operator()(R x) const
{
    ssize_t i;
    ssize_t iSize = static_cast<ssize_t>(_accessor.size());
    R fx;
...
template <typename T, typename R> std::function<T(R)> CubicArraySampler1<T, R>::functor() const
{
