...
namespace jet
{
template <typename ArrayType, typename T> void setRange1(size_t size, const T &value, ArrayType *output)
{
    setRange1(kZeroSize, size, value, output);
}

template <typename ArrayType, typename T> void setRange1(size_t begin, size_t end, const T &value, ArrayType *output)
{
...
template <typename ArrayType1, typename ArrayType2>
void copyRange3(const ArrayType1 &input, size_t beginX, size_t endX, size_t beginY, size_t endY, size_t beginZ,
