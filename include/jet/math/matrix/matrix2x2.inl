...
Matrix<T, 2, 2> Matrix<T, 2, 2>::mul(const Matrix& m) const {
    return Matrix(_elements[0] * m._elements[0] + _elements[1] * m._elements[2], _elements[0] * m._elements[1] + _elements[1] * m._elements[3],
                  _elements[2] * m._elements[0] + _elements[3] * m._elements[2], _elements[2] * m._elements[1] + _elements[3] * m._elements[3]);
}
