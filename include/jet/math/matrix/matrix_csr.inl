...
template<typename T, typename VE>
size_t
MatrixCsrVectorMul<T, VE>::size() const
{
  return _m.rows();
}
...
template<typename T, typename VE>
T
MatrixCsrVectorMul<T, VE>::operator[](size_t i) const
{
...
template<typename T, typename ME>
Size2
MatrixCsrMatrixMul<T, ME>::size() const
{
  return { rows(), cols() };
}
...
template<typename T, typename ME>
size_t
MatrixCsrMatrixMul<T, ME>::rows() const
{
  return _m1.rows();
}
...
template<typename T, typename ME>
size_t
MatrixCsrMatrixMul<T, ME>::cols() const
{
  return _m2.cols();
}
...
template<typename T, typename ME>
T
MatrixCsrMatrixMul<T, ME>::operator()(size_t i, size_t j) const
{
...
template<typename T>
void
MatrixCsr<T>::set(const MatrixCsr& other)
{
  _size = other._size;
...
template<typename T>
void
MatrixCsr<T>::reserve(size_t rows, size_t cols, size_t numNonZeros)
{
...
template<typename T>
void
MatrixCsr<T>::compress(const std::initializer_list<std::initializer_list<T>>& lst, T epsilon)
{
...
template<typename E>
void
MatrixCsr<T>::compress(const MatrixExpression<T, E>& other, T epsilon)
{
...
template<typename T>
void
MatrixCsr<T>::addElement(size_t i, size_t j, const T& value)
{
...
template<typename T>
void
MatrixCsr<T>::addElement(const Element& element)
{
...
template<typename T>
void
MatrixCsr<T>::addRow(const NonZeroContainerType& nonZeros, const IndexContainerType& columnIndices)
{
  ...
  std::sort(zipped.begin(), zipped.end(), [](std::pair<T, size_t> a, std::pair<T, size_t> b) { return a.second < b.second; });
...
template<typename T>
void
MatrixCsr<T>::setElement(size_t i, size_t j, const T& value)
{
...
template<typename T>
void
MatrixCsr<T>::setElement(const Element& element)
{
...
template<typename T>
bool
MatrixCsr<T>::isEqual(const MatrixCsr& other) const
{
...
template<typename T>
bool
MatrixCsr<T>::isSimilar(const MatrixCsr& other, double tol) const
{
  if (_size != other._size) {
    return false;
  }
...
template<typename T>
size_t
MatrixCsr<T>::numberOfNonZeros() const
{
...
template<typename T>
const T&
MatrixCsr<T>::nonZero(size_t i) const
{
  return _nonZeros[i];
}
...
template<typename T>
const size_t&
MatrixCsr<T>::rowPointer(size_t i) const
{
...
template<typename T>
const size_t&
MatrixCsr<T>::columnIndex(size_t i) const
{
...
template<typename T>
const size_t* const
MatrixCsr<T>::rowPointersData() const
{
...
template<typename T>
const size_t* const
MatrixCsr<T>::columnIndicesData() const
{
  return _columnIndices.data();
}

template<typename T>
typename MatrixCsr<T>::NonZeroIterator
MatrixCsr<T>::nonZeroBegin()
{
  return _nonZeros.begin();
}

template<typename T>
typename MatrixCsr<T>::ConstNonZeroIterator
MatrixCsr<T>::nonZeroBegin() const
{
...
template<typename T>
typename MatrixCsr<T>::ConstNonZeroIterator
MatrixCsr<T>::nonZeroEnd() const
{
  return _nonZeros.cend();
}

template<typename T>
typename MatrixCsr<T>::IndexIterator
MatrixCsr<T>::rowPointersBegin()
{
  return _rowPointers.begin();
}

template<typename T>
typename MatrixCsr<T>::ConstIndexIterator
MatrixCsr<T>::rowPointersBegin() const
{
...
template<typename T>
typename MatrixCsr<T>::ConstIndexIterator
MatrixCsr<T>::rowPointersEnd() const
{
...
template<typename T>
typename MatrixCsr<T>::IndexIterator
MatrixCsr<T>::columnIndicesBegin()
{
...
template<typename T>
typename MatrixCsr<T>::ConstIndexIterator
MatrixCsr<T>::columnIndicesBegin() const
{
...
template<typename T>
typename MatrixCsr<T>::ConstIndexIterator
MatrixCsr<T>::columnIndicesEnd() const
{
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::add(const T& s) const
{
  MatrixCsr ret(*this);
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::add(const MatrixCsr& m) const
{
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::sub(const T& s) const
{
  MatrixCsr ret(*this);
  parallelFor(kZeroSize, ret._nonZeros.size(), [&](size_t i) { ret._nonZeros[i] -= s; });
  return ret;
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::sub(const MatrixCsr& m) const
{
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::mul(const T& s) const
{
  MatrixCsr ret(*this);
  parallelFor(kZeroSize, ret._nonZeros.size(), [&](size_t i) { ret._nonZeros[i] *= s; });
  return ret;
...
MatrixCsrVectorMul<T, VE>
MatrixCsr<T>::mul(const VectorExpression<T, VE>& v) const
{
...
MatrixCsr<T>::mul(const MatrixExpression<T, ME>& m) const
{
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::div(const T& s) const
{
  MatrixCsr ret(*this);
  parallelFor(kZeroSize, ret._nonZeros.size(), [&](size_t i) { ret._nonZeros[i] /= s; });
  return ret;
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::radd(const T& s) const
{
  return add(s);
}
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::radd(const MatrixCsr& m) const
{
  return add(m);
}
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::rsub(const T& s) const
{
  MatrixCsr ret(*this);
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::rsub(const MatrixCsr& m) const
{
  return m.sub(*this);
}
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::rmul(const T& s) const
{
  return mul(s);
}
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::rdiv(const T& s) const
{
  MatrixCsr ret(*this);
  parallelFor(kZeroSize, ret._nonZeros.size(), [&](size_t i) { ret._nonZeros[i] = s / ret._nonZeros[i]; });
  return ret;
...
template<typename T>
void
MatrixCsr<T>::iadd(const MatrixCsr& m)
{
  set(add(m));
}
...
template<typename T>
void
MatrixCsr<T>::isub(const MatrixCsr& m)
{
  set(sub(m));
}
...
template<typename ME>
void
MatrixCsr<T>::imul(const MatrixExpression<T, ME>& m)
{
...
template<typename T>
MatrixCsr<T>&
MatrixCsr<T>::operator=(const MatrixCsr& other)
{
  set(other);
  return *this;
}
...
template<typename T>
MatrixCsr<T>&
MatrixCsr<T>::operator=(MatrixCsr&& other)
{
  _size = other._size;
  other._size = Size2();
...
template<typename T>
MatrixCsr<T>&
MatrixCsr<T>::operator+=(const T& s)
{
  iadd(s);
  return *this;
}
...
template<typename T>
MatrixCsr<T>&
MatrixCsr<T>::operator+=(const MatrixCsr& m)
{
  iadd(m);
  return *this;
}
...
template<typename T>
T
MatrixCsr<T>::operator()(size_t i, size_t j) const
{
...
template<typename T>
bool
MatrixCsr<T>::operator==(const MatrixCsr& m) const
{
  return isEqual(m);
}
...
template<typename T>
MatrixCsr<T>
MatrixCsr<T>::makeIdentity(size_t m)
{
  MatrixCsr ret;
  ret._size = Size2(m, m);
...
template<typename T>
size_t
MatrixCsr<T>::hasElement(size_t i, size_t j) const
{
...
template<typename T>
MatrixCsr<T>
operator+(const MatrixCsr<T>& a, const MatrixCsr<T>& b)
{
  return a.add(b);
}
...
template<typename T>
MatrixCsr<T>
operator+(const MatrixCsr<T>& a, T b)
{
  return a.add(b);
}
...
template<typename T>
MatrixCsr<T>
operator+(T a, const MatrixCsr<T>& b)
{
  return b.add(a);
}
...
template<typename T, typename VE>
MatrixCsrVectorMul<T, VE>
operator*(const MatrixCsr<T>& a, const VectorExpression<T, VE>& b)
{
  return a.mul(b);
}
...
template<typename T, typename ME>
MatrixCsrMatrixMul<T, ME>
operator*(const MatrixCsr<T>& a, const MatrixExpression<T, ME>& b)
{
  return a.mul(b);
}
