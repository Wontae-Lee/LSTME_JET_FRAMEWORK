...
template<typename T>
Vector4<T>
operator+(T a, const Vector4<T>& b);

//! Computes (a.x, a.y, a.z, a.w) + (b, b, b, b).
template<typename T>
Vector4<T>
operator+(const Vector4<T>& a, T b);
...
template<typename T>
Vector4<T>
min(const Vector4<T>& a, const Vector4<T>& b);

//! Returns element-wise max vector.
template<typename T>
Vector4<T>
max(const Vector4<T>& a, const Vector4<T>& b);

//! Returns element-wise clamped vector.
template<typename T>
Vector4<T>
clamp(const Vector4<T>& v, const Vector4<T>& low, const Vector4<T>& high);

//! Returns element-wise ceiled vector.
template<typename T>
Vector4<T>
ceil(const Vector4<T>& a);

//! Returns element-wise floored vector.
template<typename T>
Vector4<T>
floor(const Vector4<T>& a);
...
template<typename T>
Vector4<T>
monotonicCatmullRom(const Vector4<T>& v0, const Vector4<T>& v1, const Vector4<T>& v2, const Vector4<T>& v3, T f);
