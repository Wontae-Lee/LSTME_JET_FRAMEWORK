...
void
setRange1(size_t size, const T& value, ArrayType* output)
{
...
template<typename ArrayType, typename T>
void
setRange1(size_t begin, size_t end, const T& value, ArrayType* output)
{
...
void
copyRange1(const ArrayType1& input, size_t size, ArrayType2* output)
{
...
template<typename ArrayType1, typename ArrayType2>
void
copyRange1(const ArrayType1& input, size_t begin, size_t end, ArrayType2* output)
{
...
template<typename ArrayType1, typename ArrayType2>
void
copyRange2(const ArrayType1& input, size_t sizeX, size_t sizeY, ArrayType2* output)
{
...
template<typename ArrayType1, typename ArrayType2>
void
copyRange2(const ArrayType1& input, size_t beginX, size_t endX, size_t beginY, size_t endY, ArrayType2* output)
{
...
template<typename ArrayType1, typename ArrayType2>
void
copyRange3(const ArrayType1& input, size_t sizeX, size_t sizeY, size_t sizeZ, ArrayType2* output)
{
...
template<typename ArrayType1, typename ArrayType2>
void
copyRange3(const ArrayType1& input, size_t beginX, size_t endX, size_t beginY, size_t endY, size_t beginZ, size_t endZ, ArrayType2* output)
{
  parallelFor(beginX, endX, beginY, endY, beginZ, endZ, [&input, &output](size_t i, size_t j, size_t k) { (*output)(i, j, k) = input(i, j, k); });
}

template<typename T>
void
extrapolateToRegion(const ConstArrayAccessor2<T>& input,
...
template<typename T>
void
extrapolateToRegion(const ConstArrayAccessor3<T>& input,
