...
#define JET_INFO (Logger(LoggingLevel::Info) << Logging::getHeader(LoggingLevel::Info) << "[" << __FILE__ << ":" << __LINE__ << " (" << __func__ << ")] ")
#define JET_WARN (Logger(LoggingLevel::Warn) << Logging::getHeader(LoggingLevel::Warn) << "[" << __FILE__ << ":" << __LINE__ << " (" << __func__ << ")] ")
#define JET_ERROR (Logger(LoggingLevel::Error) << Logging::getHeader(LoggingLevel::Error) << "[" << __FILE__ << ":" << __LINE__ << " (" << __func__ << ")] ")
#define JET_DEBUG (Logger(LoggingLevel::Debug) << Logging::getHeader(LoggingLevel::Debug) << "[" << __FILE__ << ":" << __LINE__ << " (" << __func__ << ")] ")
