...
class FdmMgSolver3 : public FdmLinearSystemSolver3 {
 public:
    ...
    FdmMgSolver3(size_t maxNumberOfLevels, unsigned int numberOfRestrictionIter = 5, unsigned int numberOfCorrectionIter = 5, unsigned int numberOfCoarsestIter = 20,
