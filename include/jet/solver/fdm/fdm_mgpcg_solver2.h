...
class FdmMgpcgSolver2 final : public FdmMgSolver2 {
 public:
    ...
    FdmMgpcgSolver2(unsigned int numberOfCgIter, size_t maxNumberOfLevels, unsigned int numberOfRestrictionIter = 5, unsigned int numberOfCorrectionIter = 5, unsigned int numberOfCoarsestIter = 20,
