...
#include "jet/emitter/grid_emitter3.h"
...
template<typename T>
T&
GridFluidSolverBuilderBase3<T>::withResolution(const Size3& resolution)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase3<T>::withGridSpacing(const Vector3D& gridSpacing)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase3<T>::withGridSpacing(double gridSpacing)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase3<T>::withDomainSizeX(double domainSizeX)
{
...
template<typename T>
T&
GridFluidSolverBuilderBase3<T>::withOrigin(const Vector3D& gridOrigin)
{
...
template<typename T>
Vector3D
GridFluidSolverBuilderBase3<T>::getGridSpacing() const
{
...
public:
  ...
  GridFluidSolver3Ptr makeShared() const { return std::make_shared<GridFluidSolver3>(_resolution, getGridSpacing(), _gridOrigin); }
};
