...
public:
  ...
  //!     field.
  //!
  void advect(const CollocatedVectorGrid2& input,
              const VectorField2& flow,
              double dt,
  ...
  //!     field.
  //!
  void advect(const FaceCenteredGrid2& input,
              const VectorField2& flow,
              double dt,
...
private:
  Vector2D backTrace(const VectorField2& flow, double dt, double h, const Vector2D& pt0, const ScalarField2& boundarySdf);
};
