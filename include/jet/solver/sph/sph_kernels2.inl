...
inline Vector2D SphStdKernel2::gradient(double distance, const Vector2D& directionToCenter) const { return -firstDerivative(distance) * directionToCenter; }
...
inline Vector2D SphSpikyKernel2::gradient(double distance, const Vector2D& directionToCenter) const { return -firstDerivative(distance) * directionToCenter; }
