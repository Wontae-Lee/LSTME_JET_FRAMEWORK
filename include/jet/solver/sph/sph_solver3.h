...
class SphSolver3 : public ParticleSystemSolver3 {
 ...
 protected:
    ...
    void accumulatePressureForce(const ConstArrayAccessor1<Vector3D>& positions, const ConstArrayAccessor1<double>& densities, const ConstArrayAccessor1<double>& pressures,
