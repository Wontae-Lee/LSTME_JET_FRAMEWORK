...
inline double
SphStdKernel3::operator()(double distance) const
{
...
inline double
SphStdKernel3::firstDerivative(double distance) const
{
  if (distance >= h) {
    return 0.0;
  } else {
...
inline Vector3D
SphStdKernel3::gradient(const Vector3D& point) const
{
...
inline Vector3D
SphStdKernel3::gradient(double distance, const Vector3D& directionToCenter) const
{
  return -firstDerivative(distance) * directionToCenter;
}

inline double
SphStdKernel3::secondDerivative(double distance) const
{
  if (distance * distance >= h2) {
    return 0.0;
  } else {
...
inline double
SphSpikyKernel3::operator()(double distance) const
{
  if (distance >= h) {
    return 0.0;
  } else {
...
inline double
SphSpikyKernel3::firstDerivative(double distance) const
{
  if (distance >= h) {
    return 0.0;
  } else {
...
inline Vector3D
SphSpikyKernel3::gradient(const Vector3D& point) const
{
  double dist = point.length();
  if (dist > 0.0) {
    return gradient(dist, point / dist);
...
inline Vector3D
SphSpikyKernel3::gradient(double distance, const Vector3D& directionToCenter) const
{
  return -firstDerivative(distance) * directionToCenter;
}

inline double
SphSpikyKernel3::secondDerivative(double distance) const
{
  if (distance >= h) {
    return 0.0;
  } else {
