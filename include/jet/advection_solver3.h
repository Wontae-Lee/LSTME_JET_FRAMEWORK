...
class AdvectionSolver3 {
 public:
    ...
    //!
    virtual void advect(
        const ScalarGrid3& input, const VectorField3& flow, double dt,
        ScalarGrid3* output,
    ...
    //!
    virtual void advect(
        const CollocatedVectorGrid3& input, const VectorField3& flow, double dt,
    ...
    //!
    virtual void advect(
        const FaceCenteredGrid3& input, const VectorField3& flow, double dt,
